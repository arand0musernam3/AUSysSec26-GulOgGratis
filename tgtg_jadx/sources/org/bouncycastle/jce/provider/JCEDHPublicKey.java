...
public class JCEDHPublicKey implements DHPublicKey {
    ...
    private BigInteger f33319y;

    public JCEDHPublicKey(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        this.info = subjectPublicKeyInfo;
        try {
            this.f33319y = ((ASN1Integer) subjectPublicKeyInfo.parsePublicKey()).getValue();
            ...
            if (!algorithm.equals((ASN1Primitive) X9ObjectIdentifiers.dhpublicnumber)) {
                i4.a.f(s.l("unknown algorithm type: ", algorithm));
                throw null;
            }
            ...
            i4.a.f("invalid info structure in DH public key");
            throw null;
        }
    }
    ...
    private void readObject(ObjectInputStream objectInputStream) throws IOException, ClassNotFoundException {
        this.f33319y = (BigInteger) objectInputStream.readObject();
    ...
    public byte[] getEncoded() {
        ...
        return subjectPublicKeyInfo != null ? KeyUtil.getEncodedSubjectPublicKeyInfo(subjectPublicKeyInfo) : KeyUtil.getEncodedSubjectPublicKeyInfo(new AlgorithmIdentifier(PKCSObjectIdentifiers.dhKeyAgreement, new DHParameter(this.dhSpec.getP(), this.dhSpec.getG(), this.dhSpec.getL())), new ASN1Integer(this.f33319y));
    }
    ...
    public JCEDHPublicKey(DHPublicKey dHPublicKey) {
        this.f33319y = dHPublicKey.getY();
        this.dhSpec = dHPublicKey.getParams();
    }

    public JCEDHPublicKey(DHPublicKeySpec dHPublicKeySpec) {
        this.f33319y = dHPublicKeySpec.getY();
        this.dhSpec = new DHParameterSpec(dHPublicKeySpec.getP(), dHPublicKeySpec.getG());
    }

    public JCEDHPublicKey(BigInteger bigInteger, DHParameterSpec dHParameterSpec) {
        this.f33319y = bigInteger;
        this.dhSpec = dHParameterSpec;
    }

    public JCEDHPublicKey(DHPublicKeyParameters dHPublicKeyParameters) {
        this.f33319y = dHPublicKeyParameters.getY();
