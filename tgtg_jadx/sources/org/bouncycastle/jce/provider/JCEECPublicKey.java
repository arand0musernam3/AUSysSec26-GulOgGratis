...
public class JCEECPublicKey implements ECPublicKey, org.bouncycastle.jce.interfaces.ECPublicKey, ECPointEncoder {
    ...
    public JCEECPublicKey(String str, ECPublicKeySpec eCPublicKeySpec) {
        ...
        if (eCPublicKeySpec.getParams() != null) {
            ...
            if (this.f33321q.getCurve() == null) {
                this.f33321q = BouncyCastleProvider.CONFIGURATION.getEcImplicitlyCa().getCurve().createPoint(this.f33321q.getAffineXCoord().toBigInteger(), this.f33321q.getAffineYCoord().toBigInteger());
            }
    ...
    private void populateFromPubKeyInfo(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        ...
        if (algorithm.getAlgorithm().equals((ASN1Primitive) CryptoProObjectIdentifiers.gostR3410_2001)) {
            ...
            try {
                ...
                this.f33321q = curve2.decodePoint(bArr);
                ...
                i4.a.f("error recovering public key");
                return;
            }
        }
        ...
        if (bytes[0] == 4 && bytes[1] == bytes.length - 2 && (((b8 = bytes[2]) == 2 || b8 == 3) && new X9IntegerConverter().getByteLength(curve) >= bytes.length - 3)) {
            try {
        ...
        this.f33321q = new X9ECPoint(curve, dEROctetString).getPoint();
    }
    ...
    public byte[] getEncoded() {
        ...
        if (this.algorithm.equals("ECGOST3410")) {
            ...
            BigInteger bigInteger = this.f33321q.getAffineXCoord().toBigInteger();
            BigInteger bigInteger2 = this.f33321q.getAffineYCoord().toBigInteger();
    ...
    public String toString() {
        ...
        stringBuffer.append(this.f33321q.getAffineXCoord().toBigInteger().toString(16));
        stringBuffer.append(strLineSeparator);
        stringBuffer.append("            Y: ");
        stringBuffer.append(this.f33321q.getAffineYCoord().toBigInteger().toString(16));
        stringBuffer.append(strLineSeparator);
    ...
    public JCEECPublicKey(String str, ECPublicKeyParameters eCPublicKeyParameters) {
        this.algorithm = str;
        this.f33321q = eCPublicKeyParameters.getQ();
        this.ecSpec = null;
    }
    ...
    public JCEECPublicKey(String str, JCEECPublicKey jCEECPublicKey) {
        this.algorithm = str;
        this.f33321q = jCEECPublicKey.f33321q;
    ...
    public JCEECPublicKey(String str, java.security.spec.ECPublicKeySpec eCPublicKeySpec) {
        ...
        this.ecSpec = params;
        this.f33321q = EC5Util.convertPoint(params, eCPublicKeySpec.getW());
    }
    ...
    public JCEECPublicKey(ECPublicKey eCPublicKey) {
        ...
        this.ecSpec = params;
        this.f33321q = EC5Util.convertPoint(params, eCPublicKey.getW());
    }
