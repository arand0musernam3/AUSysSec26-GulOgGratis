...
public class X509CRLEntryObject extends X509CRLEntry {
    ...
    private X500Name loadCertificateIssuer(boolean z11, X500Name x500Name) {
        ...
        ASN1OctetString extensionValue = Extensions.getExtensionValue(this.f33328c.getExtensions(), Extension.certificateIssuer);
    ...
    public boolean equals(Object obj) {
        ...
        return obj instanceof X509CRLEntryObject ? this.f33328c.equals(((X509CRLEntryObject) obj).f33328c) : super.equals(this);
    }
    ...
    public byte[] getEncoded() throws CRLException {
        try {
            return this.f33328c.getEncoded(ASN1Encoding.DER);
    ...
    public byte[] getExtensionValue(String str) {
        return X509SignatureUtil.getExtensionValue(this.f33328c.getExtensions(), str);
    }
    ...
    public Date getRevocationDate() {
        return this.f33328c.getRevocationDate().getDate();
    }

    @Override // java.security.cert.X509CRLEntry
    public BigInteger getSerialNumber() {
        return this.f33328c.getUserCertificate().getValue();
    }

    @Override // java.security.cert.X509CRLEntry
    public boolean hasExtensions() {
        return this.f33328c.getExtensions() != null;
    }
