...
public class PKCS12Util {
    private static byte[] calculatePbeMac(ASN1ObjectIdentifier aSN1ObjectIdentifier, byte[] bArr, int i11, char[] cArr, byte[] bArr2, String str) throws Exception {
    ...
    public static byte[] convertToDefiniteLength(byte[] bArr, char[] cArr, String str) throws IOException {
        ...
        try {
            ...
            a.k(s.i(e5, new StringBuilder("error constructing MAC: ")));
            return null;
        }
    }
