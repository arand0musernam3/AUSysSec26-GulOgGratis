    ...
    */
    public PKCS10CertificationRequest(java.lang.String r5, org.bouncycastle.asn1.x509.X509Name r6, java.security.PublicKey r7, org.bouncycastle.asn1.ASN1Set r8, java.security.PrivateKey r9, java.lang.String r10) throws java.security.NoSuchAlgorithmException, java.security.SignatureException, java.security.InvalidKeyException, java.security.NoSuchProviderException {
        ...
        L52:
            ...
            org.bouncycastle.asn1.ASN1Primitive r7 = org.bouncycastle.asn1.ASN1Primitive.fromByteArray(r7)     // Catch: java.io.IOException -> L98
            org.bouncycastle.asn1.ASN1Sequence r7 = (org.bouncycastle.asn1.ASN1Sequence) r7     // Catch: java.io.IOException -> L98
            org.bouncycastle.asn1.pkcs.CertificationRequestInfo r0 = new org.bouncycastle.asn1.pkcs.CertificationRequestInfo     // Catch: java.io.IOException -> L98
            org.bouncycastle.asn1.x509.SubjectPublicKeyInfo r7 = org.bouncycastle.asn1.x509.SubjectPublicKeyInfo.getInstance(r7)     // Catch: java.io.IOException -> L98
            r0.<init>(r6, r7, r8)     // Catch: java.io.IOException -> L98
            r4.reqInfo = r0     // Catch: java.io.IOException -> L98
            if (r10 != 0) goto L6e
        ...
        L72:
            r5.initSign(r9)
            org.bouncycastle.asn1.pkcs.CertificationRequestInfo r6 = r4.reqInfo     // Catch: java.lang.Exception -> L8c
            java.lang.String r7 = "DER"
            byte[] r6 = r6.getEncoded(r7)     // Catch: java.lang.Exception -> L8c
        ...
        L8c:
            r5 = move-exception
            java.lang.String r6 = "exception encoding TBS cert request - "
            java.lang.String r5 = b3.i.l(r6, r5)
            i4.a.f(r5)
            r5 = 0
            throw r5
        L98:
    ...
    public static String getSignatureName(AlgorithmIdentifier algorithmIdentifier) {
        ...
        return k.p(new StringBuilder(), getDigestAlgName(RSASSAPSSparams.getInstance(parameters).getHashAlgorithm().getAlgorithm()), "withRSAandMGF1");
    }
    ...
    /* JADX WARN: Type inference failed for: r7v7, types: [java.security.PublicKey] */
    public PublicKey getPublicKey(String str) throws NoSuchAlgorithmException, InvalidKeyException, NoSuchProviderException {
        ...
        try {
            ...
            org.bouncycastle.jce.provider.a.i("error decoding public key");
            return null;
        }
    }
    ...
    public boolean verify(PublicKey publicKey, String str) throws NoSuchAlgorithmException, SignatureException, InvalidKeyException, NoSuchProviderException {
        ...
        try {
            str = str == 0 ? Signature.getInstance(getSignatureName(algorithmIdentifier)) : Signature.getInstance(getSignatureName(algorithmIdentifier), (String) str);
        } catch (NoSuchAlgorithmException e5) {
        ...
        try {
            ...
            throw new SignatureException(i.l("exception encoding TBS cert request - ", e11));
        }
    }
