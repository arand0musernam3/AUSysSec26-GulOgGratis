...
public class IDEACBCPar extends ASN1Object {
    ...
    ASN1OctetString f33279iv;

    private IDEACBCPar(ASN1Sequence aSN1Sequence) {
        this.f33279iv = aSN1Sequence.size() == 1 ? (ASN1OctetString) aSN1Sequence.getObjectAt(0) : null;
    }
    ...
    public byte[] getIV() {
        ASN1OctetString aSN1OctetString = this.f33279iv;
    ...
    public IDEACBCPar(byte[] bArr) {
        this.f33279iv = new DEROctetString(Arrays.clone(bArr));
    }
}
