...
public class ScryptParams extends ASN1Object {
    ...
    private ScryptParams(ASN1Sequence aSN1Sequence) {
        if (aSN1Sequence.size() != 4 && aSN1Sequence.size() != 5) {
            a.f(s.p(aSN1Sequence, new StringBuilder("invalid sequence: size = ")));
            throw null;
        }
        this.salt = s.D(aSN1Sequence, 0);
    ...
    public ScryptParams(byte[] bArr, int i11, int i12, int i13) {
        this(bArr, BigInteger.valueOf(i11), BigInteger.valueOf(i12), BigInteger.valueOf(i13), (BigInteger) null);
    }

    public ScryptParams(byte[] bArr, int i11, int i12, int i13, int i14) {
