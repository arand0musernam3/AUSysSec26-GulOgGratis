                ...
                if (!this.targetNames.isEmpty()) {
                    ...
                    for (Targets targets : targetsObjects) {
                        ...
                        while (true) {
                            ...
                            if (this.targetNames.contains(GeneralName.getInstance(targets2[i11].getTargetName()))) {
                                z11 = true;
                                break;
                            }
                            i11++;
            ...
            if (!this.targetGroups.isEmpty()) {
                ...
                for (Targets targets3 : targetsObjects) {
                    ...
                    while (true) {
                        ...
                        if (this.targetGroups.contains(GeneralName.getInstance(targets4[i12].getTargetGroup()))) {
                            z12 = true;
                            break;
                        }
                        i12++;
