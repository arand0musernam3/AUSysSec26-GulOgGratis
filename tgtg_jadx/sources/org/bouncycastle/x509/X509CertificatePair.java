...
public class X509CertificatePair {
    ...
    public boolean equals(Object obj) {
        ...
        boolean zEquals = x509Certificate != null ? x509Certificate.equals(x509Certificate2) : x509Certificate2 == null;
        X509Certificate x509Certificate3 = this.reverse;
        X509Certificate x509Certificate4 = x509CertificatePair.reverse;
        return zEquals && (x509Certificate3 != null ? x509Certificate3.equals(x509Certificate4) : x509Certificate4 == null);
    }
    ...
    public byte[] getEncoded() throws CertificateEncodingException {
        ...
        try {
            ...
            throw new ExtCertificateEncodingException(e5.toString(), e5);
