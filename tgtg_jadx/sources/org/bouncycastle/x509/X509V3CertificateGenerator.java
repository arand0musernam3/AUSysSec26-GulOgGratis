...
public class X509V3CertificateGenerator {
    ...
    public void copyAndAddExtension(String str, boolean z11, X509Certificate x509Certificate) throws CertificateParsingException {
        byte[] extensionValue = x509Certificate.getExtensionValue(str);
        if (extensionValue == null) {
            throw new CertificateParsingException(a0.p("extension ", str, " not present"));
        }
        try {
            addExtension(str, z11, X509ExtensionUtil.fromExtensionValue(extensionValue));
        } catch (IOException e5) {
            throw new CertificateParsingException(e5.toString());
        }
    }
    ...
    public void setIssuerDN(X500Principal x500Principal) {
        try {
            ...
            a.f(i.k("can't process principal: ", e5));
        }
    }
    ...
    public void setPublicKey(PublicKey publicKey) throws IllegalArgumentException {
        try {
            ...
            a.f(s.i(e5, new StringBuilder("unable to process key - ")));
        }
    }
    ...
    public void setSerialNumber(BigInteger bigInteger) {
        if (bigInteger.compareTo(BigInteger.ZERO) > 0) {
            ...
            a.f("serial number must be a positive integer");
        }
    }
    ...
    public void setSignatureAlgorithm(String str) {
        ...
        try {
            ...
            a.f(f.k("Unknown signature type requested: ", str));
        }
    }
    ...
    public void copyAndAddExtension(ASN1ObjectIdentifier aSN1ObjectIdentifier, boolean z11, X509Certificate x509Certificate) throws CertificateParsingException {
