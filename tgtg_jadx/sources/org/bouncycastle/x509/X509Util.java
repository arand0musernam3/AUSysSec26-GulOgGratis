...
class X509Util {
    ...
    public static byte[] calculateSignature(ASN1ObjectIdentifier aSN1ObjectIdentifier, String str, String str2, PrivateKey privateKey, SecureRandom secureRandom, ASN1Encodable aSN1Encodable) throws NoSuchAlgorithmException, SignatureException, InvalidKeyException, IOException, NoSuchProviderException {
        if (aSN1ObjectIdentifier == null) {
            h2.b("no signature algorithm specified");
            return null;
        }
    ...
    public static Implementation getImplementation(String str, String str2, Provider provider) throws NoSuchAlgorithmException {
        ...
        if (property2 == null) {
            StringBuilder sbS = f.s("cannot find implementation ", upperCase, " for provider ");
            sbS.append(provider.getName());
            throw new NoSuchAlgorithmException(sbS.toString());
        }
        try {
            ...
            StringBuilder sbS2 = f.s("algorithm ", upperCase, " in provider ");
            sbS2.append(provider.getName());
            sbS2.append(" but no class \"");
            sbS2.append(property2);
            sbS2.append("\" found!");
            throw new IllegalStateException(sbS2.toString());
        } catch (Exception unused2) {
            StringBuilder sbS3 = f.s("algorithm ", upperCase, " in provider ");
            sbS3.append(provider.getName());
            sbS3.append(" but class \"");
            sbS3.append(property2);
            sbS3.append("\" inaccessible!");
            throw new IllegalStateException(sbS3.toString());
        }
    }
    ...
    public static Provider getProvider(String str) throws NoSuchProviderException {
        ...
        throw new NoSuchProviderException(a0.p("Provider ", str, " not found"));
    }
    ...
    public static Implementation getImplementation(String str, String str2) throws NoSuchAlgorithmException {
        ...
        throw new NoSuchAlgorithmException(f.k("cannot find implementation ", str2));
    }
}
