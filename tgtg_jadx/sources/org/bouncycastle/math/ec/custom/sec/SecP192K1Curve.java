...
public class SecP192K1Curve extends ECCurve.AbstractFp {
    ...
    public static final BigInteger f33382q = SecP192K1FieldElement.Q;
    ...
    public SecP192K1Curve() {
        ...
        this.f33352b = fromBigInteger(BigInteger.valueOf(3L));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i11, final int i12) {
        ...
        for (int i14 = 0; i14 < i12; i14++) {
            ...
            Nat192.copy(((SecP192K1FieldElement) eCPoint.getRawXCoord()).f33383x, 0, iArr, i13);
            Nat192.copy(((SecP192K1FieldElement) eCPoint.getRawYCoord()).f33383x, 0, iArr, i13 + 6);
            i13 += 12;
        }
