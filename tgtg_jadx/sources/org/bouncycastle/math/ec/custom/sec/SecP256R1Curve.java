...
public class SecP256R1Curve extends ECCurve.AbstractFp {
    ...
    public static final BigInteger f33392q = SecP256R1FieldElement.Q;
    ...
    public SecP256R1Curve() {
        ...
        this.f33351a = fromBigInteger(new BigInteger(1, Hex.decodeStrict("FFFFFFFF00000001000000000000000000000000FFFFFFFFFFFFFFFFFFFFFFFC")));
        this.f33352b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("5AC635D8AA3A93E7B3EBBD55769886BC651D06B0CC53B0F63BCE3C3E27D2604B")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i11, final int i12) {
        ...
        for (int i14 = 0; i14 < i12; i14++) {
            ...
            Nat256.copy(((SecP256R1FieldElement) eCPoint.getRawXCoord()).f33393x, 0, iArr, i13);
            Nat256.copy(((SecP256R1FieldElement) eCPoint.getRawYCoord()).f33393x, 0, iArr, i13 + 8);
            i13 += 16;
        }
