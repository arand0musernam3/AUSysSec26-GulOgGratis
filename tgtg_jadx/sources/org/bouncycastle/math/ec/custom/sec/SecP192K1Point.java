...
public class SecP192K1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        SecP192K1FieldElement secP192K1FieldElement = (SecP192K1FieldElement) this.f33366x;
        SecP192K1FieldElement secP192K1FieldElement2 = (SecP192K1FieldElement) this.f33367y;
        ...
        SecP192K1FieldElement secP192K1FieldElement5 = (SecP192K1FieldElement) this.f33368zs[0];
        ...
        if (zIsOne) {
            iArr = secP192K1FieldElement3.f33383x;
            iArr2 = secP192K1FieldElement4.f33383x;
        } else {
            SecP192K1Field.square(secP192K1FieldElement5.f33383x, iArrCreate2);
            SecP192K1Field.multiply(iArrCreate2, secP192K1FieldElement3.f33383x, iArrCreate);
            SecP192K1Field.multiply(iArrCreate2, secP192K1FieldElement5.f33383x, iArrCreate2);
            SecP192K1Field.multiply(iArrCreate2, secP192K1FieldElement4.f33383x, iArrCreate2);
            iArr = iArrCreate;
            iArr2 = iArrCreate2;
        }
        boolean zIsOne2 = secP192K1FieldElement6.isOne();
        if (zIsOne2) {
            iArr3 = secP192K1FieldElement.f33383x;
            iArr4 = secP192K1FieldElement2.f33383x;
        } else {
            SecP192K1Field.square(secP192K1FieldElement6.f33383x, iArrCreate3);
            SecP192K1Field.multiply(iArrCreate3, secP192K1FieldElement.f33383x, iArrCreateExt);
            SecP192K1Field.multiply(iArrCreate3, secP192K1FieldElement6.f33383x, iArrCreate3);
            SecP192K1Field.multiply(iArrCreate3, secP192K1FieldElement2.f33383x, iArrCreate3);
            iArr3 = iArrCreateExt;
            iArr4 = iArrCreate3;
        }
        ...
        SecP192K1Field.square(iArrCreate, secP192K1FieldElement7.f33383x);
        int[] iArr5 = secP192K1FieldElement7.f33383x;
        ...
        SecP192K1Field.subtract(iArrCreate2, secP192K1FieldElement7.f33383x, secP192K1FieldElement8.f33383x);
        SecP192K1Field.multiplyAddToExt(secP192K1FieldElement8.f33383x, iArrCreate, iArrCreateExt);
        SecP192K1Field.reduce(iArrCreateExt, secP192K1FieldElement8.f33383x);
        SecP192K1FieldElement secP192K1FieldElement9 = new SecP192K1FieldElement(iArrCreate4);
        if (!zIsOne) {
            int[] iArr6 = secP192K1FieldElement9.f33383x;
            SecP192K1Field.multiply(iArr6, secP192K1FieldElement5.f33383x, iArr6);
        }
        if (!zIsOne2) {
            int[] iArr7 = secP192K1FieldElement9.f33383x;
            SecP192K1Field.multiply(iArr7, secP192K1FieldElement6.f33383x, iArr7);
        }
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new SecP192K1Point(this.curve, this.f33366x, this.f33367y.negate(), this.f33368zs);
    }
    ...
    public ECPoint twice() {
        ...
        ECCurve curve = getCurve();
        SecP192K1FieldElement secP192K1FieldElement = (SecP192K1FieldElement) this.f33367y;
        if (secP192K1FieldElement.isZero()) {
            return curve.getInfinity();
        }
        SecP192K1FieldElement secP192K1FieldElement2 = (SecP192K1FieldElement) this.f33366x;
        SecP192K1FieldElement secP192K1FieldElement3 = (SecP192K1FieldElement) this.f33368zs[0];
        int[] iArrCreate = Nat192.create();
        SecP192K1Field.square(secP192K1FieldElement.f33383x, iArrCreate);
        int[] iArrCreate2 = Nat192.create();
        SecP192K1Field.square(iArrCreate, iArrCreate2);
        int[] iArrCreate3 = Nat192.create();
        SecP192K1Field.square(secP192K1FieldElement2.f33383x, iArrCreate3);
        SecP192K1Field.reduce32(Nat192.addBothTo(iArrCreate3, iArrCreate3, iArrCreate3), iArrCreate3);
        SecP192K1Field.multiply(iArrCreate, secP192K1FieldElement2.f33383x, iArrCreate);
        ...
        SecP192K1Field.square(iArrCreate3, secP192K1FieldElement4.f33383x);
        int[] iArr = secP192K1FieldElement4.f33383x;
        SecP192K1Field.subtract(iArr, iArrCreate, iArr);
        int[] iArr2 = secP192K1FieldElement4.f33383x;
        ...
        SecP192K1Field.subtract(iArrCreate, secP192K1FieldElement4.f33383x, secP192K1FieldElement5.f33383x);
        int[] iArr3 = secP192K1FieldElement5.f33383x;
        SecP192K1Field.multiply(iArr3, iArrCreate3, iArr3);
        int[] iArr4 = secP192K1FieldElement5.f33383x;
        ...
        SecP192K1Field.twice(secP192K1FieldElement.f33383x, secP192K1FieldElement6.f33383x);
        if (!secP192K1FieldElement3.isOne()) {
            int[] iArr5 = secP192K1FieldElement6.f33383x;
            SecP192K1Field.multiply(iArr5, secP192K1FieldElement3.f33383x, iArr5);
        }
