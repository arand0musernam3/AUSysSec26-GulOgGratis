...
public class SecT409R1Curve extends ECCurve.AbstractF2m {
    ...
    public SecT409R1Curve() {
        ...
        this.f33352b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("0021A5C2C8EE9FEB5C4B9A753B7B476B7FD6422EF1F3DD674761FA99D6AC27C8A9A197B272822F6CD57A55AA4F50AE317B13545F")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i11, final int i12) {
        final long[] jArr = new long[i12 * 14];
        int i13 = 0;
        for (int i14 = 0; i14 < i12; i14++) {
            ECPoint eCPoint = eCPointArr[i11 + i14];
            Nat448.copy64(((SecT409FieldElement) eCPoint.getRawXCoord()).f33405x, 0, jArr, i13);
            Nat448.copy64(((SecT409FieldElement) eCPoint.getRawYCoord()).f33405x, 0, jArr, i13 + 7);
            i13 += 14;
        }
        return new AbstractECLookupTable() { // from class: org.bouncycastle.math.ec.custom.sec.SecT409R1Curve.1
            ...
            public ECPoint lookup(int i15) {
                ...
                for (int i17 = 0; i17 < i12; i17++) {
                    ...
                    for (int i18 = 0; i18 < 7; i18++) {
                        ...
                        jArrCreate642[i18] = jArrCreate642[i18] ^ (jArr2[(i16 + 7) + i18] & j9);
                    }
                    i16 += 14;
                }
            ...
            public ECPoint lookupVar(int i15) {
                ...
                for (int i17 = 0; i17 < 7; i17++) {
                    ...
                    jArrCreate642[i17] = jArr2[7 + i16 + i17];
                }
                return createPoint(jArrCreate64, jArrCreate642);
            }
        };
