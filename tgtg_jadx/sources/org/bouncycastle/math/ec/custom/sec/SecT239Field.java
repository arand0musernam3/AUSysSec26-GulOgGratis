...
public class SecT239Field {
    ...
    public static void implMulwAcc(long[] jArr, long j9, long j11, long[] jArr2, int i11) {
        ...
        jArr2[i11] = jArr2[i11] ^ (M60 & j16);
        int i15 = i11 + 1;
        jArr2[i15] = ((((((j9 & 585610922974906400L) & ((j11 << 4) >> 63)) >>> 5) ^ j17) << 4) ^ (j16 >>> 60)) ^ jArr2[i15];
    }
    ...
    public static void reduce(long[] jArr, long[] jArr2) {
        ...
        long j21 = ((j14 ^ (j17 >>> 47)) ^ (j18 << 47)) ^ (j19 >>> 17);
        long j22 = j9 ^ (j21 << 17);
        long j23 = (j11 ^ (j19 << 17)) ^ (j21 >>> 47);
        long j24 = ((j12 ^ (j18 << 17)) ^ (j19 >>> 47)) ^ (j21 << 47);
        long j25 = (((j13 ^ (j17 << 17)) ^ (j18 >>> 47)) ^ (j19 << 47)) ^ (j21 >>> 17);
        long j26 = j25 >>> 47;
        jArr2[0] = j22 ^ j26;
        jArr2[1] = j23;
        jArr2[2] = (j26 << 30) ^ j24;
    ...
    public static void sqrt(long[] jArr, long[] jArr2) {
        ...
        while (i12 < i11) {
            ...
            int i14 = i13 >>> 6;
            int i15 = i13 & 63;
            jArrCreateExt64[i14] = jArrCreateExt64[i14] ^ (j11 << i15);
            int i16 = i14 + 1;
            int[] iArr2 = iArr;
            int i17 = -i15;
            jArrCreateExt64[i16] = jArrCreateExt64[i16] ^ ((j16 << i15) | (j11 >>> i17));
            int i18 = i14 + 2;
            jArrCreateExt64[i18] = jArrCreateExt64[i18] ^ ((j15 << i15) | (j16 >>> i17));
            int i19 = i14 + 3;
            jArrCreateExt64[i19] = jArrCreateExt64[i19] ^ ((j14 << i15) | (j15 >>> i17));
            int i21 = i14 + 4;
            jArrCreateExt64[i21] = jArrCreateExt64[i21] ^ (j14 >>> i17);
            i12++;
            i11 = 2;
            iArr = iArr2;
        }
