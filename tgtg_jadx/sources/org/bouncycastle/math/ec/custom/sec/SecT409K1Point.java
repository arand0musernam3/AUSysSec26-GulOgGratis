    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (rawXCoord.isZero()) {
            ...
            if (eCFieldElementT.isZero()) {
                return new SecT409K1Point(curve, eCFieldElementT, curve.getB());
            }
        ...
        return new SecT409K1Point(curve, eCFieldElementT, eCFieldElementAdd, new ECFieldElement[]{eCFieldElementFromBigInteger});
    }
