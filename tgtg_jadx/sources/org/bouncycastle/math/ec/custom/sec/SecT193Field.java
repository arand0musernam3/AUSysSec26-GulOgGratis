...
public class SecT193Field {
    ...
    public static void implMulwAcc(long[] jArr, long j9, long j11, long[] jArr2, int i11) {
        ...
        jArr2[i11] = jArr2[i11] ^ (M49 & j16);
        int i15 = i11 + 1;
        jArr2[i15] = jArr2[i15] ^ ((j16 >>> 49) ^ (j17 << 15));
    }
    ...
    public static void reduce(long[] jArr, long[] jArr2) {
        ...
        long j21 = j17 ^ (j15 >>> 50);
        long j22 = j9 ^ (j18 << 63);
        long j23 = (j11 ^ (j15 << 63)) ^ ((j18 >>> M01) ^ (j18 << 14));
        long j24 = j19 ^ (j18 >>> 50);
        long j25 = j21 >>> M01;
        jArr2[0] = (j22 ^ j25) ^ (j25 << 15);
        jArr2[1] = (j21 >>> 50) ^ j23;
        jArr2[2] = j24;
        jArr2[3] = M01 & j21;
    }
    ...
    public static void reduce63(long[] jArr, int i11) {
        ...
        long j9 = jArr[i12];
        long j11 = j9 >>> M01;
        jArr[i11] = (j11 ^ (j11 << 15)) ^ jArr[i11];
        int i13 = i11 + 1;
        jArr[i13] = jArr[i13] ^ (j9 >>> 50);
        jArr[i12] = j9 & M01;
    }
    ...
    public static void sqrt(long[] jArr, long[] jArr2) {
        ...
        long j12 = (jUnshuffle3 & 4294967295L) ^ (jArr[3] << 32);
