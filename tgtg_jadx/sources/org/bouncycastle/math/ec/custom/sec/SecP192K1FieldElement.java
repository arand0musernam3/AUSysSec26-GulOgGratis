...
public class SecP192K1FieldElement extends ECFieldElement.AbstractFp {
    ...
    protected int[] f33383x;

    public SecP192K1FieldElement(BigInteger bigInteger) {
        if (bigInteger == null || bigInteger.signum() < 0 || bigInteger.compareTo(Q) >= 0) {
            a.f("x value invalid for SecP192K1FieldElement");
            throw null;
        }
        this.f33383x = SecP192K1Field.fromBigInteger(bigInteger);
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public ECFieldElement add(ECFieldElement eCFieldElement) {
        int[] iArrCreate = Nat192.create();
        SecP192K1Field.add(this.f33383x, ((SecP192K1FieldElement) eCFieldElement).f33383x, iArrCreate);
    ...
    public ECFieldElement addOne() {
        int[] iArrCreate = Nat192.create();
        SecP192K1Field.addOne(this.f33383x, iArrCreate);
        return new SecP192K1FieldElement(iArrCreate);
    }
    ...
    public ECFieldElement divide(ECFieldElement eCFieldElement) {
        int[] iArrCreate = Nat192.create();
        SecP192K1Field.inv(((SecP192K1FieldElement) eCFieldElement).f33383x, iArrCreate);
        SecP192K1Field.multiply(iArrCreate, this.f33383x, iArrCreate);
        return new SecP192K1FieldElement(iArrCreate);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SecP192K1FieldElement) {
            return Nat192.eq(this.f33383x, ((SecP192K1FieldElement) obj).f33383x);
        }
        return false;
    }
    ...
    public int hashCode() {
        return Q.hashCode() ^ Arrays.hashCode(this.f33383x, 0, 6);
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public ECFieldElement invert() {
        int[] iArrCreate = Nat192.create();
        SecP192K1Field.inv(this.f33383x, iArrCreate);
        return new SecP192K1FieldElement(iArrCreate);
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public boolean isOne() {
        return Nat192.isOne(this.f33383x);
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public boolean isZero() {
        return Nat192.isZero(this.f33383x);
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public ECFieldElement multiply(ECFieldElement eCFieldElement) {
        int[] iArrCreate = Nat192.create();
        SecP192K1Field.multiply(this.f33383x, ((SecP192K1FieldElement) eCFieldElement).f33383x, iArrCreate);
        return new SecP192K1FieldElement(iArrCreate);
    }
    ...
    public ECFieldElement negate() {
        int[] iArrCreate = Nat192.create();
        SecP192K1Field.negate(this.f33383x, iArrCreate);
        return new SecP192K1FieldElement(iArrCreate);
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public ECFieldElement sqrt() {
        int[] iArr = this.f33383x;
    ...
    public ECFieldElement square() {
        int[] iArrCreate = Nat192.create();
        SecP192K1Field.square(this.f33383x, iArrCreate);
        return new SecP192K1FieldElement(iArrCreate);
    }
    ...
    public ECFieldElement subtract(ECFieldElement eCFieldElement) {
        int[] iArrCreate = Nat192.create();
        SecP192K1Field.subtract(this.f33383x, ((SecP192K1FieldElement) eCFieldElement).f33383x, iArrCreate);
        return new SecP192K1FieldElement(iArrCreate);
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public boolean testBitZero() {
        return Nat192.getBit(this.f33383x, 0) == 1;
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public BigInteger toBigInteger() {
        return Nat192.toBigInteger(this.f33383x);
    }

    public SecP192K1FieldElement() {
        this.f33383x = Nat192.create();
    }
