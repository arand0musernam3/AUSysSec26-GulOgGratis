...
public class SecT163R2Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint twice() {
        ...
        ECFieldElement eCFieldElementT = a.t(eCFieldElement, eCFieldElementMultiply2, eCFieldElementSquare);
        if (eCFieldElementT.isZero()) {
            return new SecT163R2Point(curve, eCFieldElementT, curve.getB().sqrt());
        }
        ...
        return new SecT163R2Point(curve, eCFieldElementSquare2, eCFieldElementMultiply.squarePlusProduct(eCFieldElementT, eCFieldElementMultiply2).add(eCFieldElementSquare2).add(eCFieldElementMultiply3), new ECFieldElement[]{eCFieldElementMultiply3});
    }
