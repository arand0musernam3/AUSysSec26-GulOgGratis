...
public class SecT163K1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint twice() {
        ...
        ECFieldElement eCFieldElementT = a.t(eCFieldElement2, eCFieldElementMultiply, eCFieldElementSquare);
        if (eCFieldElementT.isZero()) {
            return new SecT163K1Point(curve, eCFieldElementT, curve.getB());
        }
        ECFieldElement eCFieldElementSquare2 = eCFieldElementT.square();
        ECFieldElement eCFieldElementMultiply2 = zIsOne ? eCFieldElementT : eCFieldElementT.multiply(eCFieldElementSquare);
        ECFieldElement eCFieldElementSquare3 = eCFieldElement2.add(eCFieldElement).square();
        return new SecT163K1Point(curve, eCFieldElementSquare2, eCFieldElementSquare3.add(eCFieldElementT).add(eCFieldElementSquare).multiply(eCFieldElementSquare3).add(eCFieldElementSquare2), new ECFieldElement[]{eCFieldElementMultiply2});
    }
