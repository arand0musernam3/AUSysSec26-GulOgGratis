...
public class SecP384R1Curve extends ECCurve.AbstractFp {
    ...
    public static final BigInteger f33394q = SecP384R1FieldElement.Q;
    ...
    public SecP384R1Curve() {
        ...
        this.f33351a = fromBigInteger(new BigInteger(1, Hex.decodeStrict("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFFFF0000000000000000FFFFFFFC")));
        this.f33352b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("B3312FA7E23EE7E4988E056BE3F82D19181D9C6EFE8141120314088F5013875AC656398D8A2ED19D2A85C8EDD3EC2AEF")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i11, final int i12) {
        final int[] iArr = new int[i12 * 24];
        int i13 = 0;
        for (int i14 = 0; i14 < i12; i14++) {
            ECPoint eCPoint = eCPointArr[i11 + i14];
            Nat.copy(12, ((SecP384R1FieldElement) eCPoint.getRawXCoord()).f33395x, 0, iArr, i13);
            Nat.copy(12, ((SecP384R1FieldElement) eCPoint.getRawYCoord()).f33395x, 0, iArr, i13 + 12);
            i13 += 24;
        }
        return new AbstractECLookupTable() { // from class: org.bouncycastle.math.ec.custom.sec.SecP384R1Curve.1
            ...
            public ECPoint lookup(int i15) {
                ...
                for (int i17 = 0; i17 < i12; i17++) {
                    ...
                    for (int i19 = 0; i19 < 12; i19++) {
                        ...
                        iArrCreate2[i19] = iArrCreate2[i19] ^ (iArr2[(i16 + 12) + i19] & i18);
                    }
                    i16 += 24;
                }
            ...
            public ECPoint lookupVar(int i15) {
                ...
                for (int i17 = 0; i17 < 12; i17++) {
                    ...
                    iArrCreate2[i17] = iArr2[i16 + 12 + i17];
                }
                return createPoint(iArrCreate, iArrCreate2);
            }
        };
