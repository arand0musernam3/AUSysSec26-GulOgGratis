...
public class SecP256K1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        SecP256K1FieldElement secP256K1FieldElement = (SecP256K1FieldElement) this.f33366x;
        SecP256K1FieldElement secP256K1FieldElement2 = (SecP256K1FieldElement) this.f33367y;
        ...
        SecP256K1FieldElement secP256K1FieldElement5 = (SecP256K1FieldElement) this.f33368zs[0];
        ...
        if (zIsOne) {
            iArr = secP256K1FieldElement3.f33391x;
            iArr2 = secP256K1FieldElement4.f33391x;
        } else {
            SecP256K1Field.square(secP256K1FieldElement5.f33391x, iArrCreate2, iArrCreateExt);
            SecP256K1Field.multiply(iArrCreate2, secP256K1FieldElement3.f33391x, iArrCreate, iArrCreateExt);
            SecP256K1Field.multiply(iArrCreate2, secP256K1FieldElement5.f33391x, iArrCreate2, iArrCreateExt);
            SecP256K1Field.multiply(iArrCreate2, secP256K1FieldElement4.f33391x, iArrCreate2, iArrCreateExt);
            iArr = iArrCreate;
            iArr2 = iArrCreate2;
        }
        boolean zIsOne2 = secP256K1FieldElement6.isOne();
        if (zIsOne2) {
            iArr3 = secP256K1FieldElement.f33391x;
            iArr4 = secP256K1FieldElement2.f33391x;
            c3 = 0;
        } else {
            c3 = 0;
            SecP256K1Field.square(secP256K1FieldElement6.f33391x, iArrCreate3, iArrCreateExt);
            SecP256K1Field.multiply(iArrCreate3, secP256K1FieldElement.f33391x, iArrCreateExt2, iArrCreateExt);
            SecP256K1Field.multiply(iArrCreate3, secP256K1FieldElement6.f33391x, iArrCreate3, iArrCreateExt);
            SecP256K1Field.multiply(iArrCreate3, secP256K1FieldElement2.f33391x, iArrCreate3, iArrCreateExt);
        ...
        SecP256K1Field.square(iArrCreate, secP256K1FieldElement7.f33391x, iArrCreateExt);
        int[] iArr5 = secP256K1FieldElement7.f33391x;
        ...
        SecP256K1Field.subtract(iArrCreate2, secP256K1FieldElement7.f33391x, secP256K1FieldElement8.f33391x);
        SecP256K1Field.multiplyAddToExt(secP256K1FieldElement8.f33391x, iArrCreate, iArrCreateExt2);
        SecP256K1Field.reduce(iArrCreateExt2, secP256K1FieldElement8.f33391x);
        SecP256K1FieldElement secP256K1FieldElement9 = new SecP256K1FieldElement(iArrCreate4);
        if (!zIsOne) {
            int[] iArr6 = secP256K1FieldElement9.f33391x;
            SecP256K1Field.multiply(iArr6, secP256K1FieldElement5.f33391x, iArr6, iArrCreateExt);
        }
        if (!zIsOne2) {
            int[] iArr7 = secP256K1FieldElement9.f33391x;
            SecP256K1Field.multiply(iArr7, secP256K1FieldElement6.f33391x, iArr7, iArrCreateExt);
        }
        ECFieldElement[] eCFieldElementArr = new ECFieldElement[1];
        eCFieldElementArr[c3] = secP256K1FieldElement9;
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new SecP256K1Point(this.curve, this.f33366x, this.f33367y.negate(), this.f33368zs);
    }
    ...
    public ECPoint twice() {
        ...
        ECCurve curve = getCurve();
        SecP256K1FieldElement secP256K1FieldElement = (SecP256K1FieldElement) this.f33367y;
        if (secP256K1FieldElement.isZero()) {
            return curve.getInfinity();
        }
        SecP256K1FieldElement secP256K1FieldElement2 = (SecP256K1FieldElement) this.f33366x;
        SecP256K1FieldElement secP256K1FieldElement3 = (SecP256K1FieldElement) this.f33368zs[0];
        int[] iArrCreateExt = Nat256.createExt();
        int[] iArrCreate = Nat256.create();
        SecP256K1Field.square(secP256K1FieldElement.f33391x, iArrCreate, iArrCreateExt);
        int[] iArrCreate2 = Nat256.create();
        SecP256K1Field.square(iArrCreate, iArrCreate2, iArrCreateExt);
        int[] iArrCreate3 = Nat256.create();
        SecP256K1Field.square(secP256K1FieldElement2.f33391x, iArrCreate3, iArrCreateExt);
        SecP256K1Field.reduce32(Nat256.addBothTo(iArrCreate3, iArrCreate3, iArrCreate3), iArrCreate3);
        SecP256K1Field.multiply(iArrCreate, secP256K1FieldElement2.f33391x, iArrCreate, iArrCreateExt);
        ...
        SecP256K1Field.square(iArrCreate3, secP256K1FieldElement4.f33391x, iArrCreateExt);
        int[] iArr = secP256K1FieldElement4.f33391x;
        SecP256K1Field.subtract(iArr, iArrCreate, iArr);
        int[] iArr2 = secP256K1FieldElement4.f33391x;
        ...
        SecP256K1Field.subtract(iArrCreate, secP256K1FieldElement4.f33391x, secP256K1FieldElement5.f33391x);
        int[] iArr3 = secP256K1FieldElement5.f33391x;
        SecP256K1Field.multiply(iArr3, iArrCreate3, iArr3, iArrCreateExt);
        int[] iArr4 = secP256K1FieldElement5.f33391x;
        ...
        SecP256K1Field.twice(secP256K1FieldElement.f33391x, secP256K1FieldElement6.f33391x);
        if (!secP256K1FieldElement3.isOne()) {
            int[] iArr5 = secP256K1FieldElement6.f33391x;
            SecP256K1Field.multiply(iArr5, secP256K1FieldElement3.f33391x, iArr5, iArrCreateExt);
        }
