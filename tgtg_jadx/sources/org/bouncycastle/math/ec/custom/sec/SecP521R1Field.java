...
public class SecP521R1Field {
    ...
    public static void implMultiply(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        int i11 = iArr[16];
        int i12 = iArr2[16];
        iArr3[32] = (i11 * i12) + Nat.mul31BothAdd(16, i11, iArr2, i12, iArr, iArr3, 16);
    }

    public static void implSquare(int[] iArr, int[] iArr2) {
        Nat512.square(iArr, iArr2);
        int i11 = iArr[16];
        iArr2[32] = (i11 * i11) + Nat.mulWordAddTo(16, i11 << 1, iArr, 0, iArr2, 16);
    }
    ...
    public static void reduce(int[] iArr, int[] iArr2) {
        int i11 = iArr[32];
        int iAddTo = Nat.addTo(16, iArr, iArr2) + (Nat.shiftDownBits(16, iArr, 16, 9, i11, iArr2, 0) >>> 23) + (i11 >>> 9);
    ...
    public static void reduce23(int[] iArr) {
        int i11 = iArr[16];
        int iAddWordTo = Nat.addWordTo(16, i11 >>> 9, iArr) + (i11 & P16);
