...
public class SecT113R2Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (rawXCoord.isZero()) {
            ...
            eCFieldElementAdd = a.t(eCFieldElementDivide, eCFieldElementDivide, xCoord).add(curve.getA());
    ...
    public ECPoint twice() {
        ...
        if (!zIsOne) {
            a11 = a11.multiply(eCFieldElementSquare);
        }
        ECFieldElement eCFieldElementT = a.t(eCFieldElement, eCFieldElementMultiply2, a11);
        if (eCFieldElementT.isZero()) {
            return new SecT113R2Point(curve, eCFieldElementT, curve.getB().sqrt());
        }
        ECFieldElement eCFieldElementSquare2 = eCFieldElementT.square();
        ECFieldElement eCFieldElementMultiply3 = zIsOne ? eCFieldElementT : eCFieldElementT.multiply(eCFieldElementSquare);
        if (!zIsOne) {
            eCFieldElementMultiply = eCFieldElementMultiply.multiply(eCFieldElement2);
        }
        return new SecT113R2Point(curve, eCFieldElementSquare2, eCFieldElementMultiply.squarePlusProduct(eCFieldElementT, eCFieldElementMultiply2).add(eCFieldElementSquare2).add(eCFieldElementMultiply3), new ECFieldElement[]{eCFieldElementMultiply3});
    }
