...
public class SecP256K1Curve extends ECCurve.AbstractFp {
    ...
    public static final BigInteger f33390q = SecP256K1FieldElement.Q;
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i11, final int i12) {
        ...
        for (int i14 = 0; i14 < i12; i14++) {
            ...
            Nat256.copy(((SecP256K1FieldElement) eCPoint.getRawXCoord()).f33391x, 0, iArr, i13);
            Nat256.copy(((SecP256K1FieldElement) eCPoint.getRawYCoord()).f33391x, 0, iArr, i13 + 8);
            i13 += 16;
        }
