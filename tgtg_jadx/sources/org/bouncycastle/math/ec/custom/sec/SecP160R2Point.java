...
public class SecP160R2Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        SecP160R2FieldElement secP160R2FieldElement = (SecP160R2FieldElement) this.f33366x;
        SecP160R2FieldElement secP160R2FieldElement2 = (SecP160R2FieldElement) this.f33367y;
        ...
        SecP160R2FieldElement secP160R2FieldElement5 = (SecP160R2FieldElement) this.f33368zs[0];
        ...
        if (zIsOne) {
            iArr = secP160R2FieldElement3.f33381x;
            iArr2 = secP160R2FieldElement4.f33381x;
        } else {
            SecP160R2Field.square(secP160R2FieldElement5.f33381x, iArrCreate2);
            SecP160R2Field.multiply(iArrCreate2, secP160R2FieldElement3.f33381x, iArrCreate);
            SecP160R2Field.multiply(iArrCreate2, secP160R2FieldElement5.f33381x, iArrCreate2);
            SecP160R2Field.multiply(iArrCreate2, secP160R2FieldElement4.f33381x, iArrCreate2);
            iArr = iArrCreate;
            iArr2 = iArrCreate2;
        }
        boolean zIsOne2 = secP160R2FieldElement6.isOne();
        if (zIsOne2) {
            iArr3 = secP160R2FieldElement.f33381x;
            iArr4 = secP160R2FieldElement2.f33381x;
        } else {
            SecP160R2Field.square(secP160R2FieldElement6.f33381x, iArrCreate3);
            SecP160R2Field.multiply(iArrCreate3, secP160R2FieldElement.f33381x, iArrCreateExt);
            SecP160R2Field.multiply(iArrCreate3, secP160R2FieldElement6.f33381x, iArrCreate3);
            SecP160R2Field.multiply(iArrCreate3, secP160R2FieldElement2.f33381x, iArrCreate3);
            iArr3 = iArrCreateExt;
            iArr4 = iArrCreate3;
        }
        ...
        SecP160R2Field.square(iArrCreate, secP160R2FieldElement7.f33381x);
        int[] iArr5 = secP160R2FieldElement7.f33381x;
        ...
        SecP160R2Field.subtract(iArrCreate2, secP160R2FieldElement7.f33381x, secP160R2FieldElement8.f33381x);
        SecP160R2Field.multiplyAddToExt(secP160R2FieldElement8.f33381x, iArrCreate, iArrCreateExt);
        SecP160R2Field.reduce(iArrCreateExt, secP160R2FieldElement8.f33381x);
        SecP160R2FieldElement secP160R2FieldElement9 = new SecP160R2FieldElement(iArrCreate4);
        if (!zIsOne) {
            int[] iArr6 = secP160R2FieldElement9.f33381x;
            SecP160R2Field.multiply(iArr6, secP160R2FieldElement5.f33381x, iArr6);
        }
        if (!zIsOne2) {
            int[] iArr7 = secP160R2FieldElement9.f33381x;
            SecP160R2Field.multiply(iArr7, secP160R2FieldElement6.f33381x, iArr7);
        }
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new SecP160R2Point(this.curve, this.f33366x, this.f33367y.negate(), this.f33368zs);
    }
    ...
    public ECPoint twice() {
        ...
        ECCurve curve = getCurve();
        SecP160R2FieldElement secP160R2FieldElement = (SecP160R2FieldElement) this.f33367y;
        if (secP160R2FieldElement.isZero()) {
            return curve.getInfinity();
        }
        SecP160R2FieldElement secP160R2FieldElement2 = (SecP160R2FieldElement) this.f33366x;
        SecP160R2FieldElement secP160R2FieldElement3 = (SecP160R2FieldElement) this.f33368zs[0];
        int[] iArrCreate = Nat160.create();
        int[] iArrCreate2 = Nat160.create();
        int[] iArrCreate3 = Nat160.create();
        SecP160R2Field.square(secP160R2FieldElement.f33381x, iArrCreate3);
        int[] iArrCreate4 = Nat160.create();
        SecP160R2Field.square(iArrCreate3, iArrCreate4);
        boolean zIsOne = secP160R2FieldElement3.isOne();
        int[] iArr = secP160R2FieldElement3.f33381x;
        if (!zIsOne) {
            SecP160R2Field.square(iArr, iArrCreate2);
            iArr = iArrCreate2;
        }
        SecP160R2Field.subtract(secP160R2FieldElement2.f33381x, iArr, iArrCreate);
        SecP160R2Field.add(secP160R2FieldElement2.f33381x, iArr, iArrCreate2);
        ...
        SecP160R2Field.square(iArrCreate2, secP160R2FieldElement4.f33381x);
        int[] iArr2 = secP160R2FieldElement4.f33381x;
        SecP160R2Field.subtract(iArr2, iArrCreate3, iArr2);
        int[] iArr3 = secP160R2FieldElement4.f33381x;
        ...
        SecP160R2Field.subtract(iArrCreate3, secP160R2FieldElement4.f33381x, secP160R2FieldElement5.f33381x);
        int[] iArr4 = secP160R2FieldElement5.f33381x;
        SecP160R2Field.multiply(iArr4, iArrCreate2, iArr4);
        int[] iArr5 = secP160R2FieldElement5.f33381x;
        ...
        SecP160R2Field.twice(secP160R2FieldElement.f33381x, secP160R2FieldElement6.f33381x);
        if (!zIsOne) {
            int[] iArr6 = secP160R2FieldElement6.f33381x;
            SecP160R2Field.multiply(iArr6, secP160R2FieldElement3.f33381x, iArr6);
        }
