...
public class SecT571R1Curve extends ECCurve.AbstractF2m {
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i11, final int i12) {
        final long[] jArr = new long[i12 * 18];
        int i13 = 0;
        for (int i14 = 0; i14 < i12; i14++) {
            ECPoint eCPoint = eCPointArr[i11 + i14];
            Nat576.copy64(((SecT571FieldElement) eCPoint.getRawXCoord()).f33406x, 0, jArr, i13);
            Nat576.copy64(((SecT571FieldElement) eCPoint.getRawYCoord()).f33406x, 0, jArr, i13 + 9);
            i13 += 18;
        }
        return new AbstractECLookupTable() { // from class: org.bouncycastle.math.ec.custom.sec.SecT571R1Curve.1
            ...
            public ECPoint lookup(int i15) {
                ...
                for (int i17 = 0; i17 < i12; i17++) {
                    ...
                    for (int i18 = 0; i18 < 9; i18++) {
                        ...
                        jArrCreate642[i18] = jArrCreate642[i18] ^ (jArr2[(i16 + 9) + i18] & j9);
                    }
                    i16 += 18;
                }
            ...
            public ECPoint lookupVar(int i15) {
                ...
                for (int i17 = 0; i17 < 9; i17++) {
                    ...
                    jArrCreate642[i17] = jArr2[9 + i16 + i17];
                }
                return createPoint(jArrCreate64, jArrCreate642);
            }
        };
