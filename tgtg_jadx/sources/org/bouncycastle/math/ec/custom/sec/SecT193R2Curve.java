...
public class SecT193R2Curve extends ECCurve.AbstractF2m {
    ...
    public SecT193R2Curve() {
        ...
        this.f33351a = fromBigInteger(new BigInteger(1, Hex.decodeStrict("0163F35A5137C2CE3EA6ED8667190B0BC43ECD69977702709B")));
        this.f33352b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("00C9BB9E8927D4D64C377E2AB2856A5B16E3EFB7F61D4316AE")));
        ...
        return new AbstractECLookupTable() { // from class: org.bouncycastle.math.ec.custom.sec.SecT193R2Curve.1
            ...
            public ECPoint lookupVar(int i15) {
                ...
                for (int i17 = 0; i17 < 4; i17++) {
                    long j9 = jArrCreate64[i17];
                    long[] jArr2 = jArr;
                    jArrCreate64[i17] = j9 ^ jArr2[i16 + i17];
                    jArrCreate642[i17] = jArrCreate642[i17] ^ jArr2[(4 + i16) + i17];
                }
                return createPoint(jArrCreate64, jArrCreate642);
            }
        };
