...
public abstract class ECPoint {
    ...
    protected ECFieldElement f33366x;

    /* JADX INFO: renamed from: y, reason: collision with root package name */
    protected ECFieldElement f33367y;

    /* JADX INFO: renamed from: zs, reason: collision with root package name */
    protected ECFieldElement[] f33368zs;
    ...
    public ECPoint(ECCurve eCCurve, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, ECFieldElement[] eCFieldElementArr) {
        ...
        this.curve = eCCurve;
        this.f33366x = eCFieldElement;
        this.f33367y = eCFieldElement2;
        this.f33368zs = eCFieldElementArr;
    }
    ...
    public void encodeTo(boolean z11, byte[] bArr, int i11) {
        if (isInfinity()) {
            bArr[i11] = 0;
            return;
        }
        ...
        if (z11) {
            bArr[i11] = (byte) (eCPointNormalize.getCompressionYTilde() ? 3 : 2);
            xCoord.encodeTo(bArr, i11 + 1);
        } else {
            bArr[i11] = 4;
            int i12 = i11 + 1;
            xCoord.encodeTo(bArr, i12);
            yCoord.encodeTo(bArr, xCoord.getEncodedLength() + i12);
        }
    }
    ...
    public int getEncodedLength(boolean z11) {
        if (isInfinity()) {
            return 1;
        }
        if (z11) {
    ...
    public ECFieldElement getZCoord(int i11) {
        ...
        ECFieldElement[] eCFieldElementArr = this.f33368zs;
    ...
    public int hashCode() {
        ...
        ECPoint eCPointNormalize = normalize();
        return (i11 ^ (eCPointNormalize.getXCoord().hashCode() * 17)) ^ (eCPointNormalize.getYCoord().hashCode() * 257);
    }

    public boolean implIsValid(final boolean z11, final boolean z12) {
        if (isInfinity()) {
            return true;
        }
    ...
    public boolean isInfinity() {
        if (this.f33366x == null || this.f33367y == null) {
            return true;
        }
        ECFieldElement[] eCFieldElementArr = this.f33368zs;
    ...
    public boolean isNormalized() {
        ...
        return curveCoordinateSystem == 0 || curveCoordinateSystem == 5 || isInfinity() || this.f33368zs[0].isOne();
    }
    ...
    public ECPoint normalize() {
        ...
        if (!isInfinity() && (curveCoordinateSystem = getCurveCoordinateSystem()) != 0 && curveCoordinateSystem != 5) {
            ...
            if (!zCoord.isOne()) {
                ...
                h2.b("Detached points must be in affine coordinates");
                return null;
            }
        }
        return this;
    ...
    public String toString() {
        ...
        for (int i11 = 0; i11 < this.f33368zs.length; i11++) {
            stringBuffer.append(',');
            stringBuffer.append(this.f33368zs[i11]);
        }
        stringBuffer.append(')');
    ...
    public static abstract class AbstractF2m extends ECPoint {
            ...
            if (coordinateSystem != 6) {
                ...
                if (coordinateSystem != 0) {
                    if (coordinateSystem != 1) {
                        h2.b("unsupported coordinate system");
                        return false;
                    }
                    ...
                    if (!eCFieldElement3.isOne()) {
                        ...
                        b8 = b8.multiply(eCFieldElementMultiply2);
                    }
                }
                return eCFieldElementMultiply.equals(eCFieldElement.add(a11).multiply(eCFieldElement.square()).add(b8));
            }
            ECFieldElement eCFieldElement4 = this.f33368zs[0];
            boolean zIsOne = eCFieldElement4.isOne();
            boolean zIsZero = eCFieldElement.isZero();
            ECFieldElement eCFieldElement5 = this.f33367y;
            if (zIsZero) {
                ECFieldElement eCFieldElementSquare = eCFieldElement5.square();
                if (!zIsOne) {
                    b8 = b8.multiply(eCFieldElement4.square());
                }
                return eCFieldElementSquare.equals(b8);
            }
            ECFieldElement eCFieldElementSquare2 = eCFieldElement.square();
            if (zIsOne) {
                eCFieldElementMultiplyPlusProduct = org.bouncycastle.jcajce.provider.asymmetric.a.t(eCFieldElement5, eCFieldElement5, a11);
                eCFieldElementSquarePlusProduct = eCFieldElementSquare2.square().add(b8);
            } else {
                ...
                eCFieldElementSquarePlusProduct = eCFieldElementSquare2.squarePlusProduct(b8, eCFieldElementSquare4);
            }
        ...
        public AbstractF2m tau() {
            ...
            if (coordinateSystem != 0) {
                ...
                return (AbstractF2m) curve.createRawPoint(eCFieldElement.square(), this.f33367y.square(), new ECFieldElement[]{this.f33368zs[0].square()});
            }
            return (AbstractF2m) curve.createRawPoint(eCFieldElement.square(), this.f33367y.square());
        }
        ...
        public AbstractF2m tauPow(int i11) {
            ...
            if (coordinateSystem != 0) {
                ...
                return (AbstractF2m) curve.createRawPoint(eCFieldElement.squarePow(i11), this.f33367y.squarePow(i11), new ECFieldElement[]{this.f33368zs[0].squarePow(i11)});
            }
            return (AbstractF2m) curve.createRawPoint(eCFieldElement.squarePow(i11), this.f33367y.squarePow(i11));
        }
    ...
    public static abstract class AbstractFp extends ECPoint {
        ...
        public boolean satisfiesCurveEquation() {
            ...
            ECFieldElement b8 = this.curve.getB();
            ...
            if (curveCoordinateSystem != 0) {
                if (curveCoordinateSystem == 1) {
                    ...
                    if (!eCFieldElement3.isOne()) {
                        ...
                        b8 = b8.multiply(eCFieldElementMultiply);
                    }
                } else {
            ...
            return eCFieldElementSquare.equals(eCFieldElement.square().add(a11).multiply(eCFieldElement).add(b8));
        }
    ...
    public static class F2m extends AbstractF2m {
        ...
        public ECPoint add(ECPoint eCPoint) {
            ...
            ECFieldElement eCFieldElement = eCPoint.f33366x;
            if (coordinateSystem == 0) {
                ECFieldElement eCFieldElement2 = this.f33367y;
                ECFieldElement eCFieldElement3 = eCPoint.f33367y;
                ...
                ECFieldElement eCFieldElementAdd5 = org.bouncycastle.jcajce.provider.asymmetric.a.t(eCFieldElementDivide, eCFieldElementDivide, eCFieldElementAdd3).add(curve.getA());
            ...
            if (coordinateSystem == 1) {
                ECFieldElement eCFieldElement4 = this.f33367y;
                ECFieldElement eCFieldElementMultiply5 = this.f33368zs[0];
                ECFieldElement eCFieldElement5 = eCPoint.f33367y;
                ECFieldElement eCFieldElement6 = eCPoint.f33368zs[0];
            ...
            ECFieldElement eCFieldElement7 = this.f33367y;
            ECFieldElement eCFieldElement8 = this.f33368zs[0];
            ECFieldElement eCFieldElement9 = eCPoint.f33367y;
            ECFieldElement eCFieldElement10 = eCPoint.f33368zs[0];
            ...
            if (eCFieldElement.isZero()) {
                ...
                eCFieldElementAdd2 = org.bouncycastle.jcajce.provider.asymmetric.a.t(eCFieldElementDivide2, eCFieldElementDivide2, xCoord).add(curve.getA());
        ...
        public ECPoint negate() {
            if (!isInfinity()) {
                ...
                if (!eCFieldElement.isZero()) {
                    int curveCoordinateSystem = getCurveCoordinateSystem();
                    if (curveCoordinateSystem == 0) {
                        return new F2m(this.curve, eCFieldElement, this.f33367y.add(eCFieldElement));
                    }
                    if (curveCoordinateSystem == 1) {
                        return new F2m(this.curve, eCFieldElement, this.f33367y.add(eCFieldElement), new ECFieldElement[]{this.f33368zs[0]});
                    }
                    if (curveCoordinateSystem == 5) {
                        return new F2m(this.curve, eCFieldElement, this.f33367y.addOne());
                    }
                    if (curveCoordinateSystem != 6) {
                        h2.b("unsupported coordinate system");
                        return null;
        ...
        public ECPoint twice() {
            ...
            ECCurve curve = getCurve();
            ECFieldElement eCFieldElementMultiply = this.f33366x;
            if (eCFieldElementMultiply.isZero()) {
                return curve.getInfinity();
            }
            int coordinateSystem = curve.getCoordinateSystem();
            if (coordinateSystem == 0) {
                ECFieldElement eCFieldElementAdd2 = this.f33367y.divide(eCFieldElementMultiply).add(eCFieldElementMultiply);
            ...
            if (coordinateSystem == 1) {
                ECFieldElement eCFieldElementMultiply2 = this.f33367y;
                ECFieldElement eCFieldElement = this.f33368zs[0];
            ...
            ECFieldElement eCFieldElementT = org.bouncycastle.jcajce.provider.asymmetric.a.t(eCFieldElement2, eCFieldElementMultiply4, eCFieldElementMultiply5);
            if (eCFieldElementT.isZero()) {
                return new F2m(curve, eCFieldElementT, curve.getB().sqrt());
            }
            ECFieldElement eCFieldElementSquare4 = eCFieldElementT.square();
            ECFieldElement eCFieldElementMultiply6 = zIsOne2 ? eCFieldElementT : eCFieldElementT.multiply(eCFieldElementSquare3);
            ECFieldElement b8 = curve.getB();
            if (b8.bitLength() < (curve.getFieldSize() >> 1)) {
                ...
                eCFieldElementAdd = eCFieldElementSquare5.add(eCFieldElementT).add(eCFieldElementSquare3).multiply(eCFieldElementSquare5).add(b8.isOne() ? eCFieldElementMultiply5.add(eCFieldElementSquare3).square() : eCFieldElementMultiply5.squarePlusProduct(b8, eCFieldElementSquare3.square())).add(eCFieldElementSquare4);
                if (!a11.isZero()) {
                    if (!a11.isOne()) {
            ...
            eCFieldElementAdd = eCFieldElementMultiply.squarePlusProduct(eCFieldElementT, eCFieldElementMultiply4).add(eCFieldElementSquare4);
        ...
        public ECPoint twicePlus(ECPoint eCPoint) {
            ...
            ECFieldElement eCFieldElement2 = eCPoint.f33366x;
            ECFieldElement eCFieldElement3 = eCPoint.f33368zs[0];
            if (eCFieldElement2.isZero() || !eCFieldElement3.isOne()) {
                return twice().add(eCPoint);
            }
            ECFieldElement eCFieldElement4 = this.f33367y;
            ECFieldElement eCFieldElement5 = this.f33368zs[0];
            ECFieldElement eCFieldElement6 = eCPoint.f33367y;
    ...
    public static class Fp extends AbstractFp {
        ...
        */
        ...
        public ECPoint negate() {
            ...
            int coordinateSystem = curve.getCoordinateSystem();
            ECFieldElement eCFieldElement = this.f33366x;
            return coordinateSystem != 0 ? new Fp(curve, eCFieldElement, this.f33367y.negate(), this.f33368zs) : new Fp(curve, eCFieldElement, this.f33367y.negate());
        }
        ...
        public ECPoint threeTimes() {
            if (!isInfinity()) {
                ...
                if (!eCFieldElement.isZero()) {
                    ...
                    ECFieldElement eCFieldElement2 = this.f33366x;
        ...
        public ECPoint timesPow2(int i11) {
            ...
            ECCurve curve = getCurve();
            ECFieldElement eCFieldElementSubtract = this.f33367y;
            if (eCFieldElementSubtract.isZero()) {
                return curve.getInfinity();
            }
            int coordinateSystem = curve.getCoordinateSystem();
            ...
            if (coordinateSystem == 4) {
                return new Fp(curve, eCFieldElementMultiply, eCFieldElementSubtract, new ECFieldElement[]{eCFieldElementFromBigInteger, a11});
            }
            h2.b("unsupported coordinate system");
            return null;
        }
        ...
        public Fp twiceJacobianModified(boolean z11) {
            ECFieldElement eCFieldElement = this.f33366x;
            ECFieldElement eCFieldElement2 = this.f33367y;
            ECFieldElement eCFieldElement3 = this.f33368zs[0];
        ...
        public ECPoint twicePlus(ECPoint eCPoint) {
            ...
            ECFieldElement eCFieldElement2 = this.f33366x;
            ECFieldElement eCFieldElement3 = eCPoint.f33366x;
            ECFieldElement eCFieldElement4 = eCPoint.f33367y;
    ...
    public ECPoint normalize(ECFieldElement eCFieldElement) {
        ...
        if (curveCoordinateSystem != 1) {
            ...
            if (curveCoordinateSystem != 6) {
                h2.b("not a projective coordinate system");
                return null;
            }
        }
