...
class LongArray implements Cloneable {
    ...
    public LongArray(BigInteger bigInteger) {
        ...
        if (i11 < i14) {
            long j9 = 0;
            while (i11 < i14) {
                j9 = (j9 << 8) | ((long) (byteArray[i11] & 255));
                i11++;
            }
            this.m_ints[i13] = j9;
            i13 = i12 - 2;
        ...
        while (i13 >= 0) {
            ...
            long j11 = 0;
            while (i15 < 8) {
                j11 = (j11 << 8) | ((long) (byteArray[i11] & 255));
                i15++;
                i11++;
            }
            this.m_ints[i13] = j11;
    ...
    private void addShiftedByBitsSafe(LongArray longArray, int i11, int i12) {
        ...
        if (i15 == 0) {
            add(jArr, i14, longArray.m_ints, 0, i13);
            return;
        }
        long jAddShiftedUp = addShiftedUp(jArr, i14, longArray.m_ints, 0, i13, i15);
        if (jAddShiftedUp != 0) {
            long[] jArr2 = this.m_ints;
            int i16 = i13 + i14;
            jArr2[i16] = jAddShiftedUp ^ jArr2[i16];
        }
    }
    ...
    private static long addShiftedUp(long[] jArr, int i11, long[] jArr2, int i12, int i13, int i14) {
        ...
        for (int i16 = 0; i16 < i13; i16++) {
            long j11 = jArr2[i12 + i16];
            int i17 = i11 + i16;
            jArr[i17] = (j9 | (j11 << i14)) ^ jArr[i17];
            j9 = j11 >>> i15;
        }
        return j9;
    }

    private static int bitLength(long j9) {
        int i11;
        int i12 = 32;
        int i13 = (int) (j9 >>> 32);
        if (i13 == 0) {
        ...
        if (i14 == 0) {
            ...
            int i16 = i13 >>> 24;
            i11 = i16 == 0 ? bitLengths[i14] + 16 : bitLengths[i16] + 24;
        }
        return i12 + i11;
    }
    ...
    private static void flipWord(long[] jArr, int i11, int i12, long j9) {
        int i13 = i11 + (i12 >>> 6);
        int i14 = i12 & 63;
        if (i14 == 0) {
            jArr[i13] = jArr[i13] ^ j9;
            return;
        }
        jArr[i13] = jArr[i13] ^ (j9 << i14);
        long j11 = j9 >>> (64 - i14);
        if (j11 != 0) {
            int i15 = i13 + 1;
            jArr[i15] = j11 ^ jArr[i15];
        }
    }
    ...
    private static long interleave2_32to64(int i11) {
        ...
        return (((long) i12) & 4294967295L) | ((((long) ((sArr[i11 >>> 24] << 16) | sArr[(i11 >>> 16) & 255])) & 4294967295L) << 32);
    }

    private static long interleave2_n(long j9, int i11) {
        while (i11 > 1) {
            i11 -= 2;
            j9 = (interleave4_16to64(((int) (j9 >>> 48)) & Blake2xsDigest.UNKNOWN_DIGEST_LENGTH) << 3) | (interleave4_16to64(((int) (j9 >>> 16)) & Blake2xsDigest.UNKNOWN_DIGEST_LENGTH) << 1) | interleave4_16to64(((int) j9) & Blake2xsDigest.UNKNOWN_DIGEST_LENGTH) | (interleave4_16to64(((int) (j9 >>> 32)) & Blake2xsDigest.UNKNOWN_DIGEST_LENGTH) << 2);
        }
        if (i11 <= 0) {
            return j9;
        }
        return (interleave2_32to64((int) (j9 >>> 32)) << 1) | interleave2_32to64((int) j9);
    }

    private static long interleave3(long j9) {
        return (interleave3_21to63(((int) (j9 >>> 42)) & 2097151) << 2) | (Long.MIN_VALUE & j9) | interleave3_21to63(((int) j9) & 2097151) | (interleave3_21to63(((int) (j9 >>> 21)) & 2097151) << 1);
    }

    private static long interleave3_13to65(int i11) {
        int[] iArr = INTERLEAVE5_TABLE;
        int i12 = iArr[i11 & 127];
        return (((long) i12) & 4294967295L) | ((((long) iArr[i11 >>> 7]) & 4294967295L) << 35);
    }

    private static long interleave3_21to63(int i11) {
        int[] iArr = INTERLEAVE3_TABLE;
        int i12 = iArr[i11 & 127];
        return (((long) i12) & 4294967295L) | ((((long) iArr[i11 >>> 14]) & 4294967295L) << 42) | ((((long) iArr[(i11 >>> 7) & 127]) & 4294967295L) << 21);
    }

    private static long interleave4_16to64(int i11) {
        int[] iArr = INTERLEAVE4_TABLE;
        int i12 = iArr[i11 & 255];
        return (((long) i12) & 4294967295L) | ((((long) iArr[i11 >>> 8]) & 4294967295L) << 32);
    }

    private static long interleave5(long j9) {
        return (interleave3_13to65(((int) (j9 >>> 52)) & 8191) << 4) | interleave3_13to65(((int) j9) & 8191) | (interleave3_13to65(((int) (j9 >>> 13)) & 8191) << 1) | (interleave3_13to65(((int) (j9 >>> 26)) & 8191) << 2) | (interleave3_13to65(((int) (j9 >>> 39)) & 8191) << 3);
    }

    private static long interleave7(long j9) {
        long[] jArr = INTERLEAVE7_TABLE;
        return (jArr[((int) (j9 >>> 54)) & 511] << 6) | (Long.MIN_VALUE & j9) | jArr[((int) j9) & 511] | (jArr[((int) (j9 >>> 9)) & 511] << 1) | (jArr[((int) (j9 >>> 18)) & 511] << 2) | (jArr[((int) (j9 >>> 27)) & 511] << 3) | (jArr[((int) (j9 >>> 36)) & 511] << 4) | (jArr[((int) (j9 >>> 45)) & 511] << 5);
    }

    private static void multiplyWord(long j9, long[] jArr, int i11, long[] jArr2, int i12) {
        int i13 = i11;
        long[] jArr3 = jArr2;
        int i14 = i12;
        if ((j9 & 1) != 0) {
            add(jArr3, i14, jArr, 0, i13);
        }
        long j11 = j9;
        int i15 = 1;
        while (true) {
            ...
            if ((j11 & 1) != 0) {
                long jAddShiftedUp = addShiftedUp(jArr3, i14, jArr, 0, i13, i15);
                if (jAddShiftedUp != 0) {
                    int i16 = i12 + i11;
                    jArr2[i16] = jArr2[i16] ^ jAddShiftedUp;
                }
            }
            i15++;
            i13 = i11;
    ...
    private static int reduceInPlace(long[] jArr, int i11, int i12, int i13, int[] iArr) {
        ...
        int iMax = Math.max(i13, i18 + 64);
        int iMin2 = (Math.min(iMin - iMax, i13 - i19) + i16) >> 6;
        if (iMin2 > 1) {
            int i21 = i17 - iMin2;
            int i22 = i17;
            reduceVectorWise(jArr, i11, i22, i21, i13, iArr);
            i17 = i22;
            while (i17 > i21) {
                i17--;
                jArr[i11 + i17] = 0;
        ...
        int i24 = i17;
        if (i23 > iMax) {
            reduceWordWise(jArr, i11, i24, iMax, i13, iArr);
        } else {
            iMax = i23;
        }
        if (iMax > i13) {
            reduceBitWise(jArr, i11, iMax, i13, iArr);
        }
        return i14;
    }
    ...
    private static void reduceWord(long[] jArr, int i11, int i12, long j9, int i13, int[] iArr) {
        int i14 = i12 - i13;
        int length = iArr.length;
        while (true) {
            length--;
            if (length < 0) {
                flipWord(jArr, i11, i14, j9);
                return;
            }
            flipWord(jArr, i11, iArr[length] + i14, j9);
        }
    }
    ...
    private static void reduceWordWise(long[] jArr, int i11, int i12, int i13, int i14, int[] iArr) {
        ...
        while (true) {
            ...
            if (j9 != 0) {
                jArr[i17] = 0;
                reduceWord(jArr, i11, i16 << 6, j9, i14, iArr);
            }
        }
        int i18 = i13 & 63;
        int i19 = i11 + i15;
    ...
    private static long shiftUp(long[] jArr, int i11, long[] jArr2, int i12, int i13, int i14) {
        ...
        long j9 = 0;
        for (int i16 = 0; i16 < i13; i16++) {
            long j11 = jArr[i11 + i16];
            jArr2[i12 + i16] = j9 | (j11 << i14);
            j9 = j11 >>> i15;
        }
        return j9;
    }
    ...
    private static void squareInPlace(long[] jArr, int i11, int i12, int[] iArr) {
        ...
        while (true) {
            ...
            long j9 = jArr[i11];
            jArr[i13 - 1] = interleave2_32to64((int) (j9 >>> 32));
            i13 -= 2;
            jArr[i13] = interleave2_32to64((int) j9);
        }
    }
    ...
    public void copyTo(long[] jArr, int i11) {
        long[] jArr2 = this.m_ints;
    ...
    public int degree() {
        ...
        while (length != 0) {
            length--;
            long j9 = this.m_ints[length];
            if (j9 != 0) {
                return (length << 6) + bitLength(j9);
            }
        }
        return 0;
    }
    ...
    public int getUsedLengthFrom(int i11) {
        long[] jArr = this.m_ints;
        int iMin = Math.min(i11, jArr.length);
        if (iMin < 1) {
            return 0;
        }
        if (jArr[0] != 0) {
    ...
    public int hashCode() {
        ...
        for (int i12 = 0; i12 < usedLength; i12++) {
            long j9 = this.m_ints[i12];
            i11 = (((i11 * 31) ^ ((int) j9)) * 31) ^ ((int) (j9 >>> 32));
        }
        return i11;
    }
    ...
    public LongArray modInverse(int i11, int[] iArr) {
        ...
        int iDegreeFrom = 0;
        reduceBit(longArray2.m_ints, 0, i11, i11, iArr);
        ...
        while (true) {
            if (i15 < 0) {
                i15 = -i15;
                iArr2[i12] = i14;
                iArr3[i12] = iDegreeFrom;
                i12 = 1 - i12;
                i14 = iArr2[i12];
                iDegreeFrom = iArr3[i12];
            }
            int i16 = 1 - i12;
            longArrayArr[i12].addShiftedByBitsSafe(longArrayArr[i16], iArr2[i16], i15);
            int iDegreeFrom2 = longArrayArr[i12].degreeFrom(i14);
            if (iDegreeFrom2 == 0) {
                return longArrayArr2[i16];
            }
            int i17 = iArr3[i16];
            longArrayArr2[i12].addShiftedByBitsSafe(longArrayArr2[i16], i17, i15);
            int i18 = i17 + i15;
            if (i18 > iDegreeFrom) {
                iDegreeFrom = i18;
            } else if (i18 == iDegreeFrom) {
                iDegreeFrom = longArrayArr2[i12].degreeFrom(iDegreeFrom);
            }
            i15 += iDegreeFrom2 - i14;
            i14 = iDegreeFrom2;
        }
    }
    ...
    public LongArray modMultiply(LongArray longArray, int i11, int[] iArr) {
        ...
        if (i14 == 1) {
            long j9 = longArray2.m_ints[0];
            if (j9 == 1) {
                return longArray3;
            }
            long[] jArr3 = new long[i16];
            multiplyWord(j9, longArray3.m_ints, i15, jArr3, 0);
            return reduceResult(jArr3, 0, i16, i11, iArr);
        }
        int i17 = (i13 + 70) >>> 6;
        ...
        iArr2[1] = i17;
        System.arraycopy(longArray3.m_ints, 0, jArr4, i17, i15);
        int i19 = 2;
        int i21 = i17;
        while (i19 < 16) {
            int i22 = i21 + i17;
            ...
            if ((i19 & 1) == 0) {
                int i23 = i17;
                shiftUp(jArr4, i22 >>> 1, jArr4, i22, i23, 1);
                i17 = i23;
            } else {
                add(jArr4, i17, jArr4, i22 - i17, jArr4, i22, i17);
                i22 = i22;
            }
            i19++;
            i21 = i22;
        ...
        while (i25 < i14) {
            ...
            int i27 = i25;
            while (true) {
                addBoth(jArr8, i27, jArr6, iArr2[((int) j11) & 15], jArr5, iArr2[((int) (j11 >>> 4)) & 15], i26);
                jArr = jArr8;
                int i28 = i27;
                jArr2 = jArr6;
                i17 = i26;
        ...
        while (true) {
            int i29 = i24 - i16;
            if (i29 == 0) {
                return reduceResult(jArr9, 0, i16, i11, iArr);
            }
            addShiftedUp(jArr9, i29 - i16, jArr9, i29, i16, 8);
            i24 = i29;
        }
    }
    ...
    public LongArray modMultiplyAlt(LongArray longArray, int i11, int[] iArr) {
        ...
        if (i19 == 1) {
            ...
            multiplyWord(j9, longArray3.m_ints, i21, jArr3, 0);
            return reduceResult(jArr3, 0, i22, i11, iArr);
        }
        int i25 = (i13 + 78) >>> 6;
        int i26 = i25 * 8;
        int[] iArr2 = new int[16];
        ...
        int i29 = i19;
        long[] jArr4 = new long[i27 + 1];
        interleave(longArray2.m_ints, 0, jArr4, 0, i29, 4);
        System.arraycopy(longArray3.m_ints, 0, jArr4, i29, i21);
        int i31 = i29;
        int i32 = 1;
        while (i32 < 8) {
            int i33 = i31 + i25;
            int i34 = i29;
            shiftUp(jArr4, i34, jArr4, i33, i25, i32);
            i29 = i34;
            i32++;
            i31 = i33;
        }
        ...
        while (true) {
            ...
            while (true) {
                ...
                int i38 = i29;
                int i39 = i23;
                long j11 = jArr4[i37] >>> i36;
                while (true) {
                    int i41 = ((int) j11) & i14;
                    if (i41 != 0) {
                        add(jArr4, iArr2[i41] + i37, jArr4, i38, i25);
                    }
                    int i42 = i39 + 1;
                    if (i42 == 8) {
                        break;
        ...
        while (true) {
            int i44 = i43 - 1;
            if (i44 <= i24) {
                return reduceResult(jArr4, iArr2[i24], i22, i11, iArr);
            }
            if ((((long) i44) & 1) == 0) {
                int i45 = i22;
                i18 = i24;
                jArr2 = jArr4;
                addShiftedUp(jArr2, iArr2[i44 >>> 1], jArr4, iArr2[i44], i45, 16);
                i17 = i45;
            } else {
                long[] jArr8 = jArr4;
                i17 = i22;
                i18 = i24;
                jArr2 = jArr8;
                distribute(jArr2, iArr2[i44], iArr2[i43 - 2], iArr2[i18], i17);
            }
            long[] jArr9 = jArr2;
            i24 = i18;
            i22 = i17;
    ...
    public LongArray modMultiplyLD(LongArray longArray, int i11, int[] iArr) {
        ...
        if (i14 == 1) {
            ...
            multiplyWord(j9, longArray3.m_ints, i15, jArr2, 0);
            return reduceResult(jArr2, 0, i16, i11, iArr);
        }
        int i18 = (i13 + 70) >>> 6;
        int[] iArr2 = new int[16];
        int i19 = i18 << 4;
        ...
        iArr2[1] = i18;
        System.arraycopy(longArray3.m_ints, 0, jArr3, i18, i15);
        int i21 = 2;
        int i22 = i18;
        while (i21 < 16) {
            int i23 = i22 + i18;
            ...
            if ((i21 & 1) == 0) {
                int i24 = i18;
                jArr = jArr3;
                shiftUp(jArr, i23 >>> 1, jArr3, i23, i24, 1);
                i18 = i24;
            } else {
                int i25 = i18;
                jArr = jArr3;
                add(jArr, i18, jArr3, i23 - i25, jArr, i23, i25);
                i23 = i23;
            }
            i21++;
            jArr3 = jArr;
        ...
        while (i26 >= 0) {
            ...
            while (i27 < i14) {
                int[] iArr3 = iArr2;
                int i28 = (int) (jArr5[i27] >>> i26);
                int i29 = i18;
                addBoth(jArr6, i27 - 1, jArr3, iArr3[i28 & 15], jArr4, iArr3[(i28 >>> 4) & 15], i29);
                i27 += 2;
                i18 = i29;
                iArr2 = iArr3;
                jArr6 = jArr6;
        ...
        int i31 = i18;
        long[] jArr9 = jArr3;
        for (int i32 = 56; i32 >= 0; i32 -= 8) {
            for (int i33 = 0; i33 < i14; i33 += 2) {
                int i34 = (int) (jArr5[i33] >>> i32);
                long[] jArr10 = jArr9;
                addBoth(jArr8, i33, jArr10, iArr4[i34 & 15], jArr4, iArr4[(i34 >>> 4) & 15], i31);
                jArr9 = jArr10;
            }
            if (i32 > 0) {
                shiftUp(jArr8, 0, i16, 8);
            }
        }
        return reduceResult(jArr8, 0, i16, i11, iArr);
    }

    public LongArray modReduce(int i11, int[] iArr) {
        long[] jArrClone = Arrays.clone(this.m_ints);
        return new LongArray(jArrClone, 0, reduceInPlace(jArrClone, 0, jArrClone.length, i11, iArr));
    }
    ...
    public LongArray modSquare(int i11, int[] iArr) {
        ...
        int i13 = 0;
        while (i13 < i12) {
            long j9 = this.m_ints[i13 >>> 1];
            int i14 = i13 + 1;
            jArr[i13] = interleave2_32to64((int) j9);
            i13 += 2;
            jArr[i14] = interleave2_32to64((int) (j9 >>> 32));
        }
    ...
    public LongArray multiply(LongArray longArray, int i11, int[] iArr) {
        ...
        if (i16 == 1) {
            ...
            multiplyWord(j9, longArray3.m_ints, i17, jArr, 0);
            return new LongArray(jArr, 0, i18);
        }
        int i19 = (i13 + 70) >>> 6;
        int[] iArr2 = new int[16];
        int i21 = i19 << 4;
        ...
        iArr2[1] = i19;
        System.arraycopy(longArray3.m_ints, 0, jArr2, i19, i17);
        int i22 = 2;
        int i23 = i19;
        while (i22 < 16) {
            int i24 = i23 + i19;
            ...
            if ((i22 & 1) == 0) {
                int i25 = i19;
                shiftUp(jArr2, i24 >>> 1, jArr2, i24, i25, 1);
                i15 = i25;
            } else {
                int i26 = i19;
                i15 = i26;
                add(jArr2, i26, jArr2, i24 - i26, jArr2, i24, i15);
                i24 = i24;
            }
            i22++;
            i23 = i24;
        ...
        while (i29 < i16) {
            ...
            while (true) {
                long[] jArr6 = jArr3;
                long[] jArr7 = jArr2;
                addBoth(jArr5, i31, jArr7, iArr2[((int) j11) & 15], jArr6, iArr2[((int) (j11 >>> 4)) & 15], i27);
                int i32 = i31;
                jArr2 = jArr7;
                jArr3 = jArr6;
                i14 = i27;
        ...
        while (true) {
            int i33 = i28 - i18;
            if (i33 == 0) {
                return new LongArray(jArr5, 0, i18);
            }
            addShiftedUp(jArr5, i33 - i18, jArr5, i33, i18, 8);
            i28 = i33;
        }
    }
    ...
    public void reduce(int i11, int[] iArr) {
        long[] jArr = this.m_ints;
        int iReduceInPlace = reduceInPlace(jArr, 0, jArr.length, i11, iArr);
    ...
    public BigInteger toBigInteger() {
        ...
        long j9 = this.m_ints[i11];
        byte[] bArr = new byte[8];
        int i12 = 0;
        boolean z11 = false;
        for (int i13 = 7; i13 >= 0; i13--) {
            byte b8 = (byte) (j9 >>> (i13 * 8));
            if (z11 || b8 != 0) {
                bArr[i12] = b8;
                i12++;
                z11 = true;
