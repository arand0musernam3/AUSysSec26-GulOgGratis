...
public abstract class Nat224 {
    ...
    public static int addTo(int[] iArr, int i11, int[] iArr2, int i12, int i13) {
        ...
        iArr2[i18] = (int) j15;
        int i19 = i12 + 6;
        long j16 = (((long) iArr[i11 + 6]) & M) + (M & ((long) iArr2[i19])) + (j15 >>> 32);
        iArr2[i19] = (int) j16;
        return (int) (j16 >>> 32);
    }
    ...
    public static int addToEachOther(int[] iArr, int i11, int[] iArr2, int i12) {
        ...
        int i31 = i11 + 6;
        int i32 = i12 + 6;
        long j16 = (((long) iArr[i31]) & M) + (M & ((long) iArr2[i32])) + (j15 >>> 32);
        int i33 = (int) j16;
        iArr[i31] = i33;
        iArr2[i32] = i33;
        return (int) (j16 >>> 32);
    ...
    public static void mul(int[] iArr, int i11, int[] iArr2, int i12, int[] iArr3, int i13) {
        ...
        iArr3[i13 + 6] = (int) j25;
        iArr3[i13 + 7] = (int) (j25 >>> 32);
        int i14 = 1;
        int i15 = i13;
        while (i14 < 7) {
            int i16 = i15 + 1;
            int i17 = i15;
            long j26 = ((long) iArr[i11 + i14]) & M;
            long j27 = (j26 * j9) + (((long) iArr3[i16]) & M);
            iArr3[i16] = (int) j27;
            int i18 = i17 + 2;
            long j28 = (j26 * j11) + (((long) iArr3[i18]) & M) + (j27 >>> 32);
            iArr3[i18] = (int) j28;
            int i19 = i17 + 3;
            long j29 = (j26 * j12) + (((long) iArr3[i19]) & M) + (j28 >>> 32);
            iArr3[i19] = (int) j29;
            int i21 = i17 + 4;
            long j31 = (j26 * j13) + (((long) iArr3[i21]) & M) + (j29 >>> 32);
            iArr3[i21] = (int) j31;
            int i22 = i17 + 5;
            long j32 = (j26 * j14) + (((long) iArr3[i22]) & M) + (j31 >>> 32);
            iArr3[i22] = (int) j32;
            int i23 = i17 + 6;
            long j33 = (j26 * j15) + (((long) iArr3[i23]) & M) + (j32 >>> 32);
            iArr3[i23] = (int) j33;
            int i24 = i17 + 7;
            long j34 = (j26 * j16) + (((long) iArr3[i24]) & M) + (j33 >>> 32);
            iArr3[i24] = (int) j34;
            iArr3[i17 + 8] = (int) (j34 >>> 32);
            i14++;
            i15 = i16;
        }
    }
    ...
    public static long mul33Add(int i11, int[] iArr, int i12, int[] iArr2, int i13, int[] iArr3, int i14) {
        ...
        long j25 = (j9 * j24) + j22 + (M & ((long) iArr2[i13 + 6])) + (j23 >>> 32);
        iArr3[i14 + 6] = (int) j25;
        return (j25 >>> 32) + j24;
    }
    ...
    public static int mulAddTo(int[] iArr, int i11, int[] iArr2, int i12, int[] iArr3, int i13) {
        ...
        while (i14 < 7) {
            ...
            long j19 = (j18 * j9) + (((long) iArr3[i15]) & M);
            long j21 = j11;
            iArr3[i15] = (int) j19;
            int i17 = i15 + 1;
            long j22 = (j18 * j21) + (((long) iArr3[i17]) & M) + (j19 >>> 32);
            iArr3[i17] = (int) j22;
            int i18 = i15 + 2;
            long j23 = (j18 * j12) + (((long) iArr3[i18]) & M) + (j22 >>> 32);
            iArr3[i18] = (int) j23;
            int i19 = i15 + 3;
            long j24 = (j18 * j13) + (((long) iArr3[i19]) & M) + (j23 >>> 32);
            iArr3[i19] = (int) j24;
            int i21 = i15 + 4;
            long j25 = (j18 * j14) + (((long) iArr3[i21]) & M) + (j24 >>> 32);
            iArr3[i21] = (int) j25;
            int i22 = i15 + 5;
            long j26 = (j18 * j15) + (((long) iArr3[i22]) & M) + (j25 >>> 32);
            iArr3[i22] = (int) j26;
            int i23 = i15 + 6;
            long j27 = (j18 * j16) + (((long) iArr3[i23]) & M) + (j26 >>> 32);
            iArr3[i23] = (int) j27;
            int i24 = i15 + 7;
            long j28 = (j27 >>> 32) + (((long) iArr3[i24]) & M) + j17;
            iArr3[i24] = (int) j28;
            j17 = j28 >>> 32;
            i14 = i16 + 1;
            i15 = i17;
    ...
    public static int mulByWord(int i11, int[] iArr) {
        ...
        iArr[5] = (int) j16;
        long j17 = (j9 * (M & ((long) iArr[6]))) + (j16 >>> 32);
        iArr[6] = (int) j17;
        return (int) (j17 >>> 32);
    }
    ...
    public static int mulByWordAddTo(int i11, int[] iArr, int[] iArr2) {
        ...
        iArr2[5] = (int) j16;
        long j17 = (j9 * (((long) iArr2[6]) & M)) + (M & ((long) iArr[6])) + (j16 >>> 32);
        iArr2[6] = (int) j17;
        return (int) (j17 >>> 32);
    }
    ...
    public static int mulWordAddTo(int i11, int[] iArr, int i12, int[] iArr2, int i13) {
        ...
        iArr2[i18] = (int) j16;
        int i19 = i13 + 6;
        long j17 = (j9 * (((long) iArr[i12 + 6]) & M)) + (((long) iArr2[i19]) & M) + (j16 >>> 32);
        iArr2[i19] = (int) j17;
        return (int) (j17 >>> 32);
    }
    ...
    public static void square(int[] iArr, int i11, int[] iArr2, int i12) {
        ...
        while (true) {
            ...
            if (i16 <= 0) {
                ...
                int i52 = i51 >>> 31;
                int i53 = i12 + 13;
                iArr2[i53] = i52 | ((iArr2[i53] + ((int) (j66 >>> 32))) << 1);
                return;
            }
            i15 = i16;
        }
    ...
    public static int subFrom(int[] iArr, int[] iArr2) {
        ...
        iArr2[5] = (int) j15;
        long j16 = ((((long) iArr2[6]) & M) - (M & ((long) iArr[6]))) + (j15 >> 32);
        iArr2[6] = (int) j16;
        return (int) (j16 >> 32);
    }
    ...
    public static int addTo(int[] iArr, int[] iArr2) {
        ...
        iArr2[5] = (int) j15;
        long j16 = (((long) iArr[6]) & M) + (M & ((long) iArr2[6])) + (j15 >>> 32);
        iArr2[6] = (int) j16;
        return (int) (j16 >>> 32);
    }
    ...
    public static int mulAddTo(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        while (i11 < 7) {
            ...
            long j21 = (((long) iArr3[i11]) & M) + (j19 * j9);
            iArr3[i11] = (int) j21;
            int i12 = i11 + 1;
            long j22 = (j19 * j11) + (((long) iArr3[i12]) & M) + (j21 >>> 32);
            iArr3[i12] = (int) j22;
            int i13 = i11 + 2;
            long j23 = (j19 * j12) + (((long) iArr3[i13]) & M) + (j22 >>> 32);
            int i14 = i11;
            iArr3[i13] = (int) j23;
            int i15 = i14 + 3;
            ...
            iArr3[i17] = (int) j26;
            int i18 = i14 + 6;
            long j27 = (j19 * j18) + (((long) iArr3[i18]) & M) + (j26 >>> 32);
            iArr3[i18] = (int) j27;
            int i19 = i14 + 7;
            long j28 = (j27 >>> 32) + (((long) iArr3[i19]) & M) + j17;
            iArr3[i19] = (int) j28;
            j17 = j28 >>> 32;
            i11 = i12;
            j16 = j18;
    ...
    public static void mul(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        for (int i12 = 7; i11 < i12; i12 = 7) {
            long j26 = ((long) iArr[i11]) & M;
            long j27 = (j26 * j9) + (((long) iArr3[i11]) & M);
            iArr3[i11] = (int) j27;
            int i13 = i11 + 1;
            long j28 = j14;
            long j29 = (j26 * j11) + (((long) iArr3[i13]) & M) + (j27 >>> 32);
            iArr3[i13] = (int) j29;
            int i14 = i11 + 2;
            long j31 = (j26 * j12) + (((long) iArr3[i14]) & M) + (j29 >>> 32);
            iArr3[i14] = (int) j31;
            int i15 = i11 + 3;
            long j32 = (j26 * j13) + (((long) iArr3[i15]) & M) + (j31 >>> 32);
            iArr3[i15] = (int) j32;
            int i16 = i11 + 4;
            long j33 = (j26 * j28) + (((long) iArr3[i16]) & M) + (j32 >>> 32);
            iArr3[i16] = (int) j33;
            int i17 = i11 + 5;
            long j34 = (j26 * j15) + (((long) iArr3[i17]) & M) + (j33 >>> 32);
            iArr3[i17] = (int) j34;
            int i18 = i11 + 6;
            long j35 = (j26 * j16) + (((long) iArr3[i18]) & M) + (j34 >>> 32);
            iArr3[i18] = (int) j35;
            iArr3[i11 + 7] = (int) (j35 >>> 32);
            i11 = i13;
            j14 = j28;
        }
    }
    ...
    public static void square(int[] iArr, int[] iArr2) {
        ...
        while (true) {
            ...
            if (i14 <= 0) {
                ...
                long j65 = j62 + (jC15 >>> 32);
                int i27 = (int) jC11;
                iArr2[7] = (i27 << 1) | i26;
                int i28 = (int) jC12;
                iArr2[8] = (i27 >>> 31) | (i28 << 1);
                int i29 = i28 >>> 31;
                int i31 = (int) jC13;
                iArr2[9] = i29 | (i31 << 1);
                int i32 = i31 >>> 31;
                ...
                int i37 = (int) j65;
                iArr2[12] = i36 | (i37 << 1);
                iArr2[13] = ((iArr2[13] + ((int) (j65 >>> 32))) << 1) | (i37 >>> 31);
                return;
            }
            i13 = i14;
        }
