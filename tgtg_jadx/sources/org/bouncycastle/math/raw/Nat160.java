...
public abstract class Nat160 {
    ...
    public static int addTo(int[] iArr, int i11, int[] iArr2, int i12, int i13) {
        ...
        iArr2[i16] = (int) j13;
        int i17 = i12 + 4;
        long j14 = (((long) iArr[i11 + 4]) & M) + (M & ((long) iArr2[i17])) + (j13 >>> 32);
        iArr2[i17] = (int) j14;
        return (int) (j14 >>> 32);
    }
    ...
    public static int addToEachOther(int[] iArr, int i11, int[] iArr2, int i12) {
        ...
        int i24 = i11 + 4;
        int i25 = i12 + 4;
        long j14 = (((long) iArr[i24]) & M) + (M & ((long) iArr2[i25])) + (j13 >>> 32);
        int i26 = (int) j14;
        iArr[i24] = i26;
        iArr2[i25] = i26;
        return (int) (j14 >>> 32);
    ...
    public static void mul(int[] iArr, int i11, int[] iArr2, int i12, int[] iArr3, int i13) {
        ...
        iArr3[i13 + 3] = (int) j19;
        long j21 = (j15 * j14) + (j19 >>> 32);
        iArr3[i13 + 4] = (int) j21;
        iArr3[i13 + 5] = (int) (j21 >>> 32);
        int i14 = 1;
        int i15 = i13;
        while (i14 < 5) {
            int i16 = i15 + 1;
            long j22 = ((long) iArr[i11 + i14]) & M;
            long j23 = j9;
            long j24 = (j22 * j9) + (((long) iArr3[i16]) & M);
            iArr3[i16] = (int) j24;
            int i17 = i15 + 2;
            long j25 = (j22 * j11) + (((long) iArr3[i17]) & M) + (j24 >>> 32);
            int i18 = i15;
            iArr3[i17] = (int) j25;
            int i19 = i18 + 3;
            long j26 = (j22 * j12) + (((long) iArr3[i19]) & M) + (j25 >>> 32);
            iArr3[i19] = (int) j26;
            int i21 = i18 + 4;
            long j27 = (j22 * j13) + (((long) iArr3[i21]) & M) + (j26 >>> 32);
            iArr3[i21] = (int) j27;
            int i22 = i18 + 5;
            long j28 = (j22 * j14) + (((long) iArr3[i22]) & M) + (j27 >>> 32);
            iArr3[i22] = (int) j28;
            iArr3[i18 + 6] = (int) (j28 >>> 32);
            i14++;
            i15 = i16;
            j9 = j23;
        }
    ...
    public static long mul33Add(int i11, int[] iArr, int i12, int[] iArr2, int i13, int[] iArr3, int i14) {
        ...
        long j21 = (j9 * j19) + j17 + (M & ((long) iArr2[i13 + 4])) + (j18 >>> 32);
        iArr3[i14 + 4] = (int) j21;
        return (j21 >>> 32) + j19;
    }
    ...
    public static int mulAddTo(int[] iArr, int i11, int[] iArr2, int i12, int[] iArr3, int i13) {
        ...
        int i15 = i13;
        while (i14 < 5) {
            long j16 = ((long) iArr[i11 + i14]) & M;
            long j17 = j9;
            long j18 = (j16 * j9) + (((long) iArr3[i15]) & M);
            iArr3[i15] = (int) j18;
            int i16 = i15 + 1;
            long j19 = (j16 * j11) + (((long) iArr3[i16]) & M) + (j18 >>> 32);
            iArr3[i16] = (int) j19;
            long j21 = j16 * j12;
            int i17 = i15 + 2;
            long j22 = j21 + (((long) iArr3[i17]) & M) + (j19 >>> 32);
            iArr3[i17] = (int) j22;
            long j23 = j16 * j13;
            int i18 = i15 + 3;
            long j24 = j23 + (((long) iArr3[i18]) & M) + (j22 >>> 32);
            iArr3[i18] = (int) j24;
            long j25 = j16 * j14;
            int i19 = i15 + 4;
            long j26 = j25 + (((long) iArr3[i19]) & M) + (j24 >>> 32);
            iArr3[i19] = (int) j26;
            int i21 = i15 + 5;
            long j27 = (j26 >>> 32) + (((long) iArr3[i21]) & M) + j15;
            iArr3[i21] = (int) j27;
            j15 = j27 >>> 32;
            i14++;
            i15 = i16;
    ...
    public static int mulWordAddExt(int i11, int[] iArr, int i12, int[] iArr2, int i13) {
        ...
        iArr2[i16] = (int) j14;
        int i17 = i13 + 4;
        long j15 = (j9 * (((long) iArr[i12 + 4]) & M)) + (((long) iArr2[i17]) & M) + (j14 >>> 32);
        iArr2[i17] = (int) j15;
        return (int) (j15 >>> 32);
    }
    ...
    public static void square(int[] iArr, int i11, int[] iArr2, int i12) {
        ...
        while (true) {
            ...
            if (i16 <= 0) {
                ...
                int i38 = i37 >>> 31;
                int i39 = i12 + 9;
                iArr2[i39] = ((iArr2[i39] + ((int) (j43 >>> 32))) << 1) | i38;
                return;
            }
            i15 = i16;
        }
    ...
    public static int subFrom(int[] iArr, int[] iArr2) {
        ...
        iArr2[3] = (int) j13;
        long j14 = ((((long) iArr2[4]) & M) - (M & ((long) iArr[4]))) + (j13 >> 32);
        iArr2[4] = (int) j14;
        return (int) (j14 >> 32);
    }
    ...
    public static int addTo(int[] iArr, int[] iArr2) {
        ...
        long j13 = (((long) iArr[3]) & M) + (((long) iArr2[3]) & M) + (j12 >>> 32);
        iArr2[3] = (int) j13;
        long j14 = (((long) iArr[4]) & M) + (M & ((long) iArr2[4])) + (j13 >>> 32);
        iArr2[4] = (int) j14;
        return (int) (j14 >>> 32);
    }
    ...
    public static int mulAddTo(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        long j16 = ((long) iArr2[4]) & M;
        long j17 = 0;
        while (i11 < 5) {
            long j18 = j11;
            long j19 = ((long) iArr[i11]) & j18;
            int i12 = i11;
            long j21 = (j19 * j12) + (((long) iArr3[i11]) & j18);
            iArr3[i12] = (int) j21;
            int i13 = i12 + 1;
            long j22 = (j19 * j13) + (((long) iArr3[i13]) & j18) + (j21 >>> 32);
            iArr3[i13] = (int) j22;
            int i14 = i12 + 2;
            long j23 = (j19 * j14) + (((long) iArr3[i14]) & j18) + (j22 >>> 32);
            iArr3[i14] = (int) j23;
            int i15 = i12 + 3;
            long j24 = (j19 * j15) + (((long) iArr3[i15]) & j18) + (j23 >>> 32);
            iArr3[i15] = (int) j24;
            int i16 = i12 + 4;
            long j25 = (j19 * j16) + (((long) iArr3[i16]) & j18) + (j24 >>> 32);
            iArr3[i16] = (int) j25;
            int i17 = i12 + 5;
            long j26 = (j25 >>> 32) + (((long) iArr3[i17]) & j18) + j17;
            iArr3[i17] = (int) j26;
            j17 = j26 >>> 32;
            j11 = j18;
            j12 = j12;
    ...
    public static void mul(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        while (true) {
            ...
            long j22 = ((long) iArr[i13]) & M;
            long j23 = (j22 * j9) + (((long) iArr3[i13]) & M);
            iArr3[i13] = (int) j23;
            i11 = i13 + 1;
            char c7 = c3;
            long j24 = (j22 * j11) + (((long) iArr3[i11]) & M) + (j23 >>> c3);
            iArr3[i11] = (int) j24;
            int i14 = i13 + 2;
            long j25 = j14;
            long j26 = (j22 * j12) + (((long) iArr3[i14]) & M) + (j24 >>> c7);
            iArr3[i14] = (int) j26;
            long j27 = j26 >>> c7;
            int i15 = i13 + 3;
            long j28 = (j22 * j13) + (((long) iArr3[i15]) & M) + j27;
            iArr3[i15] = (int) j28;
            long j29 = j28 >>> c7;
            int i16 = i13 + 4;
            long j31 = (j22 * j25) + (((long) iArr3[i16]) & M) + j29;
            iArr3[i16] = (int) j31;
            iArr3[i13 + 5] = (int) (j31 >>> c7);
            c3 = c7;
            j14 = j25;
            i12 = 5;
        }
    ...
    public static void square(int[] iArr, int[] iArr2) {
        ...
        while (true) {
            ...
            if (i14 <= 0) {
                ...
                int i28 = (int) j42;
                iArr2[8] = i27 | (i28 << 1);
                iArr2[9] = ((iArr2[9] + ((int) (j42 >>> 32))) << 1) | (i28 >>> 31);
                return;
            }
            i13 = i14;
        }
