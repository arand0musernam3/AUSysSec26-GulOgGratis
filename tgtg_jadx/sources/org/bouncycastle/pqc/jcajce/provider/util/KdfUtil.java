...
public class KdfUtil {
    ...
    public static byte[] makeKeyBytes(AlgorithmIdentifier algorithmIdentifier, byte[] bArr, byte[] bArr2, int i11) {
        int i12 = (i11 + 7) / 8;
        ...
        if (X9ObjectIdentifiers.id_kdf_kdf2.equals((ASN1Primitive) algorithmIdentifier.getAlgorithm())) {
            ...
            kDF2BytesGenerator.generateBytes(bArr3, 0, i12);
            return bArr3;
        }
        if (X9ObjectIdentifiers.id_kdf_kdf3.equals((ASN1Primitive) algorithmIdentifier.getAlgorithm())) {
            ...
            concatenationKDFGenerator.generateBytes(bArr3, 0, i12);
            return bArr3;
        }
        if (PKCSObjectIdentifiers.id_alg_hkdf_with_sha256.equals((ASN1Primitive) algorithmIdentifier.getAlgorithm())) {
            if (algorithmIdentifier.getParameters() == null) {
                ...
                hKDFBytesGenerator.generateBytes(bArr3, 0, i12);
                return bArr3;
            }
        } else if (PKCSObjectIdentifiers.id_alg_hkdf_with_sha384.equals((ASN1Primitive) algorithmIdentifier.getAlgorithm())) {
            if (algorithmIdentifier.getParameters() == null) {
                ...
                hKDFBytesGenerator2.generateBytes(bArr3, 0, i12);
                return bArr3;
            }
        } else {
            ...
            if (algorithmIdentifier.getParameters() == null) {
                ...
                hKDFBytesGenerator3.generateBytes(bArr3, 0, i12);
                return bArr3;
            }
        }
        h2.b("HDKF parameter support not added");
        return null;
    }
    ...
    public static byte[] makeKeyBytes(KEMKDFSpec kEMKDFSpec, byte[] bArr) {
        ...
        try {
            if (kEMKDFSpec == null) {
                ...
                bArrMakeKeyBytes = makeKeyBytes(kEMKDFSpec.getKdfAlgorithm(), bArr, kEMKDFSpec.getOtherInfo(), kEMKDFSpec.getKeySize());
            }
            Arrays.clear(bArr);
