    ...
    public void initialize(AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) throws InvalidAlgorithmParameterException {
        ...
        if (algorithmParameterSpec instanceof LMSKeyGenParameterSpec) {
            ...
            if (algorithmParameterSpec instanceof LMSHSSKeyGenParameterSpec) {
                ...
                while (i11 != lMSSpecs.length) {
                    lMSParametersArr[i11] = new LMSParameters(lMSSpecs[i11].getSigParams(), lMSSpecs[i11].getOtsParams());
                    i11++;
                }
                ...
                if (!(algorithmParameterSpec instanceof LMSHSSParameterSpec)) {
                    i1.v("parameter object not a LMSParameterSpec/LMSHSSParameterSpec");
                    return;
                }
                ...
                while (i11 != lMSSpecs2.length) {
                    lMSParametersArr2[i11] = new LMSParameters(lMSSpecs2[i11].getSigParams(), lMSSpecs2[i11].getOtsParams());
                    i11++;
                }
