...
public class BCLMSPrivateKey implements PrivateKey, LMSPrivateKey {
    ...
    public BCLMSPrivateKey(LMSKeyParameters lMSKeyParameters) {
        ...
        if (lMSKeyParameters instanceof HSSPrivateKeyParameters) {
            hSSPrivateKeyParameters = (HSSPrivateKeyParameters) lMSKeyParameters;
        } else {
            LMSPrivateKeyParameters lMSPrivateKeyParameters = (LMSPrivateKeyParameters) lMSKeyParameters;
            hSSPrivateKeyParameters = new HSSPrivateKeyParameters(lMSPrivateKeyParameters, lMSPrivateKeyParameters.getIndex(), ((long) lMSPrivateKeyParameters.getIndex()) + lMSPrivateKeyParameters.getUsagesRemaining());
        }
        this.keyParams = hSSPrivateKeyParameters;
    }
    ...
    public LMSPrivateKey extractKeyShard(int i11) {
        ...
        return lMSKeyParameters instanceof LMSPrivateKeyParameters ? new BCLMSPrivateKey(((LMSPrivateKeyParameters) lMSKeyParameters).extractKeyShard(i11)) : new BCLMSPrivateKey(((HSSPrivateKeyParameters) lMSKeyParameters).extractKeyShard(i11));
    }
    ...
    public int hashCode() {
        try {
            ...
            h2.b("unable to calculate hashCode");
            return 0;
        }
    }
