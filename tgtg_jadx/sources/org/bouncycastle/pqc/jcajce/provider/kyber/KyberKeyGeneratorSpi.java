...
public class KyberKeyGeneratorSpi extends KeyGeneratorSpi {
    ...
    public KyberKeyGeneratorSpi(MLKEMParameters mLKEMParameters) {
    ...
    public SecretKey engineGenerateKey() {
        ...
        SecretWithEncapsulation secretWithEncapsulationGenerateEncapsulated = new MLKEMGenerator(this.random).generateEncapsulated(((BCKyberPublicKey) kEMGenerateSpec.getPublicKey()).getKeyParams());
