...
public class McElieceCCA2KeyFactorySpi extends KeyFactorySpi implements AsymmetricKeyInfoConverter {
    ...
    public PrivateKey engineGeneratePrivate(KeySpec keySpec) throws InvalidKeySpecException {
        ...
        try {
            ...
            throw new InvalidKeySpecException(i.k("Unable to decode PKCS8EncodedKeySpec: ", e5));
        }
    }
    ...
    public PublicKey engineGeneratePublic(KeySpec keySpec) throws InvalidKeySpecException {
        ...
        try {
            ...
            try {
                ...
                throw new InvalidKeySpecException(s.g(e5, new StringBuilder("Unable to decode X509EncodedKeySpec: ")));
            }
