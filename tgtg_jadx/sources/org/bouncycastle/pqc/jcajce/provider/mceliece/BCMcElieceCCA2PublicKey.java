...
public class BCMcElieceCCA2PublicKey implements CipherParameters, PublicKey {
    ...
    public String toString() {
        StringBuilder sbR = f.r("McEliecePublicKey:\n length of the code         : " + this.params.getN() + "\n", " error correction capability: ");
        sbR.append(this.params.getT());
        sbR.append("\n");
        StringBuilder sbR2 = f.r(sbR.toString(), " generator matrix           : ");
        sbR2.append(this.params.getG().toString());
