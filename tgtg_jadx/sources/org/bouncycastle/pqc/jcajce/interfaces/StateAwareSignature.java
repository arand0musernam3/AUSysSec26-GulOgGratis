...
public interface StateAwareSignature {
    ...
    int sign(byte[] bArr, int i11, int i12) throws SignatureException;

    byte[] sign() throws SignatureException;

    void update(byte b8) throws SignatureException;

    void update(ByteBuffer byteBuffer) throws SignatureException;

    void update(byte[] bArr) throws SignatureException;

    void update(byte[] bArr, int i11, int i12) throws SignatureException;

    boolean verify(byte[] bArr) throws SignatureException;

    boolean verify(byte[] bArr, int i11, int i12) throws SignatureException;
}
