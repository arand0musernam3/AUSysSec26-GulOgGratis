...
public abstract class GF2nField {
    ...
    public final GF2nElement convert(GF2nElement gF2nElement, GF2nField gF2nField) throws RuntimeException {
        ...
        if (this.mDegree != gF2nField.mDegree) {
            d0.k("GF2nField.convert: B1 has a different degree and thus cannot be coverted to!");
            return null;
        }
        ...
        if (!(gF2nField instanceof GF2nONBField)) {
            d0.k("GF2nField.convert: B1 must be an instance of GF2nPolynomialField or GF2nONBField!");
            return null;
        }
    ...
    public final GF2Polynomial[] invertMatrix(GF2Polynomial[] gF2PolynomialArr) {
        ...
        for (int i12 = 0; i12 < this.mDegree; i12++) {
            ...
            gF2PolynomialArr3[i12] = gF2Polynomial;
            gF2Polynomial.setBit((this.mDegree - 1) - i12);
        }
        while (true) {
            ...
            if (i16 >= this.mDegree) {
                d0.k("GF2nField.invertMatrix: Matrix cannot be inverted!");
                return null;
            }
            if (i11 != i16) {
                GF2Polynomial gF2Polynomial2 = gF2PolynomialArr2[i11];
                gF2PolynomialArr2[i11] = gF2PolynomialArr2[i16];
                gF2PolynomialArr2[i16] = gF2Polynomial2;
                GF2Polynomial gF2Polynomial3 = gF2PolynomialArr3[i11];
                gF2PolynomialArr3[i11] = gF2PolynomialArr3[i16];
                gF2PolynomialArr3[i16] = gF2Polynomial3;
            }
            int i18 = i11 + 1;
            int i19 = i18;
            while (true) {
