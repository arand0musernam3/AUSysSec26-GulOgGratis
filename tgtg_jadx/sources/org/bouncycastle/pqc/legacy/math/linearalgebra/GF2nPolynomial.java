...
public class GF2nPolynomial {
    ...
    public GF2nPolynomial(GF2Polynomial gF2Polynomial, GF2nField gF2nField) {
        ...
        if (gF2nField instanceof GF2nONBField) {
            while (i11 < this.size) {
                boolean zTestBit = gF2Polynomial.testBit(i11);
                GF2nElement[] gF2nElementArr = this.coeff;
                if (zTestBit) {
                    gF2nElementArr[i11] = GF2nONBElement.ONE((GF2nONBField) gF2nField);
                } else {
                    gF2nElementArr[i11] = GF2nONBElement.ZERO((GF2nONBField) gF2nField);
                }
                i11++;
            }
            return;
        ...
        if (!(gF2nField instanceof GF2nPolynomialField)) {
            a.f("PolynomialGF2n(Bitstring, GF2nField): B1 must be an instance of GF2nONBField or GF2nPolynomialField!");
            throw null;
        }
        while (i11 < this.size) {
            boolean zTestBit2 = gF2Polynomial.testBit(i11);
            GF2nElement[] gF2nElementArr2 = this.coeff;
            if (zTestBit2) {
                gF2nElementArr2[i11] = GF2nPolynomialElement.ONE((GF2nPolynomialField) gF2nField);
            } else {
                gF2nElementArr2[i11] = GF2nPolynomialElement.ZERO((GF2nPolynomialField) gF2nField);
            }
            i11++;
        }
    }
    ...
    public final GF2nPolynomial add(GF2nPolynomial gF2nPolynomial) {
        ...
        while (i11 < size()) {
            gF2nPolynomial3.coeff[i11] = (GF2nElement) this.coeff[i11].add(gF2nPolynomial.coeff[i11]);
            i11++;
        }
        while (i11 < gF2nPolynomial.size()) {
            gF2nPolynomial3.coeff[i11] = gF2nPolynomial.coeff[i11];
            i11++;
        }
    ...
    public final boolean isZero() {
        for (int i11 = 0; i11 < this.size; i11++) {
            GF2nElement gF2nElement = this.coeff[i11];
    ...
    public final GF2nPolynomial multiply(GF2nPolynomial gF2nPolynomial) {
        if (size() != gF2nPolynomial.size()) {
            a.f("PolynomialGF2n.multiply: this and b must have the same size!");
            return null;
        }
        ...
        for (int i11 = 0; i11 < size(); i11++) {
            for (int i12 = 0; i12 < gF2nPolynomial.size(); i12++) {
                ...
                int i13 = i11 + i12;
                GF2nElement gF2nElement = gF2nElementArr[i13];
                GF2nElement[] gF2nElementArr2 = this.coeff;
                if (gF2nElement == null) {
                    gF2nElementArr[i13] = (GF2nElement) gF2nElementArr2[i11].multiply(gF2nPolynomial.coeff[i12]);
                } else {
                    gF2nElementArr[i13] = (GF2nElement) gF2nElement.add(gF2nElementArr2[i11].multiply(gF2nPolynomial.coeff[i12]));
                }
            }
        }
        return gF2nPolynomial2;
    ...
    public final void set(int i11, GF2nElement gF2nElement) {
        if ((gF2nElement instanceof GF2nPolynomialElement) || (gF2nElement instanceof GF2nONBElement)) {
            ...
            a.f("PolynomialGF2n.set f must be an instance of either GF2nPolynomialElement or GF2nONBElement!");
        }
    }
        ...
        if (i11 > 0) {
            ...
            while (true) {
                ...
                if (i12 < 0) {
                    ...
                    gF2nElementArr[i12 + i11] = gF2nElementArr[i12];
                }
            }
    ...
    public final void shrink() {
        ...
        int i12 = i11 + 1;
        if (i12 < this.size) {
            GF2nElement[] gF2nElementArr = new GF2nElement[i12];
            System.arraycopy(this.coeff, 0, gF2nElementArr, 0, i12);
            this.coeff = gF2nElementArr;
            this.size = i12;
        }
