...
public class GF2nPolynomialElement extends GF2nElement {
    ...
    private void reduceThis() {
        ...
        if (zIsTrinomial) {
            try {
                int tc2 = ((GF2nPolynomialField) gF2nField).getTc();
                if (this.mDegree - tc2 > 32) {
                    int length2 = this.polynomial.getLength();
                    int i12 = this.mDegree;
                    if (length2 <= (i12 << 1)) {
                        this.polynomial.reduceTrinomial(i12, tc2);
                        return;
                    }
                }
                ...
                d0.k("GF2nPolynomialElement.reduce: the field polynomial is not a trinomial");
                return;
            }
        }
        ...
        try {
            ...
            if (this.mDegree - pc2[2] > 32) {
                ...
                if (length3 <= (i13 << 1)) {
                    this.polynomial.reducePentanomial(i13, pc2);
                    return;
                }
            }
            reducePentanomialBitwise(pc2);
        } catch (RuntimeException unused2) {
            d0.k("GF2nPolynomialElement.reduce: the field polynomial is not a pentanomial");
        }
    }
    ...
    public void squareThisMatrix() {
        ...
        while (true) {
            if (i11 >= this.mDegree) {
                ...
                if (this.polynomial.vectorMult(((GF2nPolynomialField) this.mField).squaringMatrix[(r2 - i11) - 1])) {
