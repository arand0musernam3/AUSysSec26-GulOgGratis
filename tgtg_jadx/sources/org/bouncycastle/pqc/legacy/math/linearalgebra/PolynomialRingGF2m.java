...
public class PolynomialRingGF2m {
    ...
    private PolynomialGF2mSmallM f33723p;
    ...
    public PolynomialRingGF2m(GF2mField gF2mField, PolynomialGF2mSmallM polynomialGF2mSmallM) {
        ...
        this.f33723p = polynomialGF2mSmallM;
    ...
    private void computeSquareRootMatrix() {
        int coefficient;
        int degree = this.f33723p.getDegree();
        ...
        for (int i13 = 0; i13 < degree; i13++) {
            if (polynomialGF2mSmallMArr[i13].getCoefficient(i13) == 0) {
                ...
                if (!z11) {
                    d.f("Squaring matrix is not invertible.");
                    return;
                }
            }
            int iInverse = this.field.inverse(polynomialGF2mSmallMArr[i13].getCoefficient(i13));
            polynomialGF2mSmallMArr[i13].multThisWithElement(iInverse);
            this.sqRootMatrix[i13].multThisWithElement(iInverse);
            for (int i15 = 0; i15 < degree; i15++) {
                if (i15 != i13 && (coefficient = polynomialGF2mSmallMArr[i15].getCoefficient(i13)) != 0) {
                    PolynomialGF2mSmallM polynomialGF2mSmallMMultWithElement = polynomialGF2mSmallMArr[i13].multWithElement(coefficient);
                    PolynomialGF2mSmallM polynomialGF2mSmallMMultWithElement2 = this.sqRootMatrix[i13].multWithElement(coefficient);
                    polynomialGF2mSmallMArr[i15].addToThis(polynomialGF2mSmallMMultWithElement);
                    this.sqRootMatrix[i15].addToThis(polynomialGF2mSmallMMultWithElement2);
                }
            }
        }
    }
    ...
    private void computeSquaringMatrix() {
        ...
        while (i11 < degree) {
            ...
            iArr2[i14] = 1;
            this.sqMatrix[i11] = new PolynomialGF2mSmallM(this.field, iArr2).mod(this.f33723p);
            i11++;
        }
    }
