...
class QTesla3p {
    ...
    public static class Gaussian {
        ...
        public static void sample_gauss_poly(int i11, byte[] bArr, int i12, long[] jArr, int i13) {
            int i14 = i11 << 8;
            ...
            while (i15 < 2048) {
                int i16 = i14 + 1;
                HashUtils.customizableSecureHashAlgorithmKECCAK256Simple(bArr2, 0, 8192, (short) i14, bArr, i12, 32);
                for (int i17 = 0; i17 < 512; i17++) {
                    int i18 = i13 + i15 + i17;
                    jArr[i18] = 0;
                    for (int i19 = 1; i19 < CDT_ROWS; i19++) {
                        int i21 = 0;
                        for (int i22 = 3; i22 >= 0; i22--) {
                            int iAt = (int) (((long) (QTesla3p.at(bArr2, 0, (i17 * 4) + i22) & Integer.MAX_VALUE)) - (cdt_v[(i19 * 4) + i22] + ((long) i21)));
                            iArr[i22] = iAt;
                            i21 = iAt >> 31;
                        }
                        jArr[i18] = jArr[i18] + ((long) ((~i21) & 1));
                    }
                    int iAt2 = QTesla3p.at(bArr2, 0, i17 * 4) >> 31;
                    long j9 = jArr[i18];
                    jArr[i18] = (((long) iAt2) & (-j9)) | (j9 & ((long) (~iAt2)));
                }
                i15 += 512;
                i14 = i16;
            }
    ...
    private static long absolute(long j9) {
        long j11 = j9 >> 63;
        return (j9 ^ j11) - j11;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static int at(byte[] bArr, int i11, int i12) {
        int i13 = (i12 * 4) + (i11 * 4);
        return (bArr[i13 + 3] << 24) | (bArr[i13] & 255) | ((bArr[i13 + 1] & 255) << 8) | ((bArr[i13 + 2] & 255) << 16);
    }

    private static boolean checkPolynomial(long[] jArr, int i11, int i12) {
        int i13;
        int i14 = 2048;
        long[] jArr2 = new long[2048];
        for (int i15 = 0; i15 < 2048; i15++) {
            jArr2[i15] = absolute((int) jArr[i11 + i15]);
        }
        int i16 = 0;
        int i17 = 0;
        while (i16 < 40) {
            ...
            while (true) {
                ...
                if (i18 < i13) {
                    ...
                    long j12 = (j9 - j11) >> 31;
                    long j13 = ~j12;
                    jArr2[i19] = (j13 & j9) | (j11 & j12);
                    jArr2[i18] = (j9 & j12) | (j11 & j13);
                    i16 = i16;
                    i18 = i19;
                }
            }
    ...
    public static void decodePublicKey(int[] iArr, byte[] bArr, int i11, byte[] bArr2) {
        int i12 = 0;
        for (int i13 = 0; i13 < 10240; i13 += 16) {
            iArr[i13] = at(bArr2, i12, 0) & 1073741823;
            iArr[i13 + 1] = ((at(bArr2, i12, 0) >>> 30) | (at(bArr2, i12, 1) << 2)) & 1073741823;
            iArr[i13 + 2] = ((at(bArr2, i12, 1) >>> 28) | (at(bArr2, i12, 2) << 4)) & 1073741823;
            iArr[i13 + 3] = ((at(bArr2, i12, 2) >>> 26) | (at(bArr2, i12, 3) << 6)) & 1073741823;
            iArr[i13 + 4] = ((at(bArr2, i12, 3) >>> 24) | (at(bArr2, i12, 4) << 8)) & 1073741823;
            iArr[i13 + 5] = ((at(bArr2, i12, 4) >>> 22) | (at(bArr2, i12, 5) << 10)) & 1073741823;
            iArr[i13 + 6] = ((at(bArr2, i12, 5) >>> 20) | (at(bArr2, i12, 6) << 12)) & 1073741823;
            iArr[i13 + 7] = ((at(bArr2, i12, 6) >>> 18) | (at(bArr2, i12, 7) << 14)) & 1073741823;
            iArr[i13 + 8] = ((at(bArr2, i12, 7) >>> 16) | (at(bArr2, i12, 8) << 16)) & 1073741823;
            iArr[i13 + 9] = ((at(bArr2, i12, 8) >>> 14) | (at(bArr2, i12, 9) << 18)) & 1073741823;
            iArr[i13 + 10] = ((at(bArr2, i12, 9) >>> 12) | (at(bArr2, i12, 10) << 20)) & 1073741823;
            iArr[i13 + 11] = ((at(bArr2, i12, 10) >>> 10) | (at(bArr2, i12, 11) << 22)) & 1073741823;
            iArr[i13 + 12] = ((at(bArr2, i12, 11) >>> 8) | (at(bArr2, i12, 12) << 24)) & 1073741823;
            iArr[i13 + 13] = ((at(bArr2, i12, 12) >>> 6) | (at(bArr2, i12, 13) << 26)) & 1073741823;
            iArr[i13 + 14] = ((at(bArr2, i12, 13) >>> 4) | (at(bArr2, i12, 14) << 28)) & 1073741823;
            iArr[i13 + 15] = 1073741823 & (at(bArr2, i12, 14) >>> 2);
            i12 += 15;
        }
        System.arraycopy(bArr2, 38400, bArr, i11, 32);
    }

    public static void decodeSignature(byte[] bArr, long[] jArr, byte[] bArr2, int i11) {
        int i12 = 0;
        int i13 = 0;
        int i14 = 0;
        while (i13 < 2048) {
            int iAt = at(bArr2, i14, i12);
            int iAt2 = at(bArr2, i14, 1);
            int iAt3 = at(bArr2, i14, 2);
            int iAt4 = at(bArr2, i14, 3);
            int iAt5 = at(bArr2, i14, 4);
            int iAt6 = at(bArr2, i14, 5);
            int iAt7 = at(bArr2, i14, 6);
            int iAt8 = at(bArr2, i14, 7);
            int iAt9 = at(bArr2, i14, 8);
            int iAt10 = at(bArr2, i14, 9);
            int iAt11 = at(bArr2, i14, 10);
            int i15 = i13;
            jArr[i15] = (iAt << 10) >> 10;
            jArr[i15 + 1] = (iAt >>> 22) | ((iAt2 << 20) >> 10);
            jArr[i15 + 2] = (iAt2 >>> 12) | ((iAt3 << 30) >> 10);
            jArr[i15 + 3] = (iAt3 << 8) >> 10;
            jArr[i15 + 4] = (iAt3 >>> 24) | ((iAt4 << 18) >> 10);
            jArr[i15 + 5] = (iAt4 >>> 14) | ((iAt5 << 28) >> 10);
            jArr[i15 + 6] = (iAt5 << 6) >> 10;
            jArr[i15 + 7] = (iAt5 >>> 26) | ((iAt6 << 16) >> 10);
            jArr[i15 + 8] = (iAt6 >>> 16) | ((iAt7 << 26) >> 10);
            jArr[i15 + 9] = (iAt7 << 4) >> 10;
            jArr[i15 + 10] = (iAt7 >>> 28) | ((iAt8 << 14) >> 10);
            jArr[i15 + 11] = (iAt8 >>> 18) | ((iAt9 << 24) >> 10);
            jArr[i15 + 12] = (iAt9 << 2) >> 10;
            jArr[i15 + 13] = (iAt9 >>> 30) | ((iAt10 << 12) >> 10);
            jArr[i15 + 14] = (iAt10 >>> 20) | ((iAt11 << 22) >> 10);
            jArr[i15 + 15] = iAt11 >> 10;
            i14 += 11;
            i13 = i15 + 16;
            i12 = 0;
        }
        System.arraycopy(bArr2, i11 + 5632, bArr, 0, 32);
    }

    public static void encodeC(int[] iArr, short[] sArr, byte[] bArr, int i11) {
        short[] sArr2 = new short[2048];
        byte[] bArr2 = new byte[168];
        HashUtils.customizableSecureHashAlgorithmKECCAK128Simple(bArr2, 0, 168, (short) 0, bArr, i11, 32);
        ...
        while (i12 < 40) {
            if (i13 > 165) {
                HashUtils.customizableSecureHashAlgorithmKECCAK128Simple(bArr2, 0, 168, s7, bArr, i11, 32);
                i13 = 0;
                s7 = (short) (s7 + 1);
            }
            int i14 = ((bArr2[i13] << 8) | (bArr2[i13 + 1] & 255)) & 2047;
            if (sArr2[i14] == 0) {
                if ((bArr2[i13 + 2] & 1) == 1) {
                    sArr2[i14] = -1;
                } else {
    ...
    public static void encodePrivateKey(byte[] bArr, long[] jArr, long[] jArr2, byte[] bArr2, int i11, byte[] bArr3) {
        for (int i12 = 0; i12 < 2048; i12++) {
            bArr[i12] = (byte) jArr[i12];
        }
        for (int i13 = 0; i13 < 5; i13++) {
            for (int i14 = 0; i14 < 2048; i14++) {
                bArr[2048 + (i13 * 2048) + i14] = (byte) jArr2[r3];
            }
        }
        System.arraycopy(bArr2, i11, bArr, 12288, 64);
        HashUtils.secureHashAlgorithmKECCAK256(bArr, 12352, 40, bArr3, 0, 38400);
    }

    public static void encodePublicKey(byte[] bArr, long[] jArr, byte[] bArr2, int i11) {
        int i12 = 0;
        int i13 = 0;
        int i14 = 0;
        while (i13 < 9600) {
            int i15 = i14 + 1;
            at(bArr, i13, i12, (int) (jArr[i14] | (jArr[i15] << 30)));
            int i16 = i14 + 2;
            at(bArr, i13, 1, (int) ((jArr[i15] >> 2) | (jArr[i16] << 28)));
            int i17 = i14 + 3;
            at(bArr, i13, 2, (int) ((jArr[i16] >> 4) | (jArr[i17] << 26)));
            int i18 = i14 + 4;
            at(bArr, i13, 3, (int) ((jArr[i17] >> 6) | (jArr[i18] << 24)));
            int i19 = i14 + 5;
            at(bArr, i13, 4, (int) ((jArr[i18] >> 8) | (jArr[i19] << 22)));
            int i21 = i14 + 6;
            at(bArr, i13, 5, (int) ((jArr[i19] >> 10) | (jArr[i21] << 20)));
            int i22 = i14 + 7;
            at(bArr, i13, 6, (int) ((jArr[i21] >> 12) | (jArr[i22] << 18)));
            int i23 = i14 + 8;
            at(bArr, i13, 7, (int) ((jArr[i22] >> 14) | (jArr[i23] << 16)));
            long j9 = jArr[i23] >> 16;
            int i24 = i14 + 9;
            at(bArr, i13, 8, (int) (j9 | (jArr[i24] << 14)));
            int i25 = i14 + 10;
            at(bArr, i13, 9, (int) ((jArr[i24] >> 18) | (jArr[i25] << 12)));
            long j11 = jArr[i25] >> 20;
            int i26 = i14 + 11;
            at(bArr, i13, 10, (int) (j11 | (jArr[i26] << 10)));
            int i27 = i14 + 12;
            at(bArr, i13, 11, (int) ((jArr[i26] >> 22) | (jArr[i27] << 8)));
            int i28 = i14 + 13;
            at(bArr, i13, 12, (int) ((jArr[i27] >> 24) | (jArr[i28] << 6)));
            int i29 = i14 + 14;
            at(bArr, i13, 13, (int) ((jArr[i28] >> 26) | (jArr[i29] << 4)));
            at(bArr, i13, 14, (int) ((jArr[i29] >> 28) | (jArr[i14 + 15] << 2)));
            i14 += 16;
            i13 += 15;
            i12 = 0;
        }
        System.arraycopy(bArr2, i11, bArr, 38400, 32);
    }

    public static void encodeSignature(byte[] bArr, int i11, byte[] bArr2, int i12, long[] jArr) {
        int i13 = 0;
        int i14 = 0;
        int i15 = 0;
        while (i14 < 1408) {
            int i16 = i15 + 1;
            at(bArr, i14, i13, (int) ((jArr[i15] & 4194303) | (jArr[i16] << 22)));
            int i17 = i15 + 2;
            at(bArr, i14, 1, (int) (((jArr[i16] >>> 10) & 4095) | (jArr[i17] << 12)));
            int i18 = i15 + 4;
            at(bArr, i14, 2, (int) (((jArr[i17] >>> 20) & 3) | ((jArr[i15 + 3] & 4194303) << 2) | (jArr[i18] << 24)));
            int i19 = i15 + 5;
            at(bArr, i14, 3, (int) (((jArr[i18] >>> 8) & 16383) | (jArr[i19] << 14)));
            int i21 = i15 + 7;
            at(bArr, i14, 4, (int) (((jArr[i19] >>> 18) & 15) | ((jArr[i15 + 6] & 4194303) << 4) | (jArr[i21] << 26)));
            int i22 = i15 + 8;
            at(bArr, i14, 5, (int) (((jArr[i21] >>> 6) & 65535) | (jArr[i22] << 16)));
            long j9 = ((jArr[i22] >>> 16) & 63) | ((jArr[i15 + 9] & 4194303) << 6);
            int i23 = i15 + 10;
            at(bArr, i14, 6, (int) (j9 | (jArr[i23] << 28)));
            int i24 = i15 + 11;
            at(bArr, i14, 7, (int) (((jArr[i23] >>> 4) & 262143) | (jArr[i24] << 18)));
            long j11 = ((jArr[i24] >>> 14) & 255) | ((4194303 & jArr[i15 + 12]) << 8);
            int i25 = i15 + 13;
            at(bArr, i14, 8, (int) (j11 | (jArr[i25] << 30)));
            long j12 = (jArr[i25] >>> 2) & 1048575;
            int i26 = i15 + 14;
            at(bArr, i14, 9, (int) (j12 | (jArr[i26] << 20)));
            at(bArr, i14, 10, (int) (((jArr[i26] >>> 12) & 1023) | (jArr[i15 + 15] << 10)));
            i15 += 16;
            i14 += 11;
            i13 = 0;
        }
        System.arraycopy(bArr2, i12, bArr, i11 + 5632, 32);
    }
    ...
    public static int generateKeyPair(byte[] bArr, byte[] bArr2, SecureRandom secureRandom) {
        ...
        for (int i13 = 0; i13 < 5; i13++) {
            do {
                i12++;
                i11 = i13 * 2048;
                Gaussian.sample_gauss_poly(i12, bArr4, i13 * 32, jArr2, i11);
            } while (checkPolynomial(jArr2, i11, 901));
        }
        do {
            i12++;
            Gaussian.sample_gauss_poly(i12, bArr4, 160, jArr, 0);
        } while (checkPolynomial(jArr, 0, 901));
        QTesla3PPolynomial.poly_uniform(jArr3, bArr4, BERTags.PRIVATE);
        QTesla3PPolynomial.poly_ntt(jArr5, jArr);
        for (int i14 = 0; i14 < 5; i14++) {
            int i15 = i14 * 2048;
            QTesla3PPolynomial.poly_mul(jArr4, i15, jArr3, i15, jArr5);
            QTesla3PPolynomial.poly_add_correct(jArr4, i15, jArr4, i15, jArr2, i15);
        }
        encodePublicKey(bArr, jArr4, bArr4, BERTags.PRIVATE);
        encodePrivateKey(bArr2, jArr, jArr2, bArr4, BERTags.PRIVATE, bArr);
        return 0;
    }

    public static int generateSignature(byte[] bArr, byte[] bArr2, int i11, int i12, byte[] bArr3, SecureRandom secureRandom) {
        long[] jArr;
        long[] jArr2;
        long[] jArr3;
        int i13;
        ...
        HashUtils.secureHashAlgorithmKECCAK256(bArr7, 64, 40, bArr2, 0, i12);
        ...
        while (true) {
            i14++;
            sample_y(jArr4, bArr6, 0, i14);
            QTesla3PPolynomial.poly_ntt(jArr5, jArr4);
            for (int i15 = 0; i15 < 5; i15++) {
                int i16 = i15 * 2048;
                QTesla3PPolynomial.poly_mul(jArr7, i16, jArr10, i16, jArr5);
            }
            ...
            if (!testRejection(jArr6)) {
                ...
                while (true) {
                    ...
                    jArr2 = jArr11;
                    i13 = 0;
                    QTesla3PPolynomial.sparse_mul8(jArr8, i18, bArr4, i17 * 2048, iArr, sArr);
                    QTesla3PPolynomial.poly_sub(jArr7, i18, jArr7, i18, jArr8, i18);
                    boolean zTest_correctness = test_correctness(jArr7, i18);
                    if (zTest_correctness) {
                        z11 = zTest_correctness;
                        jArr3 = jArr12;
                        break;
                    }
                    bArr4 = bArr3;
                ...
                if (!z11) {
                    encodeSignature(bArr, i13, bArr5, i13, jArr3);
                    return i13;
                }
                bArr4 = bArr3;
                jArr6 = jArr3;
    ...
    private static void hashFunction(byte[] bArr, int i11, long[] jArr, byte[] bArr2, int i12) {
        byte[] bArr3 = new byte[10320];
        for (int i13 = 0; i13 < 5; i13++) {
            int i14 = i13 * 2048;
            int i15 = 0;
            while (i15 < 2048) {
                int i16 = (int) jArr[i14];
                int i17 = (428072960 - i16) >> 31;
                int i18 = (i16 & (~i17)) | ((i16 - PARAM_Q) & i17);
                int i19 = 16777215 & i18;
                int i21 = (8388608 - i19) >> 31;
                bArr3[i14] = (byte) ((i18 - ((i19 & (~i21)) | ((i19 - 16777216) & i21))) >> 24);
                i15++;
                i14++;
            }
        }
        System.arraycopy(bArr2, i12, bArr3, 10240, 80);
        HashUtils.secureHashAlgorithmKECCAK256(bArr, i11, 32, bArr3, 0, 10320);
    }

    public static int lE24BitToInt(byte[] bArr, int i11) {
    ...
    public static void sample_y(long[] jArr, byte[] bArr, int i11, int i12) {
        int i13 = BPLUS1BYTES;
        byte[] bArr2 = new byte[(i13 * 2048) + 1];
        short s7 = (short) (i12 << 8);
        int i14 = i13 * 2048;
        HashUtils.customizableSecureHashAlgorithmKECCAK256Simple(bArr2, 0, i14, s7, bArr, i11, 32);
        int i15 = 0;
        int i16 = 2048;
        short s8 = (short) (s7 + 1);
        int i17 = 0;
        while (i17 < 2048) {
            if (i15 >= i16 * i13) {
                int i18 = NBLOCKS_SHAKE;
                HashUtils.customizableSecureHashAlgorithmKECCAK256Simple(bArr2, 0, i14, s8, bArr, i11, 32);
                i16 = i18;
                s8 = (short) (s8 + 1);
                i15 = 0;
            }
            long jLE24BitToInt = lE24BitToInt(bArr2, i15) & maskb1;
            jArr[i17] = jLE24BitToInt;
            long j9 = jLE24BitToInt - 2097151;
            jArr[i17] = j9;
            if (j9 != 2097152) {
                i17++;
            }
    ...
    private static boolean testRejection(long[] jArr) {
        ...
        for (int i11 = 0; i11 < 2048; i11++) {
            iAbsolute = (int) (((long) iAbsolute) | (2096250 - absolute(jArr[i11])));
        }
        return (iAbsolute >>> 31) > 0;
    }
    ...
    public static boolean test_correctness(long[] jArr, int i11) {
        for (int i12 = 0; i12 < 2048; i12++) {
            long j9 = jArr[i11 + i12];
            int i13 = ((int) (428072960 - j9)) >> 31;
            int i14 = (int) ((j9 & ((long) (~i13))) | ((j9 - 856145921) & ((long) i13)));
            if ((((~(absolute(i14 - (((8388607 + i14) >> 24) << 24)) - 8387707)) | (~(absolute(i14) - 428072059))) >>> 31) == 1) {
                return true;
            }
        }
        return false;
    ...
    public static int verifying(byte[] bArr, byte[] bArr2, int i11, int i12, byte[] bArr3) {
        ...
        decodeSignature(bArr4, jArr4, bArr2, i11);
        if (testZ(jArr4)) {
            return -2;
        }
        ...
        while (i13 < 5) {
            ...
            long[] jArr7 = jArr6;
            long[] jArr8 = jArr3;
            QTesla3PPolynomial.sparse_mul32(jArr8, i14, iArr2, i14, iArr3, sArr2);
            QTesla3PPolynomial.poly_mul(jArr, i14, jArr2, i14, jArr7);
            QTesla3PPolynomial.poly_sub(jArr, i14, jArr, i14, jArr8, i14);
            i13++;
            jArr2 = jArr2;
            jArr3 = jArr8;
            jArr6 = jArr7;
    ...
    private static int absolute(int i11) {
        int i12 = i11 >> 31;
        return (i11 ^ i12) - i12;
    }
    ...
    public static class QTesla3PPolynomial {
        ...
        public static long barr_reduce(long j9) {
            return j9 - (((5 * j9) >> 32) * 856145921);
        }
        ...
        public static void ntt(long[] jArr, long[] jArr2) {
            ...
            for (int i12 = 1024; i12 > 0; i12 >>= 1) {
                ...
                while (i13 < 2048) {
                    ...
                    while (i16 < i13 + i12) {
                        int i17 = i16 + i12;
                        long jBarr_reduce = barr_reduce(reduce(((long) i15) * jArr[i17]));
                        jArr[i17] = barr_reduce((1712291842 - jBarr_reduce) + jArr[i16]);
                        jArr[i16] = barr_reduce(jBarr_reduce + jArr[i16]);
                        i16++;
                    }
                    i13 = i16 + i12;
                    i11 = i14;
        ...
        public static void nttinv(long[] jArr, int i11, long[] jArr2) {
            int i12 = 0;
            for (int i13 = 1; i13 < 2048; i13 *= 2) {
                int i14 = 0;
                while (i14 < 2048) {
                    int i15 = i12 + 1;
                    int i16 = (int) jArr2[i12];
                    int i17 = i14;
                    while (i17 < i14 + i13) {
                        int i18 = i11 + i17;
                        long j9 = jArr[i18];
                        int i19 = i18 + i13;
                        jArr[i18] = barr_reduce(jArr[i19] + j9);
                        jArr[i19] = barr_reduce(reduce(((1712291842 - jArr[i19]) + j9) * ((long) i16)));
                        i17++;
                    }
                    i14 = i17 + i13;
                    i12 = i15;
        ...
        public static void poly_add_correct(long[] jArr, int i11, long[] jArr2, int i12, long[] jArr3, int i13) {
            for (int i14 = 0; i14 < 2048; i14++) {
                int i15 = i11 + i14;
                long j9 = jArr2[i12 + i14] + jArr3[i13 + i14];
                jArr[i15] = j9;
                long j11 = j9 - 856145921;
                jArr[i15] = j11;
                jArr[i15] = j11 + (856145921 & (j11 >> 31));
            }
        }

        public static void poly_mul(long[] jArr, int i11, long[] jArr2, int i12, long[] jArr3) {
            poly_pointwise(jArr, i11, jArr2, i12, jArr3);
            nttinv(jArr, i11, zetainv);
        }
        ...
        public static void poly_pointwise(long[] jArr, int i11, long[] jArr2, int i12, long[] jArr3) {
            for (int i13 = 0; i13 < 2048; i13++) {
                jArr[i13 + i11] = reduce(jArr2[i13 + i12] * jArr3[i13]);
            }
        }

        public static void poly_sub(long[] jArr, int i11, long[] jArr2, int i12, long[] jArr3, int i13) {
            for (int i14 = 0; i14 < 2048; i14++) {
                jArr[i11 + i14] = barr_reduce(jArr2[i12 + i14] - jArr3[i13 + i14]);
            }
        }

        public static void poly_sub_correct(int[] iArr, int[] iArr2, int[] iArr3) {
            for (int i11 = 0; i11 < 2048; i11++) {
                int i12 = iArr2[i11] - iArr3[i11];
                iArr[i11] = i12;
                iArr[i11] = i12 + ((i12 >> 31) & QTesla3p.PARAM_Q);
            }
        }

        public static void poly_uniform(long[] jArr, byte[] bArr, int i11) {
            byte[] bArr2;
            long j9;
            byte[] bArr3 = new byte[30240];
            int i12 = 1;
            HashUtils.customizableSecureHashAlgorithmKECCAK128Simple(bArr3, 0, 30240, (short) 0, bArr, i11, 32);
            int i13 = QTesla3p.PARAM_GEN_A;
            short s7 = (short) 1;
            int i14 = 0;
            int i15 = 0;
            while (i15 < 10240) {
                if (i14 > (i13 * 168) - 16) {
                    HashUtils.customizableSecureHashAlgorithmKECCAK128Simple(bArr3, 0, 30240, s7, bArr, i11, 32);
                    i13 = i12;
                    i14 = 0;
                    s7 = (short) (s7 + 1);
                }
                int iLittleEndianToInt = Pack.littleEndianToInt(bArr3, i14) & 1073741823;
                int iLittleEndianToInt2 = Pack.littleEndianToInt(bArr3, i14 + 4) & 1073741823;
                int iLittleEndianToInt3 = Pack.littleEndianToInt(bArr3, i14 + 8) & 1073741823;
                int iLittleEndianToInt4 = 1073741823 & Pack.littleEndianToInt(bArr3, i14 + 12);
                i14 += 16;
                if (iLittleEndianToInt >= QTesla3p.PARAM_Q || i15 >= 10240) {
                    bArr2 = bArr3;
                } else {
                    bArr2 = bArr3;
                    jArr[i15] = reduce(((long) iLittleEndianToInt) * 513161157);
                    i15++;
                }
                if (iLittleEndianToInt2 >= QTesla3p.PARAM_Q || i15 >= 10240) {
                    j9 = 513161157;
                } else {
                    j9 = 513161157;
                    jArr[i15] = reduce(((long) iLittleEndianToInt2) * 513161157);
                    i15++;
                }
                if (iLittleEndianToInt3 < QTesla3p.PARAM_Q && i15 < 10240) {
                    jArr[i15] = reduce(((long) iLittleEndianToInt3) * j9);
                    i15++;
                }
                if (iLittleEndianToInt4 < QTesla3p.PARAM_Q && i15 < 10240) {
                    jArr[i15] = reduce(((long) iLittleEndianToInt4) * j9);
                    i15++;
                }
                bArr3 = bArr2;
                i12 = 1;
        ...
        public static long reduce(long j9) {
            return ((((QTesla3p.PARAM_QINV * j9) & 4294967295L) * 856145921) + j9) >> 32;
        }
        ...
        public static void sparse_mul16(int[] iArr, int[] iArr2, int[] iArr3, short[] sArr) {
            ...
            for (int i12 = 0; i12 < 40; i12++) {
                int i13 = iArr3[i12];
                for (int i14 = 0; i14 < i13; i14++) {
                    iArr[i14] = iArr[i14] - (sArr[i12] * iArr2[(i14 + 2048) - i13]);
                }
                for (int i15 = i13; i15 < 2048; i15++) {
                    iArr[i15] = (sArr[i12] * iArr2[i15 - i13]) + iArr[i15];
                }
            }
        }

        public static void sparse_mul32(long[] jArr, int i11, int[] iArr, int i12, int[] iArr2, short[] sArr) {
            for (int i13 = 0; i13 < 2048; i13++) {
                jArr[i11 + i13] = 0;
            }
            for (int i14 = 0; i14 < 40; i14++) {
                ...
                for (int i16 = 0; i16 < i15; i16++) {
                    int i17 = i11 + i16;
                    jArr[i17] = jArr[i17] - ((long) (sArr[i14] * iArr[((i12 + i16) + 2048) - i15]));
                }
                for (int i18 = i15; i18 < 2048; i18++) {
                    int i19 = i11 + i18;
                    jArr[i19] = jArr[i19] + ((long) (sArr[i14] * iArr[(i12 + i18) - i15]));
                }
            }
        }

        public static void sparse_mul8(long[] jArr, int i11, byte[] bArr, int i12, int[] iArr, short[] sArr) {
            for (int i13 = 0; i13 < 2048; i13++) {
                jArr[i11 + i13] = 0;
            }
            for (int i14 = 0; i14 < 40; i14++) {
                ...
                for (int i16 = 0; i16 < i15; i16++) {
                    int i17 = i11 + i16;
                    jArr[i17] = jArr[i17] - ((long) (sArr[i14] * bArr[((i12 + i16) + 2048) - i15]));
                }
                for (int i18 = i15; i18 < 2048; i18++) {
                    int i19 = i11 + i18;
                    jArr[i19] = jArr[i19] + ((long) (sArr[i14] * bArr[(i12 + i18) - i15]));
                }
            }
        }
        ...
        public static void poly_pointwise(long[] jArr, long[] jArr2, long[] jArr3) {
            for (int i11 = 0; i11 < 2048; i11++) {
                jArr[i11] = reduce(jArr2[i11] * jArr3[i11]);
            }
        }

        public static void nttinv(long[] jArr, long[] jArr2) {
            int i11 = 0;
            for (int i12 = 1; i12 < 2048; i12 *= 2) {
                int i13 = 0;
                while (i13 < 2048) {
                    int i14 = i11 + 1;
                    int i15 = (int) jArr2[i11];
                    ...
                    while (i16 < i13 + i12) {
                        long j9 = jArr[i16];
                        int i17 = i16 + i12;
                        jArr[i16] = barr_reduce(jArr[i17] + j9);
                        jArr[i17] = barr_reduce(reduce(((1712291842 - jArr[i17]) + j9) * ((long) i15)));
                        i16++;
                    }
                    i13 = i16 + i12;
                    i11 = i14;
        ...
        public static void sparse_mul8(long[] jArr, byte[] bArr, int[] iArr, short[] sArr) {
            ...
            for (int i12 = 0; i12 < 40; i12++) {
                int i13 = iArr[i12];
                for (int i14 = 0; i14 < i13; i14++) {
                    jArr[i14] = jArr[i14] - ((long) (sArr[i12] * bArr[(i14 + 2048) - i13]));
                }
                for (int i15 = i13; i15 < 2048; i15++) {
                    jArr[i15] = jArr[i15] + ((long) (sArr[i12] * bArr[i15 - i13]));
                }
            }
        }
    }

    private static void at(byte[] bArr, int i11, int i12, int i13) {
        Pack.intToLittleEndian(i13, bArr, (i12 * 4) + (i11 * 4));
    }
}
