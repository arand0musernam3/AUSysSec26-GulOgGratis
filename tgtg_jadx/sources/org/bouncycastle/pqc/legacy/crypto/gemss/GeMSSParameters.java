...
public class GeMSSParameters {
    ...
    private GeMSSParameters(String str, int i11, int i12, int i13, int i14, int i15, int i16, int i17, int i18) {
        this.name = str;
        this.engine = new GeMSSEngine(i11, i12, i13, i14, i15, i16, i17, i18);
    }
