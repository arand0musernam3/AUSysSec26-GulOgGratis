...
public class McElieceFujisakiCipher implements MessageEncryptor {
    ...
    private void initCipherDecrypt(McElieceCCA2PrivateKeyParameters mcElieceCCA2PrivateKeyParameters) {
        ...
        this.f33690n = mcElieceCCA2PrivateKeyParameters.getN();
        this.f33692t = mcElieceCCA2PrivateKeyParameters.getT();
    }

    private void initCipherEncrypt(McElieceCCA2PublicKeyParameters mcElieceCCA2PublicKeyParameters) {
        this.messDigest = Utils.getDigest(mcElieceCCA2PublicKeyParameters.getDigest());
        this.f33690n = mcElieceCCA2PublicKeyParameters.getN();
        this.f33689k = mcElieceCCA2PublicKeyParameters.getK();
        this.f33692t = mcElieceCCA2PublicKeyParameters.getT();
    }
    ...
    public void init(boolean z11, CipherParameters cipherParameters) {
        ...
        if (!z11) {
            ...
            if (!(cipherParameters instanceof ParametersWithRandom)) {
                this.f33691sr = CryptoServicesRegistrar.getSecureRandom();
            ...
            this.f33691sr = parametersWithRandom.getRandom();
    ...
    public byte[] messageDecrypt(byte[] bArr) throws InvalidCipherTextException {
        ...
        int i11 = (this.f33690n + 7) >> 3;
        int length = bArr.length - i11;
        byte[][] bArrSplit = ByteUtils.split(bArr, i11);
        byte[] bArr2 = bArrSplit[0];
        byte[] bArr3 = bArrSplit[1];
        GF2Vector[] gF2VectorArrDecryptionPrimitive = McElieceCCA2Primitives.decryptionPrimitive((McElieceCCA2PrivateKeyParameters) this.key, GF2Vector.OS2VP(this.f33690n, bArr2));
        ...
        if (Conversions.encode(this.f33690n, this.f33692t, bArr5).equals(gF2Vector)) {
            return bArr4;
        }
    ...
    public byte[] messageEncrypt(byte[] bArr) {
        ...
        GF2Vector gF2Vector = new GF2Vector(this.f33689k, this.f33691sr);
        ...
        byte[] encoded2 = McElieceCCA2Primitives.encryptionPrimitive((McElieceCCA2PublicKeyParameters) this.key, gF2Vector, Conversions.encode(this.f33690n, this.f33692t, bArr2)).getEncoded();
        DigestRandomGenerator digestRandomGenerator = new DigestRandomGenerator(new SHA1Digest());
        digestRandomGenerator.addSeedMaterial(encoded);
