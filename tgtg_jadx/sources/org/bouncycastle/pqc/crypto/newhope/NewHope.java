...
public class NewHope {
    ...
    public static void decodeB(short[] sArr, short[] sArr2, byte[] bArr) {
        ...
        for (int i11 = 0; i11 < 256; i11++) {
            int i12 = i11 * 4;
            byte b8 = bArr[i11 + 1792];
            int i13 = b8 & 255;
            sArr2[i12] = (short) (b8 & 3);
            sArr2[i12 + 1] = (short) ((i13 >>> 2) & 3);
            sArr2[i12 + 2] = (short) ((i13 >>> 4) & 3);
            sArr2[i12 + 3] = (short) (i13 >>> 6);
        }
    }
    ...
    public static void encodeB(byte[] bArr, short[] sArr, short[] sArr2) {
        ...
        for (int i11 = 0; i11 < 256; i11++) {
            int i12 = i11 * 4;
            bArr[i11 + 1792] = (byte) ((sArr2[i12 + 3] << 6) | sArr2[i12] | (sArr2[i12 + 1] << 2) | (sArr2[i12 + 2] << 4));
        }
    }
