...
public class DilithiumSigner implements MessageSigner {
    ...
    public byte[] generateSignature(byte[] bArr) {
        ...
        return engine.sign(bArr, length, dilithiumPrivateKeyParameters.rho, dilithiumPrivateKeyParameters.f33476k, dilithiumPrivateKeyParameters.f33480tr, dilithiumPrivateKeyParameters.t0, dilithiumPrivateKeyParameters.f33477s1, dilithiumPrivateKeyParameters.f33478s2);
    }
    ...
    public byte[] internalGenerateSignature(byte[] bArr, byte[] bArr2) {
        ...
        int length = bArr.length;
        DilithiumPrivateKeyParameters dilithiumPrivateKeyParameters = this.privKey;
        return engine.signSignatureInternal(bArr, length, dilithiumPrivateKeyParameters.rho, dilithiumPrivateKeyParameters.f33476k, dilithiumPrivateKeyParameters.f33480tr, dilithiumPrivateKeyParameters.t0, dilithiumPrivateKeyParameters.f33477s1, dilithiumPrivateKeyParameters.f33478s2, bArr2);
    }
    ...
    public boolean verifySignature(byte[] bArr, byte[] bArr2) {
        ...
        return engine.signOpen(bArr, bArr2, length, dilithiumPublicKeyParameters.rho, dilithiumPublicKeyParameters.f33481t1);
    }
}
