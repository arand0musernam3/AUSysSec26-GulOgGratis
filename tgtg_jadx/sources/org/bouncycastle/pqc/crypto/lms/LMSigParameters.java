...
public class LMSigParameters {
    ...
    public static LMSigParameters getParametersForType(int i11) {
        return paramBuilders.get(Integer.valueOf(i11));
    }
