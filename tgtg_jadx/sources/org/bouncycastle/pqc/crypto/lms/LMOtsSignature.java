...
class LMOtsSignature implements Encodable {
    ...
    public boolean equals(Object obj) {
        ...
        LMOtsParameters lMOtsParameters2 = lMOtsSignature.type;
        ...
        if (Arrays.equals(this.C, lMOtsSignature.C)) {
            return Arrays.equals(this.f33528y, lMOtsSignature.f33528y);
        }
        return false;
    }
    ...
    public byte[] getEncoded() throws IOException {
        return Composer.compose().u32str(this.type.getType()).bytes(this.C).bytes(this.f33528y).build();
    }
    ...
    public int hashCode() {
        LMOtsParameters lMOtsParameters = this.type;
        return Arrays.hashCode(this.f33528y) + ((Arrays.hashCode(this.C) + ((lMOtsParameters != null ? lMOtsParameters.hashCode() : 0) * 31)) * 31);
    }
}
