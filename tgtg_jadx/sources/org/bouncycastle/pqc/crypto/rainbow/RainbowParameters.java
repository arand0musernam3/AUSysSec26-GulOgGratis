...
public class RainbowParameters implements CipherParameters {
    ...
    private final int f33577m;

    /* JADX INFO: renamed from: n, reason: collision with root package name */
    private final int f33578n;
    private final String name;

    /* JADX INFO: renamed from: o1, reason: collision with root package name */
    private final int f33579o1;

    /* JADX INFO: renamed from: o2, reason: collision with root package name */
    private final int f33580o2;

    /* JADX INFO: renamed from: v1, reason: collision with root package name */
    private final int f33581v1;

    /* JADX INFO: renamed from: v2, reason: collision with root package name */
    private final int f33582v2;
    ...
    private RainbowParameters(String str, int i11, Version version) {
        ...
        if (i11 == 3) {
            ...
            if (i11 != 5) {
                a.f("No valid version. Please choose one of the following: 3, 5");
                throw null;
            }
            this.f33581v1 = 96;
            this.f33579o1 = 36;
        ...
        int i12 = this.f33581v1;
        int i13 = this.f33579o1;
        this.f33582v2 = i12 + i13;
        int i14 = this.f33580o2;
        this.f33578n = i12 + i13 + i14;
        this.f33577m = i13 + i14;
    ...
    public int getO1() {
        return this.f33579o1;
    }

    public int getO2() {
        return this.f33580o2;
    }

    public int getV1() {
        return this.f33581v1;
    }

    public int getV2() {
        return this.f33582v2;
    }
