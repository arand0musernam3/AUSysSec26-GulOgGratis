...
public class RainbowPrivateKeyParameters extends RainbowKeyParameters {
    ...
    public RainbowPrivateKeyParameters(RainbowParameters rainbowParameters, byte[] bArr) {
        ...
        if (rainbowParameters.getVersion() == Version.COMPRESSED) {
            ...
            this.f33583s1 = rainbowPrivateKeyParametersGeneratePrivateKey.f33583s1;
            this.f33584t1 = rainbowPrivateKeyParametersGeneratePrivateKey.f33584t1;
            this.f33585t3 = rainbowPrivateKeyParametersGeneratePrivateKey.f33585t3;
            this.f33586t4 = rainbowPrivateKeyParametersGeneratePrivateKey.f33586t4;
    ...
    public byte[] getPrivateKey() {
        return getParameters().getVersion() == Version.COMPRESSED ? Arrays.concatenate(this.pk_seed, this.sk_seed) : Arrays.concatenate(Arrays.concatenate(Arrays.concatenate(Arrays.concatenate(Arrays.concatenate(Arrays.concatenate(Arrays.concatenate(Arrays.concatenate(Arrays.concatenate(Arrays.concatenate(Arrays.concatenate(this.sk_seed, RainbowUtil.getEncoded(this.f33583s1)), RainbowUtil.getEncoded(this.f33584t1)), RainbowUtil.getEncoded(this.f33586t4)), RainbowUtil.getEncoded(this.f33585t3)), RainbowUtil.getEncoded(this.l1_F1, true)), RainbowUtil.getEncoded(this.l1_F2, false)), RainbowUtil.getEncoded(this.l2_F1, true)), RainbowUtil.getEncoded(this.l2_F2, false)), RainbowUtil.getEncoded(this.l2_F3, false)), RainbowUtil.getEncoded(this.l2_F5, true)), RainbowUtil.getEncoded(this.l2_F6, false));
    }
    ...
    public short[][] getS1() {
        return RainbowUtil.cloneArray(this.f33583s1);
    }
    ...
    public short[][] getT1() {
        return RainbowUtil.cloneArray(this.f33584t1);
    }

    public short[][] getT3() {
        return RainbowUtil.cloneArray(this.f33585t3);
    }

    public short[][] getT4() {
        return RainbowUtil.cloneArray(this.f33586t4);
    }
    ...
    public RainbowPrivateKeyParameters(RainbowParameters rainbowParameters, byte[] bArr, short[][] sArr, short[][] sArr2, short[][] sArr3, short[][] sArr4, short[][][] sArr5, short[][][] sArr6, short[][][] sArr7, short[][][] sArr8, short[][][] sArr9, short[][][] sArr10, short[][][] sArr11, byte[] bArr2) {
        ...
        this.f33583s1 = RainbowUtil.cloneArray(sArr);
        this.f33584t1 = RainbowUtil.cloneArray(sArr2);
        this.f33585t3 = RainbowUtil.cloneArray(sArr3);
        this.f33586t4 = RainbowUtil.cloneArray(sArr4);
