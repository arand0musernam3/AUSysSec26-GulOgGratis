...
public class NTRULPRimePrivateKeyParameters extends NTRULPRimeKeyParameters {
    ...
    public NTRULPRimePrivateKeyParameters(NTRULPRimeParameters nTRULPRimeParameters, byte[] bArr, byte[] bArr2, byte[] bArr3, byte[] bArr4) {
        ...
        this.f33561pk = Arrays.clone(bArr2);
    ...
    public byte[] getEncoded() {
        ...
        byte[] bArr3 = this.f33561pk;
        System.arraycopy(bArr3, 0, bArr, this.enca.length, bArr3.length);
        byte[] bArr4 = this.rho;
        System.arraycopy(bArr4, 0, bArr, this.enca.length + this.f33561pk.length, bArr4.length);
        byte[] bArr5 = this.hash;
        System.arraycopy(bArr5, 0, bArr, this.enca.length + this.f33561pk.length + this.rho.length, bArr5.length);
        return bArr;
    }
    ...
    public byte[] getPk() {
        return Arrays.clone(this.f33561pk);
    }
