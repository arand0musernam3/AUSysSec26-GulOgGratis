...
public class NTRULPRimeKEMGenerator implements EncapsulatedSecretGenerator {
    ...
    public SecretWithEncapsulation generateEncapsulated(AsymmetricKeyParameter asymmetricKeyParameter) {
        ...
        Utils.getRoundedDecodedPolynomial(sArr, nTRULPRimePublicKeyParameters.getRoundEncA(), p7, q7);
        short[] sArr2 = new short[p7];
        Utils.generatePolynomialInRQFromSeed(sArr2, nTRULPRimePublicKeyParameters.getSeed(), p7, q7);
        ...
        Utils.sortGenerateShortPolynomial(bArr3, iArr, p7, w10);
        short[] sArr3 = new short[p7];
        Utils.multiplicationInRQ(sArr3, sArr2, bArr3, p7, q7);
        short[] sArr4 = new short[p7];
        Utils.roundPolynomial(sArr4, sArr3);
        byte[] bArr4 = new byte[roundedPolynomialBytes];
        Utils.getRoundedEncodedPolynomial(bArr4, sArr4, p7, q7);
        short[] sArr5 = new short[p7];
        Utils.multiplicationInRQ(sArr5, sArr, bArr3, p7, q7);
        byte[] bArr5 = new byte[256];
        Utils.top(bArr5, sArr5, bArr, q7, tau0, tau1);
