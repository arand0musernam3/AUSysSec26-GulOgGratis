...
public class NTRULPRimeKEMExtractor implements EncapsulatedSecretExtractor {
    ...
    public byte[] extractSecret(byte[] bArr) {
        ...
        Utils.right(bArr6, sArr2, bArr5, q7, w10, tau2, tau3);
        ...
        Utils.getRoundedDecodedPolynomial(sArr3, bArr8, p7, q7);
        byte[] bArr9 = new byte[32];
        System.arraycopy(this.privateKey.getPk(), 0, bArr9, 0, 32);
        short[] sArr4 = new short[p7];
        Utils.generatePolynomialInRQFromSeed(sArr4, bArr9, p7, q7);
        ...
        byte[] bArr10 = new byte[p7];
        Utils.sortGenerateShortPolynomial(bArr10, iArr, p7, w10);
        short[] sArr5 = new short[p7];
        Utils.multiplicationInRQ(sArr5, sArr4, bArr10, p7, q7);
        short[] sArr6 = new short[p7];
        Utils.roundPolynomial(sArr6, sArr5);
        Utils.getRoundedEncodedPolynomial(new byte[roundedPolynomialBytes], sArr6, p7, q7);
        short[] sArr7 = new short[p7];
        Utils.multiplicationInRQ(sArr7, sArr3, bArr10, p7, q7);
        Utils.top(new byte[256], sArr7, bArr6, q7, tau0, tau1);
        ...
        int length = (hashWithPrefix2.length / 2) + i11;
        ...
        System.arraycopy(hashWithPrefix2, 0, bArr12, i11, hashWithPrefix2.length / 2);
