    ...
    public static void layer_in(long[] jArr, long[] jArr2, int i11) {
        ...
        for (int i14 = 0; i14 < 64; i14 += i12 * 2) {
            for (int i15 = i14; i15 < i14 + i12; i15++) {
                ...
                int i19 = i18 + i12;
                i13 += 2;
                long j13 = jArr2[i17] & (jArr[i19] ^ j12);
                jArr[i18] = j12 ^ j13;
    ...
    public void apply_benes(byte[] bArr, byte[] bArr2, int i11) {
        ...
        while (true) {
            ...
            for (int i19 = 0; i19 < 64; i19++) {
                jArr3[i19] = Utils.load8(bArr2, i12);
                i12 += 8;
            }
            i12 += i13;
        ...
        for (int i21 = 0; i21 <= 5; i21++) {
            for (int i22 = 0; i22 < 64; i22++) {
                jArr3[i22] = Utils.load8(bArr2, i12);
                i12 += 8;
            }
            i12 += i13;
            layer_in(jArr, jArr3, i21);
        }
        for (int i23 = 4; i23 >= 0; i23--) {
            ...
            i12 += i13;
            layer_in(jArr, jArr3, i23);
        }
        BENES.transpose_64x64(jArr2, jArr, 0);
        BENES.transpose_64x64(jArr2, jArr, 64);
        for (i14 = 6; i14 >= 0; i14--) {
            for (int i25 = 0; i25 < 64; i25++) {
                jArr3[i25] = Utils.load8(bArr2, i12);
                i12 += 8;
            }
            i12 += i13;
            BENES.transpose_64x64(jArr4, jArr3);
        ...
        for (int i26 = 0; i26 < 64; i26++) {
            int i27 = i26 * 16;
            Utils.store8(bArr, i27, jArr[i26]);
            Utils.store8(bArr, i27 + 8, jArr[i26 + 64]);
        }
    }
