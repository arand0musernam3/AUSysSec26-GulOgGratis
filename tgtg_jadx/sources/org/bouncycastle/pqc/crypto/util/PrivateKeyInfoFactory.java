...
public class PrivateKeyInfoFactory {
    ...
    public static PrivateKeyInfo createPrivateKeyInfo(AsymmetricKeyParameter asymmetricKeyParameter, ASN1Set aSN1Set) throws IOException {
        ...
        if (asymmetricKeyParameter instanceof MLKEMPrivateKeyParameters) {
            ...
            return mLKEMPrivateKeyParameters.getPreferredFormat() == 1 ? new PrivateKeyInfo(algorithmIdentifier2, new DERTaggedObject(false, 0, (ASN1Encodable) new DEROctetString(mLKEMPrivateKeyParameters.getSeed())), aSN1Set) : mLKEMPrivateKeyParameters.getPreferredFormat() == 2 ? new PrivateKeyInfo(algorithmIdentifier2, new DEROctetString(mLKEMPrivateKeyParameters.getEncoded()), aSN1Set) : new PrivateKeyInfo(algorithmIdentifier2, getBasicPQCEncoding(mLKEMPrivateKeyParameters.getSeed(), mLKEMPrivateKeyParameters.getEncoded()), aSN1Set);
        }
        ...
        if (asymmetricKeyParameter instanceof MLDSAPrivateKeyParameters) {
            ...
            return mLDSAPrivateKeyParameters.getPreferredFormat() == 1 ? new PrivateKeyInfo(algorithmIdentifier3, new DERTaggedObject(false, 0, (ASN1Encodable) new DEROctetString(mLDSAPrivateKeyParameters.getSeed())), aSN1Set) : mLDSAPrivateKeyParameters.getPreferredFormat() == 2 ? new PrivateKeyInfo(algorithmIdentifier3, new DEROctetString(mLDSAPrivateKeyParameters.getEncoded()), aSN1Set) : new PrivateKeyInfo(algorithmIdentifier3, getBasicPQCEncoding(mLDSAPrivateKeyParameters.getSeed(), mLDSAPrivateKeyParameters.getEncoded()), aSN1Set);
        }
        ...
        a.k("key parameters not recognized");
        return null;
    }
    ...
    private static XMSSPrivateKey xmssCreateKeyStructure(XMSSPrivateKeyParameters xMSSPrivateKeyParameters) throws IOException {
        ...
        try {
            ...
            o.o(e5.getMessage(), "cannot parse BDS: ");
            return null;
        }
    }
    ...
    private static XMSSMTPrivateKey xmssmtCreateKeyStructure(XMSSMTPrivateKeyParameters xMSSMTPrivateKeyParameters) throws IOException {
        ...
        int i11 = (height + 7) / 8;
        long jBytesToXBigEndian = (int) XMSSUtil.bytesToXBigEndian(encoded, 0, i11);
        if (!XMSSUtil.isIndexValid(height, jBytesToXBigEndian)) {
            a.f("index out of bounds");
            return null;
        }
        byte[] bArrExtractBytesAtOffset = XMSSUtil.extractBytesAtOffset(encoded, i11, treeDigestSize);
        int i12 = i11 + treeDigestSize;
        byte[] bArrExtractBytesAtOffset2 = XMSSUtil.extractBytesAtOffset(encoded, i12, treeDigestSize);
        int i13 = i12 + treeDigestSize;
        byte[] bArrExtractBytesAtOffset3 = XMSSUtil.extractBytesAtOffset(encoded, i13, treeDigestSize);
        int i14 = i13 + treeDigestSize;
        byte[] bArrExtractBytesAtOffset4 = XMSSUtil.extractBytesAtOffset(encoded, i14, treeDigestSize);
        int i15 = i14 + treeDigestSize;
        byte[] bArrExtractBytesAtOffset5 = XMSSUtil.extractBytesAtOffset(encoded, i15, encoded.length - i15);
        try {
            ...
            o.o(e5.getMessage(), "cannot parse BDSStateMap: ");
            return null;
        }
    }
