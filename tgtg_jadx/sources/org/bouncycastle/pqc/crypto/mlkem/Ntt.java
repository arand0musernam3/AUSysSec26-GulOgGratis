...
class Ntt {
    ...
    public static void baseMult(Poly poly, int i11, short s7, short s8, short s11, short s12, short s13) {
        poly.setCoeffIndex(i11, (short) (factorQMulMont(factorQMulMont(s8, s12), s13) + factorQMulMont(s7, s11)));
        poly.setCoeffIndex(i11 + 1, (short) (factorQMulMont(s7, s12) + factorQMulMont(s8, s11)));
    }

    public static short factorQMulMont(short s7, short s8) {
        return Reduce.montgomeryReduce(s7 * s8);
    }
    ...
    public static short[] invNtt(short[] sArr) {
        ...
        int i11 = 0;
        for (int i12 = 2; i12 <= 128; i12 <<= 1) {
            int i13 = 0;
            while (i13 < 256) {
                int i14 = i11 + 1;
                short s7 = nttZetasInv[i11];
                int i15 = i13;
                while (i15 < i13 + i12) {
                    short s8 = sArr2[i15];
                    int i16 = i15 + i12;
                    sArr2[i15] = Reduce.barretReduce((short) (sArr2[i16] + s8));
                    short s11 = (short) (s8 - sArr2[i16]);
                    sArr2[i16] = s11;
                    sArr2[i16] = factorQMulMont(s7, s11);
                    i15++;
                }
                i13 = i15 + i12;
                i11 = i14;
        ...
        for (int i17 = 0; i17 < 256; i17++) {
            sArr2[i17] = factorQMulMont(sArr2[i17], nttZetasInv[127]);
        }
        return sArr2;
    }
    ...
    public static short[] ntt(short[] sArr) {
        ...
        for (int i12 = 128; i12 >= 2; i12 >>= 1) {
            ...
            while (i13 < 256) {
                int i14 = i11 + 1;
                short s7 = nttZetas[i11];
                int i15 = i13;
                while (i15 < i13 + i12) {
                    int i16 = i15 + i12;
                    short sFactorQMulMont = factorQMulMont(s7, sArr2[i16]);
                    sArr2[i16] = (short) (sArr2[i15] - sFactorQMulMont);
                    sArr2[i15] = (short) (sArr2[i15] + sFactorQMulMont);
                    i15++;
                }
                i13 = i15 + i12;
                i11 = i14;
