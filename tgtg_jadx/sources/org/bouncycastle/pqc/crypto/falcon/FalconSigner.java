...
public class FalconSigner implements MessageSigner {
    ...
    public byte[] generateSignature(byte[] bArr) {
        ...
        return falconNIST.crypto_sign(new byte[falconNIST.CRYPTO_BYTES], bArr, bArr.length, this.encodedkey);
    }
    ...
    public boolean verifySignature(byte[] bArr, byte[] bArr2) {
        byte b8 = bArr2[0];
        FalconNIST falconNIST = this.nist;
        if (b8 != ((byte) (falconNIST.LOGN + 48))) {
            return false;
        }
        int i11 = falconNIST.NONCELEN;
        byte[] bArr3 = new byte[i11];
        byte[] bArr4 = new byte[(bArr2.length - i11) - 1];
        System.arraycopy(bArr2, 1, bArr3, 0, i11);
        int i12 = this.nist.NONCELEN;
        System.arraycopy(bArr2, i12 + 1, bArr4, 0, (bArr2.length - i12) - 1);
