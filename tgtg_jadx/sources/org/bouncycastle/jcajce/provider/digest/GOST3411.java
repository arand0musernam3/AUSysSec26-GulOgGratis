...
public class GOST3411 {
    ...
    public static class Mappings extends DigestAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            a.w(sb2, str, "$Digest", configurableProvider, "MessageDigest.GOST3411");
            ...
            StringBuilder sbP = a.p(sb3, aSN1ObjectIdentifier, configurableProvider, "GOST3411", str);
            sbP.append("$HashMac");
            addHMACAlgorithm(configurableProvider, "GOST3411", sbP.toString(), k.l(str, "$KeyGenerator"));
            ...
            StringBuilder sbP2 = a.p(new StringBuilder("Alg.Alias.MessageDigest."), RosstandartObjectIdentifiers.id_tc26_gost_3411_12_256, configurableProvider, "GOST3411-2012-256", str);
            sbP2.append("$HashMac2012_256");
            addHMACAlgorithm(configurableProvider, "GOST3411-2012-256", sbP2.toString(), k.l(str, "$KeyGenerator2012_256"));
            ...
            StringBuilder sbP3 = a.p(new StringBuilder("Alg.Alias.MessageDigest."), RosstandartObjectIdentifiers.id_tc26_gost_3411_12_512, configurableProvider, "GOST3411-2012-512", str);
            sbP3.append("$HashMac2012_512");
            addHMACAlgorithm(configurableProvider, "GOST3411-2012-512", sbP3.toString(), k.l(str, "$KeyGenerator2012_512"));
            addHMACAlias(configurableProvider, "GOST3411-2012-512", RosstandartObjectIdentifiers.id_tc26_hmac_gost_3411_12_512);
            a.y(a.l(str, "$PBEWithMacKeyFactory", configurableProvider, "SecretKeyFactory.PBEWITHHMACGOST3411", "Alg.Alias.SecretKeyFactory."), aSN1ObjectIdentifier, configurableProvider, "PBEWITHHMACGOST3411");
        }
    }
