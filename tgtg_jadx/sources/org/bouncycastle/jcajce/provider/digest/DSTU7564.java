...
public class DSTU7564 {
    ...
    public static class HashMac384 extends BaseMac {
        public HashMac384() {
            super(new DSTU7564Mac(MLKEMEngine.KyberPolyBytes));
        }
    }
    ...
    public static class KeyGenerator384 extends BaseKeyGenerator {
        public KeyGenerator384() {
            super("HMACDSTU7564-384", MLKEMEngine.KyberPolyBytes, new CipherKeyGenerator());
        }
    }
    ...
    public static class Mappings extends DigestAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            a.w(a.m(a.m(sb2, str, "$Digest256", configurableProvider, "MessageDigest.DSTU7564-256"), str, "$Digest384", configurableProvider, "MessageDigest.DSTU7564-384"), str, "$Digest512", configurableProvider, "MessageDigest.DSTU7564-512");
            ...
            addHMACAlgorithm(configurableProvider, "DSTU7564-256", k.p(new StringBuilder(), str, "$HashMac256"), k.l(str, "$KeyGenerator256"));
            addHMACAlgorithm(configurableProvider, "DSTU7564-384", k.l(str, "$HashMac384"), k.l(str, "$KeyGenerator384"));
            addHMACAlgorithm(configurableProvider, "DSTU7564-512", k.l(str, "$HashMac512"), k.l(str, "$KeyGenerator512"));
