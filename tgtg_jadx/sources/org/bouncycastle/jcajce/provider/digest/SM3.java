...
public class SM3 {
    ...
    public static class Mappings extends DigestAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            a.w(sb2, str, "$Digest", configurableProvider, "MessageDigest.SM3");
            ...
            StringBuilder sbP = a.p(new StringBuilder("Alg.Alias.MessageDigest."), GMObjectIdentifiers.sm3, configurableProvider, "SM3", str);
            sbP.append("$HashMac");
            addHMACAlgorithm(configurableProvider, "SM3", sbP.toString(), k.l(str, "$KeyGenerator"));
