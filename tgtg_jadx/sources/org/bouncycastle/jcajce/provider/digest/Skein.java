...
public class Skein {
    ...
    public static class Mappings extends DigestAlgorithmProvider {
        ...
        private void addSkeinMacAlgorithm(ConfigurableProvider configurableProvider, int i11, int i12) {
            String strK = k.k("Skein-MAC-", i11, i12, "-");
            ...
            sb2.append("_");
            sb2.append(i12);
            configurableProvider.addAlgorithm("Mac.".concat(strK), sb2.toString());
            configurableProvider.addAlgorithm("Alg.Alias.Mac.Skein-MAC" + i11 + ExpiryDateInput.SEPARATOR + i12, strK);
            configurableProvider.addAlgorithm("KeyGenerator.".concat(strK), str + "$SkeinMacKeyGenerator_" + i11 + "_" + i12);
            configurableProvider.addAlgorithm("Alg.Alias.KeyGenerator.Skein-MAC" + i11 + ExpiryDateInput.SEPARATOR + i12, strK);
        }
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            StringBuilder sb2 = new StringBuilder();
            String str = PREFIX;
            addHMACAlgorithm(configurableProvider, "Skein-256-128", k.p(a.m(a.m(a.m(a.m(a.m(a.m(a.m(a.m(a.m(a.m(a.m(a.m(a.m(sb2, str, "$Digest_256_128", configurableProvider, "MessageDigest.Skein-256-128"), str, "$Digest_256_160", configurableProvider, "MessageDigest.Skein-256-160"), str, "$Digest_256_224", configurableProvider, "MessageDigest.Skein-256-224"), str, "$Digest_256_256", configurableProvider, "MessageDigest.Skein-256-256"), str, "$Digest_512_128", configurableProvider, "MessageDigest.Skein-512-128"), str, "$Digest_512_160", configurableProvider, "MessageDigest.Skein-512-160"), str, "$Digest_512_224", configurableProvider, "MessageDigest.Skein-512-224"), str, "$Digest_512_256", configurableProvider, "MessageDigest.Skein-512-256"), str, "$Digest_512_384", configurableProvider, "MessageDigest.Skein-512-384"), str, "$Digest_512_512", configurableProvider, "MessageDigest.Skein-512-512"), str, "$Digest_1024_384", configurableProvider, "MessageDigest.Skein-1024-384"), str, "$Digest_1024_512", configurableProvider, "MessageDigest.Skein-1024-512"), str, "$Digest_1024_1024", configurableProvider, "MessageDigest.Skein-1024-1024"), str, "$HashMac_256_128"), k.l(str, "$HMacKeyGenerator_256_128"));
            addHMACAlgorithm(configurableProvider, "Skein-256-160", k.l(str, "$HashMac_256_160"), k.l(str, "$HMacKeyGenerator_256_160"));
            addHMACAlgorithm(configurableProvider, "Skein-256-224", k.l(str, "$HashMac_256_224"), k.l(str, "$HMacKeyGenerator_256_224"));
            addHMACAlgorithm(configurableProvider, "Skein-256-256", k.l(str, "$HashMac_256_256"), k.l(str, "$HMacKeyGenerator_256_256"));
            addHMACAlgorithm(configurableProvider, "Skein-512-128", k.l(str, "$HashMac_512_128"), k.l(str, "$HMacKeyGenerator_512_128"));
            addHMACAlgorithm(configurableProvider, "Skein-512-160", k.l(str, "$HashMac_512_160"), k.l(str, "$HMacKeyGenerator_512_160"));
            addHMACAlgorithm(configurableProvider, "Skein-512-224", k.l(str, "$HashMac_512_224"), k.l(str, "$HMacKeyGenerator_512_224"));
            addHMACAlgorithm(configurableProvider, "Skein-512-256", k.l(str, "$HashMac_512_256"), k.l(str, "$HMacKeyGenerator_512_256"));
            addHMACAlgorithm(configurableProvider, "Skein-512-384", k.l(str, "$HashMac_512_384"), k.l(str, "$HMacKeyGenerator_512_384"));
            addHMACAlgorithm(configurableProvider, "Skein-512-512", k.l(str, "$HashMac_512_512"), k.l(str, "$HMacKeyGenerator_512_512"));
            addHMACAlgorithm(configurableProvider, "Skein-1024-384", k.l(str, "$HashMac_1024_384"), k.l(str, "$HMacKeyGenerator_1024_384"));
            addHMACAlgorithm(configurableProvider, "Skein-1024-512", k.l(str, "$HashMac_1024_512"), k.l(str, "$HMacKeyGenerator_1024_512"));
            addHMACAlgorithm(configurableProvider, "Skein-1024-1024", k.l(str, "$HashMac_1024_1024"), k.l(str, "$HMacKeyGenerator_1024_1024"));
