...
public class RIPEMD160 {
    ...
    public static class Mappings extends DigestAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            StringBuilder sbP = a.p(new StringBuilder("Alg.Alias.MessageDigest."), TeleTrusTObjectIdentifiers.ripemd160, configurableProvider, "RIPEMD160", str);
            sbP.append("$HashMac");
            addHMACAlgorithm(configurableProvider, "RIPEMD160", sbP.toString(), k.l(str, "$KeyGenerator"));
            ...
            sb3.append(str);
            a.x(sb3, "$PBEWithHmac", configurableProvider, "Mac.PBEWITHHMACRIPEMD160");
        }
    }
