...
public class Blake2s {
    ...
    public static class Mappings extends DigestAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            StringBuilder sbP = a.p(new StringBuilder("Alg.Alias.MessageDigest."), MiscObjectIdentifiers.id_blake2s256, configurableProvider, "BLAKE2S-256", str);
            sbP.append("$Blake2s224");
            configurableProvider.addAlgorithm("MessageDigest.BLAKE2S-224", sbP.toString());
            StringBuilder sbP2 = a.p(new StringBuilder("Alg.Alias.MessageDigest."), MiscObjectIdentifiers.id_blake2s224, configurableProvider, "BLAKE2S-224", str);
            sbP2.append("$Blake2s160");
            configurableProvider.addAlgorithm("MessageDigest.BLAKE2S-160", sbP2.toString());
            StringBuilder sbP3 = a.p(new StringBuilder("Alg.Alias.MessageDigest."), MiscObjectIdentifiers.id_blake2s160, configurableProvider, "BLAKE2S-160", str);
            sbP3.append("$Blake2s128");
            configurableProvider.addAlgorithm("MessageDigest.BLAKE2S-128", sbP3.toString());
            a.y(new StringBuilder("Alg.Alias.MessageDigest."), MiscObjectIdentifiers.id_blake2s128, configurableProvider, "BLAKE2S-128");
        }
    }
