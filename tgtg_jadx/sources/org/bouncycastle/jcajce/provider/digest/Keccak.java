...
public class Keccak {
    ...
    public static class Mappings extends DigestAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            addHMACAlgorithm(configurableProvider, "KECCAK224", k.p(a.m(a.m(a.m(a.m(a.m(sb2, str, "$Digest224", configurableProvider, "MessageDigest.KECCAK-224"), str, "$Digest288", configurableProvider, "MessageDigest.KECCAK-288"), str, "$Digest256", configurableProvider, "MessageDigest.KECCAK-256"), str, "$Digest384", configurableProvider, "MessageDigest.KECCAK-384"), str, "$Digest512", configurableProvider, "MessageDigest.KECCAK-512"), str, "$HashMac224"), k.l(str, "$KeyGenerator224"));
            addHMACAlgorithm(configurableProvider, "KECCAK256", k.l(str, "$HashMac256"), k.l(str, "$KeyGenerator256"));
            addHMACAlgorithm(configurableProvider, "KECCAK288", k.l(str, "$HashMac288"), k.l(str, "$KeyGenerator288"));
            addHMACAlgorithm(configurableProvider, "KECCAK384", k.l(str, "$HashMac384"), k.l(str, "$KeyGenerator384"));
            addHMACAlgorithm(configurableProvider, "KECCAK512", k.l(str, "$HashMac512"), k.l(str, "$KeyGenerator512"));
        }
    }
