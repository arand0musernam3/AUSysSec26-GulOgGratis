...
public class Tiger {
    ...
    public static class Mappings extends DigestAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            addHMACAlgorithm(configurableProvider, "TIGER", k.p(a.m(a.m(sb2, str, "$Digest", configurableProvider, "MessageDigest.TIGER"), str, "$Digest", configurableProvider, "MessageDigest.Tiger"), str, "$HashMac"), k.l(str, "$KeyGenerator"));
