...
class BcFKSKeyStoreSpi extends KeyStoreSpi {
    ...
    static {
        ...
        ASN1ObjectIdentifier aSN1ObjectIdentifier2 = PKCSObjectIdentifiers.id_hmacWithSHA512_224;
        map.put("HMACSHA512/224", aSN1ObjectIdentifier2);
        ASN1ObjectIdentifier aSN1ObjectIdentifier3 = PKCSObjectIdentifiers.id_hmacWithSHA512_256;
        map.put("HMACSHA512/256", aSN1ObjectIdentifier3);
        map.put("HMACSHA512(224)", aSN1ObjectIdentifier2);
        map.put("HMACSHA512(256)", aSN1ObjectIdentifier3);
        map.put("HMACSHA3-224", NISTObjectIdentifiers.id_hmacWithSHA3_224);
        map.put("HMACSHA3-256", NISTObjectIdentifiers.id_hmacWithSHA3_256);
        map.put("HMACSHA3-384", NISTObjectIdentifiers.id_hmacWithSHA3_384);
        map.put("HMACSHA3-512", NISTObjectIdentifiers.id_hmacWithSHA3_512);
        map.put("KMAC128", NISTObjectIdentifiers.id_Kmac128);
        map.put("KMAC256", NISTObjectIdentifiers.id_Kmac256);
    ...
    private byte[] calculateMac(byte[] bArr, AlgorithmIdentifier algorithmIdentifier, KeyDerivationFunc keyDerivationFunc, char[] cArr) throws NoSuchAlgorithmException, IOException, NoSuchProviderException {
        ...
        try {
            ...
            o.o(e5.getMessage(), "Cannot set up MAC calculation: ");
            return null;
        }
    }
    ...
    private EncryptedPrivateKeyData createPrivateKeySequence(EncryptedPrivateKeyInfo encryptedPrivateKeyInfo, Certificate[] certificateArr) throws CertificateEncodingException {
        ...
        for (int i11 = 0; i11 != certificateArr.length; i11++) {
            certificateArr2[i11] = org.bouncycastle.asn1.x509.Certificate.getInstance(certificateArr[i11].getEncoded());
        }
    ...
    private byte[] decryptData(String str, AlgorithmIdentifier algorithmIdentifier, char[] cArr, byte[] bArr) throws IOException {
        ...
        if (!algorithmIdentifier.getAlgorithm().equals((ASN1Primitive) PKCSObjectIdentifiers.id_PBES2)) {
            a.k("BCFKS KeyStore cannot recognize protection algorithm.");
            return null;
        }
    ...
    private byte[] generateKey(KeyDerivationFunc keyDerivationFunc, String str, char[] cArr, int i11) throws IOException {
        ...
        if (MiscObjectIdentifiers.id_scrypt.equals((ASN1Primitive) keyDerivationFunc.getAlgorithm())) {
            ...
            if (scryptParams.getKeyLength() != null) {
                i11 = scryptParams.getKeyLength().intValue();
            } else if (i11 == -1) {
                a.k("no keyLength found in ScryptParams");
                return null;
            }
            return SCrypt.generate(Arrays.concatenate(bArrPKCS12PasswordToBytes, bArrPKCS12PasswordToBytes2), scryptParams.getSalt(), scryptParams.getCostParameter().intValue(), scryptParams.getBlockSize().intValue(), scryptParams.getBlockSize().intValue(), i11);
        }
        if (!keyDerivationFunc.getAlgorithm().equals((ASN1Primitive) PKCSObjectIdentifiers.id_PBKDF2)) {
            a.k("BCFKS KeyStore: unrecognized MAC PBKD.");
            return null;
        }
        ...
        if (pBKDF2Params.getKeyLength() != null) {
            ...
            a.k("no keyLength found in PBKDF2Params");
            return null;
        }
        if (pBKDF2Params.getPrf().getAlgorithm().equals((ASN1Primitive) PKCSObjectIdentifiers.id_hmacWithSHA512)) {
            ...
            return ((KeyParameter) pKCS5S2ParametersGenerator.generateDerivedParameters(i11 * 8)).getKey();
        }
        if (!pBKDF2Params.getPrf().getAlgorithm().equals((ASN1Primitive) NISTObjectIdentifiers.id_hmacWithSHA3_512)) {
            o.o(pBKDF2Params.getPrf().getAlgorithm(), "BCFKS KeyStore: unrecognized MAC PBKD PRF: ");
            return null;
        }
        ...
        return ((KeyParameter) pKCS5S2ParametersGenerator2.generateDerivedParameters(i11 * 8)).getKey();
    }

    private KeyDerivationFunc generatePkbdAlgorithmIdentifier(KeyDerivationFunc keyDerivationFunc, int i11) {
        ...
        if (zEquals) {
            ...
            return new KeyDerivationFunc(aSN1ObjectIdentifier, new ScryptParams(bArr, scryptParams.getCostParameter(), scryptParams.getBlockSize(), scryptParams.getParallelizationParameter(), BigInteger.valueOf(i11)));
        }
        PBKDF2Params pBKDF2Params = PBKDF2Params.getInstance(parameters);
        byte[] bArr2 = new byte[pBKDF2Params.getSalt().length];
        getDefaultSecureRandom().nextBytes(bArr2);
        return new KeyDerivationFunc(PKCSObjectIdentifiers.id_PBKDF2, new PBKDF2Params(bArr2, pBKDF2Params.getIterationCount().intValue(), i11, pBKDF2Params.getPrf()));
    }
    ...
    private AlgorithmIdentifier generateSignatureAlgId(Key key, BCFKSLoadStoreParameter.SignatureAlgorithm signatureAlgorithm) throws IOException {
        ...
        a.k("unknown signature algorithm");
        return null;
    }
    ...
    private EncryptedObjectStoreData getEncryptedObjectStoreData(AlgorithmIdentifier algorithmIdentifier, char[] cArr) throws NoSuchAlgorithmException, IOException {
    ...
    private void verifyMac(byte[] bArr, PbkdMacIntegrityCheck pbkdMacIntegrityCheck, char[] cArr) throws NoSuchAlgorithmException, IOException, NoSuchProviderException {
        ...
        a.k("BCFKS KeyStore corrupted: MAC calculation failed");
    }
    ...
    private void verifySig(ASN1Encodable aSN1Encodable, SignatureCheck signatureCheck, PublicKey publicKey) throws GeneralSecurityException, IOException {
        ...
        a.k("BCFKS KeyStore corrupted: signature calculation failed");
    }
    ...
    public Key engineGetKey(String str, char[] cArr) throws UnrecoverableKeyException, NoSuchAlgorithmException {
        ...
        if (!objectData.getType().equals(PRIVATE_KEY) && !objectData.getType().equals(PROTECTED_PRIVATE_KEY)) {
            if (!objectData.getType().equals(SECRET_KEY) && !objectData.getType().equals(PROTECTED_SECRET_KEY)) {
                throw new UnrecoverableKeyException(a0.p("BCFKS KeyStore unable to recover secret key (", str, "): type not recognized"));
            }
            ...
            try {
                ...
                throw new UnrecoverableKeyException(k.j(e5, f.s("BCFKS KeyStore unable to recover secret key (", str, "): ")));
            }
        }
        ...
        try {
            ...
            throw new UnrecoverableKeyException(k.j(e11, f.s("BCFKS KeyStore unable to recover private key (", str, "): ")));
        }
    }
        ...
        try {
            ...
            if (integrityCheck.getType() == 0) {
                ...
                if (integrityCheck.getType() != 1) {
                    a.k("BCFKS KeyStore unable to recognize integrity check.");
                    return;
                }
                ...
                try {
                    ...
                    if (this.validator == null) {
                        ...
                        X509Certificate[] x509CertificateArr = new X509Certificate[length];
                        for (int i11 = 0; i11 != length; i11++) {
                            x509CertificateArr[i11] = (X509Certificate) certificateFactoryCreateCertificateFactory.generateCertificate(new ByteArrayInputStream(certificates[i11].getEncoded()));
                        }
            ...
            try {
                ...
                if (!objectStoreData.getIntegrityAlgorithm().equals(signatureAlgorithm)) {
                    a.k("BCFKS KeyStore storeData integrity algorithm does not match store integrity algorithm.");
                    return;
                }
                ...
                a.k("BCFKS KeyStore unable to parse store data information.");
            }
        } catch (Exception e12) {
            a.k(e12.getMessage());
        }
    ...
    public void engineSetCertificateEntry(String str, Certificate certificate) throws KeyStoreException {
        ...
        if (objectData == null) {
            ...
            if (!objectData.getType().equals(CERTIFICATE)) {
                throw new KeyStoreException(f.k("BCFKS KeyStore already has a key entry with alias ", str));
            }
    ...
    public void engineSetKeyEntry(String str, Key key, char[] cArr, Certificate[] certificateArr) throws KeyStoreException {
        ...
        if (key instanceof PrivateKey) {
            ...
            try {
                ...
                throw new ExtKeyStoreException(s.i(e5, new StringBuilder("BCFKS KeyStore exception storing private key: ")), e5);
            }
        } else {
            ...
            try {
                ...
                throw new ExtKeyStoreException(s.i(e11, new StringBuilder("BCFKS KeyStore exception storing private key: ")), e11);
            }
        }
        this.lastModifiedDate = date;
    }
    ...
    public void engineStore(KeyStore.LoadStoreParameter loadStoreParameter) throws NoSuchAlgorithmException, IOException, CertificateException {
        ...
        if (loadStoreParameter == null) {
            a.f("'parameter' arg cannot be null");
            return;
        }
        ...
        if (!(loadStoreParameter instanceof BCFKSLoadStoreParameter)) {
            if (loadStoreParameter instanceof BCLoadStoreParameter) {
                ...
                a.f("no support for 'parameter' of type ".concat(loadStoreParameter.getClass().getName()));
                return;
            }
        }
        ...
        try {
            ...
            if (storeCertificates != null) {
                ...
                for (int i11 = 0; i11 != length; i11++) {
                    certificateArr[i11] = org.bouncycastle.asn1.x509.Certificate.getInstance(storeCertificates[i11].getEncoded());
                }
    ...
    public static class SharedKeyStoreSpi extends BcFKSKeyStoreSpi implements PKCSObjectIdentifiers, X509ObjectIdentifiers {
        ...
        private byte[] calculateMac(String str, char[] cArr) throws NoSuchAlgorithmException, InvalidKeyException {
            return SCrypt.generate(cArr != null ? Arrays.concatenate(Strings.toUTF8ByteArray(cArr), Strings.toUTF8ByteArray(str)) : Arrays.concatenate(this.seedKey, Strings.toUTF8ByteArray(str)), this.seedKey, BrotliInputStream.DEFAULT_INTERNAL_BUFFER_SIZE, 8, 1, 32);
        }
        ...
        public Key engineGetKey(String str, char[] cArr) throws NoSuchAlgorithmException, UnrecoverableKeyException {
            try {
                ...
                if (this.cache.containsKey(str) && !Arrays.constantTimeAreEqual(this.cache.get(str), bArrCalculateMac)) {
                    throw new UnrecoverableKeyException(a0.p("unable to recover key (", str, ")"));
                }
                ...
                StringBuilder sbS = f.s("unable to recover key (", str, "): ");
                sbS.append(e5.getMessage());
                throw new UnrecoverableKeyException(sbS.toString());
            }
        }
    ...
    private KeyDerivationFunc generatePkbdAlgorithmIdentifier(ASN1ObjectIdentifier aSN1ObjectIdentifier, int i11) {
        ...
        if (aSN1ObjectIdentifier2.equals((ASN1Primitive) aSN1ObjectIdentifier)) {
            return new KeyDerivationFunc(aSN1ObjectIdentifier2, new PBKDF2Params(bArr, 51200, i11, new AlgorithmIdentifier(PKCSObjectIdentifiers.id_hmacWithSHA512, DERNull.INSTANCE)));
        }
        h2.b(s.l("unknown derivation algorithm: ", aSN1ObjectIdentifier));
        return null;
    }

    private KeyDerivationFunc generatePkbdAlgorithmIdentifier(PBKDFConfig pBKDFConfig, int i11) {
        ASN1ObjectIdentifier aSN1ObjectIdentifier = MiscObjectIdentifiers.id_scrypt;
        if (aSN1ObjectIdentifier.equals((ASN1Primitive) pBKDFConfig.getAlgorithm())) {
            ScryptConfig scryptConfig = (ScryptConfig) pBKDFConfig;
            byte[] bArr = new byte[scryptConfig.getSaltLength()];
            getDefaultSecureRandom().nextBytes(bArr);
            return new KeyDerivationFunc(aSN1ObjectIdentifier, new ScryptParams(bArr, scryptConfig.getCostParameter(), scryptConfig.getBlockSize(), scryptConfig.getParallelizationParameter(), i11));
        }
        PBKDF2Config pBKDF2Config = (PBKDF2Config) pBKDFConfig;
        byte[] bArr2 = new byte[pBKDF2Config.getSaltLength()];
        getDefaultSecureRandom().nextBytes(bArr2);
        return new KeyDerivationFunc(PKCSObjectIdentifiers.id_PBKDF2, new PBKDF2Params(bArr2, pBKDF2Config.getIterationCount(), i11, pBKDF2Config.getPRF()));
    }
    ...
    public void engineStore(OutputStream outputStream, char[] cArr) throws NoSuchAlgorithmException, IOException, CertificateException {
        ...
        if (this.creationDate == null) {
            a.k("KeyStore not initialized");
            return;
        }
        EncryptedObjectStoreData encryptedObjectStoreData = getEncryptedObjectStoreData(this.hmacAlgorithm, cArr);
        boolean zEquals = MiscObjectIdentifiers.id_scrypt.equals((ASN1Primitive) this.hmacPkbdAlgorithm.getAlgorithm());
        ...
        try {
            ...
            o.o(e5.getMessage(), "cannot calculate mac: ");
        }
    }
    ...
    public void engineLoad(KeyStore.LoadStoreParameter loadStoreParameter) throws NoSuchAlgorithmException, IOException, CertificateException {
        ...
        if (inputStream != null) {
            ...
            a.k("configuration parameters do not match existing store");
        }
    }
        ...
        if (certificateArr != null) {
            try {
                ...
                try {
                    ...
                    throw new ExtKeyStoreException(s.i(e5, new StringBuilder("BCFKS KeyStore exception storing protected private key: ")), e5);
                }
            } catch (Exception e11) {
            ...
            try {
                ...
                throw new ExtKeyStoreException(s.i(e12, new StringBuilder("BCFKS KeyStore exception storing protected private key: ")), e12);
            }
        }
        this.lastModifiedDate = date;
    }
