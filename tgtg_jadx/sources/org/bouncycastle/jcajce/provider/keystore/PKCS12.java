    ...
    public static class Mappings extends AsymmetricAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            if (propertyValue != null) {
                StringBuilder sbQ = a.q(configurableProvider, "Alg.Alias.KeyStore.PKCS12", propertyValue, "Alg.Alias.KeyStore.BCPKCS12", propertyValue);
                sbQ.append(propertyValue.substring(0, 5));
                sbQ.append("-DEF");
                sbQ.append(propertyValue.substring(6));
                configurableProvider.addAlgorithm("Alg.Alias.KeyStore.PKCS12-DEF", sbQ.toString());
            } else {
