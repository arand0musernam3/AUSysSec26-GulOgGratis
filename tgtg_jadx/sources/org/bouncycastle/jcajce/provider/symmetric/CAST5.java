...
public final class CAST5 {
    ...
    public static class Mappings extends AlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            a.w(sb2, str, "$AlgParams", configurableProvider, "AlgorithmParameters.CAST5");
            a.w(a.q(configurableProvider, "AlgorithmParameterGenerator.CAST5", a.e("Alg.Alias.AlgorithmParameters.1.2.840.113533.7.66.10", "CAST5", configurableProvider, str, "$AlgParamGen"), "Alg.Alias.AlgorithmParameterGenerator.1.2.840.113533.7.66.10", "CAST5"), str, "$ECB", configurableProvider, "Cipher.CAST5");
            ...
            a.w(new StringBuilder(), str, "$KeyGen", configurableProvider, "KeyGenerator.CAST5");
    ...
    public static class AlgParams extends BaseAlgorithmParameters {
        ...
        public void engineInit(byte[] bArr, String str) throws IOException {
            if (isASN1FormatString(str)) {
                ...
                this.f33302iv = cAST5CBCParameters.getIV();
        ...
        public AlgorithmParameterSpec localEngineGetParameterSpec(Class cls) throws InvalidParameterSpecException {
            if (cls == IvParameterSpec.class || cls == AlgorithmParameterSpec.class) {
                return new IvParameterSpec(this.f33302iv);
            }
            i1.u("unknown parameter spec passed to CAST5 parameters object.");
            return null;
        }

        @Override // java.security.AlgorithmParametersSpi
        public byte[] engineGetEncoded() {
            byte[] bArr = this.f33302iv;
        ...
        public void engineInit(AlgorithmParameterSpec algorithmParameterSpec) throws InvalidParameterSpecException {
            if (algorithmParameterSpec instanceof IvParameterSpec) {
                this.f33302iv = ((IvParameterSpec) algorithmParameterSpec).getIV();
            } else {
                i1.u("IvParameterSpec required to initialise a CAST5 parameters algorithm parameters object");
            }
        }
    }
}
