...
public class DSTU7624 {
    ...
    public static class Mappings extends SymmetricAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            a.w(sb2, str, "$AlgParams", configurableProvider, "AlgorithmParameters.DSTU7624");
            ...
            configurableProvider.addAlgorithm("Cipher", aSN1ObjectIdentifier3, k.p(a.o(a.r(configurableProvider, "Cipher", k.p(new StringBuilder(), str, "$CBC128"), str, aSN1ObjectIdentifier), "$CBC256", configurableProvider, "Cipher", aSN1ObjectIdentifier2), str, "$CBC512"));
            ...
            a.w(new StringBuilder(), str, "$Wrap", configurableProvider, "Cipher.DSTU7624KW");
            StringBuilder sbS = s.s(configurableProvider, "Cipher.DSTU7624-128KW", a.e("Alg.Alias.Cipher.DSTU7624WRAP", "DSTU7624KW", configurableProvider, str, "$Wrap128"), "Alg.Alias.Cipher.");
            ASN1ObjectIdentifier aSN1ObjectIdentifier19 = UAObjectIdentifiers.dstu7624kw_128;
            sbS.append(aSN1ObjectIdentifier19.getId());
            configurableProvider.addAlgorithm(sbS.toString(), "DSTU7624-128KW");
            StringBuilder sbS2 = s.s(configurableProvider, "Cipher.DSTU7624-256KW", a.e("Alg.Alias.Cipher.DSTU7624-128WRAP", "DSTU7624-128KW", configurableProvider, str, "$Wrap256"), "Alg.Alias.Cipher.");
            ASN1ObjectIdentifier aSN1ObjectIdentifier20 = UAObjectIdentifiers.dstu7624kw_256;
            sbS2.append(aSN1ObjectIdentifier20.getId());
            configurableProvider.addAlgorithm(sbS2.toString(), "DSTU7624-256KW");
            StringBuilder sbS3 = s.s(configurableProvider, "Cipher.DSTU7624-512KW", a.e("Alg.Alias.Cipher.DSTU7624-256WRAP", "DSTU7624-256KW", configurableProvider, str, "$Wrap512"), "Alg.Alias.Cipher.");
            ASN1ObjectIdentifier aSN1ObjectIdentifier21 = UAObjectIdentifiers.dstu7624kw_512;
            sbS3.append(aSN1ObjectIdentifier21.getId());
            configurableProvider.addAlgorithm(sbS3.toString(), "DSTU7624-512KW");
            StringBuilder sbS4 = s.s(configurableProvider, "Mac.DSTU7624-128GMAC", a.e("Mac.DSTU7624GMAC", a.e("Alg.Alias.Cipher.DSTU7624-512WRAP", "DSTU7624-512KW", configurableProvider, str, "$GMAC"), configurableProvider, str, "$GMAC128"), "Alg.Alias.Mac.");
            ASN1ObjectIdentifier aSN1ObjectIdentifier22 = UAObjectIdentifiers.dstu7624gmac_128;
            sbS4.append(aSN1ObjectIdentifier22.getId());
            configurableProvider.addAlgorithm(sbS4.toString(), "DSTU7624-128GMAC");
    ...
    public static class KeyGen extends BaseKeyGenerator {
        public KeyGen(int i11) {
            super("DSTU7624", i11, new CipherKeyGenerator());
        }
