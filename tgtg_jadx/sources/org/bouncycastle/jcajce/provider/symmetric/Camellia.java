...
public final class Camellia {
    ...
    public static class CBC192 extends BaseBlockCipher {
        public CBC192() {
            super(BERTags.PRIVATE, new CBCBlockCipher(new CamelliaEngine()), 128);
        }
    }
    ...
    public static class Mappings extends SymmetricAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            a.w(sb2, str, "$AlgParams", configurableProvider, "AlgorithmParameters.CAMELLIA");
            ...
            a.x(a.r(configurableProvider, "Alg.Alias.AlgorithmParameters", "CAMELLIA", str, aSN1ObjectIdentifier3), "$AlgParamGen", configurableProvider, "AlgorithmParameterGenerator.CAMELLIA");
            ...
            a.w(a.m(a.o(a.r(configurableProvider, "Cipher", k.p(a.o(a.n(a.r(configurableProvider, "Alg.Alias.AlgorithmParameterGenerator", "CAMELLIA", str, aSN1ObjectIdentifier3), "$ECB", configurableProvider, "Cipher.CAMELLIA", str), "$CBC128", configurableProvider, "Cipher", aSN1ObjectIdentifier), str, "$CBC192"), str, aSN1ObjectIdentifier2), "$CBC256", configurableProvider, "Cipher", aSN1ObjectIdentifier3), str, "$RFC3211Wrap", configurableProvider, "Cipher.CAMELLIARFC3211WRAP"), str, "$Wrap", configurableProvider, "Cipher.CAMELLIAWRAP");
            ASN1ObjectIdentifier aSN1ObjectIdentifier4 = NTTObjectIdentifiers.id_camellia128_wrap;
            a.z(configurableProvider, str, "$Wrap128", "Cipher", aSN1ObjectIdentifier4);
            ASN1ObjectIdentifier aSN1ObjectIdentifier5 = NTTObjectIdentifiers.id_camellia192_wrap;
            a.z(configurableProvider, str, "$Wrap192", "Cipher", aSN1ObjectIdentifier5);
            ASN1ObjectIdentifier aSN1ObjectIdentifier6 = NTTObjectIdentifiers.id_camellia256_wrap;
            configurableProvider.addAlgorithm("Cipher", aSN1ObjectIdentifier6, str + "$Wrap256");
            a.w(new StringBuilder(), str, "$KeyFactory", configurableProvider, "SecretKeyFactory.CAMELLIA");
            ...
            StringBuilder sbR = a.r(configurableProvider, "KeyGenerator", k.p(a.o(a.r(configurableProvider, "KeyGenerator", k.p(a.o(a.r(configurableProvider, "KeyGenerator", k.p(a.o(a.n(a.r(configurableProvider, "Alg.Alias.SecretKeyFactory", "CAMELLIA", str, aSN1ObjectIdentifier3), "$KeyGen", configurableProvider, "KeyGenerator.CAMELLIA", str), "$KeyGen128", configurableProvider, "KeyGenerator", aSN1ObjectIdentifier4), str, "$KeyGen192"), str, aSN1ObjectIdentifier5), "$KeyGen256", configurableProvider, "KeyGenerator", aSN1ObjectIdentifier6), str, "$KeyGen128"), str, aSN1ObjectIdentifier), "$KeyGen192", configurableProvider, "KeyGenerator", aSN1ObjectIdentifier2), str, "$KeyGen256"), str, aSN1ObjectIdentifier3);
            sbR.append("$GMAC");
            addGMacAlgorithm(configurableProvider, "CAMELLIA", sbR.toString(), k.l(str, "$KeyGen"));
            addPoly1305Algorithm(configurableProvider, "CAMELLIA", k.l(str, "$Poly1305"), k.l(str, "$Poly1305KeyGen"));
        }
    }
    ...
    public static class Wrap192 extends BaseWrapCipher {
        public Wrap192() {
            super(BERTags.PRIVATE, new CamelliaWrapEngine());
        }
    }
    ...
    public static class KeyGen extends BaseKeyGenerator {
        public KeyGen(int i11) {
            super("Camellia", i11, new CipherKeyGenerator());
        }
