...
public final class RC6 {
    ...
    public static class Mappings extends SymmetricAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            addGMacAlgorithm(configurableProvider, "RC6", k.p(a.m(a.m(a.m(sb2, str, "$ECB", configurableProvider, "Cipher.RC6"), str, "$KeyGen", configurableProvider, "KeyGenerator.RC6"), str, "$AlgParams", configurableProvider, "AlgorithmParameters.RC6"), str, "$GMAC"), k.l(str, "$KeyGen"));
            addPoly1305Algorithm(configurableProvider, "RC6", k.l(str, "$Poly1305"), k.l(str, "$Poly1305KeyGen"));
        }
    }
