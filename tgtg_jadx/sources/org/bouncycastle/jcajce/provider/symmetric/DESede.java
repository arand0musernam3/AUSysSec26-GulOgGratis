...
public final class DESede {
    ...
    public static class Mappings extends AlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            a.w(sb2, str, "$ECB", configurableProvider, "Cipher.DESEDE");
            ...
            a.w(new StringBuilder(), str, "$Wrap", configurableProvider, "Cipher.DESEDEWRAP");
            configurableProvider.addAlgorithm("Cipher", PKCSObjectIdentifiers.id_alg_CMS3DESwrap, str + "$Wrap");
            a.w(new StringBuilder(), str, "$RFC3211", configurableProvider, "Cipher.DESEDERFC3211WRAP");
            ...
            if (configurableProvider.hasAlgorithm("MessageDigest", McElieceCCA2KeyGenParameterSpec.SHA1)) {
                ...
                sb3.append(str);
                a.x(sb3, "$PBEWithSHAAndDES2Key", configurableProvider, "Cipher.PBEWITHSHAAND2-KEYTRIPLEDES-CBC");
            ...
            StringBuilder sbL = a.l(str, "$KeyGenerator", configurableProvider, "KeyGenerator.DESEDE", "KeyGenerator.");
            sbL.append(aSN1ObjectIdentifier);
            configurableProvider.addAlgorithm(sbL.toString(), str + "$KeyGenerator3");
            StringBuilder sb4 = new StringBuilder();
            sb4.append(str);
            a.x(a.n(sb4, "$KeyGenerator", configurableProvider, "KeyGenerator.DESEDEWRAP", str), "$KeyFactory", configurableProvider, "SecretKeyFactory.DESEDE");
            configurableProvider.addAlgorithm("SecretKeyFactory", OIWObjectIdentifiers.desEDE, str + "$KeyFactory");
            a.w(a.m(new StringBuilder(), str, "$CMAC", configurableProvider, "Mac.DESEDECMAC"), str, "$CBCMAC", configurableProvider, "Mac.DESEDEMAC");
            a.w(a.q(configurableProvider, "Mac.DESEDEMAC/CFB8", a.e("Alg.Alias.Mac.DESEDE", "DESEDEMAC", configurableProvider, str, "$DESedeCFB8"), "Alg.Alias.Mac.DESEDE/CFB8", "DESEDEMAC/CFB8"), str, "$DESede64", configurableProvider, "Mac.DESEDEMAC64");
            configurableProvider.addAlgorithm("Mac.DESEDEMAC64WITHISO7816-4PADDING", a.e("Alg.Alias.Mac.DESEDE64", "DESEDEMAC64", configurableProvider, str, "$DESede64with7816d4"));
