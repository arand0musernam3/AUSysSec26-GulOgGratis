...
public final class ChaCha {
    ...
    public static class Mappings extends AlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            a.w(a.m(a.m(a.m(a.m(sb2, str, "$Base", configurableProvider, "Cipher.CHACHA"), str, "$KeyGen", configurableProvider, "KeyGenerator.CHACHA"), str, "$Base7539", configurableProvider, "Cipher.CHACHA7539"), str, "$KeyGen7539", configurableProvider, "KeyGenerator.CHACHA7539"), str, "$AlgParams", configurableProvider, "AlgorithmParameters.CHACHA7539");
            ...
            StringBuilder sbN = a.n(a.p(sb3, aSN1ObjectIdentifier, configurableProvider, "CHACHA7539", str), "$BaseCC20P1305", configurableProvider, "Cipher.CHACHA20-POLY1305", str);
            sbN.append("$AlgParamsCC1305");
            configurableProvider.addAlgorithm("AlgorithmParameters.CHACHA20-POLY1305", sbN.toString());
            a.y(s.r(s.r(s.r(new StringBuilder("Alg.Alias.Cipher."), aSN1ObjectIdentifier, configurableProvider, "CHACHA20-POLY1305", "Alg.Alias.AlgorithmParameters."), aSN1ObjectIdentifier, configurableProvider, "CHACHA20-POLY1305", "Alg.Alias.Cipher.OID."), aSN1ObjectIdentifier, configurableProvider, "CHACHA20-POLY1305", "Alg.Alias.AlgorithmParameters.OID."), aSN1ObjectIdentifier, configurableProvider, "CHACHA20-POLY1305");
        }
    }
