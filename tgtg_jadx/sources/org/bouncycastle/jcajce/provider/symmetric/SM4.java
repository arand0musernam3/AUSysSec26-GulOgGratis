...
public final class SM4 {
    ...
    public static class Mappings extends SymmetricAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            addCMacAlgorithm(configurableProvider, "SM4", k.p(a.m(a.m(a.m(a.m(sb2, str, "$AlgParams", configurableProvider, "AlgorithmParameters.SM4"), str, "$AlgParamGen", configurableProvider, "AlgorithmParameterGenerator.SM4"), str, "$ECB", configurableProvider, "Cipher.SM4"), str, "$KeyGen", configurableProvider, "KeyGenerator.SM4"), str, "$CMAC"), k.l(str, "$KeyGen"));
            addGMacAlgorithm(configurableProvider, "SM4", k.l(str, "$GMAC"), k.l(str, "$KeyGen"));
            addPoly1305Algorithm(configurableProvider, "SM4", k.l(str, "$Poly1305"), k.l(str, "$Poly1305KeyGen"));
        }
    }
