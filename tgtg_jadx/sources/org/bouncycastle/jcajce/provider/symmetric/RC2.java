...
public final class RC2 {
    ...
    public static class AlgParamGen extends BaseAlgorithmParameterGenerator {
        ...
        public void engineInit(AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) throws InvalidAlgorithmParameterException {
            if (algorithmParameterSpec instanceof RC2ParameterSpec) {
                ...
                i1.v("No supported AlgorithmParameterSpec for RC2 parameter generation.");
            }
        }
    }
    ...
    public static class Mappings extends AlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            a.w(new StringBuilder(), str, "$CBCMAC", configurableProvider, "Mac.RC2MAC");
            configurableProvider.addAlgorithm("Mac.RC2MAC/CFB8", a.e("Alg.Alias.Mac.RC2", "RC2MAC", configurableProvider, str, "$CFB8MAC"));
            ...
            a.w(a.m(a.m(a.m(a.m(a.q(configurableProvider, "Alg.Alias.SecretKeyFactory.1.2.840.113549.1.12.1.5", "PBEWITHSHAAND128BITRC2-CBC", "Alg.Alias.SecretKeyFactory.1.2.840.113549.1.12.1.6", "PBEWITHSHAAND40BITRC2-CBC"), str, "$PBEWithMD2KeyFactory", configurableProvider, "SecretKeyFactory.PBEWITHMD2ANDRC2"), str, "$PBEWithMD5KeyFactory", configurableProvider, "SecretKeyFactory.PBEWITHMD5ANDRC2"), str, "$PBEWithSHA1KeyFactory", configurableProvider, "SecretKeyFactory.PBEWITHSHA1ANDRC2"), str, "$PBEWithSHAAnd128BitKeyFactory", configurableProvider, "SecretKeyFactory.PBEWITHSHAAND128BITRC2-CBC"), str, "$PBEWithSHAAnd40BitKeyFactory", configurableProvider, "SecretKeyFactory.PBEWITHSHAAND40BITRC2-CBC");
            ...
            a.w(a.q(configurableProvider, "Alg.Alias.Cipher.PBEWITHSHA1AND128BITRC2-CBC", "PBEWITHSHAAND128BITRC2-CBC", "Alg.Alias.Cipher.PBEWITHSHA1AND40BITRC2-CBC", "PBEWITHSHAAND40BITRC2-CBC"), str, "$PBEWithSHA1AndRC2", configurableProvider, "Cipher.PBEWITHSHA1ANDRC2");
            a.w(a.m(a.m(a.q(configurableProvider, "Alg.Alias.Cipher.PBEWITHSHAANDRC2-CBC", "PBEWITHSHA1ANDRC2", "Alg.Alias.Cipher.PBEWITHSHA1ANDRC2-CBC", "PBEWITHSHA1ANDRC2"), str, "$PBEWithSHAAnd128BitRC2", configurableProvider, "Cipher.PBEWITHSHAAND128BITRC2-CBC"), str, "$PBEWithSHAAnd40BitRC2", configurableProvider, "Cipher.PBEWITHSHAAND40BITRC2-CBC"), str, "$PBEWithMD5AndRC2", configurableProvider, "Cipher.PBEWITHMD5ANDRC2");
    ...
    public static class AlgParams extends BaseAlgorithmParameters {
        ...
        public byte[] engineGetEncoded(String str) throws IOException {
            if (isASN1FormatString(str)) {
                ...
                return i11 == -1 ? new RC2CBCParameter(engineGetEncoded()).getEncoded() : new RC2CBCParameter(i11, engineGetEncoded()).getEncoded();
            }
            if (str.equals("RAW")) {
        ...
        public void engineInit(byte[] bArr, String str) throws IOException {
            if (isASN1FormatString(str)) {
                ...
                this.f33307iv = rC2CBCParameter.getIV();
                return;
            }
            if (str.equals("RAW")) {
                engineInit(bArr);
        ...
        public AlgorithmParameterSpec localEngineGetParameterSpec(Class cls) throws InvalidParameterSpecException {
            ...
            if ((cls == RC2ParameterSpec.class || cls == AlgorithmParameterSpec.class) && (i11 = this.parameterVersion) != -1) {
                return i11 < 256 ? new RC2ParameterSpec(ekb[this.parameterVersion], this.f33307iv) : new RC2ParameterSpec(this.parameterVersion, this.f33307iv);
            }
            if (cls == IvParameterSpec.class) {
                return new IvParameterSpec(this.f33307iv);
            }
            i1.u("unknown parameter spec passed to RC2 parameters object.");
            return null;
        }

        @Override // java.security.AlgorithmParametersSpi
        public byte[] engineGetEncoded() {
            return Arrays.clone(this.f33307iv);
        }

        @Override // java.security.AlgorithmParametersSpi
        public void engineInit(byte[] bArr) throws IOException {
            this.f33307iv = Arrays.clone(bArr);
        }

        @Override // java.security.AlgorithmParametersSpi
        public void engineInit(AlgorithmParameterSpec algorithmParameterSpec) throws InvalidParameterSpecException {
            if (algorithmParameterSpec instanceof IvParameterSpec) {
                this.f33307iv = ((IvParameterSpec) algorithmParameterSpec).getIV();
                return;
            }
            if (!(algorithmParameterSpec instanceof RC2ParameterSpec)) {
                i1.u("IvParameterSpec or RC2ParameterSpec required to initialise a RC2 parameters algorithm parameters object");
                return;
            }
            ...
            if (effectiveKeyBits != -1) {
                ...
                if (effectiveKeyBits < 256) {
                    i11 = table[effectiveKeyBits];
                }
                this.parameterVersion = i11;
            }
            this.f33307iv = rC2ParameterSpec.getIV();
        }
    }
}
