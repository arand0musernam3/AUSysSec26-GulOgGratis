...
public final class ARIA {
    ...
    public static class Mappings extends SymmetricAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            a.w(sb2, str, "$AlgParams", configurableProvider, "AlgorithmParameters.ARIA");
            ...
            a.x(a.r(configurableProvider, "Alg.Alias.AlgorithmParameters", "ARIA", str, aSN1ObjectIdentifier3), "$AlgParamGen", configurableProvider, "AlgorithmParameterGenerator.ARIA");
            ...
            a.x(a.r(configurableProvider, "Alg.Alias.AlgorithmParameterGenerator", "ARIA", str, aSN1ObjectIdentifier9), "$ECB", configurableProvider, "Cipher.ARIA");
            ...
            configurableProvider.addAlgorithm("Cipher.ARIAWRAPPAD", a.e("Alg.Alias.Cipher.ARIAKW", "ARIAWRAP", configurableProvider, str, "$WrapPad"));
            ...
            a.w(new StringBuilder(), str, "$KeyFactory", configurableProvider, "SecretKeyFactory.ARIA");
            ...
            StringBuilder sbR2 = a.r(configurableProvider, "Alg.Alias.SecretKeyFactory", "ARIA", str, aSN1ObjectIdentifier3);
            sbR2.append("$AlgParamGen");
            configurableProvider.addAlgorithm("AlgorithmParameterGenerator.ARIACCM", sbR2.toString());
            a.x(a.p(s.r(s.r(new StringBuilder("Alg.Alias.AlgorithmParameterGenerator."), aSN1ObjectIdentifier19, configurableProvider, "ARIACCM", "Alg.Alias.AlgorithmParameterGenerator."), aSN1ObjectIdentifier20, configurableProvider, "ARIACCM", "Alg.Alias.AlgorithmParameterGenerator."), aSN1ObjectIdentifier21, configurableProvider, "ARIACCM", str), "$CCM", configurableProvider, "Cipher.ARIACCM");
            ...
            StringBuilder sbR3 = a.r(configurableProvider, "Alg.Alias.Cipher", "CCM", str, aSN1ObjectIdentifier21);
            sbR3.append("$AlgParamGen");
            configurableProvider.addAlgorithm("AlgorithmParameterGenerator.ARIAGCM", sbR3.toString());
            ...
            StringBuilder sbR4 = a.r(configurableProvider, "Alg.Alias.Cipher", "ARIAGCM", str, aSN1ObjectIdentifier24);
            sbR4.append("$GMAC");
            addGMacAlgorithm(configurableProvider, "ARIA", sbR4.toString(), k.l(str, "$KeyGen"));
            addPoly1305Algorithm(configurableProvider, "ARIA", k.l(str, "$Poly1305"), k.l(str, "$Poly1305KeyGen"));
        }
    }
    ...
    public static class KeyGen extends BaseKeyGenerator {
        public KeyGen(int i11) {
            super("ARIA", i11, new CipherKeyGenerator());
        }
