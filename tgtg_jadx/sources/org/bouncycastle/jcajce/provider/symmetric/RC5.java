...
public final class RC5 {
    ...
    public static class Mappings extends AlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            a.w(sb2, str, "$ECB32", configurableProvider, "Cipher.RC5");
            a.w(a.m(a.m(a.m(a.q(configurableProvider, "KeyGenerator.RC5", a.e("Cipher.RC5-64", a.e("Alg.Alias.Cipher.RC5-32", "RC5", configurableProvider, str, "$ECB64"), configurableProvider, str, "$KeyGen32"), "Alg.Alias.KeyGenerator.RC5-32", "RC5"), str, "$KeyGen64", configurableProvider, "KeyGenerator.RC5-64"), str, "$AlgParams", configurableProvider, "AlgorithmParameters.RC5"), str, "$AlgParams", configurableProvider, "AlgorithmParameters.RC5-64"), str, "$Mac32", configurableProvider, "Mac.RC5MAC");
            configurableProvider.addAlgorithm("Mac.RC5MAC/CFB8", a.e("Alg.Alias.Mac.RC5", "RC5MAC", configurableProvider, str, "$CFB8Mac32"));
