...
public final class Noekeon {
    ...
    public static class Mappings extends SymmetricAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            addGMacAlgorithm(configurableProvider, "NOEKEON", k.p(a.m(a.m(a.m(a.m(sb2, str, "$AlgParams", configurableProvider, "AlgorithmParameters.NOEKEON"), str, "$AlgParamGen", configurableProvider, "AlgorithmParameterGenerator.NOEKEON"), str, "$ECB", configurableProvider, "Cipher.NOEKEON"), str, "$KeyGen", configurableProvider, "KeyGenerator.NOEKEON"), str, "$GMAC"), k.l(str, "$KeyGen"));
            addPoly1305Algorithm(configurableProvider, "NOEKEON", k.l(str, "$Poly1305"), k.l(str, "$Poly1305KeyGen"));
        }
    }
