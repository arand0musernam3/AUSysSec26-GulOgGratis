...
public final class SipHash {
    ...
    public static class Mappings extends AlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            a.w(sb2, str, "$Mac24", configurableProvider, "Mac.SIPHASH-2-4");
            configurableProvider.addAlgorithm("KeyGenerator.SIPHASH", a.e("Mac.SIPHASH-4-8", a.e("Alg.Alias.Mac.SIPHASH", "SIPHASH-2-4", configurableProvider, str, "$Mac48"), configurableProvider, str, "$KeyGen"));
