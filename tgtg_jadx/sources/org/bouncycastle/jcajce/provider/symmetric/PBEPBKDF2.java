...
public class PBEPBKDF2 {
    ...
    public static class Mappings extends AlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            a.x(a.p(sb3, aSN1ObjectIdentifier, configurableProvider, "PBKDF2", str), "$PBKDF2withUTF8", configurableProvider, "SecretKeyFactory.PBKDF2");
    ...
    public static class BasePBKDF2 extends BaseSecretKeyFactory {
        ...
        private int getDigestCode(ASN1ObjectIdentifier aSN1ObjectIdentifier) throws InvalidKeySpecException {
            ...
            throw new InvalidKeySpecException(s.l("Invalid KeySpec: unknown PRF algorithm ", aSN1ObjectIdentifier));
        }
    ...
    public static class AlgParams extends BaseAlgorithmParameters {
        ...
        public byte[] engineGetEncoded() {
            try {
                ...
                throw new RuntimeException("Oooops! " + e5.toString());
            }
        }
        ...
        public void engineInit(AlgorithmParameterSpec algorithmParameterSpec) throws InvalidParameterSpecException {
            if (!(algorithmParameterSpec instanceof PBEParameterSpec)) {
                i1.u("PBEParameterSpec required to initialise a PBKDF2 PBE parameters algorithm parameters object");
            } else {
        ...
        public AlgorithmParameterSpec localEngineGetParameterSpec(Class cls) throws InvalidParameterSpecException {
            ...
            i1.u("unknown parameter spec passed to PBKDF2 PBE parameters object.");
            return null;
        }
        ...
        public void engineInit(byte[] bArr, String str) throws IOException {
            if (isASN1FormatString(str)) {
                ...
                i4.a.k("Unknown parameters format in PBKDF2 parameters object");
            }
        }
