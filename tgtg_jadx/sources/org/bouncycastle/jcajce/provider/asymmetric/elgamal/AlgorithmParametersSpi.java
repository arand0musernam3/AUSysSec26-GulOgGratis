...
public class AlgorithmParametersSpi extends BaseAlgorithmParameters {
    ...
    public byte[] engineGetEncoded() {
        try {
            ...
            d0.k("Error encoding ElGamalParameters");
            return null;
        }
    }
    ...
    public void engineInit(AlgorithmParameterSpec algorithmParameterSpec) throws InvalidParameterSpecException {
        ...
        if (!z11 && !(algorithmParameterSpec instanceof DHParameterSpec)) {
            i1.u("DHParameterSpec required to initialise a ElGamal algorithm parameters object");
        } else if (z11) {
    ...
    public AlgorithmParameterSpec localEngineGetParameterSpec(Class cls) throws InvalidParameterSpecException {
        ...
        i1.u("unknown parameter spec passed to ElGamal parameters object.");
        return null;
    }
    ...
    public void engineInit(byte[] bArr) throws IOException {
        try {
            ...
            a.k("Not a valid ElGamal Parameter encoding.");
