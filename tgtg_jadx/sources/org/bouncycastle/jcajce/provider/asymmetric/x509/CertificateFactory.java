...
public class CertificateFactory extends CertificateFactorySpi {
    ...
    private CRL doGenerateCRL(InputStream inputStream, boolean z11) throws CRLException {
        ...
        try {
            ...
            inputStream.reset();
            return i11 != 48 ? readPEMCRL(inputStream, z11) : readDERCRL(new ASN1InputStream(inputStream, true));
    ...
    private Certificate doGenerateCertificate(InputStream inputStream, boolean z11) throws CertificateException {
        ...
        try {
            ...
            inputStream.reset();
            return i11 != 48 ? readPEMCertificate(inputStream, z11) : readDERCertificate(new ASN1InputStream(inputStream));
        } catch (Exception e5) {
            throw new ExCertificateException(k.j(e5, new StringBuilder("parsing issue: ")), e5);
        }
    }
    ...
    private CRL readPEMCRL(InputStream inputStream, boolean z11) throws IOException, CRLException {
        return getCRL(PEM_CRL_PARSER.readPEMObject(inputStream, z11));
    }

    private Certificate readPEMCertificate(InputStream inputStream, boolean z11) throws CertificateParsingException, IOException {
