...
class X509SignatureUtil {
    ...
    public static byte[] getExtensionValue(Extensions extensions, String str) {
        ...
        try {
            ...
            throw Exceptions.illegalStateException("error parsing " + e5.getMessage(), e5);
        }
    }
    ...
    public static void prettyPrintSignature(byte[] bArr, StringBuffer stringBuffer, String str) {
        ...
        while (i11 < bArr.length) {
            ...
            stringBuffer.append("                       ");
            stringBuffer.append(i11 < length2 ? Hex.toHexString(bArr, i11, 20) : Hex.toHexString(bArr, i11, bArr.length - i11));
            stringBuffer.append(str);
            i11 += 20;
        }
    }
