...
class X509CertificateObject extends X509CertificateImpl implements PKCS12BagAttributeCarrier {
    ...
    private static BasicConstraints createBasicConstraints(Certificate certificate) throws CertificateParsingException {
        try {
            ...
            throw new CertificateParsingException(i.l("cannot construct BasicConstraints: ", e5));
        }
    }
    ...
    private static String createSigAlgName(Certificate certificate) throws CertificateParsingException {
        try {
            ...
            throw new CertificateParsingException(i.l("cannot construct SigAlgName: ", e5));
        }
    }
    ...
    private static byte[] createSigAlgParams(Certificate certificate) throws CertificateParsingException {
        try {
            ...
            throw new CertificateParsingException(i.l("cannot construct SigAlgParams: ", e5));
        }
    }
    ...
    private X509CertificateInternal getInternalCertificate() throws IOException {
        ...
        synchronized (this.cacheLock) {
            try {
                ...
                try {
                    encoded = this.f33300c.getEncoded(ASN1Encoding.DER);
                    x509CertificateEncodingException = null;
                } catch (IOException e5) {
                    encoded = null;
                    x509CertificateEncodingException = new X509CertificateEncodingException(e5);
                }
                X509CertificateInternal x509CertificateInternal3 = new X509CertificateInternal(this.bcHelper, this.f33300c, this.basicConstraints, this.keyUsage, this.sigAlgName, this.sigAlgParams, encoded, x509CertificateEncodingException);
                synchronized (this.cacheLock) {
                    try {
    ...
    public boolean equals(Object obj) throws IOException {
        ...
        if (obj instanceof X509CertificateObject) {
            ...
            } else if ((this.internalCertificateValue == null || x509CertificateObject.internalCertificateValue == null) && (signature = this.f33300c.getSignature()) != null && !signature.equals((ASN1Primitive) x509CertificateObject.f33300c.getSignature())) {
                return false;
            }
