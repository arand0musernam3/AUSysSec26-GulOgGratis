...
class X509CRLObject extends X509CRLImpl {
    ...
    private static String createSigAlgName(CertificateList certificateList) throws CRLException {
        try {
            ...
            throw new X509CRLException(k.j(e5, new StringBuilder("CRL contents invalid: ")), e5);
        }
    }
    ...
    private static byte[] createSigAlgParams(CertificateList certificateList) throws CRLException {
        try {
            ...
            throw new CRLException(i.l("CRL contents invalid: ", e5));
        }
    }
    ...
    private X509CRLInternal getInternalCRL() throws IOException {
        ...
        synchronized (this.cacheLock) {
            try {
                ...
                try {
                    encoded = this.f33299c.getEncoded(ASN1Encoding.DER);
                    x509CRLException = null;
                } catch (IOException e5) {
                    encoded = null;
                    x509CRLException = new X509CRLException(e5);
                }
                X509CRLInternal x509CRLInternal3 = new X509CRLInternal(this.bcHelper, this.f33299c, this.sigAlgName, this.sigAlgParams, this.isIndirect, encoded, x509CRLException);
                synchronized (this.cacheLock) {
                    try {
    ...
    public boolean equals(Object obj) throws IOException {
        ...
        if (obj instanceof X509CRLObject) {
            ...
            } else if ((this.internalCRLValue == null || x509CRLObject.internalCRLValue == null) && (signature = this.f33299c.getSignature()) != null && !signature.equals((ASN1Primitive) x509CRLObject.f33299c.getSignature())) {
                return false;
            }
