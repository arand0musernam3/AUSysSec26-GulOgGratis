...
public class KeyPairGeneratorSpi extends KeyPairGenerator {
    ...
    private void init(GOST3410ParameterSpec gOST3410ParameterSpec, SecureRandom secureRandom) throws InvalidAlgorithmParameterException {
        ...
        if (byOIDX9 == null) {
            throw new InvalidAlgorithmParameterException(s.l("unknown curve: ", publicKeyParamSet));
        }
    ...
    public KeyPair generateKeyPair() {
        if (!this.initialised) {
            h2.b("EC Key Pair Generator not initialised");
            return null;
        }
    ...
    public void initialize(AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) throws InvalidAlgorithmParameterException {
        ...
        if (z11 || (algorithmParameterSpec instanceof ECNamedCurveGenParameterSpec)) {
            init(new GOST3410ParameterSpec(z11 ? ((ECGenParameterSpec) algorithmParameterSpec).getName() : ((ECNamedCurveGenParameterSpec) algorithmParameterSpec).getName()), secureRandom);
            return;
        }
