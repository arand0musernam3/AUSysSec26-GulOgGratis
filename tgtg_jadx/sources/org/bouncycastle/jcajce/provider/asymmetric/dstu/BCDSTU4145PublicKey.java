...
public class BCDSTU4145PublicKey implements ECPublicKey, org.bouncycastle.jce.interfaces.ECPublicKey, ECPointEncoder {
    ...
    private void populateFromPubKeyInfo(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        ...
        try {
            ...
            if (aSN1Sequence.getObjectAt(0) instanceof ASN1Integer) {
                ...
                boolean zIsNamedCurve = dSTU4145Params.isNamedCurve();
                DSTU4145Params dSTU4145Params2 = this.dstuParams;
                if (zIsNamedCurve) {
                    ASN1ObjectIdentifier namedCurve = dSTU4145Params2.getNamedCurve();
                    ...
                    DSTU4145ECBinary eCBinary = dSTU4145Params2.getECBinary();
    ...
    public org.bouncycastle.math.ec.ECPoint getQ() {
        org.bouncycastle.math.ec.ECPoint q7 = this.ecPublicKey.getQ();
        return this.ecSpec == null ? q7.getDetachedPoint() : q7;
    }
