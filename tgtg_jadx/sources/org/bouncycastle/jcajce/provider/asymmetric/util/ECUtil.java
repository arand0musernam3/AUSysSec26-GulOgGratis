...
public class ECUtil {
    public static int[] convertMidTerms(int[] iArr) {
        ...
        if (iArr.length != 3) {
            a.f("Only Trinomials and pentanomials supported");
            return null;
        }
        int i12 = iArr[0];
        int i13 = iArr[1];
    ...
    public static AsymmetricKeyParameter generatePrivateKeyParameter(PrivateKey privateKey) throws InvalidKeyException {
        ...
        try {
            ...
            org.bouncycastle.jce.provider.a.i("can't identify EC private key.");
            return null;
        } catch (Exception e5) {
            throw new InvalidKeyException(s.i(e5, new StringBuilder("cannot identify EC private key: ")));
        }
    }
    ...
    public static AsymmetricKeyParameter generatePublicKeyParameter(PublicKey publicKey) throws InvalidKeyException {
        ...
        try {
            ...
            org.bouncycastle.jce.provider.a.i("cannot identify EC public key.");
            return null;
        } catch (Exception e5) {
            throw new InvalidKeyException(s.i(e5, new StringBuilder("cannot identify EC public key: ")));
        }
    }
