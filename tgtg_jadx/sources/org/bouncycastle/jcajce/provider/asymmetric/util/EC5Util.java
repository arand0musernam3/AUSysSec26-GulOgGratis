...
public class EC5Util {
    ...
    public static ECCurve convertCurve(EllipticCurve ellipticCurve) {
        ...
        if (field instanceof ECFieldFp) {
            return CustomCurves.substitute(new ECCurve.Fp(((ECFieldFp) field).getP(), a11, b8, null, null));
        }
        ECFieldF2m eCFieldF2m = (ECFieldF2m) field;
        int m11 = eCFieldF2m.getM();
        int[] iArrConvertMidTerms = ECUtil.convertMidTerms(eCFieldF2m.getMidTermsOfReductionPolynomial());
        return new ECCurve.F2m(m11, iArrConvertMidTerms[0], iArrConvertMidTerms[1], iArrConvertMidTerms[2], a11, b8, (BigInteger) null, (BigInteger) null);
    }
    ...
    public static ECParameterSpec convertSpec(java.security.spec.ECParameterSpec eCParameterSpec) {
        ...
        return eCParameterSpec instanceof ECNamedCurveSpec ? new ECNamedCurveParameterSpec(((ECNamedCurveSpec) eCParameterSpec).getName(), eCCurveConvertCurve, eCPointConvertPoint, order, bigIntegerValueOf, seed) : new ECParameterSpec(eCCurveConvertCurve, eCPointConvertPoint, order, bigIntegerValueOf, seed);
    }
    ...
    public static java.security.spec.ECParameterSpec convertToSpec(X962Parameters x962Parameters, ECCurve eCCurve) {
        ...
        if (aSN1Sequence.size() > 3) {
            ...
            return x9ECParameters.getH() != null ? new java.security.spec.ECParameterSpec(ellipticCurveConvertCurve, convertPoint(x9ECParameters.getG()), x9ECParameters.getN(), x9ECParameters.getH().intValue()) : new java.security.spec.ECParameterSpec(ellipticCurveConvertCurve, convertPoint(x9ECParameters.getG()), x9ECParameters.getN(), 1);
        }
    ...
    public static org.bouncycastle.math.ec.ECPoint convertPoint(java.security.spec.ECParameterSpec eCParameterSpec, ECPoint eCPoint) {
