    ...
    public static class OAEP extends AlgorithmParametersSpi {
        ...
        public byte[] engineGetEncoded() {
            ...
            try {
                ...
                d0.k("Error encoding OAEPParameters");
                return null;
            }
        }
        ...
        public void engineInit(byte[] bArr) throws IOException {
            try {
                ...
                a.k("Not a valid OAEP Parameter encoding.");
        ...
        public AlgorithmParameterSpec localEngineGetParameterSpec(Class cls) throws InvalidParameterSpecException {
            ...
            i1.u("unknown parameter spec passed to OAEP parameters object.");
            return null;
        }
        ...
        public void engineInit(AlgorithmParameterSpec algorithmParameterSpec) throws InvalidParameterSpecException {
            if (algorithmParameterSpec instanceof OAEPParameterSpec) {
                ...
                i1.u("OAEPParameterSpec required to initialise an OAEP algorithm parameters object");
            }
        }
    ...
    public static class PSS extends AlgorithmParametersSpi {
        ...
        public void engineInit(byte[] bArr) throws IOException {
            try {
                ...
                a.k("Not a valid PSS Parameter encoding.");
            } catch (ClassCastException unused2) {
                a.k("Not a valid PSS Parameter encoding.");
            }
        }
        ...
        public AlgorithmParameterSpec localEngineGetParameterSpec(Class cls) throws InvalidParameterSpecException {
            ...
            i1.u("unknown parameter spec passed to PSS parameters object.");
            return null;
        }
        ...
        public void engineInit(AlgorithmParameterSpec algorithmParameterSpec) throws InvalidParameterSpecException {
            if (algorithmParameterSpec instanceof PSSParameterSpec) {
                ...
                i1.u("PSSParameterSpec required to initialise an PSS algorithm parameters object");
            }
        }
