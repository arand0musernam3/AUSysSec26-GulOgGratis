...
public class PSSSignatureSpi extends SignatureSpi {
    ...
    public void engineInitSign(PrivateKey privateKey) throws InvalidKeyException {
        if (!(privateKey instanceof RSAPrivateKey)) {
            org.bouncycastle.jce.provider.a.i("Supplied key is not a RSAPrivateKey instance");
            return;
        }
    ...
    public void engineInitVerify(PublicKey publicKey) throws InvalidKeyException {
        if (!(publicKey instanceof RSAPublicKey)) {
            org.bouncycastle.jce.provider.a.i("Supplied key is not a RSAPublicKey instance");
            return;
        }
    ...
    public void engineSetParameter(AlgorithmParameterSpec algorithmParameterSpec) throws InvalidAlgorithmParameterException {
        ...
        if (!(algorithmParameterSpec instanceof PSSParameterSpec)) {
            i1.v("Only PSSParameterSpec supported");
            return;
        }
        ...
        if (this.key != null) {
            ...
            boolean zIsPrivate = this.key.isPrivate();
