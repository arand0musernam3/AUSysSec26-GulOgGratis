...
public class RSA {
    ...
    public static class Mappings extends AsymmetricAlgorithmProvider {
        private void addDigestSignature(ConfigurableProvider configurableProvider, String str, String str2, ASN1ObjectIdentifier aSN1ObjectIdentifier) {
            String strL = k.l(str, "WITHRSA");
            String strL2 = k.l(str, "withRSA");
            String strL3 = k.l(str, "WithRSA");
            String strL4 = k.l(str, "/RSA");
            String strL5 = k.l(str, "WITHRSAENCRYPTION");
            String strL6 = k.l(str, "withRSAEncryption");
            String strL7 = k.l(str, "WithRSAEncryption");
            configurableProvider.addAlgorithm("Signature.".concat(strL), str2);
            configurableProvider.addAlgorithm("Alg.Alias.Signature.".concat(strL2), strL);
            configurableProvider.addAlgorithm("Alg.Alias.Signature.".concat(strL3), strL);
            configurableProvider.addAlgorithm("Alg.Alias.Signature.".concat(strL5), strL);
            configurableProvider.addAlgorithm("Alg.Alias.Signature.".concat(strL6), strL);
            configurableProvider.addAlgorithm("Alg.Alias.Signature.".concat(strL7), strL);
            configurableProvider.addAlgorithm("Alg.Alias.Signature.".concat(strL4), strL);
            if (aSN1ObjectIdentifier != null) {
                configurableProvider.addAlgorithm("Alg.Alias.Signature." + aSN1ObjectIdentifier, strL);
                a.y(new StringBuilder("Alg.Alias.Signature.OID."), aSN1ObjectIdentifier, configurableProvider, strL);
            }
            configurableProvider.addAttributes("Signature.".concat(strL), RSA.generalRsaAttributes);
        }

        private void addISO9796Signature(ConfigurableProvider configurableProvider, String str, String str2) {
            StringBuilder sbL = a.l(str, "WITHRSA/ISO9796-2", configurableProvider, k.p(a.l(str, "WITHRSA/ISO9796-2", configurableProvider, a0.p("Alg.Alias.Signature.", str, "withRSA/ISO9796-2"), "Alg.Alias.Signature."), str, "WithRSA/ISO9796-2"), "Signature.");
            sbL.append(str);
            sbL.append("WITHRSA/ISO9796-2");
            configurableProvider.addAlgorithm(sbL.toString(), str2);
            configurableProvider.addAttributes(a0.p("Signature.", str, "WITHRSA/ISO9796-2"), RSA.generalRsaAttributes);
        }

        private void addPSSSignature(ConfigurableProvider configurableProvider, String str, String str2, String str3) {
            String strK = f.k("WITHRSAAND", str2);
            if (str2.equals("MGF1")) {
                configurableProvider.addAlgorithm(k.p(a.l(str, strK, configurableProvider, k.p(a.l(str, strK, configurableProvider, k.p(a.l(str, strK, configurableProvider, k.p(a.l(str, strK, configurableProvider, k.p(a.l(str, strK, configurableProvider, a0.p("Alg.Alias.Signature.", str, "withRSA/PSS"), "Alg.Alias.Signature."), str, "WithRSA/PSS"), "Alg.Alias.Signature."), str, "WITHRSA/PSS"), "Alg.Alias.Signature."), str, "withRSASSA-PSS"), "Alg.Alias.Signature."), str, "WithRSASSA-PSS"), "Alg.Alias.Signature."), str, "WITHRSASSA-PSS"), str + strK);
            }
            configurableProvider.addAlgorithm(f.n(a.l(str, strK, configurableProvider, f.n(a.l(str, strK, configurableProvider, s.k("Alg.Alias.Signature.", str, "withRSAand", str2), "Alg.Alias.Signature."), str, "WithRSAAnd", str2), "Signature."), str, "WITHRSAAND", str2), str3);
            StringBuilder sb2 = new StringBuilder("Signature.");
            sb2.append(str);
            configurableProvider.addAttributes(k.p(sb2, "WITHRSAAND", str2), RSA.generalRsaAttributes);
        }

        private void addX931Signature(ConfigurableProvider configurableProvider, String str, String str2) {
            StringBuilder sbL = a.l(str, "WITHRSA/X9.31", configurableProvider, k.p(a.l(str, "WITHRSA/X9.31", configurableProvider, a0.p("Alg.Alias.Signature.", str, "withRSA/X9.31"), "Alg.Alias.Signature."), str, "WithRSA/X9.31"), "Signature.");
            sbL.append(str);
            sbL.append("WITHRSA/X9.31");
            configurableProvider.addAlgorithm(sbL.toString(), str2);
            configurableProvider.addAttributes(a0.p("Signature.", str, "WITHRSA/X9.31"), RSA.generalRsaAttributes);
        }
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            configurableProvider.addAlgorithm(a.j(configurableProvider, "Alg.Alias.Signature." + aSN1ObjectIdentifier4, "RSASSA-PSS", "Alg.Alias.Signature.OID.", aSN1ObjectIdentifier4), "RSASSA-PSS");
            ...
            if (configurableProvider.hasAlgorithm("MessageDigest", "SHA1")) {
                ...
                a.y(s.r(sb2, aSN1ObjectIdentifier5, configurableProvider, "SHA1WITHRSA", "Alg.Alias.Signature.OID."), aSN1ObjectIdentifier5, configurableProvider, "SHA1WITHRSA");
        ...
        private void addPSSSignature(ConfigurableProvider configurableProvider, String str, String str2, ASN1ObjectIdentifier aSN1ObjectIdentifier) {
            configurableProvider.addAlgorithm(k.p(a.l(str, "WITHRSAPSS", configurableProvider, k.p(a.l(str, "WITHRSAPSS", configurableProvider, k.p(a.l(str, "WITHRSAPSS", configurableProvider, k.p(a.l(str, "WITHRSAPSS", configurableProvider, a0.p("Alg.Alias.Signature.", str, "withRSA/PSS"), "Alg.Alias.Signature."), str, "WithRSA/PSS"), "Alg.Alias.Signature."), str, "withRSASSA-PSS"), "Alg.Alias.Signature."), str, "WithRSASSA-PSS"), "Alg.Alias.Signature."), str, "WITHRSASSA-PSS"), str + "WITHRSAPSS");
            ...
            configurableProvider.addAttributes(a0.p("Signature.", str, "WITHRSAPSS"), RSA.generalRsaAttributes);
        }
    }
}
