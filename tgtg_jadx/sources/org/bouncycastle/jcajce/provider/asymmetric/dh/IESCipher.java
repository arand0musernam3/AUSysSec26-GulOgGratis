...
public class IESCipher extends BaseCipherSpi {
    ...
    public byte[] engineDoFinal(byte[] bArr, int i11, int i12) throws BadPaddingException, IllegalBlockSizeException {
            ...
            try {
                this.engine.init(this.key, iESWithCipherParameters, new EphemeralKeyPairGenerator(dHKeyPairGenerator, new KeyEncoder() { // from class: org.bouncycastle.jcajce.provider.asymmetric.dh.IESCipher.1
                    ...
                    public byte[] getEncoded(AsymmetricKeyParameter asymmetricKeyParameter2) {
                        ...
                        a.f("Senders's public key longer than expected.");
                        return null;
                    }
                }));
                return this.engine.processBlock(byteArray, 0, byteArray.length);
        ...
        if (i13 != 2 && i13 != 4) {
            h2.b("IESCipher not initialised");
            return null;
        }
        try {
        ...
        if (this.key != null) {
            ...
            if (this.engine.getCipher() != null) {
                ...
                if (i12 == 1 || i12 == 3) {
                    ...
                    cipher = this.engine.getCipher();
                    i11 = (i11 - macSize) - iBitLength;
                }
                i11 = cipher.getOutputSize(i11);
            }
            int i13 = this.state;
            if (i13 == 1 || i13 == 3) {
        ...
        if (i11 == 1 || i11 == 3) {
            if (!(key instanceof DHPublicKey)) {
                if (!(key instanceof IESKey)) {
                    org.bouncycastle.jce.provider.a.i("must be passed recipient's public DH key for encryption");
                    return;
                }
            ...
            if (key instanceof DHPrivateKey) {
                ...
                org.bouncycastle.jce.provider.a.i("must be passed recipient's private DH key for decryption");
                return;
            } else {
