...
public class BCDHPrivateKey implements DHPrivateKey, PKCS12BagAttributeCarrier {
    ...
    public BCDHPrivateKey(PrivateKeyInfo privateKeyInfo) throws IOException {
        ...
        this.f33282x = aSN1Integer.getValue();
        if (algorithm.equals((ASN1Primitive) PKCSObjectIdentifiers.dhKeyAgreement)) {
            ...
            if (dHParameter.getL() != null) {
                ...
                dHPrivateKeyParameters = new DHPrivateKeyParameters(this.f33282x, new DHParameters(dHParameter.getP(), dHParameter.getG(), null, dHParameter.getL().intValue()));
            } else {
                this.dhSpec = new DHParameterSpec(dHParameter.getP(), dHParameter.getG());
                dHPrivateKeyParameters = new DHPrivateKeyParameters(this.f33282x, new DHParameters(dHParameter.getP(), dHParameter.getG()));
            }
        } else {
            ...
            dHPrivateKeyParameters = new DHPrivateKeyParameters(this.f33282x, new DHParameters(domainParameters.getP(), domainParameters.getG(), domainParameters.getQ(), domainParameters.getJ(), (DHValidationParameters) null));
        }
    ...
    public DHPrivateKeyParameters engineGetKeyParameters() {
        ...
        boolean z11 = dHParameterSpec instanceof DHDomainParameterSpec;
        BigInteger bigInteger = this.f33282x;
        return z11 ? new DHPrivateKeyParameters(bigInteger, ((DHDomainParameterSpec) dHParameterSpec).getDomainParameters()) : new DHPrivateKeyParameters(bigInteger, new DHParameters(dHParameterSpec.getP(), this.dhSpec.getG(), null, this.dhSpec.getL()));
    }
    ...
    public String toString() {
        return DHUtil.privateKeyToString("DH", this.f33282x, new DHParameters(this.dhSpec.getP(), this.dhSpec.getG()));
    }

    public BCDHPrivateKey(DHPrivateKey dHPrivateKey) {
        this.f33282x = dHPrivateKey.getX();
        this.dhSpec = dHPrivateKey.getParams();
    }

    public BCDHPrivateKey(DHPrivateKeySpec dHPrivateKeySpec) {
        this.f33282x = dHPrivateKeySpec.getX();
    ...
    public BCDHPrivateKey(DHPrivateKeyParameters dHPrivateKeyParameters) {
        this.f33282x = dHPrivateKeyParameters.getX();
