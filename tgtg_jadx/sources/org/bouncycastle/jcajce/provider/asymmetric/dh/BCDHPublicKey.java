...
public class BCDHPublicKey implements DHPublicKey {
    ...
    private BigInteger f33283y;

    public BCDHPublicKey(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        this.info = subjectPublicKeyInfo;
        try {
            this.f33283y = ((ASN1Integer) subjectPublicKeyInfo.parsePublicKey()).getValue();
            ...
            if (algorithm.equals((ASN1Primitive) PKCSObjectIdentifiers.dhKeyAgreement) || isPKCSParam(aSN1Sequence)) {
                ...
                if (dHParameter.getL() != null) {
                    ...
                    this.dhPublicKey = new DHPublicKeyParameters(this.f33283y, new DHParameters(this.dhSpec.getP(), this.dhSpec.getG(), null, this.dhSpec.getL()));
                    return;
                } else {
                    this.dhSpec = new DHParameterSpec(dHParameter.getP(), dHParameter.getG());
                    this.dhPublicKey = new DHPublicKeyParameters(this.f33283y, new DHParameters(this.dhSpec.getP(), this.dhSpec.getG()));
                    return;
                }
            }
            if (!algorithm.equals((ASN1Primitive) X9ObjectIdentifiers.dhpublicnumber)) {
                a.f(s.l("unknown algorithm type: ", algorithm));
                throw null;
            }
            ...
            if (validationParams != null) {
                this.dhPublicKey = new DHPublicKeyParameters(this.f33283y, new DHParameters(domainParameters.getP(), domainParameters.getG(), domainParameters.getQ(), domainParameters.getJ(), new DHValidationParameters(validationParams.getSeed(), validationParams.getPgenCounter().intValue())));
            } else {
                this.dhPublicKey = new DHPublicKeyParameters(this.f33283y, new DHParameters(domainParameters.getP(), domainParameters.getG(), domainParameters.getQ(), domainParameters.getJ(), (DHValidationParameters) null));
            }
            this.dhSpec = new DHDomainParameterSpec(this.dhPublicKey.getParameters());
        } catch (IOException unused) {
            a.f("invalid info structure in DH public key");
            throw null;
        }
    }
    ...
    public byte[] getEncoded() {
        ...
        if (!(dHParameterSpec instanceof DHDomainParameterSpec) || ((DHDomainParameterSpec) dHParameterSpec).getQ() == null) {
            return KeyUtil.getEncodedSubjectPublicKeyInfo(new AlgorithmIdentifier(PKCSObjectIdentifiers.dhKeyAgreement, new DHParameter(this.dhSpec.getP(), this.dhSpec.getG(), this.dhSpec.getL()).toASN1Primitive()), new ASN1Integer(this.f33283y));
        }
    ...
    public String toString() {
        return DHUtil.publicKeyToString("DH", this.f33283y, new DHParameters(this.dhSpec.getP(), this.dhSpec.getG()));
    }

    public BCDHPublicKey(DHPublicKey dHPublicKey) {
        this.f33283y = dHPublicKey.getY();
        DHParameterSpec params = dHPublicKey.getParams();
        this.dhSpec = params;
        if (params instanceof DHDomainParameterSpec) {
            this.dhPublicKey = new DHPublicKeyParameters(this.f33283y, ((DHDomainParameterSpec) params).getDomainParameters());
        } else {
            this.dhPublicKey = new DHPublicKeyParameters(this.f33283y, new DHParameters(this.dhSpec.getP(), this.dhSpec.getG()));
        }
    }
    ...
    public BCDHPublicKey(DHPublicKeySpec dHPublicKeySpec) {
        this.f33283y = dHPublicKeySpec.getY();
        ...
        if (dHParameterSpec instanceof DHDomainParameterSpec) {
            this.dhPublicKey = new DHPublicKeyParameters(this.f33283y, ((DHDomainParameterSpec) dHParameterSpec).getDomainParameters());
        } else {
            this.dhPublicKey = new DHPublicKeyParameters(this.f33283y, new DHParameters(dHPublicKeySpec.getP(), dHPublicKeySpec.getG()));
        }
    }

    public BCDHPublicKey(BigInteger bigInteger, DHParameterSpec dHParameterSpec) {
        this.f33283y = bigInteger;
    ...
    public BCDHPublicKey(DHPublicKeyParameters dHPublicKeyParameters) {
        this.f33283y = dHPublicKeyParameters.getY();
