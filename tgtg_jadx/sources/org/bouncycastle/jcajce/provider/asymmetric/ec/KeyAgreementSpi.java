...
public class KeyAgreementSpi extends BaseAgreementSpi {
    ...
    public void doInitFromKey(Key key, AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) throws InvalidKeyException, InvalidAlgorithmParameterException {
        ...
        if (obj instanceof ECMQVBasicAgreement) {
            ...
            boolean z11 = key instanceof MQVPrivateKey;
            if (!z11 && !(algorithmParameterSpec instanceof MQVParameterSpec)) {
                StringBuilder sb2 = new StringBuilder();
                sb2.append(this.kaAlgorithm);
                sb2.append(" key agreement requires ");
                throw new InvalidAlgorithmParameterException(k.p(sb2, getSimpleName(MQVParameterSpec.class), " for initialisation"));
            }
            if (z11) {
        ...
        if (!(algorithmParameterSpec instanceof DHUParameterSpec)) {
            if (!(key instanceof PrivateKey)) {
                ...
                throw new InvalidKeyException(k.p(sb3, getSimpleName(ECPrivateKey.class), " for initialisation"));
            }
        ...
        if (this.parameters == null) {
            ...
            if (z11) {
                ...
                try {
                    ...
                    throw new InvalidKeyException(k.j(e5, new StringBuilder("calculation failed: "))) { // from class: org.bouncycastle.jcajce.provider.asymmetric.ec.KeyAgreementSpi.1
