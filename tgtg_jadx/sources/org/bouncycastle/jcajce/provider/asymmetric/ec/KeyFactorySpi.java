...
public class KeyFactorySpi extends BaseKeyFactorySpi implements AsymmetricKeyInfoConverter {
    ...
    public PrivateKey engineGeneratePrivate(KeySpec keySpec) throws InvalidKeySpecException {
        ...
        try {
            ...
            throw new InvalidKeySpecException(s.g(e5, new StringBuilder("bad encoding: ")));
        }
    }
    ...
    public PublicKey engineGeneratePublic(KeySpec keySpec) throws InvalidKeySpecException {
        try {
            ...
            throw new InvalidKeySpecException(k.j(e5, new StringBuilder("invalid KeySpec: ")), e5);
        }
    }
        ...
        if (cls.isAssignableFrom(OpenSSHPublicKeySpec.class) && (key instanceof ECPublicKey)) {
            ...
            if (key instanceof BCECPrivateKey) {
                try {
                    ...
                    iOException = e11;
                    sb2 = new StringBuilder("cannot encoded key: ");
                    strConcat = s.g(iOException, sb2);
                    a.f(strConcat);
                    return null;
                }
