...
class ECUtils {
    ...
    public static X962Parameters getDomainParametersFromName(ECParameterSpec eCParameterSpec, boolean z11) {
        if (!(eCParameterSpec instanceof ECNamedCurveSpec)) {
            ...
            return new X962Parameters(new X9ECParameters(eCCurveConvertCurve, new X9ECPoint(EC5Util.convertPoint(eCCurveConvertCurve, eCParameterSpec.getGenerator()), z11), eCParameterSpec.getOrder(), BigInteger.valueOf(eCParameterSpec.getCofactor()), eCParameterSpec.getCurve().getSeed()));
        }
