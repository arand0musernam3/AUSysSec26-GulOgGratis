    ...
    public static class Mappings extends AsymmetricAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            for (int i11 = 1; i11 <= 36; i11++) {
                ...
                configurableProvider.addAlgorithm("Alg.Alias.Signature.OID." + aSN1ObjectIdentifier + "." + i11, "SPHINCSPLUS");
            }
            ...
            for (int i12 = 0; i12 != 12; i12++) {
                StringBuilder sbR = s.r(new StringBuilder("Alg.Alias.Signature."), aSN1ObjectIdentifierArr[i12], configurableProvider, "SPHINCSPLUS", "Alg.Alias.Signature.OID.");
                sbR.append(aSN1ObjectIdentifierArr[i12]);
                configurableProvider.addAlgorithm(sbR.toString(), "SPHINCSPLUS");
            }
