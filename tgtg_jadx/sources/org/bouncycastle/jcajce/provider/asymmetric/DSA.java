    ...
    public static class Mappings extends AsymmetricAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            while (true) {
                ...
                a.y(new StringBuilder("Alg.Alias.Signature."), aSN1ObjectIdentifierArr[i11], configurableProvider, "DSA");
                registerOid(configurableProvider, aSN1ObjectIdentifierArr[i11], "DSA", keyFactorySpi);
                registerOidAlgorithmParameterGenerator(configurableProvider, aSN1ObjectIdentifierArr[i11], "DSA");
                i11++;
            }
        }
    }
