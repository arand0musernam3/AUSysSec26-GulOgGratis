...
public class BCECGOST3410_2012PublicKey implements ECPublicKey, org.bouncycastle.jce.interfaces.ECPublicKey, ECPointEncoder {
    ...
    private void populateFromPubKeyInfo(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        ...
        try {
            ...
            int i11 = algorithm.equals((ASN1Primitive) RosstandartObjectIdentifiers.id_tc26_gost_3410_12_512) ? 64 : 32;
            int i12 = i11 * 2;
    ...
    public byte[] getEncoded() {
        ...
        boolean z11 = bigInteger.bitLength() > 256;
    ...
    public GOST3410PublicKeyAlgParameters getGostParams() {
        if (this.gostParams == null && (this.ecSpec instanceof ECNamedCurveSpec)) {
            boolean z11 = this.ecPublicKey.getQ().getAffineXCoord().toBigInteger().bitLength() > 256;
    ...
    public ECPoint getQ() {
        ECParameterSpec eCParameterSpec = this.ecSpec;
        ECPublicKeyParameters eCPublicKeyParameters = this.ecPublicKey;
        return eCParameterSpec == null ? eCPublicKeyParameters.getQ().getDetachedPoint() : eCPublicKeyParameters.getQ();
    }
