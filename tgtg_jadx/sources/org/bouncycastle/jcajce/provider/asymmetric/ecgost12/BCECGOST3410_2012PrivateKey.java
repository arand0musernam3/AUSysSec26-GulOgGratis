...
public class BCECGOST3410_2012PrivateKey implements ECPrivateKey, org.bouncycastle.jce.interfaces.ECPrivateKey, PKCS12BagAttributeCarrier, ECPointEncoder {
    ...
    private transient BigInteger f33292d;
    ...
    public BCECGOST3410_2012PrivateKey(String str, ECPrivateKeyParameters eCPrivateKeyParameters, BCECGOST3410_2012PublicKey bCECGOST3410_2012PublicKey, org.bouncycastle.jce.spec.ECParameterSpec eCParameterSpec) {
        ...
        this.algorithm = str;
        this.f33292d = eCPrivateKeyParameters.getD();
    ...
    private void populateFromPrivKeyInfo(PrivateKeyInfo privateKeyInfo) throws IOException {
        ...
        if ((aSN1Primitive instanceof ASN1Sequence) && ASN1Sequence.getInstance(aSN1Primitive).size() <= 3) {
            ...
            if (privateKey.getOctets().length == 32 || privateKey.getOctets().length == 64) {
                this.f33292d = new BigInteger(1, Arrays.reverse(privateKey.getOctets()));
                return;
            }
            ASN1Encodable privateKey2 = privateKeyInfo.parsePrivateKey();
            if (privateKey2 instanceof ASN1Integer) {
                this.f33292d = ASN1Integer.getInstance(privateKey2).getPositiveValue();
                return;
            } else {
                this.f33292d = new BigInteger(1, Arrays.reverse(ASN1OctetString.getInstance(privateKey2).getOctets()));
                return;
            }
        }
    ...
    */
    ...
    public String toString() {
        return ECUtil.privateKeyToString(this.algorithm, this.f33292d, engineGetSpec());
    }
    ...
    public BCECGOST3410_2012PrivateKey(ECPrivateKey eCPrivateKey) {
        this.algorithm = "ECGOST3410-2012";
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.f33292d = eCPrivateKey.getS();
    ...
    public BCECGOST3410_2012PrivateKey(ECPrivateKeySpec eCPrivateKeySpec) {
        this.algorithm = "ECGOST3410-2012";
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.f33292d = eCPrivateKeySpec.getS();
    ...
    public BCECGOST3410_2012PrivateKey(BCECGOST3410_2012PrivateKey bCECGOST3410_2012PrivateKey) {
        this.algorithm = "ECGOST3410-2012";
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.f33292d = bCECGOST3410_2012PrivateKey.f33292d;
    ...
    public BCECGOST3410_2012PrivateKey(org.bouncycastle.jce.spec.ECPrivateKeySpec eCPrivateKeySpec) {
        this.algorithm = "ECGOST3410-2012";
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.f33292d = eCPrivateKeySpec.getD();
