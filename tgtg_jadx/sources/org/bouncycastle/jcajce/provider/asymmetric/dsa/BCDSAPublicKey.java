...
public class BCDSAPublicKey implements DSAPublicKey {
    ...
    private BigInteger f33288y;

    public BCDSAPublicKey(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        try {
            this.f33288y = ((ASN1Integer) subjectPublicKeyInfo.parsePublicKey()).getValue();
            ...
            this.lwKeyParams = new DSAPublicKeyParameters(this.f33288y, DSAUtil.toDSAParameters(this.dsaSpec));
        } catch (IOException unused) {
            a.f("invalid info structure in DSA public key");
            throw null;
        }
    }
    ...
    public byte[] getEncoded() {
        DSAParams dSAParams = this.dsaSpec;
        return dSAParams == null ? KeyUtil.getEncodedSubjectPublicKeyInfo(new AlgorithmIdentifier(X9ObjectIdentifiers.id_dsa), new ASN1Integer(this.f33288y)) : KeyUtil.getEncodedSubjectPublicKeyInfo(new AlgorithmIdentifier(X9ObjectIdentifiers.id_dsa, new DSAParameter(dSAParams.getP(), this.dsaSpec.getQ(), this.dsaSpec.getG()).toASN1Primitive()), new ASN1Integer(this.f33288y));
    }
    ...
    public String toString() {
        ...
        stringBuffer.append(DSAUtil.generateKeyFingerprint(this.f33288y, getParams()));
        stringBuffer.append("]");
    ...
    public BCDSAPublicKey(DSAPublicKeySpec dSAPublicKeySpec) {
        this.f33288y = dSAPublicKeySpec.getY();
        this.dsaSpec = new DSAParameterSpec(dSAPublicKeySpec.getP(), dSAPublicKeySpec.getQ(), dSAPublicKeySpec.getG());
        this.lwKeyParams = new DSAPublicKeyParameters(this.f33288y, DSAUtil.toDSAParameters(this.dsaSpec));
    }

    public BCDSAPublicKey(DSAPublicKey dSAPublicKey) {
        this.f33288y = dSAPublicKey.getY();
        this.dsaSpec = dSAPublicKey.getParams();
        this.lwKeyParams = new DSAPublicKeyParameters(this.f33288y, DSAUtil.toDSAParameters(this.dsaSpec));
    }

    public BCDSAPublicKey(DSAPublicKeyParameters dSAPublicKeyParameters) {
        this.f33288y = dSAPublicKeyParameters.getY();
