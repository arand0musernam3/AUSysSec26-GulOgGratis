...
public class AlgorithmParametersSpi extends java.security.AlgorithmParametersSpi {
    ...
    public byte[] engineGetEncoded() {
        try {
            ...
            d0.k("Error encoding GOST3410Parameters");
            return null;
        }
    }
    ...
    public AlgorithmParameterSpec localEngineGetParameterSpec(Class cls) throws InvalidParameterSpecException {
        ...
        i1.u("unknown parameter spec passed to GOST3410 parameters object.");
        return null;
    }
    ...
    public void engineInit(byte[] bArr) throws IOException {
        try {
            ...
            a.k("Not a valid GOST3410 Parameter encoding.");
    ...
    public void engineInit(AlgorithmParameterSpec algorithmParameterSpec) throws InvalidParameterSpecException {
        if (algorithmParameterSpec instanceof GOST3410ParameterSpec) {
            ...
            i1.u("GOST3410ParameterSpec required to initialise a GOST3410 algorithm parameters object");
        }
    }
