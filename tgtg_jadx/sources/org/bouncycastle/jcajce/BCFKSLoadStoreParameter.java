...
public class BCFKSLoadStoreParameter extends BCLoadStoreParameter {
    ...
    public static class Builder {
        ...
        public Builder(InputStream inputStream, CertChainValidator certChainValidator) {
            this.storeConfig = new PBKDF2Config.Builder().withIterationCount(BrotliInputStream.DEFAULT_INTERNAL_BUFFER_SIZE).withSaltLength(64).withPRF(PBKDF2Config.PRF_SHA512).build();
