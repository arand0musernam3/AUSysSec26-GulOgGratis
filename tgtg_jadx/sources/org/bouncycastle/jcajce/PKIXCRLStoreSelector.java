...
public class PKIXCRLStoreSelector<T extends CRL> implements Selector<T> {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:31:0x0064, code lost:
        ...
        if (org.bouncycastle.util.Arrays.areEqual(r0, r2) == false) goto L32;
     */
    ...
    */
    public boolean match(java.security.cert.CRL r5) {
        ...
        Lb:
            ...
            r1 = 0
            org.bouncycastle.asn1.ASN1ObjectIdentifier r2 = org.bouncycastle.asn1.x509.Extension.deltaCRLIndicator     // Catch: java.lang.Exception -> L66
            java.lang.String r2 = r2.getId()     // Catch: java.lang.Exception -> L66
            byte[] r2 = r0.getExtensionValue(r2)     // Catch: java.lang.Exception -> L66
            if (r2 == 0) goto L28
            org.bouncycastle.asn1.ASN1OctetString r2 = org.bouncycastle.asn1.ASN1OctetString.getInstance(r2)     // Catch: java.lang.Exception -> L66
            byte[] r2 = r2.getOctets()     // Catch: java.lang.Exception -> L66
            org.bouncycastle.asn1.ASN1Integer r2 = org.bouncycastle.asn1.ASN1Integer.getInstance(r2)     // Catch: java.lang.Exception -> L66
            goto L29
        L28:
            r2 = 0
        L29:
            if (r2 != 0) goto L32
            boolean r2 = r4.isDeltaCRLIndicatorEnabled()
            if (r2 == 0) goto L4b
            return r1
        L32:
