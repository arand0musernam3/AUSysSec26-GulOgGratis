...
public class KEMGenerateSpec extends KEMKDFSpec implements AlgorithmParameterSpec {
    ...
    public static final class Builder {
        ...
        public Builder(PublicKey publicKey, String str, int i11) {
    ...
    public KEMGenerateSpec(PublicKey publicKey, String str, int i11) {
        this(publicKey, str, i11, DefKdf, EMPTY_OTHER_INFO);
    }

    private KEMGenerateSpec(PublicKey publicKey, String str, int i11, AlgorithmIdentifier algorithmIdentifier, byte[] bArr) {
