...
public class KEMExtractSpec extends KEMKDFSpec implements AlgorithmParameterSpec {
    ...
    public static final class Builder {
        ...
        public Builder(PrivateKey privateKey, byte[] bArr, String str, int i11) {
    ...
    public KEMExtractSpec(PrivateKey privateKey, byte[] bArr, String str, int i11) {
        this(privateKey, bArr, str, i11, DefKdf, EMPTY_OTHER_INFO);
    }
    ...
    private KEMExtractSpec(PrivateKey privateKey, byte[] bArr, String str, int i11, AlgorithmIdentifier algorithmIdentifier, byte[] bArr2) {
        super(algorithmIdentifier, bArr2, str, i11);
        this.privateKey = privateKey;
        this.encapsulation = Arrays.clone(bArr);
    }
}
