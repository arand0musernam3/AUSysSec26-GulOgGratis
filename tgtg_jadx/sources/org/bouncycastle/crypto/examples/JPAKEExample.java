...
public class JPAKEExample {
    ...
    public static void main(String[] strArr) throws CryptoException {
        ...
        BigInteger p7 = jPAKEPrimeOrderGroup.getP();
        BigInteger q7 = jPAKEPrimeOrderGroup.getQ();
        BigInteger g11 = jPAKEPrimeOrderGroup.getG();
        System.out.println("********* Initialization **********");
        System.out.println("Public parameters for the cyclic group:");
        System.out.println("p (" + p7.bitLength() + " bits): " + p7.toString(16));
        System.out.println("q (" + q7.bitLength() + " bits): " + q7.toString(16));
        System.out.println("g (" + p7.bitLength() + " bits): " + g11.toString(16));
        PrintStream printStream = System.out;
        StringBuilder sb2 = new StringBuilder("p mod q = ");
        sb2.append(p7.mod(q7).toString(16));
        printStream.println(sb2.toString());
        System.out.println("g^{q} mod p = " + g11.modPow(q7, p7).toString(16));
        System.out.println("");
