...
public class StandardDSAEncoding implements DSAEncoding {
    ...
    public BigInteger[] decode(BigInteger bigInteger, byte[] bArr) throws IOException {
        ...
        a.f("Malformed signature");
        return null;
    }

    public BigInteger decodeValue(BigInteger bigInteger, ASN1Sequence aSN1Sequence, int i11) {
        return checkValue(bigInteger, ((ASN1Integer) aSN1Sequence.getObjectAt(i11)).getValue());
    }
