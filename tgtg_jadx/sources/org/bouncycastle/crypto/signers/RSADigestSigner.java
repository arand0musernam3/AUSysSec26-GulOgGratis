...
public class RSADigestSigner implements Signer {
    ...
    private byte[] derEncode(byte[] bArr) throws IOException {
        ...
        try {
            ...
            o.o(e5.getMessage(), "malformed DigestInfo for NONEwithRSA hash: ");
            return null;
        }
    }
    ...
    public byte[] generateSignature() throws DataLengthException, CryptoException {
        if (!this.forSigning) {
            h2.b("RSADigestSigner not initialised for signature generation.");
            return null;
        }
        ...
        try {
            ...
            throw new CryptoException(s.g(e5, new StringBuilder("unable to encode signature: ")), e5);
        }
    }
    ...
    public boolean verifySignature(byte[] bArr) {
        ...
        byte[] bArrDerEncode;
        if (this.forSigning) {
            h2.b("RSADigestSigner not initialised for verification");
            return false;
        }
