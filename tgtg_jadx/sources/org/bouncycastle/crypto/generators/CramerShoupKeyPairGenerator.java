...
public class CramerShoupKeyPairGenerator implements AsymmetricCipherKeyPairGenerator {
    ...
    private CramerShoupPublicKeyParameters calculatePublicKey(CramerShoupParameters cramerShoupParameters, CramerShoupPrivateKeyParameters cramerShoupPrivateKeyParameters) {
        ...
        BigInteger p7 = cramerShoupParameters.getP();
        return new CramerShoupPublicKeyParameters(cramerShoupParameters, g12.modPow(cramerShoupPrivateKeyParameters.getX1(), p7).multiply(g22.modPow(cramerShoupPrivateKeyParameters.getX2(), p7)), g12.modPow(cramerShoupPrivateKeyParameters.getY1(), p7).multiply(g22.modPow(cramerShoupPrivateKeyParameters.getY2(), p7)), g12.modPow(cramerShoupPrivateKeyParameters.getZ(), p7));
    }
    ...
    private CramerShoupPrivateKeyParameters generatePrivateKey(SecureRandom secureRandom, CramerShoupParameters cramerShoupParameters) {
        BigInteger p7 = cramerShoupParameters.getP();
        return new CramerShoupPrivateKeyParameters(cramerShoupParameters, generateRandomElement(p7, secureRandom), generateRandomElement(p7, secureRandom), generateRandomElement(p7, secureRandom), generateRandomElement(p7, secureRandom), generateRandomElement(p7, secureRandom));
    }
