...
public class SkeinEngine implements Memoable {
    ...
    public static class Configuration {
        ...
        public Configuration(long j9) {
            ...
            bArr[4] = 1;
            bArr[5] = 0;
            Pack.longToLittleEndian(j9, bArr, 8);
        }
    ...
    public SkeinEngine(int i11, int i12) {
        ...
        if (i12 % 8 != 0) {
            a.f(s.f(i12, "Output size must be a multiple of 8 bits. :"));
            throw null;
        }
    ...
    private void checkInitialised() {
        ...
        a.f("Skein engine is not initialised.");
    }
    ...
    private void output(long j9, byte[] bArr, int i11, int i12) {
        byte[] bArr2 = new byte[8];
        Pack.longToLittleEndian(j9, bArr2, 0);
        ...
        for (int i14 = 0; i14 < i13; i14++) {
            int i15 = i14 * 8;
            int iMin = Math.min(8, i12 - i15);
            if (iMin == 8) {
                Pack.longToLittleEndian(jArr[i14], bArr, i15 + i11);
            } else {
                Pack.longToLittleEndian(jArr[i14], bArr2, 0);
                System.arraycopy(bArr2, 0, bArr, i15 + i11, iMin);
            }
        }
    }
    ...
    public int doFinal(byte[] bArr, int i11) {
        ...
        if (bArr.length < this.outputSizeBytes + i11) {
            i1.r("Output buffer is too short to hold output");
            return 0;
        }
        ubiFinal();
        ...
        for (int i14 = 0; i14 < i13; i14++) {
            ...
            output(i14, bArr, i11 + i15, Math.min(blockSize, this.outputSizeBytes - i15));
        }
        reset();
    ...
    public void init(SkeinParameters skeinParameters) {
        ...
        if (skeinParameters != null) {
            if (skeinParameters.getKey().length < 16) {
                a.f("Skein key must be at least 128 bits.");
                return;
            }
    ...
    public void reset(Memoable memoable) {
        ...
        if (getBlockSize() == skeinEngine.getBlockSize() && this.outputSizeBytes == skeinEngine.outputSizeBytes) {
            ...
            a.f("Incompatible parameters in provided SkeinEngine.");
        }
    }
    ...
    public static class UbiTweak {
        ...
        public void advancePosition(int i11) {
            boolean z11 = this.extendedPosition;
            long[] jArr = this.tweak;
            if (!z11) {
                long j9 = jArr[0] + ((long) i11);
                jArr[0] = j9;
                if (j9 > LOW_RANGE) {
        ...
        public void setFinal(boolean z11) {
            ...
            if (z11) {
                ...
                jArr[1] = jArr[1] & LongCompanionObject.MAX_VALUE;
            }
        }
    ...
    public class UBI {
        ...
        public void update(byte[] bArr, int i11, int i12, long[] jArr) {
            ...
            while (i12 > i13) {
                ...
                int iMin = Math.min(i12 - i13, this.currentBlock.length - this.currentOffset);
                System.arraycopy(bArr, i11 + i13, this.currentBlock, this.currentOffset, iMin);
                i13 += iMin;
