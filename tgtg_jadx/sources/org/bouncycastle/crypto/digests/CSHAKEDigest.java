...
public class CSHAKEDigest extends SHAKEDigest {
    ...
    public CSHAKEDigest(int i11, CryptoServicePurpose cryptoServicePurpose, byte[] bArr, byte[] bArr2) {
        super(i11, cryptoServicePurpose);
    ...
    public CSHAKEDigest(int i11, byte[] bArr, byte[] bArr2) {
        this(i11, CryptoServicePurpose.ANY, bArr, bArr2);
    }
