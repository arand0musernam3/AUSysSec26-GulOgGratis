...
public class RIPEMD160Digest extends GeneralDigest {
    ...
    public void processBlock() {
        ...
        int i14 = this.H3;
        int i15 = this.H4;
        int iRL = RL(f1(i12, i13, i14) + i11 + this.X[0], 11) + i15;
        int iRL2 = RL(i13, 10);
        int iRL3 = RL(f1(iRL, i12, iRL2) + i15 + this.X[1], 14) + i14;
        int iRL4 = RL(i12, 10);
        int iRL5 = RL(f1(iRL3, iRL, iRL4) + i14 + this.X[2], 15) + iRL2;
        int iRL6 = RL(iRL, 10);
        ...
        int iRL33 = RL(i11 + f5(i12, i13, i14) + this.X[5] + 1352829926, 8) + i15;
        int iRL34 = RL(i13, 10);
        int iRL35 = RL(i15 + f5(iRL33, i12, iRL34) + this.X[14] + 1352829926, 9) + i14;
        int iRL36 = RL(i12, 10);
        int iRL37 = RL(i14 + f5(iRL35, iRL33, iRL36) + this.X[7] + 1352829926, 9) + iRL34;
