...
public class Haraka512Digest extends HarakaBase {
    ...
    private int haraka512256(byte[] bArr, byte[] bArr2, int i11) {
        ...
        System.arraycopy(bArr3[0], 8, bArr2, i11, 8);
        System.arraycopy(bArr3[1], 8, bArr2, i11 + 8, 8);
        System.arraycopy(bArr3[2], 0, bArr2, i11 + 16, 8);
        System.arraycopy(bArr3[3], 0, bArr2, i11 + 24, 8);
        return 32;
    }
    ...
    public int doFinal(byte[] bArr, int i11) {
        if (this.off != 64) {
            h2.b("input must be exactly 64 bytes");
            return 0;
        }
        if (bArr.length - i11 < 32) {
            a.f("output too short to receive digest");
            return 0;
        }
        int iHaraka512256 = haraka512256(this.buffer, bArr, i11);
        reset();
