...
public class Haraka256Digest extends HarakaBase {
    ...
    private int haraka256256(byte[] bArr, byte[] bArr2, int i11) {
        ...
        mix256(bArr3, bArr4);
        Bytes.xor(16, bArr4[0], 0, bArr, 0, bArr2, i11);
        Bytes.xor(16, bArr4[1], 0, bArr, 16, bArr2, i11 + 16);
        return 32;
    }
    ...
    public int doFinal(byte[] bArr, int i11) {
        if (this.off != 32) {
            h2.b("input must be exactly 32 bytes");
            return 0;
        }
        ...
        int iHaraka256256 = haraka256256(this.buffer, bArr, i11);
        reset();
