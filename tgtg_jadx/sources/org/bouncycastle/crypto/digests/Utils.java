...
class Utils {
    ...
    public static class DefaultProperties implements CryptoServiceProperties {
        ...
        public DefaultProperties(int i11, String str, CryptoServicePurpose cryptoServicePurpose) {
    ...
    public static class DefaultPropertiesWithPRF implements CryptoServiceProperties {
        ...
        public DefaultPropertiesWithPRF(int i11, int i12, String str, CryptoServicePurpose cryptoServicePurpose) {
            this.bitsOfSecurity = i11;
            this.prfBitsOfSecurity = i12;
            this.algorithmName = str;
            this.purpose = cryptoServicePurpose;
        }
    ...
    public static CryptoServiceProperties getDefaultProperties(Digest digest, int i11, CryptoServicePurpose cryptoServicePurpose) {
        return new DefaultPropertiesWithPRF(digest.getDigestSize() * 4, i11, digest.getAlgorithmName(), cryptoServicePurpose);
    }
