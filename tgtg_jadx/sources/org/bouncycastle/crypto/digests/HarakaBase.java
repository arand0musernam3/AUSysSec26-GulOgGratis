...
public abstract class HarakaBase implements Digest {
    ...
    private static byte[] mixColumns(byte[] bArr) {
        ...
        for (int i12 = 0; i12 < 4; i12++) {
            ...
            int i15 = i13 + 2;
            int i16 = i13 + 3;
            bArr2[i11] = (byte) ((((mulX(bArr[i13]) ^ mulX(bArr[i14])) ^ bArr[i14]) ^ bArr[i15]) ^ bArr[i16]);
            bArr2[i11 + 1] = (byte) ((((bArr[i13] ^ mulX(bArr[i14])) ^ mulX(bArr[i15])) ^ bArr[i15]) ^ bArr[i16]);
            int i17 = i11 + 3;
            bArr2[i11 + 2] = (byte) ((((bArr[i13] ^ bArr[i14]) ^ mulX(bArr[i15])) ^ mulX(bArr[i16])) ^ bArr[i16]);
            i11 += 4;
            bArr2[i17] = (byte) ((((mulX(bArr[i13]) ^ bArr[i13]) ^ bArr[i14]) ^ bArr[i15]) ^ mulX(bArr[i16]));
        }
        return bArr2;
    }

    public static byte mulX(byte b8) {
        return (byte) ((((b8 & ByteCompanionObject.MIN_VALUE) >> 7) * 27) ^ ((b8 & ByteCompanionObject.MAX_VALUE) << 1));
    }

    public static byte sBox(byte b8) {
        return S[(b8 & 255) >>> 4][b8 & 15];
    }
