...
public class RIPEMD320Digest extends GeneralDigest {
    ...
    public int doFinal(byte[] bArr, int i11) {
        ...
        Pack.intToLittleEndian(this.H8, bArr, i11 + 32);
        Pack.intToLittleEndian(this.H9, bArr, i11 + 36);
        reset();
        return 40;
    }
    ...
    public void processBlock() {
        ...
        int i19 = this.H8;
        int i21 = this.H9;
        int iRL = RL(i11 + f1(i12, i13, i14) + this.X[0], 11) + i15;
        int iRL2 = RL(i13, 10);
        int iRL3 = RL(i15 + f1(iRL, i12, iRL2) + this.X[1], 14) + i14;
        int iRL4 = RL(i12, 10);
        int iRL5 = RL(i14 + f1(iRL3, iRL, iRL4) + this.X[2], 15) + iRL2;
        int iRL6 = RL(iRL, 10);
        ...
        int iRL33 = RL(i16 + f5(i17, i18, i19) + this.X[5] + 1352829926, 8) + i21;
        int iRL34 = RL(i18, 10);
        int iRL35 = RL(i21 + f5(iRL33, i17, iRL34) + this.X[14] + 1352829926, 9) + i19;
        int iRL36 = RL(i17, 10);
        int iRL37 = RL(i19 + f5(iRL35, iRL33, iRL36) + this.X[7] + 1352829926, 9) + iRL34;
