...
public class SHA256Digest extends GeneralDigest implements SavableDigest {
    ...
    public static SavableDigest newInstance(Digest digest) {
        ...
        throw new IllegalArgumentException("receiver digest not available for input type ".concat(digest != null ? digest.getClass().getName() : Address.ADDRESS_NULL_PLACEHOLDER));
    }
