...
public class RIPEMD128Digest extends GeneralDigest {
    ...
    private int F2(int i11, int i12, int i13, int i14, int i15, int i16) {
        return RL(a.C(i11, f2(i12, i13, i14), i15, 1518500249), i16);
    }

    private int F3(int i11, int i12, int i13, int i14, int i15, int i16) {
        return RL(a.C(i11, f3(i12, i13, i14), i15, 1859775393), i16);
    }

    private int F4(int i11, int i12, int i13, int i14, int i15, int i16) {
        return RL(a.C(i11, f4(i12, i13, i14), i15, -1894007588), i16);
    }
    ...
    private int FF2(int i11, int i12, int i13, int i14, int i15, int i16) {
        return RL(a.C(i11, f2(i12, i13, i14), i15, 1836072691), i16);
    }

    private int FF3(int i11, int i12, int i13, int i14, int i15, int i16) {
        return RL(a.C(i11, f3(i12, i13, i14), i15, 1548603684), i16);
    }

    private int FF4(int i11, int i12, int i13, int i14, int i15, int i16) {
        return RL(a.C(i11, f4(i12, i13, i14), i15, 1352829926), i16);
    }
    ...
    public void processBlock() {
        ...
        int iF12 = F1(i14, iF1, i12, i13, this.X[1], 14);
        int iF13 = F1(i13, iF12, iF1, i12, this.X[2], 15);
        int iF14 = F1(i12, iF13, iF12, iF1, this.X[3], 12);
        ...
        int iFF4 = FF4(i11, i12, i13, i14, this.X[5], 8);
        int iFF42 = FF4(i14, iFF4, i12, i13, this.X[14], 9);
        int iFF43 = FF4(i13, iFF42, iFF4, i12, this.X[7], 9);
        int iFF44 = FF4(i12, iFF43, iFF42, iFF4, this.X[0], 11);
