...
public class MD5Digest extends GeneralDigest implements EncodableDigest {
    ...
    public MD5Digest(byte[] bArr) {
        ...
        for (int i11 = 0; i11 != this.xOff; i11++) {
            this.X[i11] = Pack.bigEndianToInt(bArr, (i11 * 4) + 36);
        }
    }
    ...
    public byte[] getEncodedState() {
        ...
        for (int i12 = 0; i12 != this.xOff; i12++) {
            Pack.intToBigEndian(this.X[i12], bArr, (i12 * 4) + 36);
        }
        bArr[i11 + 36] = (byte) this.purpose.ordinal();
        return bArr;
    }
    ...
    public void processBlock() {
        ...
        int i13 = this.H3;
        int i14 = this.H4;
        int iRotateLeft = rotateLeft(((i11 + F(i12, i13, i14)) + this.X[0]) - 680876936, 7) + i12;
        int iRotateLeft2 = rotateLeft(((i14 + F(iRotateLeft, i12, i13)) + this.X[1]) - 389564586, 12) + iRotateLeft;
        int iRotateLeft3 = rotateLeft(i13 + F(iRotateLeft2, iRotateLeft, i12) + this.X[2] + 606105819, 17) + iRotateLeft2;
        int iRotateLeft4 = rotateLeft(((i12 + F(iRotateLeft3, iRotateLeft2, iRotateLeft)) + this.X[3]) - 1044525330, 22) + iRotateLeft3;
