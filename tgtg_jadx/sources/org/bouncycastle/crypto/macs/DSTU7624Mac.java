...
public class DSTU7624Mac implements Mac {
    ...
    private void processBlock(byte[] bArr, int i11) {
        xor(this.f33157c, 0, bArr, i11, this.cTemp);
        this.engine.processBlock(this.cTemp, 0, this.f33157c, 0);
    }
    ...
    private void xor(byte[] bArr, int i11, byte[] bArr2, int i12, byte[] bArr3) {
        ...
        if (length < i13 || bArr2.length - i12 < i13 || bArr3.length < i13) {
            a.f("some of input buffers too short");
            return;
        }
    ...
    public int doFinal(byte[] bArr, int i11) throws IllegalStateException, DataLengthException {
        ...
        if (i12 % bArr2.length != 0) {
            i1.t("input must be a multiple of blocksize");
            return 0;
        }
        xor(this.f33157c, 0, bArr2, 0, this.cTemp);
        xor(this.cTemp, 0, this.kDelta, 0, this.f33157c);
        DSTU7624Engine dSTU7624Engine = this.engine;
        byte[] bArr3 = this.f33157c;
        ...
        System.arraycopy(this.f33157c, 0, bArr, i11, i13);
        reset();
        return this.macSize;
    }
    ...
    public void init(CipherParameters cipherParameters) throws IllegalArgumentException {
        if (!(cipherParameters instanceof KeyParameter)) {
            a.f("Invalid parameter passed to DSTU7624Mac");
            return;
        }
    ...
    @Override // org.bouncycastle.crypto.Mac
    public void reset() {
        Arrays.fill(this.f33157c, (byte) 0);
