...
public class CMac implements Mac {
    ...
    public CMac(BlockCipher blockCipher, int i11) {
        ...
        if (i11 > blockCipher.getBlockSize() * 8) {
            o.l(blockCipher.getBlockSize() * 8, "MAC size must be less or equal to ");
            throw null;
        }
    ...
    private byte[] doubleLu(byte[] bArr) {
        ...
        int i11 = (-shiftLeft(bArr, bArr2)) & 255;
        int length = bArr.length - 3;
        byte b8 = bArr2[length];
        byte[] bArr3 = this.poly;
        bArr2[length] = (byte) (b8 ^ (bArr3[1] & i11));
    ...
    private static byte[] lookupPoly(int i11) {
        ...
        switch (i12) {
            ...
            case NewHope.SENDB_BYTES /* 2048 */:
                ...
                break;
            default:
                a.f(s.f(i12, "Unknown block size for CMAC: "));
                return null;
        }
    ...
    public void validate(CipherParameters cipherParameters) {
        ...
        a.f("CMac mode only permits key to be set.");
    }
