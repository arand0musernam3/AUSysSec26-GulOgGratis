...
public class DualECSP800DRBG implements SP80090DRBG {
    ...
    static {
        ...
        nistPoints = new DualECPoints[]{createDualECPoints("P-256", 128, bigInteger, bigInteger2, bigInteger3, bigInteger4, 1), createDualECPoints("P-384", BERTags.PRIVATE, bigInteger5, bigInteger6, bigInteger7, bigInteger8, 1), createDualECPoints("P-521", 256, bigInteger9, bigInteger10, bigInteger11, bigInteger12, 1)};
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:23:0x0089, code lost:
        ...
        i4.a.f("security strength cannot be greater than 256 bits");
     */
    ...
    */
    public DualECSP800DRBG(org.bouncycastle.crypto.prng.drbg.DualECPoints[] r2, org.bouncycastle.crypto.Digest r3, int r4, org.bouncycastle.crypto.prng.EntropySource r5, byte[] r6, byte[] r7) {
        ...
        L2f:
            ...
            goto L73
        L69:
            java.lang.String r2 = "Requested security strength is not supported by digest"
            i4.a.f(r2)
            r2 = 0
            throw r2
        L70:
        ...
        L73:
            ...
            return
        L89:
            java.lang.String r2 = "security strength cannot be greater than 256 bits"
            i4.a.f(r2)
            r2 = 0
            throw r2
        L90:
            java.lang.String r2 = "EntropySource must provide between "
            java.lang.String r3 = " and 4096 bits"
            java.lang.String r2 = r8.k.h(r4, r2, r3)
            i4.a.f(r2)
            r2 = 0
            throw r2
        L9d:
            java.lang.String r2 = "Personalization string too large"
            i4.a.f(r2)
            r2 = 0
            throw r2
        */
    ...
    private static DualECPoints createDualECPoints(String str, int i11, BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3, BigInteger bigInteger4, int i12) {
        ECCurve.AbstractFp abstractFp = (ECCurve.AbstractFp) CustomNamedCurves.getByNameLazy(str).getCurve();
        return new DualECPoints(i11, abstractFp.createPoint(bigInteger, bigInteger2), abstractFp.createPoint(bigInteger3, bigInteger4), i12);
    }
    ...
    private byte[] pad8(byte[] bArr, int i11) {
        ...
        while (length >= 0) {
            ...
            bArr[length] = (byte) ((i14 >> (8 - i13)) | (i15 << i13));
            length--;
            i14 = i15;
        }
        return bArr;
    ...
    public int generate(byte[] bArr, byte[] bArr2, boolean z11) {
        ...
        if (Utils.isTooLarge(bArr2, 512)) {
            a.f("Additional input too large");
            return 0;
        }
        ...
        if (i11 < bArr.length) {
            ...
            if (length6 >= i14) {
                length3 = byteArray2.length - i14;
            } else {
                int length7 = i14 - byteArray2.length;
                if (length7 < length5) {
                    i11 += length7;
                    length5 -= length7;
                }
            ...
            System.arraycopy(byteArray2, length3, bArr, i11, length5);
            this._reseedCounter++;
        }
    ...
    public void reseed(byte[] bArr) {
        if (Utils.isTooLarge(bArr, 512)) {
            a.f("Additional input string too large");
            return;
        }
