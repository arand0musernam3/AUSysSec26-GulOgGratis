...
public class Tables16kKGCMMultiplier_512 implements KGCMMultiplier {
    ...
    public void init(long[] jArr) {
        ...
        for (int i11 = 2; i11 < 256; i11 += 2) {
            long[][] jArr3 = this.T;
            KGCMUtil_512.multiplyX(jArr3[i11 >> 1], jArr3[i11]);
            long[][] jArr4 = this.T;
            KGCMUtil_512.add(jArr4[i11], jArr4[1], jArr4[i11 + 1]);
        }
    }
    ...
    public void multiplyH(long[] jArr) {
        ...
        for (int i11 = 62; i11 >= 0; i11--) {
            ...
            KGCMUtil_512.add(this.T[((int) (jArr[i11 >>> 3] >>> ((i11 & 7) << 3))) & 255], jArr2, jArr2);
        }
