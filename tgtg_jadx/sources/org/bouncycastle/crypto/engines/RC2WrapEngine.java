...
public class RC2WrapEngine implements Wrapper {
    ...
    public void init(boolean z11, CipherParameters cipherParameters) {
        ...
        if (cipherParameters instanceof ParametersWithRandom) {
            ...
            this.f33124sr = parametersWithRandom.getRandom();
            cipherParameters = parametersWithRandom.getParameters();
        } else {
            this.f33124sr = CryptoServicesRegistrar.getSecureRandom();
        }
        if (!(cipherParameters instanceof ParametersWithIV)) {
            ...
            if (this.forWrapping) {
                ...
                this.f33123iv = bArr;
                this.f33124sr.nextBytes(bArr);
                this.paramPlusIV = new ParametersWithIV(this.param, this.f33123iv);
                return;
            }
            return;
        }
        ...
        this.f33123iv = parametersWithIV.getIV();
        this.param = this.paramPlusIV.getParameters();
        if (!this.forWrapping) {
            a.f("You should not supply an IV for unwrapping");
            return;
        }
        byte[] bArr2 = this.f33123iv;
    ...
    public byte[] unwrap(byte[] bArr, int i11, int i12) throws InvalidCipherTextException {
        ...
        if (bArr == null) {
            ...
            ParametersWithIV parametersWithIV = new ParametersWithIV(this.param, this.f33123iv);
            this.paramPlusIV = parametersWithIV;
    ...
    public byte[] wrap(byte[] bArr, int i11, int i12) {
        ...
        if (this.forWrapping) {
            ...
            if (i16 > 0) {
                this.f33124sr.nextBytes(bArr3);
                System.arraycopy(bArr3, 0, bArr2, i13, i16);
            }
            byte[] bArrCalculateCMSKeyChecksum = calculateCMSKeyChecksum(bArr2);
            int length = bArrCalculateCMSKeyChecksum.length + i15;
            byte[] bArr4 = new byte[length];
            System.arraycopy(bArr2, 0, bArr4, 0, i15);
            System.arraycopy(bArrCalculateCMSKeyChecksum, 0, bArr4, i15, bArrCalculateCMSKeyChecksum.length);
            ...
            if (length % this.engine.getBlockSize() == 0) {
                ...
                byte[] bArr6 = this.f33123iv;
                int length2 = bArr6.length + length;
                byte[] bArr7 = new byte[length2];
                System.arraycopy(bArr6, 0, bArr7, 0, bArr6.length);
                System.arraycopy(bArr5, 0, bArr7, this.f33123iv.length, length);
