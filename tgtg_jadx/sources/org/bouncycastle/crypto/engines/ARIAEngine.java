...
public class ARIAEngine implements BlockCipher {
    ...
    private static final byte[] SB2_sbox = {-30, 78, 84, -4, -108, -62, 74, -52, 98, 13, 106, 70, 60, 77, -117, -47, 94, -6, 100, -53, -76, -105, -66, 43, PSSSigner.TRAILER_IMPLICIT, 119, 46, 3, -45, 25, 89, -63, 29, 6, 65, 107, 85, -16, -103, 105, -22, -100, 24, -82, 99, -33, -25, -69, 0, 115, 102, -5, -106, 76, -123, -28, 58, 9, 69, -86, 15, -18, 16, -21, 45, ByteCompanionObject.MAX_VALUE, -12, 41, -84, -49, -83, -111, -115, 120, -56, -107, -7, 47, -50, -51, 8, 122, -120, 56, 92, -125, 42, 40, 71, -37, -72, -57, -109, -92, 18, 83, -1, -121, 14, 49, 54, 33, 88, 72, 1, -114, 55, 116, 50, -54, -23, -79, -73, -85, 12, -41, -60, 86, 66, 38, 7, -104, 96, -39, -74, -71, 17, 64, -20, 32, -116, -67, -96, -55, -124, 4, 73, 35, -15, 79, 80, 31, 19, -36, -40, -64, -98, 87, -29, -61, 123, 101, 59, 2, -113, 62, -24, 37, -110, -27, 21, -35, -3, 23, -87, -65, -44, -102, 126, -59, 57, 103, -2, 118, -99, 67, -89, -31, -48, -11, 104, -14, 27, 52, 112, 5, -93, -118, -43, 121, -122, -88, 48, -58, 81, 75, 30, -90, 39, -10, 53, -46, 110, 36, 22, -126, 95, -38, -26, 117, -94, -17, 44, -78, 28, -97, 93, 111, ByteCompanionObject.MIN_VALUE, 10, 114, 68, -101, 108, -112, 11, 91, 51, 125, 90, 82, -13, 97, -95, -9, -80, -42, 63, 124, 109, -19, 20, -32, -91, 61, 34, -77, -8, -119, -34, 113, 26, -81, -70, -75, -127};
    ...
    public static void A(byte[] bArr) {
        ...
        byte b25 = bArr[14];
        byte b26 = bArr[15];
        bArr[0] = (byte) ((((((b13 ^ b14) ^ b16) ^ b18) ^ b19) ^ b24) ^ b25);
        bArr[1] = (byte) ((((((b12 ^ b15) ^ b17) ^ b18) ^ b19) ^ b23) ^ b26);
        bArr[2] = (byte) ((((((b11 ^ b14) ^ b16) ^ b21) ^ b22) ^ b23) ^ b26);
        bArr[3] = (byte) ((((((b8 ^ b15) ^ b17) ^ b21) ^ b22) ^ b24) ^ b25);
        int i11 = b8 ^ b12;
        bArr[4] = (byte) (((((i11 ^ b15) ^ b18) ^ b22) ^ b25) ^ b26);
        int i12 = b11 ^ b13;
        bArr[5] = (byte) (((((i12 ^ b14) ^ b19) ^ b21) ^ b25) ^ b26);
        bArr[6] = (byte) (((((i11 ^ b17) ^ b19) ^ b21) ^ b23) ^ b24);
        bArr[7] = (byte) (((((i12 ^ b16) ^ b18) ^ b22) ^ b23) ^ b24);
        int i13 = b8 ^ b11;
        bArr[8] = (byte) (((((i13 ^ b14) ^ b17) ^ b21) ^ b24) ^ b26);
        bArr[9] = (byte) (((((i13 ^ b15) ^ b16) ^ b22) ^ b23) ^ b25);
        int i14 = b12 ^ b13;
        bArr[10] = (byte) (((((i14 ^ b15) ^ b16) ^ b18) ^ b24) ^ b26);
        bArr[11] = (byte) (((((i14 ^ b14) ^ b17) ^ b19) ^ b23) ^ b25);
        int i15 = b11 ^ b12;
        bArr[12] = (byte) (((((i15 ^ b16) ^ b17) ^ b19) ^ b22) ^ b23);
        int i16 = b8 ^ b13;
        bArr[13] = (byte) (((((i16 ^ b16) ^ b17) ^ b18) ^ b21) ^ b24);
        bArr[14] = (byte) (((((i16 ^ b14) ^ b15) ^ b19) ^ b22) ^ b25);
        bArr[15] = (byte) (((((i15 ^ b14) ^ b15) ^ b18) ^ b21) ^ b26);
    }
    ...
    public static byte SB1(byte b8) {
        return SB1_sbox[b8 & 255];
    }

    public static byte SB2(byte b8) {
        return SB2_sbox[b8 & 255];
    }

    public static byte SB3(byte b8) {
        return SB3_sbox[b8 & 255];
    }

    public static byte SB4(byte b8) {
        return SB4_sbox[b8 & 255];
    }
    ...
    public static byte[][] keySchedule(boolean z11, byte[] bArr) {
        ...
        int i13 = i12 * 2;
        int i14 = i13 + 12;
        byte[][] bArr12 = (byte[][]) Array.newInstance((Class<?>) Byte.TYPE, i13 + 13, 16);
    ...
    public void init(boolean z11, CipherParameters cipherParameters) throws IllegalArgumentException {
        if (!(cipherParameters instanceof KeyParameter)) {
            a.f(s.n("invalid parameter passed to ARIA init - ", cipherParameters));
            return;
        }
    ...
    public int processBlock(byte[] bArr, int i11, byte[] bArr2, int i12) throws IllegalStateException, DataLengthException {
        if (this.roundKeys == null) {
            h2.b("ARIA engine not initialised");
            return 0;
        }
        ...
        while (true) {
            ...
            if (i13 >= length) {
                ...
                SL2(bArr3);
                xor(bArr3, this.roundKeys[i13 + 2]);
