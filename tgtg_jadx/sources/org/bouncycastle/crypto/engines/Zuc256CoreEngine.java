...
public class Zuc256CoreEngine extends Zuc128CoreEngine {
    ...
    public Zuc256CoreEngine(int i11) {
        ...
        if (i11 == 64) {
            ...
            a.f(s.f(i11, "Unsupported length: "));
            throw null;
        }
    }

    private static int MAKEU31(byte b8, byte b11, byte b12, byte b13) {
        return ((b8 & 255) << 23) | ((b11 & 255) << 16) | ((b12 & 255) << 8) | (b13 & 255);
    }
    ...
    public void setKeyAndIV(int[] iArr, byte[] bArr, byte[] bArr2) {
        if (bArr == null || bArr.length != 32) {
            a.f("A key of 32 bytes is needed");
            return;
        }
        if (bArr2 == null || bArr2.length != 25) {
            a.f("An IV of 25 bytes is needed");
            return;
        }
