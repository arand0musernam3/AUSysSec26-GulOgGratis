...
public class RijndaelEngine implements BlockCipher {
    ...
    public RijndaelEngine(int i11) {
        if (i11 == 128) {
            ...
            if (i11 != 256) {
                a.f("unknown blocksize to Rijndael");
                throw null;
            }
            this.BC = 64;
            this.BC_MASK = -1L;
    ...
    private void MixColumn() {
        ...
        for (int i11 = 0; i11 < this.BC; i11 += 8) {
            ...
            jMul0x24 |= ((long) ((((mul0x2(i13) ^ mul0x3(i14)) ^ i15) ^ i12) & 255)) << i11;
            jMul0x22 |= ((long) ((((mul0x2(i14) ^ mul0x3(i15)) ^ i12) ^ i13) & 255)) << i11;
            jMul0x23 = (((long) ((((mul0x2(i15) ^ mul0x3(i12)) ^ i13) ^ i14) & 255)) << i11) | jMul0x23;
        }
        this.A0 = jMul0x2;
        this.A1 = jMul0x24;
        this.A2 = jMul0x22;
    ...
    private long applyS(long j9, byte[] bArr) {
        long j11 = 0;
        for (int i11 = 0; i11 < this.BC; i11 += 8) {
            j11 |= ((long) (bArr[(int) ((j9 >> i11) & 255)] & 255)) << i11;
        }
        return j11;
    }
    ...
    private long[][] generateWorkingKey(byte[] bArr) {
        ...
        if (length == 128) {
            ...
            if (length != 256) {
                a.f("Key length not 128/160/192/224/256 bits.");
                return null;
            }
            i11 = 8;
        }
        ...
        int i18 = 0;
        int i19 = 0;
        while (i18 < i11 && i19 < (this.BC / i12) * (this.ROUNDS + i13)) {
            int i21 = i14;
            while (i21 < 4) {
                int i22 = this.BC;
        ...
        int i24 = i14;
        int i25 = i24;
        while (i19 < (this.BC / 8) * (this.ROUNDS + 1)) {
            int i26 = i24;
            while (i26 < i15) {
            ...
            if (i11 <= 6) {
                ...
                while (i28 < i15) {
                    for (int i31 = i24; i31 < i15; i31++) {
                        byte[] bArr6 = bArr2[i31];
                        bArr6[i28] = (byte) (bArr6[i28] ^ bArr6[i28 - 1]);
                    }
                    i28++;
                }
                for (int i32 = i24; i32 < i15; i32++) {
                    byte[] bArr7 = bArr2[i32];
                    bArr7[i15] = (byte) (bArr7[i15] ^ S[bArr7[3] & 255]);
                }
                for (int i33 = 5; i33 < i11; i33++) {
                    for (int i34 = i24; i34 < i15; i34++) {
                        byte[] bArr8 = bArr2[i34];
                        bArr8[i33] = (byte) (bArr8[i33] ^ bArr8[i33 - 1]);
                    }
                }
            }
            int i35 = i24;
            while (i35 < i11 && i19 < (this.BC / 8) * (this.ROUNDS + 1)) {
                int i36 = i24;
                while (i36 < i15) {
                    int i37 = this.BC;
                    long[] jArr3 = jArr[i19 / (i37 / 8)];
                    jArr3[i36] = (((long) (bArr2[i36][i35] & 255)) << ((i19 * 8) % i37)) | jArr3[i36];
                    i36++;
                    i11 = i11;
                    i15 = 4;
                }
    ...
    private byte mul0xe(int i11) {
        if (i11 >= 0) {
            return aLogtable[i11 + AppConstants.GO_TO_GPS_SETTINGS];
        }
        return (byte) 0;
    }
    ...
    private long shift(long j9, int i11) {
        return ((j9 << (this.BC - i11)) | (j9 >>> i11)) & this.BC_MASK;
    }
    ...
    public void init(boolean z11, CipherParameters cipherParameters) {
        if (!(cipherParameters instanceof KeyParameter)) {
            a.f(s.n("invalid parameter passed to Rijndael init - ", cipherParameters));
            return;
        }
    ...
    public int processBlock(byte[] bArr, int i11, byte[] bArr2, int i12) {
        if (this.workingKey == null) {
            h2.b("Rijndael engine not initialised");
            return 0;
        }
        int i13 = this.BC;
