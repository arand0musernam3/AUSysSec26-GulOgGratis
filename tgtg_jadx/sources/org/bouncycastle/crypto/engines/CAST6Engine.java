...
public final class CAST6Engine extends CAST5Engine {
    ...
    public void setKey(byte[] bArr) {
        ...
        for (int i16 = 0; i16 < 8; i16++) {
            this._workingKey[i16] = BytesTo32bits(bArr2, i16 * 4);
        }
        int i17 = 0;
        while (i17 < 12) {
            int i18 = i17 * 16;
            ...
            int i21 = i18 + 2;
            iArr3[4] = iArr3[4] ^ F3(iArr3[5], this._Tm[i21], this._Tr[i21]);
            int[] iArr4 = this._workingKey;
            int i22 = i18 + 3;
            char c7 = c3;
            iArr4[3] = F1(iArr4[4], this._Tm[i22], this._Tr[i22]) ^ iArr4[3];
            int[] iArr5 = this._workingKey;
            int i23 = i18 + 4;
            iArr5[2] = F2(iArr5[3], this._Tm[i23], this._Tr[i23]) ^ iArr5[2];
            int[] iArr6 = this._workingKey;
            int i24 = i18 + 5;
            iArr6[1] = F3(iArr6[2], this._Tm[i24], this._Tr[i24]) ^ iArr6[1];
            int[] iArr7 = this._workingKey;
            int i25 = i18 + 6;
            iArr7[c7] = iArr7[c7] ^ F1(iArr7[1], this._Tm[i25], this._Tr[i25]);
            int[] iArr8 = this._workingKey;
            int i26 = i18 + 7;
            iArr8[7] = F2(iArr8[c7], this._Tm[i26], this._Tr[i26]) ^ iArr8[7];
            int i27 = ((i17 * 2) + 1) * 8;
            int[] iArr9 = this._workingKey;
            iArr9[6] = iArr9[6] ^ F1(iArr9[7], this._Tm[i27], this._Tr[i27]);
            int[] iArr10 = this._workingKey;
            int i28 = i27 + 1;
            iArr10[5] = iArr10[5] ^ F2(iArr10[6], this._Tm[i28], this._Tr[i28]);
            int[] iArr11 = this._workingKey;
            int i29 = i27 + 2;
            iArr11[4] = iArr11[4] ^ F3(iArr11[5], this._Tm[i29], this._Tr[i29]);
            int[] iArr12 = this._workingKey;
            int i31 = i27 + 3;
            iArr12[3] = iArr12[3] ^ F1(iArr12[4], this._Tm[i31], this._Tr[i31]);
            int[] iArr13 = this._workingKey;
            int i32 = i27 + 4;
            iArr13[2] = iArr13[2] ^ F2(iArr13[3], this._Tm[i32], this._Tr[i32]);
            int[] iArr14 = this._workingKey;
            int i33 = i27 + 5;
            iArr14[1] = iArr14[1] ^ F3(iArr14[2], this._Tm[i33], this._Tr[i33]);
            int[] iArr15 = this._workingKey;
            int i34 = i27 + 6;
            iArr15[c7] = iArr15[c7] ^ F1(iArr15[1], this._Tm[i34], this._Tr[i34]);
            int[] iArr16 = this._workingKey;
            int i35 = i27 + 7;
            iArr16[7] = F2(iArr16[c7], this._Tm[i35], this._Tr[i35]) ^ iArr16[7];
            int[] iArr17 = this._Kr;
            int i36 = i17 * 4;
            int[] iArr18 = this._workingKey;
            iArr17[i36] = iArr18[c7] & 31;
            int i37 = i36 + 1;
