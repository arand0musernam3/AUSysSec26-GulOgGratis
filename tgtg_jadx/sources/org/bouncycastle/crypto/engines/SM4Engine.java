...
public class SM4Engine implements BlockCipher {
    ...
    private int[] expandKey(boolean z11, byte[] bArr) {
        ...
        if (z11) {
            ...
            int[] iArr5 = CK;
            int iT_ap = i12 ^ T_ap(i13 ^ iArr5[0]);
            iArr[0] = iT_ap;
            ...
            int[] iArr6 = CK;
            int iT_ap4 = i15 ^ T_ap(i16 ^ iArr6[0]);
            iArr[31] = iT_ap4;
    ...
    public void init(boolean z11, CipherParameters cipherParameters) throws IllegalArgumentException {
        if (!(cipherParameters instanceof KeyParameter)) {
            a.f(s.n("invalid parameter passed to SM4 init - ", cipherParameters));
            return;
        }
        byte[] key = ((KeyParameter) cipherParameters).getKey();
        if (key.length != 16) {
            a.f("SM4 requires a 128 bit key");
        } else {
            this.f33133rk = expandKey(z11, key);
    ...
    public int processBlock(byte[] bArr, int i11, byte[] bArr2, int i12) throws IllegalStateException, DataLengthException {
        if (this.f33133rk == null) {
            h2.b("SM4 not initialised");
            return 0;
        }
        ...
        while (true) {
            int[] iArr = this.X;
            if (i13 >= 32) {
                Pack.intToBigEndian(iArr[3], bArr2, i12);
            ...
            iArr[0] = F0(iArr, this.f33133rk[i13]);
            int[] iArr2 = this.X;
            iArr2[1] = F1(iArr2, this.f33133rk[i13 + 1]);
            int[] iArr3 = this.X;
            iArr3[2] = F2(iArr3, this.f33133rk[i13 + 2]);
            int[] iArr4 = this.X;
            iArr4[3] = F3(iArr4, this.f33133rk[i13 + 3]);
            i13 += 4;
        }
    }
