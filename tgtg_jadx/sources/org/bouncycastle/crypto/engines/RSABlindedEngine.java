...
public class RSABlindedEngine implements AsymmetricBlockCipher {
    ...
    public void init(boolean z11, CipherParameters cipherParameters) {
        ...
        this.random = initSecureRandom(rSAKeyParameters instanceof RSAPrivateCrtKeyParameters, random);
    }
    ...
    public byte[] processBlock(byte[] bArr, int i11, int i12) {
        if (this.key != null) {
            return this.core.convertOutput(processInput(this.core.convertInput(bArr, i11, i12)));
        }
