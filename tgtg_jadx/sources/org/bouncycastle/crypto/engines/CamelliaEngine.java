...
public class CamelliaEngine implements BlockCipher {
    ...
    private int[] f33101ke = new int[12];
    ...
    private void camelliaF2(int[] iArr, int[] iArr2, int i11) {
        ...
        int i14 = i13 ^ iArr4[(i12 >>> 8) & 255];
        int[] iArr5 = SBOX2_0222;
        int i15 = i14 ^ iArr5[(i12 >>> 16) & 255];
        int[] iArr6 = SBOX1_1110;
        int i16 = iArr6[(i12 >>> 24) & 255] ^ i15;
        int i17 = iArr[1] ^ iArr2[i11 + 1];
        int i18 = (iArr5[(i17 >>> 24) & 255] ^ ((iArr6[i17 & 255] ^ iArr3[(i17 >>> 8) & 255]) ^ iArr4[(i17 >>> 16) & 255])) ^ i16;
        iArr[2] = iArr[2] ^ i18;
        int iRightRotate = (rightRotate(i16, 8) ^ i18) ^ iArr[3];
        iArr[3] = iRightRotate;
        int i19 = iArr[2] ^ iArr2[i11 + 2];
        int i21 = iArr6[(i19 >>> 24) & 255] ^ ((iArr3[i19 & 255] ^ iArr4[(i19 >>> 8) & 255]) ^ iArr5[(i19 >>> 16) & 255]);
        int i22 = iArr2[i11 + 3] ^ iRightRotate;
        int i23 = (iArr5[(i22 >>> 24) & 255] ^ ((iArr6[i22 & 255] ^ iArr3[(i22 >>> 8) & 255]) ^ iArr4[(i22 >>> 16) & 255])) ^ i21;
        iArr[0] = iArr[0] ^ i23;
        iArr[1] = (i23 ^ rightRotate(i21, 8)) ^ iArr[1];
    }
    ...
    private int processBlock192or256(byte[] bArr, int i11, byte[] bArr2, int i12) {
        ...
        camelliaF2(iArr, this.subkey, 28);
        camelliaF2(iArr, this.subkey, 32);
        camelliaFLs(iArr, this.f33101ke, 8);
    ...
    private void setKey(boolean z11, byte[] bArr) {
        ...
        if (this._keySize == 16) {
            ...
            if (z11) {
                ...
                iArr6[18] = iArr4[2];
                iArr6[19] = iArr4[3];
                roldq(17, iArr, 0, this.f33101ke, 4);
                ...
                roldq(15, iArr2, 0, this.f33101ke, 0);
            ...
            iArr9[16] = iArr4[0];
            iArr9[17] = iArr4[1];
            decroldq(17, iArr, 0, this.f33101ke, 0);
            ...
            decroldq(15, iArr2, 0, this.f33101ke, 4);
        ...
        if (z11) {
            ...
            roldq(15, iArr, 0, this.f33101ke, 4);
            roldq(17, iArr, 0, this.subkey, 32);
            roldqo32(34, iArr, 0, this.subkey, 44);
            roldq(15, iArr, 4, this.subkey, 4);
            roldq(15, iArr, 4, this.f33101ke, 0);
    ...
    public int processBlock(byte[] bArr, int i11, byte[] bArr2, int i12) throws IllegalStateException, DataLengthException {
        if (!this.initialised) {
            h2.b("Camellia engine not initialised");
            return 0;
        }
