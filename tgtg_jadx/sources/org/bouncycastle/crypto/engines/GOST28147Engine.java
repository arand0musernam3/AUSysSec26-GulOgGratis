...
public class GOST28147Engine implements BlockCipher {
    ...
    static {
        addSBox(AnalyticsValueType.DEFAULT_TYPE, Sbox_Default);
    ...
    private void GOST28147Func(int[] iArr, byte[] bArr, int i11, byte[] bArr2, int i12) {
        int i13;
        int i14;
        ...
        if (this.forEncryption) {
            for (int i16 = 0; i16 < 3; i16++) {
                int i17 = 0;
                while (i17 < 8) {
                    int iGOST28147_mainStep = iBytesToint2 ^ GOST28147_mainStep(iBytesToint, iArr[i17]);
                    i17++;
                    int i18 = iBytesToint;
            ...
            i14 = iBytesToint;
            while (i15 > 0) {
                int iGOST28147_mainStep2 = i13 ^ GOST28147_mainStep(i14, iArr[i15]);
                i15--;
                i13 = i14;
                i14 = iGOST28147_mainStep2;
            }
        } else {
            int i19 = 0;
            while (i19 < 8) {
                int iGOST28147_mainStep3 = iBytesToint2 ^ GOST28147_mainStep(iBytesToint, iArr[i19]);
                i19++;
                int i21 = iBytesToint;
            ...
            for (int i22 = 0; i22 < 3; i22++) {
                ...
                while (i23 >= 0 && (i22 != 2 || i23 != 0)) {
                    int iGOST28147_mainStep4 = i13 ^ GOST28147_mainStep(i14, iArr[i23]);
                    i23--;
                    i13 = i14;
                    i14 = iGOST28147_mainStep4;
                }
            }
        }
        int iGOST28147_mainStep5 = GOST28147_mainStep(i14, iArr[0]) ^ i13;
        intTobytes(i14, bArr2, i12);
        intTobytes(iGOST28147_mainStep5, bArr2, i12 + 4);
    }
    ...
    public static byte[] getSBox(String str) {
        ...
        a.f("Unknown S-Box - possible types: \"Default\", \"E-Test\", \"E-A\", \"E-B\", \"E-C\", \"E-D\", \"Param-Z\", \"D-Test\", \"D-A\".");
        return null;
    }
    ...
    public static String getSBoxName(byte[] bArr) {
        ...
        a.f("SBOX provided did not map to a known one");
        return null;
    }
    ...
    public void init(boolean z11, CipherParameters cipherParameters) {
        if (cipherParameters instanceof ParametersWithSBox) {
            ...
            if (sBox.length != Sbox_Default.length) {
                a.f("invalid S-box passed to GOST28147 init");
                return;
            } else {
                this.S = Arrays.clone(sBox);
                if (parametersWithSBox.getParameters() != null) {
                    this.workingKey = generateWorkingKey(z11, ((KeyParameter) parametersWithSBox.getParameters()).getKey());
                }
            }
        ...
        CryptoServicesRegistrar.checkConstraints(new DefaultServiceProperties(getAlgorithmName(), 178, cipherParameters, Utils.getPurpose(z11)));
    }
    ...
    public int processBlock(byte[] bArr, int i11, byte[] bArr2, int i12) {
        ...
        if (iArr == null) {
            h2.b("GOST28147 engine not initialised");
            return 0;
        }
        ...
        if (i12 + 8 <= bArr2.length) {
            GOST28147Func(iArr, bArr, i11, bArr2, i12);
            return 8;
        }
