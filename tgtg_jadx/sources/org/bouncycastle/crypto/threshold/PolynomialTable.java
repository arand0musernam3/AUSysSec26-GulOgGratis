...
class PolynomialTable extends Polynomial {
    ...
    public PolynomialTable(ShamirSecretSplitter.Algorithm algorithm) {
        int i11 = AnonymousClass1.$SwitchMap$org$bouncycastle$crypto$threshold$ShamirSecretSplitter$Algorithm[algorithm.ordinal()];
        if (i11 == 1) {
            this.LOG = AES_LOG;
            this.EXP = AES_EXP;
        } else {
    ...
    public byte gfDiv(int i11, int i12) {
        ...
        byte[] bArr = this.EXP;
        byte[] bArr2 = this.LOG;
        return bArr[(((bArr2[i11] & 255) - (bArr2[i12] & 255)) + 255) % 255];
    }
    ...
    public byte gfMul(int i11, int i12) {
        ...
        byte[] bArr = this.EXP;
        byte[] bArr2 = this.LOG;
        return (byte) (bArr[((bArr2[i11] & 255) + (bArr2[i12] & 255)) % 255] & 255);
    }
}
