...
public final class X448PrivateKeyParameters extends AsymmetricKeyParameter {
    ...
    private static byte[] validate(byte[] bArr) {
        ...
        a.f("'buf' must have length 56");
        return null;
    }

    public void encode(byte[] bArr, int i11) {
        System.arraycopy(this.data, 0, bArr, i11, 56);
    }
    ...
    public void generateSecret(X448PublicKeyParameters x448PublicKeyParameters, byte[] bArr, int i11) {
        byte[] bArr2 = new byte[56];
        x448PublicKeyParameters.encode(bArr2, 0);
        if (X448.calculateAgreement(this.data, 0, bArr2, 0, bArr, i11)) {
            return;
        }
        h2.b("X448 agreement failed");
    }
    ...
    public X448PrivateKeyParameters(byte[] bArr, int i11) {
        super(true);
        byte[] bArr2 = new byte[56];
        this.data = bArr2;
