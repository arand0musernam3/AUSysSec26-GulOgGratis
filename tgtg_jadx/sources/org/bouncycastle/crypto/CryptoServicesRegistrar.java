...
public final class CryptoServicesRegistrar {
    ...
    private static int chooseLowerBound(int i11) {
        if (i11 <= 1024) {
            return 160;
        }
        if (i11 <= 2048) {
    ...
    public static <T> T getSizedProperty(Property property, int i11) {
        Object[] objArrLookupProperty = lookupProperty(property);
        if (objArrLookupProperty == null) {
            return null;
        }
        ...
        if (property.type.isAssignableFrom(DHParameters.class)) {
            while (i12 != objArrLookupProperty.length) {
                ?? r42 = (T) ((DHParameters) objArrLookupProperty[i12]);
                if (r42.getP().bitLength() == i11) {
                    return r42;
                }
                i12++;
            }
            ...
            while (i12 != objArrLookupProperty.length) {
                ?? r43 = (T) ((DSAParameters) objArrLookupProperty[i12]);
                if (r43.getP().bitLength() == i11) {
                    return r43;
                }
                i12++;
            }
