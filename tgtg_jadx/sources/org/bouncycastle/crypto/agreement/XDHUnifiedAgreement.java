...
public class XDHUnifiedAgreement implements RawAgreement {
    ...
    public void calculateAgreement(CipherParameters cipherParameters, byte[] bArr, int i11) {
        ...
        this.xAgreement.calculateAgreement(xDHUPublicParameters.getEphemeralPublicKey(), bArr, i11);
        this.xAgreement.init(this.privParams.getStaticPrivateKey());
        this.xAgreement.calculateAgreement(xDHUPublicParameters.getStaticPublicKey(), bArr, this.xAgreement.getAgreementSize() + i11);
    }
