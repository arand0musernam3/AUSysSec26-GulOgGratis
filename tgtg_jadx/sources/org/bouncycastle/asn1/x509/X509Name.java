...
public class X509Name extends ASN1Object {
    ...
    static {
        ...
        hashtable4.put(Constants.BRAZE_PUSH_TITLE_KEY, aSN1ObjectIdentifier4);
    ...
    private ASN1ObjectIdentifier decodeOID(String str, Hashtable hashtable) {
        ...
        a.f(a0.p("Unknown object id - ", strTrim, " - passed to distinguished name"));
        return null;
    }
    ...
    private ASN1Primitive decodeObject(String str) {
        try {
            ...
            h2.b(i.k("unknown encoding in name: ", e5));
            return null;
        }
    }
    ...
    */
    public boolean equals(java.lang.Object r12) {
        ...
        Le:
            ...
            return r0
        L20:
            org.bouncycastle.asn1.x509.X509Name r12 = getInstance(r12)     // Catch: java.lang.IllegalArgumentException -> L91
    ...
    public Vector getValues(ASN1ObjectIdentifier aSN1ObjectIdentifier) {
        ...
        for (int i11 = 0; i11 != this.values.size(); i11++) {
            if (this.ordering.elementAt(i11).equals(aSN1ObjectIdentifier)) {
                String strSubstring = (String) this.values.elementAt(i11);
    ...
    public int hashCode() {
        ...
        for (int i11 = 0; i11 != this.ordering.size(); i11++) {
            String strStripInternalSpaces = stripInternalSpaces(canonicalize((String) this.values.elementAt(i11)));
            int iHashCode = this.hashCodeValue ^ this.ordering.elementAt(i11).hashCode();
    ...
    public ASN1Primitive toASN1Primitive() {
        if (this.seq == null) {
            ...
            for (int i11 = 0; i11 != this.ordering.size(); i11++) {
                ...
                aSN1ObjectIdentifier = (ASN1ObjectIdentifier) this.ordering.elementAt(i11);
                aSN1EncodableVector2.add(new DERSequence(aSN1ObjectIdentifier, this.converter.getConvertedValue(aSN1ObjectIdentifier, (String) this.values.elementAt(i11))));
            }
            aSN1EncodableVector.add(new DERSet(aSN1EncodableVector2));
    ...
    public boolean equals(Object obj, boolean z11) {
        ...
        try {
            ...
            for (int i11 = 0; i11 < size; i11++) {
                if (!((ASN1ObjectIdentifier) this.ordering.elementAt(i11)).equals((ASN1Primitive) x509Name.ordering.elementAt(i11)) || !equivalentStrings((String) this.values.elementAt(i11), (String) x509Name.values.elementAt(i11))) {
                    return false;
                }
            }
            return true;
    ...
    public X509Name(Vector vector, Hashtable hashtable, X509NameEntryConverter x509NameEntryConverter) {
        ...
        for (int i12 = 0; i12 != this.ordering.size(); i12++) {
            ...
            if (hashtable.get(aSN1ObjectIdentifier) == null) {
                i1.j("No attribute for object id - ", aSN1ObjectIdentifier.getId(), " - passed to distinguished name");
                throw null;
            }
    ...
    public X509Name(Vector vector, Vector vector2, X509NameEntryConverter x509NameEntryConverter) {
        ...
        if (vector.size() != vector2.size()) {
            a.f("oids vector must be same length as values.");
            throw null;
        }
        for (int i11 = 0; i11 < vector.size(); i11++) {
            this.ordering.addElement(vector.elementAt(i11));
    ...
    public X509Name(boolean z11, Hashtable hashtable, String str, X509NameEntryConverter x509NameEntryConverter) {
        ...
        if (z11) {
            ...
            int i11 = 1;
            for (int i12 = 0; i12 < this.ordering.size(); i12++) {
                boolean zBooleanValue = ((Boolean) this.added.elementAt(i12)).booleanValue();
                Vector vector4 = this.ordering;
                if (zBooleanValue) {
                    vector.insertElementAt(vector4.elementAt(i12), i11);
                    vector2.insertElementAt(this.values.elementAt(i12), i11);
                    vector3.insertElementAt(this.added.elementAt(i12), i11);
                    i11++;
                } else {
                    vector.insertElementAt(vector4.elementAt(i12), 0);
