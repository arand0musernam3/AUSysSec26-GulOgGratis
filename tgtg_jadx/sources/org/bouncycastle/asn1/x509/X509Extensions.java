...
public class X509Extensions extends ASN1Object {
        ...
        while (objects.hasMoreElements()) {
            ...
            if (aSN1Sequence2.size() == 3) {
                ...
                if (aSN1Sequence2.size() != 2) {
                    a.f(s.p(aSN1Sequence2, new StringBuilder("Bad sequence size: ")));
                    throw null;
                }
    ...
    private ASN1ObjectIdentifier[] getExtensionOIDs(boolean z11) {
        ...
        for (int i11 = 0; i11 != this.ordering.size(); i11++) {
            ...
            if (((X509Extension) this.extensions.get(objElementAt)).isCritical() == z11) {
    ...
    public X509Extensions(Vector vector, Hashtable hashtable) {
        ...
        while (true) {
            ...
            if (!zHasMoreElements) {
                ...
                vector2.addElement(ASN1ObjectIdentifier.getInstance(enumerationKeys.nextElement()));
            }
        }
    ...
    public X509Extensions(Vector vector, Vector vector2) {
        ...
        while (enumerationElements2.hasMoreElements()) {
            this.extensions.put((ASN1ObjectIdentifier) enumerationElements2.nextElement(), (X509Extension) vector2.elementAt(i11));
            i11++;
        }
    }
