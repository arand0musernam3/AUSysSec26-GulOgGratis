...
public class ObjectDigestInfo extends ASN1Object {
    ...
    private ObjectDigestInfo(ASN1Sequence aSN1Sequence) {
        ...
        this.digestAlgorithm = AlgorithmIdentifier.getInstance(aSN1Sequence.getObjectAt(i11 + 1));
        this.objectDigest = ASN1BitString.getInstance(aSN1Sequence.getObjectAt(i11 + 2));
    }
    ...
    public static ObjectDigestInfo getInstance(ASN1TaggedObject aSN1TaggedObject, boolean z11) {
        return getInstance(ASN1Sequence.getInstance(aSN1TaggedObject, z11));
    }

    public ObjectDigestInfo(int i11, ASN1ObjectIdentifier aSN1ObjectIdentifier, AlgorithmIdentifier algorithmIdentifier, byte[] bArr) {
        this.digestedObjectType = new ASN1Enumerated(i11);
        if (i11 == 2) {
