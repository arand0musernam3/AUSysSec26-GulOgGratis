...
public class DisplayText extends ASN1Object implements ASN1Choice {
    ...
    public DisplayText(int i11, String str) {
        ...
        ASN1String dERUTF8String = i11 != 0 ? i11 != 1 ? (i11 == 2 || i11 != 3) ? new DERUTF8String(str) : new DERVisibleString(str) : new DERBMPString(str) : new DERIA5String(str);
    ...
    private DisplayText(ASN1String aSN1String) {
        ...
        if (aSN1String instanceof ASN1UTF8String) {
            ...
            if (!(aSN1String instanceof ASN1VisibleString)) {
                a.f("unknown STRING type in DisplayText");
                throw null;
            }
            i11 = 3;
        }
