...
public class Certificate extends ASN1Object {
    ...
    public Certificate(TBSCertificate tBSCertificate, AlgorithmIdentifier algorithmIdentifier, ASN1BitString aSN1BitString) {
        if (tBSCertificate == null) {
            w.l("'tbsCertificate' cannot be null");
            throw null;
        }
        if (algorithmIdentifier == null) {
            w.l("'signatureAlgorithm' cannot be null");
            throw null;
        }
    ...
    public static Certificate getInstance(ASN1TaggedObject aSN1TaggedObject, boolean z11) {
    ...
    private Certificate(ASN1Sequence aSN1Sequence) {
        ...
        if (aSN1Sequence.size() != 3) {
            a.f("sequence wrong size for a certificate");
            throw null;
        }
