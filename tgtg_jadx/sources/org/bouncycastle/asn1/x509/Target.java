...
public class Target extends ASN1Object implements ASN1Choice {
    ...
    private Target(ASN1TaggedObject aSN1TaggedObject) {
        ...
        if (tagNo == 0) {
            ...
            o.l(aSN1TaggedObject.getTagNo(), "unknown tag: ");
            throw null;
        }
    }
    ...
    public static Target getInstance(Object obj) {
        ...
        d.t(obj.getClass(), "unknown object in factory: ");
        return null;
    }
    ...
    public Target(int i11, GeneralName generalName) {
        this(new DERTaggedObject(i11, generalName));
    }
}
