...
public class Iso4217CurrencyCode extends ASN1Object implements ASN1Choice {
    ...
    final int NUMERIC_MAXSIZE = InAppMessageBase.INAPP_MESSAGE_DURATION_MIN_MILLIS;

    public Iso4217CurrencyCode(String str) {
        if (str.length() <= 3) {
            this.obj = new DERPrintableString(str);
        } else {
            a.f("wrong size in alphabetic code : max size is 3");
            throw null;
        }
    }
    ...
    public Iso4217CurrencyCode(int i11) {
        if (i11 > 999 || i11 < 1) {
            a.f("wrong size in numeric code : not in (1..999)");
            throw null;
        }
