...
public class AltSignatureValue extends ASN1Object {
    ...
    public static AltSignatureValue getInstance(ASN1TaggedObject aSN1TaggedObject, boolean z11) {
        return getInstance(ASN1BitString.getInstance(aSN1TaggedObject, z11));
    }
}
