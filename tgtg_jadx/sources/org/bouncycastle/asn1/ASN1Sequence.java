...
public abstract class ASN1Sequence extends ASN1Primitive implements Iterable<ASN1Encodable> {
    ...
    public ASN1Sequence(ASN1Encodable aSN1Encodable, ASN1Encodable aSN1Encodable2) {
        if (aSN1Encodable == null) {
            w.l("'element1' cannot be null");
            throw null;
        }
        if (aSN1Encodable2 != null) {
            this.elements = new ASN1Encodable[]{aSN1Encodable, aSN1Encodable2};
        } else {
            w.l("'element2' cannot be null");
            throw null;
        }
    }
        ...
        if (!(obj instanceof ASN1Encodable)) {
            if (obj instanceof byte[]) {
                try {
                    ...
                    strG = s.g(e5, new StringBuilder("failed to construct sequence from byte[]: "));
                }
            }
            a.f(strG);
            return null;
    ...
    public ASN1Sequence(ASN1EncodableVector aSN1EncodableVector) {
        if (aSN1EncodableVector != null) {
            ...
            w.l("'elementVector' cannot be null");
            throw null;
        }
    }
    ...
    public ASN1Sequence(ASN1Encodable[] aSN1EncodableArr) {
        if (Arrays.isNullOrContainsNull(aSN1EncodableArr)) {
            w.l("'elements' cannot be null, or contain null");
            throw null;
        }
