...
public class X962Parameters extends ASN1Object implements ASN1Choice {
    ...
    public static X962Parameters getInstance(Object obj) {
        ...
        if (obj instanceof byte[]) {
            try {
                ...
                strJ = k.j(e5, new StringBuilder("unable to parse encoded data: "));
            }
        } else {
            strJ = "unknown object in getInstance()";
        }
        a.f(strJ);
        return null;
    }
    ...
    public static X962Parameters getInstance(ASN1TaggedObject aSN1TaggedObject, boolean z11) {
        if (z11) {
