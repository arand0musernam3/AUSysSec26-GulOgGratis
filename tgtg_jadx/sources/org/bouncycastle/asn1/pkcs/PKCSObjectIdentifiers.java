...
public interface PKCSObjectIdentifiers {
    ...
    public static final ASN1ObjectIdentifier id_mod_CMS_AEADChaCha20Poly1305;
    public static final ASN1ObjectIdentifier id_mod_cms_seed;
    public static final ASN1ObjectIdentifier id_mod_mts_hashsig_2013;
    ...
    static {
        ...
        pkcs_7 = s.w("1.2.840.113549.1.7");
        data = s.w("1.2.840.113549.1.7.1");
        signedData = s.w("1.2.840.113549.1.7.2");
        envelopedData = s.w("1.2.840.113549.1.7.3");
        signedAndEnvelopedData = s.w("1.2.840.113549.1.7.4");
        digestedData = s.w("1.2.840.113549.1.7.5");
        encryptedData = s.w("1.2.840.113549.1.7.6");
        ...
        id_mod_mts_hashsig_2013 = new ASN1ObjectIdentifier("1.2.840.113549.1.9.16.0.64");
        id_mod_CMS_AEADChaCha20Poly1305 = new ASN1ObjectIdentifier("1.2.840.113549.1.9.16.0.66");
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch3 = aSN1ObjectIdentifierIntern.branch("1");
        id_ct = aSN1ObjectIdentifierBranch3;
        id_ct_authData = aSN1ObjectIdentifierBranch3.branch("2");
        id_ct_TSTInfo = aSN1ObjectIdentifierBranch3.branch("4");
        id_ct_compressedData = aSN1ObjectIdentifierBranch3.branch("9");
        id_ct_authEnvelopedData = aSN1ObjectIdentifierBranch3.branch("23");
        id_ct_timestampedData = aSN1ObjectIdentifierBranch3.branch("31");
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch4 = aSN1ObjectIdentifierIntern.branch("3");
        smime_alg = aSN1ObjectIdentifierBranch4;
        id_alg = aSN1ObjectIdentifierIntern.branch("3");
        id_alg_ESDH = aSN1ObjectIdentifierBranch4.branch("5");
        id_alg_CMS3DESwrap = aSN1ObjectIdentifierBranch4.branch("6");
        id_alg_CMSRC2wrap = aSN1ObjectIdentifierBranch4.branch("7");
        id_alg_zlibCompress = aSN1ObjectIdentifierBranch4.branch("8");
        id_alg_PWRI_KEK = aSN1ObjectIdentifierBranch4.branch("9");
        id_alg_SSDH = aSN1ObjectIdentifierBranch4.branch("10");
        id_rsa_KEM = aSN1ObjectIdentifierBranch4.branch("14");
        id_alg_hss_lms_hashsig = aSN1ObjectIdentifierBranch4.branch("17");
        id_alg_AEADChaCha20Poly1305 = aSN1ObjectIdentifierBranch4.branch("18");
        id_alg_hkdf_with_sha256 = aSN1ObjectIdentifierBranch4.branch("28");
        id_alg_hkdf_with_sha384 = aSN1ObjectIdentifierBranch4.branch("29");
        id_alg_hkdf_with_sha512 = aSN1ObjectIdentifierBranch4.branch("30");
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch5 = aSN1ObjectIdentifierIntern.branch("6");
        id_cti = aSN1ObjectIdentifierBranch5;
        id_cti_ets_proofOfOrigin = aSN1ObjectIdentifierBranch5.branch("1");
        id_cti_ets_proofOfReceipt = aSN1ObjectIdentifierBranch5.branch("2");
        id_cti_ets_proofOfDelivery = aSN1ObjectIdentifierBranch5.branch("3");
        id_cti_ets_proofOfSender = aSN1ObjectIdentifierBranch5.branch("4");
        id_cti_ets_proofOfApproval = aSN1ObjectIdentifierBranch5.branch("5");
        id_cti_ets_proofOfCreation = aSN1ObjectIdentifierBranch5.branch("6");
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch6 = aSN1ObjectIdentifierIntern.branch("2");
        id_aa = aSN1ObjectIdentifierBranch6;
        pkcs_9_at_binarySigningTime = aSN1ObjectIdentifierBranch6.branch("46").intern();
        id_aa_receiptRequest = aSN1ObjectIdentifierBranch6.branch("1");
        id_aa_contentHint = aSN1ObjectIdentifierBranch6.branch("4");
        id_aa_msgSigDigest = aSN1ObjectIdentifierBranch6.branch("5");
        id_aa_contentReference = aSN1ObjectIdentifierBranch6.branch("10");
        id_aa_encrypKeyPref = aSN1ObjectIdentifierBranch6.branch("11");
        id_aa_signingCertificate = aSN1ObjectIdentifierBranch6.branch("12");
        id_aa_signingCertificateV2 = aSN1ObjectIdentifierBranch6.branch("47");
        id_aa_contentIdentifier = aSN1ObjectIdentifierBranch6.branch("7");
        id_aa_signatureTimeStampToken = aSN1ObjectIdentifierBranch6.branch("14");
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch7 = aSN1ObjectIdentifierBranch6.branch("15");
        id_aa_ets_sigPolicyId = aSN1ObjectIdentifierBranch7;
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch8 = aSN1ObjectIdentifierBranch6.branch("16");
        id_aa_ets_commitmentType = aSN1ObjectIdentifierBranch8;
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch9 = aSN1ObjectIdentifierBranch6.branch("17");
        id_aa_ets_signerLocation = aSN1ObjectIdentifierBranch9;
        id_aa_ets_signerAttr = aSN1ObjectIdentifierBranch6.branch("18");
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch10 = aSN1ObjectIdentifierBranch6.branch("19");
        id_aa_ets_otherSigCert = aSN1ObjectIdentifierBranch10;
        id_aa_ets_contentTimestamp = aSN1ObjectIdentifierBranch6.branch("20");
        id_aa_ets_certificateRefs = aSN1ObjectIdentifierBranch6.branch("21");
        id_aa_ets_revocationRefs = aSN1ObjectIdentifierBranch6.branch("22");
        id_aa_ets_certValues = aSN1ObjectIdentifierBranch6.branch("23");
        id_aa_ets_revocationValues = aSN1ObjectIdentifierBranch6.branch("24");
        id_aa_ets_escTimeStamp = aSN1ObjectIdentifierBranch6.branch("25");
        id_aa_ets_certCRLTimestamp = aSN1ObjectIdentifierBranch6.branch("26");
        id_aa_ets_archiveTimestamp = aSN1ObjectIdentifierBranch6.branch("27");
        id_aa_decryptKeyID = aSN1ObjectIdentifierBranch6.branch("37");
        id_aa_implCryptoAlgs = aSN1ObjectIdentifierBranch6.branch("38");
        id_aa_asymmDecryptKeyID = aSN1ObjectIdentifierBranch6.branch("54");
        id_aa_implCompressAlgs = aSN1ObjectIdentifierBranch6.branch("43");
        id_aa_communityIdentifiers = aSN1ObjectIdentifierBranch6.branch("40");
        id_aa_sigPolicyId = aSN1ObjectIdentifierBranch7;
        id_aa_commitmentType = aSN1ObjectIdentifierBranch8;
        id_aa_signerLocation = aSN1ObjectIdentifierBranch9;
        id_aa_otherSigCert = aSN1ObjectIdentifierBranch10;
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch11 = aSN1ObjectIdentifierIntern.branch("5");
        id_spq_oid = aSN1ObjectIdentifierBranch11;
        id_spq_ets_uri = aSN1ObjectIdentifierBranch11.branch("1");
        id_spq_ets_unotice = aSN1ObjectIdentifierBranch11.branch("2");
        ASN1ObjectIdentifier aSN1ObjectIdentifier7 = new ASN1ObjectIdentifier("1.2.840.113549.1.12");
        pkcs_12 = aSN1ObjectIdentifier7;
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch12 = aSN1ObjectIdentifier7.branch("10.1");
        bagtypes = aSN1ObjectIdentifierBranch12;
        keyBag = aSN1ObjectIdentifierBranch12.branch("1");
        pkcs8ShroudedKeyBag = aSN1ObjectIdentifierBranch12.branch("2");
        certBag = aSN1ObjectIdentifierBranch12.branch("3");
        crlBag = aSN1ObjectIdentifierBranch12.branch("4");
        secretBag = aSN1ObjectIdentifierBranch12.branch("5");
        safeContentsBag = aSN1ObjectIdentifierBranch12.branch("6");
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch13 = aSN1ObjectIdentifier7.branch("1");
        pkcs_12PbeIds = aSN1ObjectIdentifierBranch13;
        pbeWithSHAAnd128BitRC4 = aSN1ObjectIdentifierBranch13.branch("1");
        pbeWithSHAAnd40BitRC4 = aSN1ObjectIdentifierBranch13.branch("2");
        pbeWithSHAAnd3_KeyTripleDES_CBC = aSN1ObjectIdentifierBranch13.branch("3");
        pbeWithSHAAnd2_KeyTripleDES_CBC = aSN1ObjectIdentifierBranch13.branch("4");
        pbeWithSHAAnd128BitRC2_CBC = aSN1ObjectIdentifierBranch13.branch("5");
        pbeWithSHAAnd40BitRC2_CBC = aSN1ObjectIdentifierBranch13.branch("6");
        pbewithSHAAnd40BitRC2_CBC = aSN1ObjectIdentifierBranch13.branch("6");
    }
}
