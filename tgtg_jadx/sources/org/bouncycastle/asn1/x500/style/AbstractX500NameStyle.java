...
public abstract class AbstractX500NameStyle implements X500NameStyle {
    ...
    public boolean areEqual(X500Name x500Name, X500Name x500Name2) {
        ...
        boolean z11 = (rDNs[0].getFirst() == null || rDNs2[0].getFirst() == null) ? false : !r0.getType().equals((ASN1Primitive) r1.getType());
        ...
        for (int i11 = 0; i11 != rDNs.length; i11++) {
            if (rDNs[i11].isMultiValued()) {
                ...
                for (int i12 = 0; i12 != typesAndValues.length; i12++) {
                    iHashCode = (iHashCode ^ typesAndValues[i12].getType().hashCode()) ^ calcHashCode(typesAndValues[i12].getValue());
                }
            } else {
                iHashCode = (iHashCode ^ rDNs[i11].getFirst().getType().hashCode()) ^ calcHashCode(rDNs[i11].getFirst().getValue());
            }
        }
        return iHashCode;
    }
