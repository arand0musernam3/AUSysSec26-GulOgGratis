...
public class ASN1InputStream extends FilterInputStream implements BERTags {
    ...
    public static ASN1Primitive createPrimitiveDERObject(int i11, DefiniteLengthInputStream definiteLengthInputStream, byte[][] bArr) throws IOException {
        try {
            switch (i11) {
                ...
                case 36:
                    throw new IOException("unsupported tag " + i11 + " encountered");
                case 18:
    ...
    private static char[] getBMPCharBuffer(DefiniteLengthInputStream definiteLengthInputStream) throws IOException {
        ...
        if ((remaining & 1) != 0) {
            a.k("malformed BMPString encoding encountered");
            return null;
        }
        int i11 = remaining / 2;
    ...
    public static int readLength(InputStream inputStream, int i11, boolean z11) throws IOException {
        ...
        if (255 != i12) {
            ...
            while (true) {
                ...
                if ((i14 >>> 23) != 0) {
                    strK = "long form definite-length more than 31 bits";
                    break;
                }
                i14 = (i14 << 8) + i16;
                i15++;
                if (i15 >= i13) {
                    ...
                    strK = k.k("corrupted stream - out of bounds length found: ", i14, i11, " >= ");
                }
            }
        } else {
            strK = "invalid long form definite-length 0xFF";
        }
        a.k(strK);
        return 0;
    }
    ...
    public ASN1BitString buildConstructedBitString(ASN1EncodableVector aSN1EncodableVector) throws IOException {
        ...
        for (int i11 = 0; i11 != size; i11++) {
            ...
            if (!(aSN1Encodable instanceof ASN1BitString)) {
                i1.h(aSN1Encodable.getClass(), "unknown object encountered in constructed BIT STRING: ");
                return null;
            }
    ...
    public ASN1OctetString buildConstructedOctetString(ASN1EncodableVector aSN1EncodableVector) throws IOException {
        ...
        for (int i11 = 0; i11 != size; i11++) {
            ...
            if (!(aSN1Encodable instanceof ASN1OctetString)) {
                i1.h(aSN1Encodable.getClass(), "unknown object encountered in constructed OCTET STRING: ");
                return null;
            }
    ...
    public ASN1Primitive buildObject(int i11, int i12, int i13) throws IOException {
        ...
        int i14 = i11 & BERTags.PRIVATE;
        if (i14 != 0) {
            return readTaggedObjectDL(i14, i12, (i11 & 32) != 0, definiteLengthInputStream);
        }
        if (i12 == 3) {
        ...
        a.k(k.h(i12, "unknown tag ", " encountered"));
        return null;
    }
    ...
    public ASN1Primitive readObject() throws IOException {
        ...
        if (i11 > 0) {
            ...
            if ((i11 & 32) != 0) {
                ...
                if (i12 != 0) {
                    return aSN1StreamParser.loadTaggedIL(i12, tagNumber);
                }
                if (tagNumber == 3) {
