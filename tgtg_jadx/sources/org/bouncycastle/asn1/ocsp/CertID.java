...
public class CertID extends ASN1Object {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ASN1Encodable) {
            try {
                ...
                if (this.hashAlgorithm.getAlgorithm().equals((ASN1Primitive) certID.hashAlgorithm.getAlgorithm()) && isEqual(this.hashAlgorithm.getParameters(), certID.hashAlgorithm.getParameters()) && this.issuerNameHash.equals((ASN1Primitive) certID.issuerNameHash) && this.issuerKeyHash.equals((ASN1Primitive) certID.issuerKeyHash)) {
    ...
    public int hashCode() {
        ...
        return (((((((this.serialNumber.hashCode() * 7) + this.issuerKeyHash.hashCode()) * 7) + this.issuerNameHash.hashCode()) * 7) + this.hashAlgorithm.getAlgorithm().hashCode()) * 7) + ((parameters == null || DERNull.INSTANCE.equals(parameters)) ? 0 : parameters.hashCode());
    }
    ...
    public static CertID getInstance(ASN1TaggedObject aSN1TaggedObject, boolean z11) {
