...
public class TBSRequest extends ASN1Object {
    ...
    private TBSRequest(ASN1Sequence aSN1Sequence) {
        ...
        if (aSN1Sequence.getObjectAt(i11) instanceof ASN1TaggedObject) {
            this.requestorName = GeneralName.getInstance((ASN1TaggedObject) aSN1Sequence.getObjectAt(i11), true);
            i11++;
        }
        int i12 = i11 + 1;
        this.requestList = (ASN1Sequence) aSN1Sequence.getObjectAt(i11);
        if (aSN1Sequence.size() == i11 + 2) {
            this.requestExtensions = Extensions.getInstance((ASN1TaggedObject) aSN1Sequence.getObjectAt(i12), true);
        }
    }
    ...
    public static TBSRequest getInstance(ASN1TaggedObject aSN1TaggedObject, boolean z11) {
