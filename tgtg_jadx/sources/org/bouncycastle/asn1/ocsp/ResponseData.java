...
public class ResponseData extends ASN1Object {
    ...
    private ResponseData(ASN1Sequence aSN1Sequence) {
        ...
        this.responderID = ResponderID.getInstance(aSN1Sequence.getObjectAt(i11));
        int i12 = i11 + 2;
        this.producedAt = ASN1GeneralizedTime.getInstance(aSN1Sequence.getObjectAt(i11 + 1));
        int i13 = i11 + 3;
    ...
    public static ResponseData getInstance(ASN1TaggedObject aSN1TaggedObject, boolean z11) {
