...
public class SignatureCheck extends ASN1Object {
    ...
    private SignatureCheck(ASN1Sequence aSN1Sequence) {
        ...
        this.signatureValue = ASN1BitString.getInstance(aSN1Sequence.getObjectAt(i11));
    }
    ...
    public Certificate[] getCertificates() {
        ...
        for (int i11 = 0; i11 != size; i11++) {
            certificateArr[i11] = Certificate.getInstance(this.certificates.getObjectAt(i11));
        }
