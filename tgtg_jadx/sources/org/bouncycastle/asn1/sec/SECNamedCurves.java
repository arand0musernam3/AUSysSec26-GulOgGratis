...
public class SECNamedCurves {
    ...
    static X9ECParametersHolder sect131r1 = new X9ECParametersHolder() { // from class: org.bouncycastle.asn1.sec.SECNamedCurves.18
        @Override // org.bouncycastle.asn1.x9.X9ECParametersHolder
        public ECCurve createCurve() {
            return SECNamedCurves.configureCurve(new ECCurve.F2m(AppConstants.RESULT_CODE_ORDER_NOT_COLLECTED, 2, 3, 8, SECNamedCurves.fromHex("07A11B09A76B562144418FF3FF8C2570B8"), SECNamedCurves.fromHex("0217C05610884B63B9C6C7291678F9D341"), SECNamedCurves.fromHex("0400000000000000023123953A9464B54D"), BigInteger.valueOf(2L)));
        }
    ...
    static X9ECParametersHolder sect131r2 = new X9ECParametersHolder() { // from class: org.bouncycastle.asn1.sec.SECNamedCurves.19
        @Override // org.bouncycastle.asn1.x9.X9ECParametersHolder
        public ECCurve createCurve() {
            return SECNamedCurves.configureCurve(new ECCurve.F2m(AppConstants.RESULT_CODE_ORDER_NOT_COLLECTED, 2, 3, 8, SECNamedCurves.fromHex("03E5A88919D7CAFCBF415F07C2176573B2"), SECNamedCurves.fromHex("04B8266A46C55657AC734CE38F018F2192"), SECNamedCurves.fromHex("0400000000000000016954A233049BA98F"), BigInteger.valueOf(2L)));
        }
