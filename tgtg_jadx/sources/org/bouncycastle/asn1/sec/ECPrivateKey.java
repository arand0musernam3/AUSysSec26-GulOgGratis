...
public class ECPrivateKey extends ASN1Object {
    ...
    public ECPrivateKey(int i11, BigInteger bigInteger, ASN1BitString aSN1BitString, ASN1Encodable aSN1Encodable) {
        byte[] bArrAsUnsignedByteArray = BigIntegers.asUnsignedByteArray((i11 + 7) / 8, bigInteger);
    ...
    private ASN1Object getObjectInTag(int i11, int i12) {
        Enumeration objects = this.seq.getObjects();
        while (objects.hasMoreElements()) {
            ASN1Encodable aSN1Encodable = (ASN1Encodable) objects.nextElement();
            if (aSN1Encodable instanceof ASN1TaggedObject) {
                ASN1TaggedObject aSN1TaggedObject = (ASN1TaggedObject) aSN1Encodable;
                if (aSN1TaggedObject.hasContextTag(i11)) {
                    return i12 < 0 ? aSN1TaggedObject.getExplicitBaseObject().toASN1Primitive() : aSN1TaggedObject.getBaseUniversal(true, i12);
                }
            }
        }
        return null;
    ...
    public ECPrivateKey(int i11, BigInteger bigInteger) {
        this.seq = new DERSequence(new ASN1Integer(1L), new DEROctetString(BigIntegers.asUnsignedByteArray((i11 + 7) / 8, bigInteger)));
    }

    public ECPrivateKey(int i11, BigInteger bigInteger, ASN1Encodable aSN1Encodable) {
