...
public final class f extends z70.i implements Function2 {
    ...
    public final /* synthetic */ i f27913k;
    ...
    public final x70.c create(Object obj, x70.c cVar) {
        return new f(this.f27913k, cVar);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i11 == 0) {
            ...
            b1 b1Var = new b1(iVar, null, 11);
            this.f27912j = 1;
            if (x0.b(viewLifecycleOwner, state, b1Var, this) == aVar) {
                return aVar;
            }
        } else {
            if (i11 != 1) {
