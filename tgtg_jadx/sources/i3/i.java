...
public final class i extends z70.i implements Function2 {
    ...
    public final /* synthetic */ int f23121j;
    ...
    public /* synthetic */ i(ea eaVar, x70.c cVar, int i11) {
        super(2, cVar);
        this.f23121j = i11;
        this.l = eaVar;
    }
        ...
        switch (this.f23121j) {
            case 0:
                ...
                if (i11 != 0) {
                    ...
                    ba0.g.M(obj);
                    this.f23122k = 1;
                    if (this.l.c(j1.Default, this) == aVar) {
                    }
                }
                break;
            default:
                y70.a aVar2 = y70.a.COROUTINE_SUSPENDED;
                int i12 = this.f23122k;
                if (i12 != 0) {
                    if (i12 != 1) {
                        h2.b("call to 'resume' before 'invoke' with coroutine");
                    } else {
