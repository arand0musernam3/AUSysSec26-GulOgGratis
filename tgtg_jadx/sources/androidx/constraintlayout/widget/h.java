...
public final class h {
    ...
    public final ArrayList f2378b = new ArrayList();

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public final int f2379c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    public final q f2380d;
    ...
    public h(Context context, XmlResourceParser xmlResourceParser) {
        ...
        for (int i11 = 0; i11 < indexCount; i11++) {
            ...
            if (index == 0) {
                this.f2377a = typedArrayObtainStyledAttributes.getResourceId(index, this.f2377a);
            } else if (index == 1) {
                int resourceId = typedArrayObtainStyledAttributes.getResourceId(index, this.f2379c);
                this.f2379c = resourceId;
