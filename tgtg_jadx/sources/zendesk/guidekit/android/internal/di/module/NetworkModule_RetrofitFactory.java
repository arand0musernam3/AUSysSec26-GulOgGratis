...
public final class NetworkModule_RetrofitFactory implements c {
    ...
    public static o0 retrofit(NetworkModule networkModule, String str, d0 d0Var, j jVar) {
        o0 o0VarRetrofit = networkModule.retrofit(str, d0Var, jVar);
        x0.o(o0VarRetrofit);
    ...
    @Override // t70.a
    public o0 get() {
        return retrofit(this.module, (String) this.baseUrlProvider.get(), (d0) this.okHttpClientProvider.get(), (j) this.converterFactoryProvider.get());
    }
}
