...
public final class BackNavigationResolver_Factory implements c {
    private final c conversationKitProvider;
    private final c messagingSettingsProvider;

    private BackNavigationResolver_Factory(c cVar, c cVar2) {
        this.conversationKitProvider = cVar;
        this.messagingSettingsProvider = cVar2;
    }

    public static BackNavigationResolver_Factory create(c cVar, c cVar2) {
        return new BackNavigationResolver_Factory(cVar, cVar2);
    }
