...
public final /* data */ class MessageList {
    ...
    @NotNull
    private static final j[] $childSerializers = {l.a(m.PUBLICATION, new b(24)), null, null};

    public /* synthetic */ MessageList(int i11, List list, Boolean bool, Boolean bool2, m1 m1Var) {
        if (7 != (i11 & 7)) {
            c1.j(i11, 7, MessageList$$serializer.INSTANCE.getDescriptor());
            throw null;
        }
        this.messages = list;
    ...
    public static /* synthetic */ MessageList copy$default(MessageList messageList, List list, Boolean bool, Boolean bool2, int i11, Object obj) {
        if ((i11 & 1) != 0) {
    ...
    public static final /* synthetic */ void write$Self$zendesk_conversationkit_conversationkit_android(MessageList self, l90.b output, SerialDescriptor serialDesc) {
    ...
    @NotNull
    public final MessageList copy(@NotNull List<Message> messages, @Nullable Boolean hasPrevious, @Nullable Boolean hasNext) {
        messages.getClass();
        return new MessageList(messages, hasPrevious, hasNext);
    }
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return Intrinsics.areEqual(this.messages, messageList.messages) && Intrinsics.areEqual(this.hasPrevious, messageList.hasPrevious) && Intrinsics.areEqual(this.hasNext, messageList.hasNext);
    }
    ...
    /* JADX INFO: compiled from: r8-map-id-bad8e3e1b75e2d3fd72c92f1b960553adb24fef824cc9e98cee450b85845d4c2 */
    @Metadata(d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\f\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00060\u0005¨\u0006\u0007"}, d2 = {"Lzendesk/conversationkit/android/model/MessageList$Companion;", "", "<init>", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lzendesk/conversationkit/android/model/MessageList;", "zendesk.conversationkit_conversationkit-android"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final class Companion {
        ...
        public final KSerializer serializer() {
            return MessageList$$serializer.INSTANCE;
        }
    ...
    public MessageList(@NotNull List<Message> list, @Nullable Boolean bool, @Nullable Boolean bool2) {
        list.getClass();
        this.messages = list;
        this.hasPrevious = bool;
        this.hasNext = bool2;
