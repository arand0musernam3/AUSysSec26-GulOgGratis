...
public /* synthetic */ class ResponseTimeDto$$serializer implements d0 {
    ...
    static {
        ...
        e1 e1Var = new e1("zendesk.conversationkit.android.model.ResponseTimeDto", responseTimeDto$$serializer, 3);
        e1Var.j("upper", false);
        e1Var.j("lower", false);
        e1Var.j("value", false);
        descriptor = e1Var;
    ...
    @Override // i90.b
    @NotNull
    public final ResponseTimeDto deserialize(@NotNull Decoder decoder) {
        decoder.getClass();
        ...
        return new ResponseTimeDto(i11, iQ, iQ2, iQ3, null);
    }
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull ResponseTimeDto value) {
        encoder.getClass();
        value.getClass();
        SerialDescriptor serialDescriptor = descriptor;
        b bVarC = encoder.c(serialDescriptor);
        ResponseTimeDto.write$Self$zendesk_conversationkit_conversationkit_android(value, bVarC, serialDescriptor);
