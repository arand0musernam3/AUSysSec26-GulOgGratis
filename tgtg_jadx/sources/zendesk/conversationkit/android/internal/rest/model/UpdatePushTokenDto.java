...
public final /* data */ class UpdatePushTokenDto {
    ...
    public /* synthetic */ UpdatePushTokenDto(int i11, String str, String str2, m1 m1Var) {
        if (3 != (i11 & 3)) {
            c1.j(i11, 3, UpdatePushTokenDto$$serializer.INSTANCE.getDescriptor());
            throw null;
        }
    ...
    public static /* synthetic */ UpdatePushTokenDto copy$default(UpdatePushTokenDto updatePushTokenDto, String str, String str2, int i11, Object obj) {
        if ((i11 & 1) != 0) {
    ...
    public static final /* synthetic */ void write$Self$zendesk_conversationkit_conversationkit_android(UpdatePushTokenDto self, b output, SerialDescriptor serialDesc) {
        r1 r1Var = r1.f29848a;
        output.r(serialDesc, 0, r1Var, self.pushNotificationToken);
        output.r(serialDesc, 1, r1Var, self.integrationId);
    }
    ...
    @NotNull
    public final UpdatePushTokenDto copy(@Nullable String pushNotificationToken, @Nullable String integrationId) {
    ...
    public String toString() {
        return a.d("UpdatePushTokenDto(pushNotificationToken=", this.pushNotificationToken, ", integrationId=", this.integrationId, ")");
    }

    /* JADX INFO: compiled from: r8-map-id-bad8e3e1b75e2d3fd72c92f1b960553adb24fef824cc9e98cee450b85845d4c2 */
    @Metadata(d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\f\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00060\u0005¨\u0006\u0007"}, d2 = {"Lzendesk/conversationkit/android/internal/rest/model/UpdatePushTokenDto$Companion;", "", "<init>", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lzendesk/conversationkit/android/internal/rest/model/UpdatePushTokenDto;", "zendesk.conversationkit_conversationkit-android"}, k = 1, mv = {2, 1, 0}, xi = 48)
    ...
    public UpdatePushTokenDto(@Nullable String str, @Nullable String str2) {
        this.pushNotificationToken = str;
        this.integrationId = str2;
    }
}
