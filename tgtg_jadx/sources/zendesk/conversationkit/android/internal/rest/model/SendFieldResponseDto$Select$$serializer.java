...
public /* synthetic */ class SendFieldResponseDto$Select$$serializer implements d0 {
    ...
    static {
        ...
        e1 e1Var = new e1("select", sendFieldResponseDto$Select$$serializer, 5);
    ...
    public final KSerializer[] childSerializers() {
        j[] jVarArr = SendFieldResponseDto.Select.$childSerializers;
        r1 r1Var = r1.f29848a;
        return new KSerializer[]{r1Var, r1Var, r1Var, r1Var, jVarArr[4].getValue()};
    }
    ...
    public final SendFieldResponseDto.Select deserialize(@NotNull Decoder decoder) {
        ...
        return new SendFieldResponseDto.Select(i11, strU, strU2, strU3, strU4, list, null);
    }
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull SendFieldResponseDto.Select value) {
        ...
        SendFieldResponseDto.Select.write$Self$zendesk_conversationkit_conversationkit_android(value, bVarC, serialDescriptor);
