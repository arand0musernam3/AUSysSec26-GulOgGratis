...
public /* synthetic */ class ParticipantDto$$serializer implements d0 {
    ...
    static {
        ...
        e1 e1Var = new e1("zendesk.conversationkit.android.internal.rest.model.ParticipantDto", participantDto$$serializer, 4);
        e1Var.j("_id", false);
    ...
    public final KSerializer[] childSerializers() {
        ...
        r1 r1Var = r1.f29848a;
        return new KSerializer[]{r1Var, r1Var, kSerializerB, kSerializerB2};
    }

    @Override // i90.b
    @NotNull
    public final ParticipantDto deserialize(@NotNull Decoder decoder) {
        decoder.getClass();
        ...
        while (z11) {
            ...
            if (iW == -1) {
                ...
                d3 = (Double) aVarC.m(serialDescriptor, 3, v.f29868a, d3);
                i11 |= 8;
            }
        }
        aVarC.b(serialDescriptor);
        return new ParticipantDto(i11, strU, strU2, num, d3, null);
    }
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull ParticipantDto value) {
        encoder.getClass();
        value.getClass();
        SerialDescriptor serialDescriptor = descriptor;
        b bVarC = encoder.c(serialDescriptor);
        ParticipantDto.write$Self$zendesk_conversationkit_conversationkit_android(value, bVarC, serialDescriptor);
