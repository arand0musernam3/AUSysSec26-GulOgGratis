...
public /* synthetic */ class LoginRequestBody$$serializer implements d0 {
    ...
    static {
        ...
        e1 e1Var = new e1("zendesk.conversationkit.android.internal.rest.user.model.LoginRequestBody", loginRequestBody$$serializer, 4);
    ...
    public final KSerializer[] childSerializers() {
        r1 r1Var = r1.f29848a;
        return new KSerializer[]{r1Var, ClientDto$$serializer.INSTANCE, f0.B(r1Var), f0.B(r1Var)};
    }

    @Override // i90.b
    @NotNull
    public final LoginRequestBody deserialize(@NotNull Decoder decoder) {
        decoder.getClass();
        ...
        while (z11) {
            ...
            if (iW == -1) {
                ...
                clientDto = (ClientDto) aVarC.n(serialDescriptor, 1, ClientDto$$serializer.INSTANCE, clientDto);
                i11 |= 2;
            } else if (iW == 2) {
        ...
        return new LoginRequestBody(i11, strU, clientDto, str, str2, (m1) null);
    }
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull LoginRequestBody value) {
        encoder.getClass();
        value.getClass();
        SerialDescriptor serialDescriptor = descriptor;
        b bVarC = encoder.c(serialDescriptor);
        LoginRequestBody.write$Self$zendesk_conversationkit_conversationkit_android(value, bVarC, serialDescriptor);
