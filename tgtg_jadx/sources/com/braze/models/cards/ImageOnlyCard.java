...
public final class ImageOnlyCard extends Card {
    ...
    public ImageOnlyCard(JSONObject jSONObject, m0 m0Var) {
        this(jSONObject, m0Var, null, null, 12, null);
        jSONObject.getClass();
    }

    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    public ImageOnlyCard(JSONObject jSONObject, m0 m0Var, ICardStorageProvider<?> iCardStorageProvider) {
        this(jSONObject, m0Var, iCardStorageProvider, null, 8, null);
        jSONObject.getClass();
    }

    public /* synthetic */ ImageOnlyCard(JSONObject jSONObject, m0 m0Var, ICardStorageProvider iCardStorageProvider, b bVar, int i11, DefaultConstructorMarker defaultConstructorMarker) {
