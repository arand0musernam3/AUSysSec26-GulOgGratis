...
public final class AddToCustomAttributeArrayStep extends BaseBrazeActionStep {
    ...
    public static final Unit run$lambda$1(String str, String str2, BrazeUser brazeUser) {
        brazeUser.getClass();
    ...
    public void run(@NotNull Context context, @NotNull StepData data) {
        context.getClass();
        data.getClass();
        BaseBrazeActionStep.INSTANCE.runOnUser$android_sdk_ui_release(Braze.INSTANCE.getInstance(context), new x0(String.valueOf(data.getFirstArg()), String.valueOf(data.getSecondArg()), 4));
    }
}
