...
public final /* data */ class SavedCreditCard extends BasicSavedPaymentMethod implements Parcelable {
    ...
    public /* synthetic */ SavedCreditCard(int i11, PaymentProvider paymentProvider, PaymentType paymentType, CardStatus cardStatus, String str, String str2, m1 m1Var) {
        super(null);
        if (31 != (i11 & 31)) {
            c1.j(i11, 31, SavedCreditCard$$serializer.INSTANCE.getDescriptor());
            throw null;
        }
    ...
    public static /* synthetic */ SavedCreditCard copy$default(SavedCreditCard savedCreditCard, PaymentProvider paymentProvider, PaymentType paymentType, CardStatus cardStatus, String str, String str2, int i11, Object obj) {
        if ((i11 & 1) != 0) {
            paymentProvider = savedCreditCard.paymentProvider;
        }
        if ((i11 & 2) != 0) {
            paymentType = savedCreditCard.type;
        }
        if ((i11 & 4) != 0) {
            cardStatus = savedCreditCard.cardStatus;
        }
        if ((i11 & 8) != 0) {
            str = savedCreditCard.cardIdentifier;
        }
        if ((i11 & 16) != 0) {
            str2 = savedCreditCard.displayValue;
        }
        String str3 = str2;
        CardStatus cardStatus2 = cardStatus;
        return savedCreditCard.copy(paymentProvider, paymentType, cardStatus2, str, str3);
    }

    public static final /* synthetic */ void write$Self$app(SavedCreditCard self, b output, SerialDescriptor serialDesc) {
    ...
    @NotNull
    public final SavedCreditCard copy(@NotNull PaymentProvider paymentProvider, @NotNull PaymentType type, @NotNull CardStatus cardStatus, @NotNull String cardIdentifier, @NotNull String displayValue) {
        paymentProvider.getClass();
        type.getClass();
        cardStatus.getClass();
        cardIdentifier.getClass();
        displayValue.getClass();
        return new SavedCreditCard(paymentProvider, type, cardStatus, cardIdentifier, displayValue);
    }
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return this.paymentProvider == savedCreditCard.paymentProvider && this.type == savedCreditCard.type && this.cardStatus == savedCreditCard.cardStatus && Intrinsics.areEqual(this.cardIdentifier, savedCreditCard.cardIdentifier) && Intrinsics.areEqual(this.displayValue, savedCreditCard.displayValue);
    }
    ...
    public String toString() {
        ...
        StringBuilder sb2 = new StringBuilder("SavedCreditCard(paymentProvider=");
    ...
    /* JADX INFO: compiled from: r8-map-id-bad8e3e1b75e2d3fd72c92f1b960553adb24fef824cc9e98cee450b85845d4c2 */
    @Metadata(d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\f\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00060\u0005¨\u0006\u0007"}, d2 = {"Lcom/app/tgtg/model/remote/payment/SavedCreditCard$Companion;", "", "<init>", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lcom/app/tgtg/model/remote/payment/SavedCreditCard;", "app"}, k = 1, mv = {2, 3, 0}, xi = 48)
    public static final class Companion {
        ...
        public final KSerializer serializer() {
            return SavedCreditCard$$serializer.INSTANCE;
        }
    ...
    public static final class Creator implements Parcelable.Creator<SavedCreditCard> {
        ...
        public final SavedCreditCard createFromParcel(Parcel parcel) {
            parcel.getClass();
            return new SavedCreditCard(PaymentProvider.valueOf(parcel.readString()), PaymentType.valueOf(parcel.readString()), CardStatus.valueOf(parcel.readString()), parcel.readString(), parcel.readString());
        }

        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public final SavedCreditCard[] newArray(int i11) {
            return new SavedCreditCard[i11];
        }
    }
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SavedCreditCard(@NotNull PaymentProvider paymentProvider, @NotNull PaymentType paymentType, @NotNull CardStatus cardStatus, @NotNull String str, @NotNull String str2) {
        super(null);
        paymentProvider.getClass();
