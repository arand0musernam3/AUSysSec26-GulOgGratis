...
public final class ActionTypeSerializer implements KSerializer {
    ...
    public ActionType deserialize(@NotNull Decoder decoder) {
        ...
        while (true) {
            ...
            next = it.next();
            if (Intrinsics.areEqual(((ActionType) next).name(), strR)) {
                break;
            }
        }
