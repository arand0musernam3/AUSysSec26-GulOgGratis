...
@Metadata(d1 = {"\u0000:\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0011\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0005\bÇ\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0003\u0010\u0004J\u001d\u0010\t\u001a\u00020\b2\u0006\u0010\u0006\u001a\u00020\u00052\u0006\u0010\u0007\u001a\u00020\u0002¢\u0006\u0004\b\t\u0010\nJ\u0015\u0010\r\u001a\u00020\u00022\u0006\u0010\f\u001a\u00020\u000b¢\u0006\u0004\b\r\u0010\u000eJ\u0017\u0010\u0011\u001a\f\u0012\b\u0012\u0006\u0012\u0002\b\u00030\u00100\u000f¢\u0006\u0004\b\u0011\u0010\u0012R\u0017\u0010\u0014\u001a\u00020\u00138\u0006¢\u0006\f\n\u0004\b\u0014\u0010\u0015\u001a\u0004\b\u0016\u0010\u0017¨\u0006\u0018"}, d2 = {"com/app/tgtg/model/remote/item/CateringItemInformation.$serializer", "Lm90/d0;", "Lcom/app/tgtg/model/remote/item/CateringItemInformation;", "<init>", "()V", "Lkotlinx/serialization/encoding/Encoder;", "encoder", "value", "", "serialize", "(Lkotlinx/serialization/encoding/Encoder;Lcom/app/tgtg/model/remote/item/CateringItemInformation;)V", "Lkotlinx/serialization/encoding/Decoder;", "decoder", "deserialize", "(Lkotlinx/serialization/encoding/Decoder;)Lcom/app/tgtg/model/remote/item/CateringItemInformation;", "", "Lkotlinx/serialization/KSerializer;", "childSerializers", "()[Lkotlinx/serialization/KSerializer;", "Lkotlinx/serialization/descriptors/SerialDescriptor;", "descriptor", "Lkotlinx/serialization/descriptors/SerialDescriptor;", "getDescriptor", "()Lkotlinx/serialization/descriptors/SerialDescriptor;", "app"}, k = 1, mv = {2, 3, 0}, xi = 48)
@d
public final /* synthetic */ class CateringItemInformation$$serializer implements d0 {
    public static final int $stable;

    @NotNull
    public static final CateringItemInformation$$serializer INSTANCE;

    @NotNull
    private static final SerialDescriptor descriptor;

    static {
        CateringItemInformation$$serializer cateringItemInformation$$serializer = new CateringItemInformation$$serializer();
        INSTANCE = cateringItemInformation$$serializer;
        $stable = 8;
        e1 e1Var = new e1("com.app.tgtg.model.remote.item.CateringItemInformation", cateringItemInformation$$serializer, 21);
        ...
        e1Var.j("catering_item_properties", true);
    ...
    private CateringItemInformation$$serializer() {
    }
    ...
    public final KSerializer[] childSerializers() {
        j[] jVarArr = CateringItemInformation.$childSerializers;
        ...
        return new KSerializer[]{f0.B(picture$$serializer), f0.B(r1Var), f0.B(r1Var), ItemId$$serializer.INSTANCE, price$$serializer, f0.B(price$$serializer), f0.B(picture$$serializer), ItemCategorySerializer.INSTANCE, jVarArr[8].getValue(), jVarArr[9].getValue(), f0.B((KSerializer) jVarArr[10].getValue()), f0.B(AverageItemRating$$serializer.INSTANCE), f0.B(CateringItemProperties$$serializer.INSTANCE), f0.B(AllergensInfo$$serializer.INSTANCE), f0.B(DynamicPriceInfo$$serializer.INSTANCE), f0.B(price$$serializer), f0.B(r1Var), f0.B(r1Var), f0.B(r1Var), f0.B(r1Var), g.f29797a};
    }

    @Override // i90.b
    @NotNull
    public final CateringItemInformation deserialize(@NotNull Decoder decoder) {
        List list;
        ...
        List list5 = null;
        CateringItemProperties cateringItemProperties = null;
        ...
        while (z11) {
            ...
            switch (iW) {
                ...
                case 12:
                    list = list5;
                    itemCategory = itemCategory3;
                    cateringItemProperties = (CateringItemProperties) aVarC.m(serialDescriptor, 12, CateringItemProperties$$serializer.INSTANCE, cateringItemProperties);
                    i12 |= 4096;
                    itemCategory3 = itemCategory;
                    list5 = list;
                    break;
        ...
        return new CateringItemInformation(i12, picture3, str7, str8, strM205unboximpl, price2, price3, picture2, itemCategory4, list7, packagingOptions, list6, averageItemRating3, cateringItemProperties, allergensInfo, dynamicPriceInfo, price, str, str2, str3, str4, zT, null, null);
    }
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull CateringItemInformation value) {
        encoder.getClass();
        value.getClass();
        SerialDescriptor serialDescriptor = descriptor;
        l90.b bVarC = encoder.c(serialDescriptor);
        CateringItemInformation.write$Self$app(value, bVarC, serialDescriptor);
