...
import com.app.tgtg.model.remote.manufacturer.response.CateringItemProperties$$serializer;
...
public final /* data */ class CateringItemInformation extends BasicItemInformation implements Parcelable {
    ...
    @Nullable
    private final CateringItemProperties cateringItemProperties;
    ...
    @NotNull
    public static final Parcelable.Creator<CateringItemInformation> CREATOR = new Creator();

    /* JADX WARN: Failed to restore enum class, 'enum' modifier and super class removed */
    /* JADX WARN: Unknown enum class pattern. Please report as an issue! */
    /* JADX INFO: compiled from: r8-map-id-bad8e3e1b75e2d3fd72c92f1b960553adb24fef824cc9e98cee450b85845d4c2 */
    @Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0002\b\u0005\b\u0086\u0081\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003j\u0002\b\u0004j\u0002\b\u0005¨\u0006\u0006"}, d2 = {"Lcom/app/tgtg/model/remote/item/CateringItemInformation$DietCategory;", "", "<init>", "(Ljava/lang/String;I)V", "VEGETARIAN", "VEGAN", "app"}, k = 1, mv = {2, 3, 0}, xi = 48)
    ...
    static {
        ...
        $childSerializers = new j[]{null, null, null, null, null, null, null, null, l.a(mVar, new com.braze.ui.inappmessage.views.a(20)), l.a(mVar, new com.braze.ui.inappmessage.views.a(21)), l.a(mVar, new com.braze.ui.inappmessage.views.a(22)), null, null, null, null, null, null, null, null, null, null};
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    private CateringItemInformation(int i11, Picture picture, String str, String str2, String str3, Price price, Price price2, Picture picture2, ItemCategory itemCategory, List list, PackagingOptions packagingOptions, List list2, AverageItemRating averageItemRating, CateringItemProperties cateringItemProperties, AllergensInfo allergensInfo, DynamicPriceInfo dynamicPriceInfo, Price price3, String str4, String str5, String str6, String str7, boolean z11, m1 m1Var) {
        super(i11, m1Var);
        if (56 != (i11 & 56)) {
            c1.j(i11, 56, CateringItemInformation$$serializer.INSTANCE.getDescriptor());
            throw null;
        }
        if ((i11 & 1) == 0) {
        ...
        if ((i11 & 4096) == 0) {
            this.cateringItemProperties = null;
        } else {
            this.cateringItemProperties = cateringItemProperties;
        }
        if ((i11 & 8192) == 0) {
    ...
    public static /* synthetic */ CateringItemInformation m341copyGVdzyvs$default(CateringItemInformation cateringItemInformation, Picture picture, String str, String str2, String str3, Price price, Price price2, Picture picture2, ItemCategory itemCategory, List list, PackagingOptions packagingOptions, List list2, AverageItemRating averageItemRating, CateringItemProperties cateringItemProperties, AllergensInfo allergensInfo, DynamicPriceInfo dynamicPriceInfo, Price price3, String str4, String str5, String str6, String str7, boolean z11, int i11, Object obj) {
        boolean z12;
        String str8;
        Picture picture3 = (i11 & 1) != 0 ? cateringItemInformation.coverPicture_ : picture;
        String str9 = (i11 & 2) != 0 ? cateringItemInformation.name : str;
        String str10 = (i11 & 4) != 0 ? cateringItemInformation.description : str2;
        String str11 = (i11 & 8) != 0 ? cateringItemInformation.itemId : str3;
        Price price4 = (i11 & 16) != 0 ? cateringItemInformation.itemPrice : price;
        Price price5 = (i11 & 32) != 0 ? cateringItemInformation.itemValue : price2;
        Picture picture4 = (i11 & 64) != 0 ? cateringItemInformation.logoPicture_ : picture2;
        ItemCategory itemCategory2 = (i11 & 128) != 0 ? cateringItemInformation.itemCategory : itemCategory;
        List list3 = (i11 & 256) != 0 ? cateringItemInformation.dietCategories : list;
        PackagingOptions packagingOptions2 = (i11 & 512) != 0 ? cateringItemInformation.packagingOption : packagingOptions;
        List list4 = (i11 & 1024) != 0 ? cateringItemInformation.positiveRatingReasons : list2;
        AverageItemRating averageItemRating2 = (i11 & NewHope.SENDB_BYTES) != 0 ? cateringItemInformation.averageItemRating : averageItemRating;
        CateringItemProperties cateringItemProperties2 = (i11 & 4096) != 0 ? cateringItemInformation.cateringItemProperties : cateringItemProperties;
        AllergensInfo allergensInfo2 = (i11 & 8192) != 0 ? cateringItemInformation.allergensInfo : allergensInfo;
        Picture picture5 = picture3;
        DynamicPriceInfo dynamicPriceInfo2 = (i11 & BrotliInputStream.DEFAULT_INTERNAL_BUFFER_SIZE) != 0 ? cateringItemInformation.dynamicPriceInfo : dynamicPriceInfo;
        Price price6 = (i11 & 32768) != 0 ? cateringItemInformation.soldOutAtDynamicItemPrice : price3;
        String str12 = (i11 & 65536) != 0 ? cateringItemInformation.subtitle : str4;
        String str13 = (i11 & 131072) != 0 ? cateringItemInformation.descriptionTranslated : str5;
        String str14 = (i11 & 262144) != 0 ? cateringItemInformation.collectionInfo : str6;
        String str15 = (i11 & 524288) != 0 ? cateringItemInformation.smileyReportLink : str7;
        if ((i11 & 1048576) != 0) {
            str8 = str15;
            z12 = cateringItemInformation.isEdible;
        } else {
            z12 = z11;
            str8 = str15;
        }
        return cateringItemInformation.m344copyGVdzyvs(picture5, str9, str10, str11, price4, price5, picture4, itemCategory2, list3, packagingOptions2, list4, averageItemRating2, cateringItemProperties2, allergensInfo2, dynamicPriceInfo2, price6, str12, str13, str14, str8, z12);
    }

    public static final void write$Self$app(CateringItemInformation self, b output, SerialDescriptor serialDesc) {
        ...
        if (output.C(serialDesc) || self.cateringItemProperties != null) {
            output.r(serialDesc, 12, CateringItemProperties$$serializer.INSTANCE, self.cateringItemProperties);
        }
    ...
    public final CateringItemProperties getCateringItemProperties() {
        return this.cateringItemProperties;
    }
    ...
    public String toString() {
        ...
        CateringItemProperties cateringItemProperties = this.cateringItemProperties;
        ...
        StringBuilder sb2 = new StringBuilder("CateringItemInformation(coverPicture_=");
        sb2.append(picture);
        sb2.append(", name=");
        sb2.append(str);
        ...
        sb2.append(averageItemRating);
        sb2.append(", cateringItemProperties=");
        sb2.append(cateringItemProperties);
    ...
    public final void writeToParcel(@NotNull Parcel dest, int flags) {
        ...
        if (cateringItemProperties == null) {
            ...
            dest.writeInt(1);
            cateringItemProperties.writeToParcel(dest, flags);
        }
        AllergensInfo allergensInfo = this.allergensInfo;
    ...
    /* JADX INFO: compiled from: r8-map-id-bad8e3e1b75e2d3fd72c92f1b960553adb24fef824cc9e98cee450b85845d4c2 */
    @Metadata(d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\f\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00060\u0005¨\u0006\u0007"}, d2 = {"Lcom/app/tgtg/model/remote/item/CateringItemInformation$Companion;", "", "<init>", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lcom/app/tgtg/model/remote/item/CateringItemInformation;", "app"}, k = 1, mv = {2, 3, 0}, xi = 48)
    public static final class Companion {
        ...
        public final KSerializer serializer() {
            return CateringItemInformation$$serializer.INSTANCE;
        }
    ...
    public static final class Creator implements Parcelable.Creator<CateringItemInformation> {
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public final CateringItemInformation createFromParcel(Parcel parcel) {
            Picture picture;
            ...
            CateringItemProperties cateringItemPropertiesCreateFromParcel = null;
            ...
            if (parcel.readInt() != 0) {
                cateringItemPropertiesCreateFromParcel = CateringItemProperties.CREATOR.createFromParcel(parcel);
            }
            CateringItemProperties cateringItemProperties = cateringItemPropertiesCreateFromParcel;
            if (parcel.readInt() == 0) {
            ...
            return new CateringItemInformation(picture, string, string2, strM205unboximpl, priceCreateFromParcel, priceCreateFromParcel2, pictureCreateFromParcel2, itemCategoryValueOf, arrayListCreateStringArrayList, packagingOptionsValueOf, arrayListCreateStringArrayList2, averageItemRatingCreateFromParcel, cateringItemProperties, allergensInfo, dynamicPriceInfoCreateFromParcel, parcel.readInt() == 0 ? null : creator.createFromParcel(parcel), parcel.readString(), parcel.readString(), parcel.readString(), parcel.readString(), parcel.readInt() != 0, null);
        }

        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public final CateringItemInformation[] newArray(int i11) {
            return new CateringItemInformation[i11];
        }
    }
    ...
    @g("catering_item_properties")
    public static /* synthetic */ void getCateringItemProperties$annotations() {
    }
    ...
    public static /* synthetic */ void m342getItemIdFvU5WIY$annotations() {
    }
    ...
    public /* synthetic */ CateringItemInformation(Picture picture, String str, String str2, String str3, Price price, Price price2, Picture picture2, ItemCategory itemCategory, List list, PackagingOptions packagingOptions, List list2, AverageItemRating averageItemRating, CateringItemProperties cateringItemProperties, AllergensInfo allergensInfo, DynamicPriceInfo dynamicPriceInfo, Price price3, String str4, String str5, String str6, String str7, boolean z11, DefaultConstructorMarker defaultConstructorMarker) {
        this(picture, str, str2, str3, price, price2, picture2, itemCategory, list, packagingOptions, list2, averageItemRating, cateringItemProperties, allergensInfo, dynamicPriceInfo, price3, str4, str5, str6, str7, z11);
    }

    public /* synthetic */ CateringItemInformation(int i11, Picture picture, String str, String str2, String str3, Price price, Price price2, Picture picture2, ItemCategory itemCategory, List list, PackagingOptions packagingOptions, List list2, AverageItemRating averageItemRating, CateringItemProperties cateringItemProperties, AllergensInfo allergensInfo, DynamicPriceInfo dynamicPriceInfo, Price price3, String str4, String str5, String str6, String str7, boolean z11, m1 m1Var, DefaultConstructorMarker defaultConstructorMarker) {
        this(i11, picture, str, str2, str3, price, price2, picture2, itemCategory, list, packagingOptions, list2, averageItemRating, cateringItemProperties, allergensInfo, dynamicPriceInfo, price3, str4, str5, str6, str7, z11, m1Var);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    private CateringItemInformation(Picture picture, String str, String str2, String str3, Price price, Price price2, Picture picture2, ItemCategory itemCategory, List<String> list, PackagingOptions packagingOptions, List<String> list2, AverageItemRating averageItemRating, CateringItemProperties cateringItemProperties, AllergensInfo allergensInfo, DynamicPriceInfo dynamicPriceInfo, Price price3, String str4, String str5, String str6, String str7, boolean z11) {
        super(null);
        str3.getClass();
        price.getClass();
        itemCategory.getClass();
