...
public final /* data */ class TableReservationItem extends BasicItem {
    ...
    public /* synthetic */ TableReservationItem(int i11, Function1 function1, String str, String str2, double d3, MagicBagItemInformation magicBagItemInformation, int i12, boolean z11, PickupInterval pickupInterval, PickupLocation pickupLocation, String str3, String str4, StoreInformation storeInformation, boolean z12, boolean z13, String str5, int i13, String str6, ItemType itemType, boolean z14, String str7, List list, ItemCardType itemCardType, ItemSpecialReward itemSpecialReward, Ingredients ingredients, Boolean bool, m1 m1Var) {
        ...
        this.itemType = (131072 & i11) == 0 ? ItemType.TABLE_RESERVATION : itemType;
        if ((262144 & i11) == 0) {
    ...
    public static /* synthetic */ TableReservationItem copy$default(TableReservationItem tableReservationItem, String str, String str2, double d3, MagicBagItemInformation magicBagItemInformation, int i11, boolean z11, PickupInterval pickupInterval, PickupLocation pickupLocation, String str3, String str4, StoreInformation storeInformation, boolean z12, boolean z13, String str5, int i12, String str6, ItemType itemType, boolean z14, String str7, List list, ItemCardType itemCardType, ItemSpecialReward itemSpecialReward, Ingredients ingredients, Boolean bool, int i13, Object obj) {
        Boolean bool2;
        Ingredients ingredients2;
        String str8 = (i13 & 1) != 0 ? tableReservationItem.displayName : str;
        String str9 = (i13 & 2) != 0 ? tableReservationItem.displayDescription : str2;
        double d11 = (i13 & 4) != 0 ? tableReservationItem.distance : d3;
        MagicBagItemInformation magicBagItemInformation2 = (i13 & 8) != 0 ? tableReservationItem.information : magicBagItemInformation;
        int i14 = (i13 & 16) != 0 ? tableReservationItem.itemsAvailable : i11;
        boolean z15 = (i13 & 32) != 0 ? tableReservationItem.itemIsNew : z11;
        PickupInterval pickupInterval2 = (i13 & 64) != 0 ? tableReservationItem.pickupIntervalOrNull : pickupInterval;
        PickupLocation pickupLocation2 = (i13 & 128) != 0 ? tableReservationItem.pickupLocation : pickupLocation;
        String str10 = (i13 & 256) != 0 ? tableReservationItem.purchaseEnd : str3;
        String str11 = (i13 & 512) != 0 ? tableReservationItem.soldOutAt : str4;
        StoreInformation storeInformation2 = (i13 & 1024) != 0 ? tableReservationItem.storeInfoOrNull : storeInformation;
        boolean z16 = (i13 & NewHope.SENDB_BYTES) != 0 ? tableReservationItem.favorite : z12;
        boolean z17 = (i13 & 4096) != 0 ? tableReservationItem.subscribedForNotification : z13;
        String str12 = str8;
        String str13 = (i13 & 8192) != 0 ? tableReservationItem.sharingUrl : str5;
        int i15 = (i13 & BrotliInputStream.DEFAULT_INTERNAL_BUFFER_SIZE) != 0 ? tableReservationItem.userPurchaseLimit : i12;
        String str14 = (i13 & 32768) != 0 ? tableReservationItem.nextSalesWindowPurchaseStart : str6;
        ItemType itemType2 = (i13 & 65536) != 0 ? tableReservationItem.itemType : itemType;
        boolean z18 = (i13 & 131072) != 0 ? tableReservationItem.isSelected : z14;
        String str15 = (i13 & 262144) != 0 ? tableReservationItem.reservationBlockedUntil : str7;
        List list2 = (i13 & 524288) != 0 ? tableReservationItem.itemTags : list;
        ItemCardType itemCardType2 = (i13 & 1048576) != 0 ? tableReservationItem.itemCardType : itemCardType;
        ItemSpecialReward itemSpecialReward2 = (i13 & 2097152) != 0 ? tableReservationItem.itemSpecialReward : itemSpecialReward;
        Ingredients ingredients3 = (i13 & 4194304) != 0 ? tableReservationItem.ingredients : ingredients;
        if ((i13 & 8388608) != 0) {
            ingredients2 = ingredients3;
            bool2 = tableReservationItem.matchesFilters;
        } else {
            bool2 = bool;
            ingredients2 = ingredients3;
        }
        return tableReservationItem.copy(str12, str9, d11, magicBagItemInformation2, i14, z15, pickupInterval2, pickupLocation2, str10, str11, storeInformation2, z16, z17, str13, i15, str14, itemType2, z18, str15, list2, itemCardType2, itemSpecialReward2, ingredients2, bool2);
    }
    ...
    */
    public static final /* synthetic */ void write$Self$app(com.app.tgtg.model.remote.item.response.TableReservationItem r8, l90.b r9, kotlinx.serialization.descriptors.SerialDescriptor r10) {
        /*
            Method dump skipped, instruction units count: 574
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.app.tgtg.model.remote.item.response.TableReservationItem.write$Self$app(com.app.tgtg.model.remote.item.response.TableReservationItem, l90.b, kotlinx.serialization.descriptors.SerialDescriptor):void");
    }
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if (!(other instanceof TableReservationItem)) {
            return false;
        }
        TableReservationItem tableReservationItem = (TableReservationItem) other;
        return Intrinsics.areEqual(this.displayName, tableReservationItem.displayName) && Intrinsics.areEqual(this.displayDescription, tableReservationItem.displayDescription) && Double.compare(this.distance, tableReservationItem.distance) == 0 && Intrinsics.areEqual(this.information, tableReservationItem.information) && this.itemsAvailable == tableReservationItem.itemsAvailable && this.itemIsNew == tableReservationItem.itemIsNew && Intrinsics.areEqual(this.pickupIntervalOrNull, tableReservationItem.pickupIntervalOrNull) && Intrinsics.areEqual(this.pickupLocation, tableReservationItem.pickupLocation) && Intrinsics.areEqual(this.purchaseEnd, tableReservationItem.purchaseEnd) && Intrinsics.areEqual(this.soldOutAt, tableReservationItem.soldOutAt) && Intrinsics.areEqual(this.storeInfoOrNull, tableReservationItem.storeInfoOrNull) && this.favorite == tableReservationItem.favorite && this.subscribedForNotification == tableReservationItem.subscribedForNotification && Intrinsics.areEqual(this.sharingUrl, tableReservationItem.sharingUrl) && this.userPurchaseLimit == tableReservationItem.userPurchaseLimit && Intrinsics.areEqual(this.nextSalesWindowPurchaseStart, tableReservationItem.nextSalesWindowPurchaseStart) && this.itemType == tableReservationItem.itemType && this.isSelected == tableReservationItem.isSelected && Intrinsics.areEqual(this.reservationBlockedUntil, tableReservationItem.reservationBlockedUntil) && Intrinsics.areEqual(this.itemTags, tableReservationItem.itemTags) && Intrinsics.areEqual(this.itemCardType, tableReservationItem.itemCardType) && Intrinsics.areEqual(this.itemSpecialReward, tableReservationItem.itemSpecialReward) && Intrinsics.areEqual(this.ingredients, tableReservationItem.ingredients) && Intrinsics.areEqual(this.matchesFilters, tableReservationItem.matchesFilters);
    }
    ...
    public int hashCode() {
        ...
        int iHashCode8 = (iHashCode7 + (itemSpecialReward == null ? 0 : itemSpecialReward.hashCode())) * 31;
        Ingredients ingredients = this.ingredients;
        int iHashCode9 = (iHashCode8 + (ingredients == null ? 0 : ingredients.hashCode())) * 31;
    ...
    public String toString() {
        ...
        MagicBagItemInformation magicBagItemInformation = this.information;
        ...
        Ingredients ingredients = this.ingredients;
        Boolean bool = this.matchesFilters;
        StringBuilder sbT = f.t("TableReservationItem(displayName=", str, ", displayDescription=", str2, ", distance=");
        sbT.append(d3);
        sbT.append(", information=");
        sbT.append(magicBagItemInformation);
    ...
    /* JADX INFO: compiled from: r8-map-id-bad8e3e1b75e2d3fd72c92f1b960553adb24fef824cc9e98cee450b85845d4c2 */
    @Metadata(d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\f\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00060\u0005¨\u0006\u0007"}, d2 = {"Lcom/app/tgtg/model/remote/item/response/TableReservationItem$Companion;", "", "<init>", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lcom/app/tgtg/model/remote/item/response/TableReservationItem;", "app"}, k = 1, mv = {2, 3, 0}, xi = 48)
    public static final class Companion {
        ...
        public final KSerializer serializer() {
            return TableReservationItem$$serializer.INSTANCE;
        }
    ...
    public static final class Creator implements Parcelable.Creator<TableReservationItem> {
        ...
        public final TableReservationItem createFromParcel(Parcel parcel) {
            boolean z11;
            ArrayList arrayList;
            boolean z12;
            String str;
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public final TableReservationItem[] newArray(int i11) {
            return new TableReservationItem[i11];
        }
    }
    ...
    public /* synthetic */ TableReservationItem(String str, String str2, double d3, MagicBagItemInformation magicBagItemInformation, int i11, boolean z11, PickupInterval pickupInterval, PickupLocation pickupLocation, String str3, String str4, StoreInformation storeInformation, boolean z12, boolean z13, String str5, int i12, String str6, ItemType itemType, boolean z14, String str7, List list, ItemCardType itemCardType, ItemSpecialReward itemSpecialReward, Ingredients ingredients, Boolean bool, int i13, DefaultConstructorMarker defaultConstructorMarker) {
        this((i13 & 1) != 0 ? "" : str, (i13 & 2) != 0 ? "" : str2, (i13 & 4) != 0 ? 0.0d : d3, magicBagItemInformation, (i13 & 16) != 0 ? 0 : i11, (i13 & 32) != 0 ? false : z11, (i13 & 64) != 0 ? null : pickupInterval, (i13 & 128) != 0 ? new PickupLocation((Address) null, (String) null, (LatLngInfo) null, 7, (DefaultConstructorMarker) null) : pickupLocation, (i13 & 256) != 0 ? null : str3, (i13 & 512) != 0 ? null : str4, (i13 & 1024) != 0 ? null : storeInformation, (i13 & NewHope.SENDB_BYTES) != 0 ? false : z12, (i13 & 4096) != 0 ? false : z13, (i13 & 8192) != 0 ? null : str5, (i13 & BrotliInputStream.DEFAULT_INTERNAL_BUFFER_SIZE) != 0 ? 0 : i12, (32768 & i13) != 0 ? null : str6, (65536 & i13) != 0 ? ItemType.TABLE_RESERVATION : itemType, (131072 & i13) != 0 ? false : z14, (262144 & i13) != 0 ? null : str7, (524288 & i13) != 0 ? null : list, (1048576 & i13) != 0 ? null : itemCardType, (2097152 & i13) != 0 ? null : itemSpecialReward, (4194304 & i13) != 0 ? null : ingredients, (i13 & 8388608) != 0 ? Boolean.TRUE : bool);
    }
}
