...
import com.app.tgtg.model.remote.item.CateringItemInformation$$serializer;
...
@Metadata(d1 = {"\u0000:\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0011\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0005\bÇ\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0003\u0010\u0004J\u001d\u0010\t\u001a\u00020\b2\u0006\u0010\u0006\u001a\u00020\u00052\u0006\u0010\u0007\u001a\u00020\u0002¢\u0006\u0004\b\t\u0010\nJ\u0015\u0010\r\u001a\u00020\u00022\u0006\u0010\f\u001a\u00020\u000b¢\u0006\u0004\b\r\u0010\u000eJ\u0017\u0010\u0011\u001a\f\u0012\b\u0012\u0006\u0012\u0002\b\u00030\u00100\u000f¢\u0006\u0004\b\u0011\u0010\u0012R\u0017\u0010\u0014\u001a\u00020\u00138\u0006¢\u0006\f\n\u0004\b\u0014\u0010\u0015\u001a\u0004\b\u0016\u0010\u0017¨\u0006\u0018"}, d2 = {"com/app/tgtg/model/remote/item/response/CateringItem.$serializer", "Lm90/d0;", "Lcom/app/tgtg/model/remote/item/response/CateringItem;", "<init>", "()V", "Lkotlinx/serialization/encoding/Encoder;", "encoder", "value", "", "serialize", "(Lkotlinx/serialization/encoding/Encoder;Lcom/app/tgtg/model/remote/item/response/CateringItem;)V", "Lkotlinx/serialization/encoding/Decoder;", "decoder", "deserialize", "(Lkotlinx/serialization/encoding/Decoder;)Lcom/app/tgtg/model/remote/item/response/CateringItem;", "", "Lkotlinx/serialization/KSerializer;", "childSerializers", "()[Lkotlinx/serialization/KSerializer;", "Lkotlinx/serialization/descriptors/SerialDescriptor;", "descriptor", "Lkotlinx/serialization/descriptors/SerialDescriptor;", "getDescriptor", "()Lkotlinx/serialization/descriptors/SerialDescriptor;", "app"}, k = 1, mv = {2, 3, 0}, xi = 48)
@d
public final /* synthetic */ class CateringItem$$serializer implements d0 {
    public static final int $stable;

    @NotNull
    public static final CateringItem$$serializer INSTANCE;

    @NotNull
    private static final SerialDescriptor descriptor;

    static {
        CateringItem$$serializer cateringItem$$serializer = new CateringItem$$serializer();
        INSTANCE = cateringItem$$serializer;
        $stable = 8;
        e1 e1Var = new e1("CATERING", cateringItem$$serializer, 22);
    ...
    private CateringItem$$serializer() {
    }

    @Override // m90.d0
    @NotNull
    public final KSerializer[] childSerializers() {
        j[] jVarArr = CateringItem.$childSerializers;
        ...
        l0 l0Var = l0.f29821a;
        return new KSerializer[]{kSerializerB, CateringItemInformation$$serializer.INSTANCE, kSerializerB2, r1Var, PickupLocation$$serializer.INSTANCE, kSerializerB3, l0Var, v.f29868a, gVar, gVar, kSerializerB4, kSerializerB5, kSerializerB6, kSerializerB7, l0Var, kSerializerB8, ItemTypeSerializer.INSTANCE, gVar, kSerializerB9, kSerializerB10, kSerializerB11, kSerializerB12};
    }

    @Override // i90.b
    @NotNull
    public final CateringItem deserialize(@NotNull Decoder decoder) {
        ...
        CateringItemInformation cateringItemInformation = null;
        double dY = 0.0d;
        int i12 = 0;
        boolean z11 = true;
        int iQ = 0;
        ...
        while (z11) {
            ...
            switch (iW) {
                ...
                case 1:
                    ...
                    cateringItemInformation = (CateringItemInformation) aVarC.n(serialDescriptor, 1, CateringItemInformation$$serializer.INSTANCE, cateringItemInformation);
                    i12 |= 2;
                    storeInformation4 = storeInformation4;
        ...
        CateringItemInformation cateringItemInformation2 = cateringItemInformation;
        aVarC.b(serialDescriptor);
        return new CateringItem(i12, function13, cateringItemInformation2, storeInformation4, strU, pickupLocation5, pickupInterval, iQ, dY, zT, zT2, bool, str3, str4, str, iQ2, str2, itemType, zT3, list, itemCardType3, ingredients, bool2, null);
    }
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull CateringItem value) {
        encoder.getClass();
        value.getClass();
        SerialDescriptor serialDescriptor = descriptor;
        l90.b bVarC = encoder.c(serialDescriptor);
        CateringItem.write$Self$app(value, bVarC, serialDescriptor);
