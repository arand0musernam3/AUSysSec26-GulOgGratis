...
public final class AFk1sSDK {
    ...
    static {
        ...
        for (int i13 = 0; i13 < 256; i13++) {
            int i14 = component1[i13] & 255;
            getCurrencyIso4217Code[i14] = (byte) i13;
            int i15 = i13 << 1;
            if (i15 >= 256) {
                i15 ^= 283;
            }
            ...
            AFAdRevenueData[i14] = i19;
            getMediationNetwork[i14] = (i19 >>> 8) | (i19 << 24);
            getRevenue[i14] = (i19 >>> 16) | (i19 << 16);
            getMonetizationNetwork[i14] = (i19 << 8) | (i19 >>> 24);
        }
    ...
    public static int[] getCurrencyIso4217Code(byte[] bArr, int i11) throws IllegalArgumentException {
        if (bArr.length != 16) {
            i4.a.h();
            return null;
        }
        ...
        while (i18 < i13) {
            ...
            if (i19 == 0) {
                ...
                i22 = ((bArr2[i22 >>> 24] & 255) | (((bArr2[(i22 >>> 16) & 255] << 24) | ((bArr2[(i22 >>> 8) & 255] & 255) << 16)) | ((bArr2[i22 & 255] & 255) << 8))) ^ areAllFieldsValid[i21];
                i19 = 4;
                i21++;
            }
    ...
    public static byte[][] getCurrencyIso4217Code(int i11) {
