...
public class AppsFlyerProperties {
    ...
    public long getLong(String str, long j9) {
        String string = getString(str);
        return string == null ? j9 : Long.parseLong(string);
    }
        ...
        try {
            ...
            if (revenue != null) {
                ...
                try {
                    ...
                    AFLogger.afErrorLog("Failed loading properties", e5);
                }
    ...
    public synchronized void set(String str, long j9) {
        this.getCurrencyIso4217Code.put(str, Long.toString(j9));
    }
