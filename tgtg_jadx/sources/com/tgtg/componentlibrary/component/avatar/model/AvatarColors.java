...
public final /* data */ class AvatarColors {
    ...
    public AvatarColors(long j9, long j11, long j12, int i11, DefaultConstructorMarker defaultConstructorMarker) {
        long j13;
        long j14;
        long j15;
        if ((i11 & 1) != 0) {
        ...
        this(j13, j14, j15, null);
    }

    /* JADX INFO: renamed from: copy-ysEtTa8$default, reason: not valid java name */
    public static /* synthetic */ AvatarColors m554copyysEtTa8$default(AvatarColors avatarColors, long j9, long j11, long j12, int i11, Object obj) {
        if ((i11 & 1) != 0) {
            j9 = avatarColors.containerColor;
        }
        long j13 = j9;
        if ((i11 & 2) != 0) {
            j11 = avatarColors.contentColor;
        }
        long j14 = j11;
        if ((i11 & 4) != 0) {
            j12 = avatarColors.borderColor;
        }
        return avatarColors.m558copyysEtTa8(j13, j14, j12);
    }
    ...
    public final AvatarColors m558copyysEtTa8(long containerColor, long contentColor, long borderColor) {
        return new AvatarColors(containerColor, contentColor, borderColor, null);
    }
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return v.c(this.containerColor, avatarColors.containerColor) && v.c(this.contentColor, avatarColors.contentColor) && v.c(this.borderColor, avatarColors.borderColor);
    }

    /* JADX INFO: renamed from: getBorderColor-0d7_KjU, reason: not valid java name */
    public final long m559getBorderColor0d7_KjU() {
        return this.borderColor;
    }

    /* JADX INFO: renamed from: getContainerColor-0d7_KjU, reason: not valid java name */
    public final long m560getContainerColor0d7_KjU() {
        return this.containerColor;
    }

    /* JADX INFO: renamed from: getContentColor-0d7_KjU, reason: not valid java name */
    public final long m561getContentColor0d7_KjU() {
        return this.contentColor;
    }
    ...
    public String toString() {
        ...
        return k.p(f.t("AvatarColors(containerColor=", strI, ", contentColor=", strI2, ", borderColor="), v.i(this.borderColor), ")");
    }

    public AvatarColors(long j9, long j11, long j12, DefaultConstructorMarker defaultConstructorMarker) {
