...
public final class PantryChoiceChipDoc {
    ...
    public final void PantryChoiceChip(@Nullable n nVar, int i11) {
        int i12;
        s sVar = (s) nVar;
        sVar.c0(-259052720);
        if ((i11 & 6) == 0) {
        ...
        if (sVar.R(i12 & 1, (i12 & 3) != 2)) {
            ...
            PantryChoiceChipKt.PantryChoiceChip("Label", false, (Function0) objM, null, null, true, false, sVar, 390, 24);
        } else {
            sVar.U();
        }
        w1 w1VarS = sVar.s();
        if (w1VarS != null) {
            w1VarS.f29476d = new c(this, i11, 12);
        }
    }
