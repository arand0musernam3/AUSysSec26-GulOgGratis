...
@Metadata(d1 = {"\u0000\u0018\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0002\u001a\u000f\u0010\u0001\u001a\u00020\u0000H\u0007¢\u0006\u0004\b\u0001\u0010\u0002¨\u0006\t²\u0006\u000e\u0010\u0004\u001a\u00020\u00038\n@\nX\u008a\u008e\u0002²\u0006\u000e\u0010\u0005\u001a\u00020\u00038\n@\nX\u008a\u008e\u0002²\u0006\u000e\u0010\u0006\u001a\u00020\u00038\n@\nX\u008a\u008e\u0002²\u0006\u000e\u0010\b\u001a\u00020\u00078\n@\nX\u008a\u008e\u0002"}, d2 = {"", "DemoFilterChip", "(Lm3/n;I)V", "", "isEnabled", "isSelected", "isElevated", "Lcom/tgtg/componentlibrary/component/chip/model/ChipVariant;", "variant", "app_release"}, k = 2, mv = {2, 3, 0}, xi = 48)
@SourceDebugExtension({"SMAP\nDemoFilterChip.kt\nKotlin\n*S Kotlin\n*F\n+ 1 DemoFilterChip.kt\ncom/tgtg/componentlibrary/component/chip/type/filterchip/DemoFilterChipKt\n+ 2 CompositionLocal.kt\nandroidx/compose/runtime/CompositionLocal\n+ 3 Column.kt\nandroidx/compose/foundation/layout/ColumnKt\n+ 4 Layout.kt\nandroidx/compose/ui/layout/LayoutKt\n+ 5 Composables.kt\nandroidx/compose/runtime/ComposablesKt\n+ 6 Row.kt\nandroidx/compose/foundation/layout/RowKt\n+ 7 Composer.kt\nandroidx/compose/runtime/ComposerKt\n+ 8 SnapshotState.kt\nandroidx/compose/runtime/SnapshotStateKt__SnapshotStateKt\n*L\n1#1,268:1\n75#2:269\n75#2:270\n75#2:271\n75#2:473\n75#2:474\n87#3:272\n85#3,8:273\n87#3:416\n85#3,8:417\n94#3:468\n94#3:472\n81#4,6:281\n88#4,6:296\n81#4,6:312\n88#4,6:327\n96#4:372\n81#4,6:425\n88#4,6:440\n96#4:467\n96#4:471\n81#4,6:481\n88#4,6:496\n96#4:505\n391#5,9:287\n400#5:302\n391#5,9:318\n400#5:333\n401#5,2:370\n391#5,9:431\n400#5:446\n401#5,2:465\n401#5,2:469\n391#5,9:487\n400#5,3:502\n99#6:303\n97#6,8:304\n106#6:373\n99#6,6:475\n106#6:506\n1128#7,6:334\n1128#7,6:340\n1128#7,6:346\n1128#7,6:352\n1128#7,6:358\n1128#7,6:364\n1128#7,6:374\n1128#7,6:380\n1128#7,6:386\n1128#7,6:392\n1128#7,6:398\n1128#7,6:404\n1128#7,6:410\n1128#7,6:447\n1128#7,6:453\n1128#7,6:459\n1128#7,6:519\n1128#7,6:525\n1128#7,6:531\n85#8:507\n117#8,2:508\n85#8:510\n117#8,2:511\n85#8:513\n117#8,2:514\n85#8:516\n117#8,2:517\n*S KotlinDebug\n*F\n+ 1 DemoFilterChip.kt\ncom/tgtg/componentlibrary/component/chip/type/filterchip/DemoFilterChipKt\n*L\n47#1:269\n48#1:270\n49#1:271\n223#1:473\n224#1:474\n51#1:272\n51#1:273,8\n172#1:416\n172#1:417,8\n172#1:468\n51#1:472\n51#1:281,6\n51#1:296,6\n61#1:312,6\n61#1:327,6\n61#1:372\n172#1:425,6\n172#1:440,6\n172#1:467\n51#1:471\n225#1:481,6\n225#1:496,6\n225#1:505\n51#1:287,9\n51#1:302\n61#1:318,9\n61#1:333\n61#1:370,2\n172#1:431,9\n172#1:446\n172#1:465,2\n51#1:469,2\n225#1:487,9\n225#1:502,3\n61#1:303\n61#1:304,8\n61#1:373\n225#1:475,6\n225#1:506\n67#1:334,6\n68#1:340,6\n69#1:346,6\n74#1:352,6\n80#1:358,6\n92#1:364,6\n109#1:374,6\n110#1:380,6\n111#1:386,6\n112#1:392,6\n138#1:398,6\n147#1:404,6\n168#1:410,6\n176#1:447,6\n177#1:453,6\n178#1:459,6\n195#1:519,6\n202#1:525,6\n209#1:531,6\n109#1:507\n109#1:508,2\n110#1:510\n110#1:511,2\n111#1:513\n111#1:514,2\n112#1:516\n112#1:517,2\n*E\n"})
public final class DemoFilterChipKt {
    ...
    public static final void DemoFilterChip(@Nullable n nVar, int i11) {
        h hVar;
        Function1 function1;
        f fVar;
        int i12;
        ...
        if (sVar.R(i11 & 1, i11 != 0)) {
            ...
            r9.d("Filter Chip", null, hVar2.J, 0L, null, 0L, null, null, 0L, 0, false, 0, 0, null, u0Var, sVar, 6, 0, 131066);
            q qVar = q.f5711a;
            ...
            if (zF || objM4 == fVar2) {
                ...
                objM4 = new b0(function1Component23, zBooleanValue3, 6);
                sVar.k0(objM4);
            } else {
                function1 = function1Component2;
            }
            ...
            h hVar4 = hVar;
            TextOnlyFilterChipKt.TextOnlyFilterChip("Organic", zBooleanValue3, (Function0) objM4, null, null, false, false, null, sVar, 6, 248);
            boolean zF2 = sVar.f(function12) | sVar.g(zBooleanValue);
            Object objM5 = sVar.M();
            if (zF2 || objM5 == fVar2) {
                objM5 = new b0(function12, zBooleanValue, 7);
                sVar.k0(objM5);
            }
            ...
            IconFilterChipKt.IconFilterChip("Vegetarian", zBooleanValue, (Function0) objM5, null, null, false, false, composableSingletons$DemoFilterChipKt.m791getLambda$2000847503$app_release(), sVar, 12582918, 120);
            boolean zF3 = sVar.f(function1Component22) | sVar.g(zBooleanValue2);
            Object objM6 = sVar.M();
            if (zF3 || objM6 == fVar2) {
                objM6 = new b0(function1Component22, zBooleanValue2, 8);
                sVar.k0(objM6);
            }
            AvatarFilterChipKt.AvatarFilterChip("Vegan", zBooleanValue2, (Function0) objM6, null, null, false, false, composableSingletons$DemoFilterChipKt.m793getLambda$654014127$app_release(), sVar, 12582918, 120);
            sVar.q(true);
            Object objM7 = sVar.M();
            if (objM7 == fVar2) {
            ...
            Function2<n, Integer, Unit> function2M790getLambda$1810700092$app_release = ((ChipVariant) b1Var7.getValue()) == ChipVariant.Icon ? composableSingletons$DemoFilterChipKt.m790getLambda$1810700092$app_release() : null;
            ...
            if (i14 != 1) {
                if (i14 == 2) {
                    ...
                    IconFilterChipKt.IconFilterChip("Vegetarian", zBooleanValue4, (Function0) objM11, null, null, zBooleanValue5, zBooleanValue6, function2M790getLambda$1810700092$app_release, sVar, 390, 24);
                    i13 = 0;
                    sVar.q(false);
                } else {
                    if (i14 != 3) {
                        throw e0.f.v(sVar, 1699549997, false);
                    }
                    sVar.a0(1147061892);
                    ...
                    AvatarFilterChipKt.AvatarFilterChip("Vegetarian", zBooleanValue7, (Function0) objM12, null, null, zBooleanValue8, zBooleanValue9, composableSingletons$DemoFilterChipKt.getLambda$609945717$app_release(), sVar, 12583302, 24);
                    i13 = 0;
                    sVar.q(false);
                }
                i12 = i13;
                ...
                TextOnlyFilterChipKt.TextOnlyFilterChip("Vegetarian", zBooleanValue10, (Function0) objM13, null, null, zBooleanValue11, zBooleanValue12, function2M790getLambda$1810700092$app_release, sVar, 390, 24);
                i12 = 0;
                sVar.q(false);
            }
            ...
            sVar = sVar;
            g6.c(m2.d(c.B(qVar, 0.0f, f12, 1), 1.0f), 0.0f, e.e(1940759505, sVar, new gi.b(b1Var7, 2)), sVar, MLKEMEngine.KyberPolyBytes);
            sVar.q(true);
        } else {
            sVar.U();
        }
        w1 w1VarS = sVar.s();
        if (w1VarS != null) {
            w1VarS.f29476d = new c60.b(i11, 24);
        }
    }
    ...
    public static final void a(String str, boolean z11, Function1 function1, n nVar, int i11) {
        ...
        w1 w1VarS = sVar.s();
        if (w1VarS != null) {
            w1VarS.f29476d = new l60.a(str, z11, function1, i11, 1);
        }
    }
}
