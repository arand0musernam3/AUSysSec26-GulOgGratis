...
public final class SevenElevenPaymentMethod extends EContextPaymentMethod {
    ...
    @NotNull
    public static final Parcelable.Creator<SevenElevenPaymentMethod> CREATOR = new Creator();

    @NotNull
    public static final ModelObject.Serializer<SevenElevenPaymentMethod> SERIALIZER = new ModelObject.Serializer<SevenElevenPaymentMethod>() { // from class: com.adyen.checkout.components.core.paymentmethod.SevenElevenPaymentMethod$Companion$SERIALIZER$1
        @Override // com.adyen.checkout.core.internal.data.model.ModelObject.Serializer
        @NotNull
        public SevenElevenPaymentMethod deserialize(@NotNull JSONObject jsonObject) {
            jsonObject.getClass();
            return new SevenElevenPaymentMethod(JsonUtilsKt.getStringOrNull(jsonObject, "type"), JsonUtilsKt.getStringOrNull(jsonObject, PaymentMethodDetails.CHECKOUT_ATTEMPT_ID), JsonUtilsKt.getStringOrNull(jsonObject, PaymentMethodDetails.SDK_DATA), JsonUtilsKt.getStringOrNull(jsonObject, EContextPaymentMethod.FIRST_NAME), JsonUtilsKt.getStringOrNull(jsonObject, EContextPaymentMethod.LAST_NAME), JsonUtilsKt.getStringOrNull(jsonObject, EContextPaymentMethod.TELEPHONE_NUMBER), JsonUtilsKt.getStringOrNull(jsonObject, EContextPaymentMethod.SHOPPER_EMAIL));
        }

        @Override // com.adyen.checkout.core.internal.data.model.ModelObject.Serializer
        @NotNull
        public JSONObject serialize(@NotNull SevenElevenPaymentMethod modelObject) {
            ...
            try {
                ...
                w.j(SevenElevenPaymentMethod.class, e5);
                return null;
            }
        }
    };

    public /* synthetic */ SevenElevenPaymentMethod(String str, String str2, String str3, String str4, String str5, String str6, String str7, int i11, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public static final class Creator implements Parcelable.Creator<SevenElevenPaymentMethod> {
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        @NotNull
        public final SevenElevenPaymentMethod createFromParcel(@NotNull Parcel parcel) {
            parcel.getClass();
            return new SevenElevenPaymentMethod(parcel.readString(), parcel.readString(), parcel.readString(), parcel.readString(), parcel.readString(), parcel.readString(), parcel.readString());
        }

        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        @NotNull
        public final SevenElevenPaymentMethod[] newArray(int i11) {
            return new SevenElevenPaymentMethod[i11];
        }
    }
    ...
    public SevenElevenPaymentMethod() {
        this(null, null, null, null, null, null, null, 127, null);
    }

    public SevenElevenPaymentMethod(@Nullable String str, @Nullable String str2, @Nullable String str3, @Nullable String str4, @Nullable String str5, @Nullable String str6, @Nullable String str7) {
        this.type = str;
