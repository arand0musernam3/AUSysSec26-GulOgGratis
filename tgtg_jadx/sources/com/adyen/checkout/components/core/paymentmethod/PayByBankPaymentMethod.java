...
public final class PayByBankPaymentMethod extends IssuerListPaymentMethod {
    ...
    public static final ModelObject.Serializer<PayByBankPaymentMethod> SERIALIZER = new ModelObject.Serializer<PayByBankPaymentMethod>() { // from class: com.adyen.checkout.components.core.paymentmethod.PayByBankPaymentMethod$Companion$SERIALIZER$1
        ...
        @NotNull
        public PayByBankPaymentMethod deserialize(@NotNull JSONObject jsonObject) {
            jsonObject.getClass();
            return new PayByBankPaymentMethod(JsonUtilsKt.getStringOrNull(jsonObject, "type"), JsonUtilsKt.getStringOrNull(jsonObject, PaymentMethodDetails.CHECKOUT_ATTEMPT_ID), JsonUtilsKt.getStringOrNull(jsonObject, PaymentMethodDetails.SDK_DATA), JsonUtilsKt.getStringOrNull(jsonObject, IssuerListPaymentMethod.ISSUER));
        }

        @Override // com.adyen.checkout.core.internal.data.model.ModelObject.Serializer
        @NotNull
        public JSONObject serialize(@NotNull PayByBankPaymentMethod modelObject) {
            ...
            try {
                ...
                w.j(PayByBankPaymentMethod.class, e5);
                return null;
            }
        }
    };

    public /* synthetic */ PayByBankPaymentMethod(String str, String str2, String str3, String str4, int i11, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public static final class Creator implements Parcelable.Creator<PayByBankPaymentMethod> {
        ...
        @NotNull
        public final PayByBankPaymentMethod createFromParcel(@NotNull Parcel parcel) {
            parcel.getClass();
            return new PayByBankPaymentMethod(parcel.readString(), parcel.readString(), parcel.readString(), parcel.readString());
        }

        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        @NotNull
        public final PayByBankPaymentMethod[] newArray(int i11) {
            return new PayByBankPaymentMethod[i11];
        }
    }
    ...
    public PayByBankPaymentMethod(@Nullable String str, @Nullable String str2, @Nullable String str3, @Nullable String str4) {
        this.type = str;
