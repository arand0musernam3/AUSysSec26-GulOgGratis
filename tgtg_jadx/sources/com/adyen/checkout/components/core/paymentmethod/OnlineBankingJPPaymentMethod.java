...
public final class OnlineBankingJPPaymentMethod extends EContextPaymentMethod {
    ...
    public static final ModelObject.Serializer<OnlineBankingJPPaymentMethod> SERIALIZER = new ModelObject.Serializer<OnlineBankingJPPaymentMethod>() { // from class: com.adyen.checkout.components.core.paymentmethod.OnlineBankingJPPaymentMethod$Companion$SERIALIZER$1
        ...
        @NotNull
        public OnlineBankingJPPaymentMethod deserialize(@NotNull JSONObject jsonObject) {
            jsonObject.getClass();
        ...
        @Override // com.adyen.checkout.core.internal.data.model.ModelObject.Serializer
        @NotNull
        public JSONObject serialize(@NotNull OnlineBankingJPPaymentMethod modelObject) {
            ...
            try {
                ...
                w.j(OnlineBankingJPPaymentMethod.class, e5);
                return null;
            }
        }
    };

    public /* synthetic */ OnlineBankingJPPaymentMethod(String str, String str2, String str3, String str4, String str5, String str6, String str7, int i11, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public static final class Creator implements Parcelable.Creator<OnlineBankingJPPaymentMethod> {
        ...
        @NotNull
        public final OnlineBankingJPPaymentMethod createFromParcel(@NotNull Parcel parcel) {
            parcel.getClass();
            return new OnlineBankingJPPaymentMethod(parcel.readString(), parcel.readString(), parcel.readString(), parcel.readString(), parcel.readString(), parcel.readString(), parcel.readString());
        }

        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        @NotNull
        public final OnlineBankingJPPaymentMethod[] newArray(int i11) {
            return new OnlineBankingJPPaymentMethod[i11];
        }
    }
    ...
    public OnlineBankingJPPaymentMethod(@Nullable String str, @Nullable String str2, @Nullable String str3, @Nullable String str4, @Nullable String str5, @Nullable String str6, @Nullable String str7) {
        this.type = str;
