...
@Metadata(d1 = {"\u00004\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0006\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0081\b\u0018\u0000 \u00152\u00020\u0001:\u0001\u0015B\r\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\t\u0010\u0007\u001a\u00020\u0003HÆ\u0003J\u0013\u0010\b\u001a\u00020\u00002\b\b\u0002\u0010\u0002\u001a\u00020\u0003HÆ\u0001J\u0013\u0010\t\u001a\u00020\n2\b\u0010\u000b\u001a\u0004\u0018\u00010\fHÖ\u0003J\t\u0010\r\u001a\u00020\u000eHÖ\u0001J\t\u0010\u000f\u001a\u00020\u0003HÖ\u0001J\u0019\u0010\u0010\u001a\u00020\u00112\u0006\u0010\u0012\u001a\u00020\u00132\u0006\u0010\u0014\u001a\u00020\u000eHÖ\u0001R\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\u0005\u0010\u0006¨\u0006\u0016"}, d2 = {"Lcom/adyen/checkout/components/core/internal/data/model/PublicKeyResponse;", "Lcom/adyen/checkout/core/internal/data/model/ModelObject;", PublicKeyResponse.PUBLIC_KEY, "", "(Ljava/lang/String;)V", "getPublicKey", "()Ljava/lang/String;", "component1", "copy", "equals", "", "other", "", "hashCode", "", "toString", "writeToParcel", "", "parcel", "Landroid/os/Parcel;", "flags", "Companion", "components-core_release"}, k = 1, mv = {1, 9, 0}, xi = 48)
public final /* data */ class PublicKeyResponse extends ModelObject {
    ...
    public static final ModelObject.Serializer<PublicKeyResponse> SERIALIZER = new ModelObject.Serializer<PublicKeyResponse>() { // from class: com.adyen.checkout.components.core.internal.data.model.PublicKeyResponse$Companion$SERIALIZER$1
        ...
        public PublicKeyResponse deserialize(@NotNull JSONObject jsonObject) {
            jsonObject.getClass();
            try {
                String stringOrNull = JsonUtilsKt.getStringOrNull(jsonObject, "publicKey");
                if (stringOrNull == null) {
                    stringOrNull = "";
                }
                return new PublicKeyResponse(stringOrNull);
            } catch (JSONException e5) {
                w.j(PublicKeyResponse.class, e5);
                return null;
            }
        }
    ...
    public PublicKeyResponse(@NotNull String str) {
        str.getClass();
        this.publicKey = str;
    }
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return (other instanceof PublicKeyResponse) && Intrinsics.areEqual(this.publicKey, ((PublicKeyResponse) other).publicKey);
    }
    ...
    public String toString() {
        return a0.p("PublicKeyResponse(publicKey=", this.publicKey, ")");
    }
    ...
    public static final class Creator implements Parcelable.Creator<PublicKeyResponse> {
        ...
        @NotNull
        public final PublicKeyResponse createFromParcel(@NotNull Parcel parcel) {
            parcel.getClass();
