...
public final class AddressFormBrBinding implements a {
    ...
    private AddressFormBrBinding(@NonNull View view, @NonNull AppCompatAutoCompleteTextView appCompatAutoCompleteTextView, @NonNull AdyenTextInputEditText adyenTextInputEditText, @NonNull AdyenTextInputEditText adyenTextInputEditText2, @NonNull AdyenTextInputEditText adyenTextInputEditText3, @NonNull AdyenTextInputEditText adyenTextInputEditText4, @NonNull AdyenTextInputEditText adyenTextInputEditText5, @NonNull TextInputLayout textInputLayout, @NonNull TextInputLayout textInputLayout2, @NonNull TextInputLayout textInputLayout3, @NonNull TextInputLayout textInputLayout4, @NonNull TextInputLayout textInputLayout5, @NonNull TextInputLayout textInputLayout6) {
        this.rootView = view;
        ...
        this.editTextStreet = adyenTextInputEditText5;
    ...
    @NonNull
    public static AddressFormBrBinding bind(@NonNull View view) {
                                            ...
                                            if (textInputLayout4 != null) {
                                                ...
                                                if (textInputLayout5 != null) {
                                                    ...
                                                    if (textInputLayout6 != null) {
                                                        return new AddressFormBrBinding(view, appCompatAutoCompleteTextView, adyenTextInputEditText, adyenTextInputEditText2, adyenTextInputEditText3, adyenTextInputEditText4, adyenTextInputEditText5, textInputLayout, textInputLayout2, textInputLayout3, textInputLayout4, textInputLayout5, textInputLayout6);
                                                    }
                                                }
                                            }
                                        }
    ...
    @NonNull
    public static AddressFormBrBinding inflate(@NonNull LayoutInflater layoutInflater, @NonNull ViewGroup viewGroup) {
        if (viewGroup != null) {
            layoutInflater.inflate(R.layout.address_form_br, viewGroup);
