...
public final class IssuerListComponentParamsMapper {
    ...
    public IssuerListComponentParamsMapper(@NotNull CommonComponentParamsMapper commonComponentParamsMapper) {
        commonComponentParamsMapper.getClass();
        this.commonComponentParamsMapper = commonComponentParamsMapper;
    }

    @NotNull
    public final IssuerListComponentParams mapToParams(@NotNull CheckoutConfiguration checkoutConfiguration, @NotNull Locale deviceLocale, @Nullable DropInOverrideParams dropInOverrideParams, @Nullable SessionParams componentSessionParams, @Nullable IssuerListConfiguration componentConfiguration, boolean hideIssuerLogosDefaultValue) {
        boolean zBooleanValue;
        IssuerListViewType viewType;
        ...
        if (dropInOverrideParams != null) {
            ...
            Boolean boolIsSubmitButtonVisible = componentConfiguration != null ? componentConfiguration.isSubmitButtonVisible() : null;
        ...
        if (componentConfiguration == null || (viewType = componentConfiguration.getViewType()) == null) {
            viewType = IssuerListViewType.RECYCLER_VIEW;
        }
        if (componentConfiguration != null && (hideIssuerLogos = componentConfiguration.getHideIssuerLogos()) != null) {
            hideIssuerLogosDefaultValue = hideIssuerLogos.booleanValue();
        }
        return new IssuerListComponentParams(commonComponentParams, zBooleanValue, viewType, hideIssuerLogosDefaultValue);
    }
}
