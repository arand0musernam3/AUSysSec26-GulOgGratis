...
public final class SimpleVoucherViewBinding implements a {
    ...
    @NonNull
    public static SimpleVoucherViewBinding inflate(@NonNull LayoutInflater layoutInflater, @NonNull ViewGroup viewGroup) {
        if (viewGroup != null) {
