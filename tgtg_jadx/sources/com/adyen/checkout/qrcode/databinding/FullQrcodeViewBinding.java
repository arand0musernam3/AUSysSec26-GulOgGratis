...
public final class FullQrcodeViewBinding implements a {
    ...
    private FullQrcodeViewBinding(@NonNull View view, @NonNull MaterialButton materialButton, @NonNull ImageView imageView, @NonNull ImageView imageView2, @NonNull LinearProgressIndicator linearProgressIndicator, @NonNull TextView textView, @NonNull TextView textView2, @NonNull TextView textView3) {
        this.rootView = view;
    ...
    @NonNull
    public static FullQrcodeViewBinding bind(@NonNull View view) {
        int i11 = R.id.button_saveImage;
                    ...
                    if (linearProgressIndicator != null) {
                        ...
                        if (textView != null) {
                            ...
                            if (textView2 != null) {
                                ...
                                if (textView3 != null) {
                                    return new FullQrcodeViewBinding(view, materialButton, imageView, imageView2, linearProgressIndicator, textView, textView2, textView3);
                                }
                            }
                        }
                    }
    ...
    @NonNull
    public static FullQrcodeViewBinding inflate(@NonNull LayoutInflater layoutInflater, @NonNull ViewGroup viewGroup) {
        if (viewGroup != null) {
            layoutInflater.inflate(R.layout.full_qrcode_view, viewGroup);
