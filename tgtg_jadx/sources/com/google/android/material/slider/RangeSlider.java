...
public class RangeSlider extends e {
    ...
    public RangeSlider(@NonNull Context context, AttributeSet attributeSet, int i11) {
        ...
        TypedArray typedArrayM = i0.m(context, attributeSet, a.O, i11, R.style.Widget_MaterialComponents_Slider, new int[0]);
        if (typedArrayM.hasValue(1)) {
            TypedArray typedArrayObtainTypedArray = typedArrayM.getResources().obtainTypedArray(typedArrayM.getResourceId(1, 0));
        ...
        this.f12602b2 = typedArrayM.getDimension(0, 0.0f);
        typedArrayM.recycle();
    }
    ...
    public final void onRestoreInstanceState(Parcelable parcelable) {
        ...
        this.f12602b2 = gVar.f34197a;
        int i11 = gVar.f34198b;
        this.f12603c2 = i11;
    ...
    public final Parcelable onSaveInstanceState() {
        ...
        gVar.f34197a = this.f12602b2;
        gVar.f34198b = this.f12603c2;
        return gVar;
    }
