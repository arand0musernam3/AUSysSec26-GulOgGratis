...
public abstract /* synthetic */ class f0 {
    ...
    static {
        ...
        try {
            iArr[AddressField.PHONE_COUNTRY_CODE.ordinal()] = 3;
        } catch (NoSuchFieldError unused3) {
        }
        try {
            iArr[AddressField.PHONE_NUMBER.ordinal()] = 4;
        ...
        try {
            iArr[AddressField.POSTAL_CODE.ordinal()] = 10;
        } catch (NoSuchFieldError unused10) {
        }
        try {
            iArr[AddressField.CITY.ordinal()] = 11;
        } catch (NoSuchFieldError unused11) {
        }
        try {
            iArr[AddressField.STATE.ordinal()] = 12;
        } catch (NoSuchFieldError unused12) {
        }
        try {
            iArr[AddressField.COUNTRY_CODE.ordinal()] = 13;
