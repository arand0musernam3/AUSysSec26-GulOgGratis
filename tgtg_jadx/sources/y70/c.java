...
public final class c extends z70.c {
    ...
    public final /* synthetic */ Function2 f45422k;
    public final /* synthetic */ x70.c l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public c(x70.c cVar, CoroutineContext coroutineContext, Function2 function2, x70.c cVar2) {
        super(coroutineContext, cVar);
        this.f45422k = function2;
        this.l = cVar2;
    }

    @Override // z70.a
    public final Object invokeSuspend(Object obj) {
        int i11 = this.f45421j;
        if (i11 == 0) {
            this.f45421j = 1;
            ba0.g.M(obj);
            Function2 function2 = this.f45422k;
            function2.getClass();
