...
public final class z1 extends y1 {
    ...
    public static final SparseIntArray f35319v;
    ...
    static {
        ...
        f35319v = sparseIntArray;
        sparseIntArray.put(R.id.middle, 1);
        sparseIntArray.put(R.id.animationView, 2);
        sparseIntArray.put(R.id.about3TitleTv, 3);
    }

    /* JADX WARN: Illegal instructions before constructor call */
    public z1(View view) {
        Object[] objArrB0 = a8.k.b0(view, 4, null, f35319v);
