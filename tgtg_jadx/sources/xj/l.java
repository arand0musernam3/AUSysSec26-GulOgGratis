...
public abstract class l extends km.a implements r70.c {

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public p70.k f44431b;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    public volatile p70.g f44433d;
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f44432c) {
            return null;
        }
        p();
        return this.f44431b;
    ...
    public final void p() {
        if (this.f44431b == null) {
            this.f44431b = new p70.k(super.getContext(), this);
            this.f44432c = z.v(super.getContext());
        }
    }
