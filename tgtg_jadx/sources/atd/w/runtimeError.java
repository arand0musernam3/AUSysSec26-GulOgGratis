...
@SourceDebugExtension({"SMAP\nPhoneType.kt\nKotlin\n*S Kotlin\n*F\n+ 1 PhoneType.kt\ncom/adyen/threeds2/internal/deviceinfo/parameter/telephony/PhoneType\n+ 2 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,18:1\n1#2:19\n*E\n"})
public final class runtimeError extends InitializeResultSuccess {
    ...
    public static void AuthenticationRequestParameters() {
        getSDKReferenceNumber = -1926926366972712510L;
    }
    ...
    public final DeviceParameterResult getSDKReferenceNumber() {
        ...
        getSDKAppID = (AuthenticationRequestParameters + 33) % 128;
        DeviceParameterResult.Success.IntValue intValueM150boximpl = DeviceParameterResult.Success.IntValue.m150boximpl(DeviceParameterResult.Success.IntValue.m151constructorimpl(telephonyManagerChallengeResult.getPhoneType()));
