...
public final class ReflectionObjectRenderer {
    ...
    private final String renderCallable(CallableDescriptor descriptor) {
        ...
        a.p(descriptor, "Illegal callable: ");
        return null;
    }
    ...
    public final String renderFunction(@NotNull FunctionDescriptor descriptor) {
        ...
        CollectionsKt.T(valueParameters, sb2, ", ", "(", ")", new Function1<ValueParameterDescriptor, CharSequence>() { // from class: kotlin.reflect.jvm.internal.ReflectionObjectRenderer$renderFunction$1$1
    ...
    public final String renderLambda(@NotNull FunctionDescriptor invoke) {
        ...
        valueParameters.getClass();
        CollectionsKt.T(valueParameters, sb2, ", ", "(", ")", new Function1<ValueParameterDescriptor, CharSequence>() { // from class: kotlin.reflect.jvm.internal.ReflectionObjectRenderer$renderLambda$1$1
            @Override // kotlin.jvm.functions.Function1
            @NotNull
            public final CharSequence invoke(ValueParameterDescriptor valueParameterDescriptor) {
                ReflectionObjectRenderer reflectionObjectRenderer2 = ReflectionObjectRenderer.INSTANCE;
