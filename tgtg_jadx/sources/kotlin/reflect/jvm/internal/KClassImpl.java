...
public final class KClassImpl<T> extends KDeclarationContainerImpl implements KClass<T>, KClassifierImpl, KTypeParameterOwnerImpl {
        ...
        public Data() {
            ...
            this.constructors = ReflectProperties.lazySoft(new Function0<List<? extends KFunction<? extends T>>>() { // from class: kotlin.reflect.jvm.internal.KClassImpl$Data$constructors$2
                ...
                public final List<KFunction<T>> invoke() {
                    ...
                    ArrayList arrayList = new ArrayList(e0.o(constructorDescriptors, 10));
            ...
            this.objectInstance = ReflectProperties.lazy(new Function0<T>(this) { // from class: kotlin.reflect.jvm.internal.KClassImpl$Data$objectInstance$2
                ...
                public final T invoke() {
                    ...
                    T t9 = (T) ((!descriptor.isCompanionObject() || CompanionObjectMappingUtilsKt.isMappedIntrinsicCompanionObject(CompanionObjectMapping.INSTANCE, descriptor)) ? kClassImpl.getJClass().getDeclaredField("INSTANCE") : kClassImpl.getJClass().getEnclosingClass().getDeclaredField(descriptor.getName().asString())).get(null);
                    t9.getClass();
                    return t9;
                }
            });
            ...
            this.supertypes = ReflectProperties.lazySoft(new Function0<List<? extends KTypeImpl>>(this) { // from class: kotlin.reflect.jvm.internal.KClassImpl$Data$supertypes$2
                ...
                public final List<KTypeImpl> invoke() {
                    Collection<KotlinType> collectionMo978getSupertypes = this.this$0.getDescriptor().getTypeConstructor().mo978getSupertypes();
                    collectionMo978getSupertypes.getClass();
                    ArrayList arrayList = new ArrayList(collectionMo978getSupertypes.size());
                    final KClassImpl<T>.Data data = this.this$0;
                    final KClassImpl<T> kClassImpl = kClassImpl;
                    for (final KotlinType kotlinType : collectionMo978getSupertypes) {
                        kotlinType.getClass();
                        arrayList.add(new KTypeImpl(kotlinType, new Function0<Type>() { // from class: kotlin.reflect.jvm.internal.KClassImpl$Data$supertypes$2$1$1
                            ...
                            public final Type invoke() {
                                ...
                                if (!(classifierDescriptorMo977getDeclarationDescriptor instanceof ClassDescriptor)) {
                                    d.q(classifierDescriptorMo977getDeclarationDescriptor, "Supertype not a class: ");
                                    return null;
                                }
                                Class<?> javaClass = UtilKt.toJavaClass((ClassDescriptor) classifierDescriptorMo977getDeclarationDescriptor);
                                if (javaClass == null) {
                                    throw new KotlinReflectionInternalError("Unsupported superclass of " + data + ": " + classifierDescriptorMo977getDeclarationDescriptor);
                                }
                                boolean zAreEqual = Intrinsics.areEqual(kClassImpl.getJClass().getSuperclass(), javaClass);
                                ClassBasedDeclarationContainer classBasedDeclarationContainer = kClassImpl;
                                if (zAreEqual) {
                                    Type genericSuperclass = classBasedDeclarationContainer.getJClass().getGenericSuperclass();
                                    genericSuperclass.getClass();
                                    return genericSuperclass;
                                }
                                Class<?>[] interfaces = classBasedDeclarationContainer.getJClass().getInterfaces();
                                interfaces.getClass();
                                int iE = y.E(interfaces, javaClass);
                                if (iE >= 0) {
                                    Type type = kClassImpl.getJClass().getGenericInterfaces()[iE];
                                    type.getClass();
                                    return type;
                                }
                                throw new KotlinReflectionInternalError("No superclass of " + data + " in Java reflection for " + classifierDescriptorMo977getDeclarationDescriptor);
                            }
                        }));
                    }
            ...
            this.allNonStaticMembers = ReflectProperties.lazySoft(new Function0<List<? extends KCallableImpl<?>>>(this) { // from class: kotlin.reflect.jvm.internal.KClassImpl$Data$allNonStaticMembers$2
                ...
                public final List<KCallableImpl<?>> invoke() {
                    return kotlin.collections.CollectionsKt.d0(this.this$0.getInheritedNonStaticMembers(), this.this$0.getDeclaredNonStaticMembers());
                }
            });
            this.allStaticMembers = ReflectProperties.lazySoft(new Function0<List<? extends KCallableImpl<?>>>(this) { // from class: kotlin.reflect.jvm.internal.KClassImpl$Data$allStaticMembers$2
                ...
                @Override // kotlin.jvm.functions.Function0
                public final List<KCallableImpl<?>> invoke() {
                    return kotlin.collections.CollectionsKt.d0(this.this$0.getInheritedStaticMembers(), this.this$0.getDeclaredStaticMembers());
                }
            });
            this.declaredMembers = ReflectProperties.lazySoft(new Function0<List<? extends KCallableImpl<?>>>(this) { // from class: kotlin.reflect.jvm.internal.KClassImpl$Data$declaredMembers$2
                ...
                @Override // kotlin.jvm.functions.Function0
                public final List<KCallableImpl<?>> invoke() {
                    return kotlin.collections.CollectionsKt.d0(this.this$0.getDeclaredStaticMembers(), this.this$0.getDeclaredNonStaticMembers());
                }
            });
            this.allMembers = ReflectProperties.lazySoft(new Function0<List<? extends KCallableImpl<?>>>(this) { // from class: kotlin.reflect.jvm.internal.KClassImpl$Data$allMembers$2
                ...
                @Override // kotlin.jvm.functions.Function0
                public final List<KCallableImpl<?>> invoke() {
                    return kotlin.collections.CollectionsKt.d0(this.this$0.getAllStaticMembers(), this.this$0.getAllNonStaticMembers());
                }
            });
        }
    ...
    public boolean equals(@Nullable Object other) {
        return (other instanceof KClassImpl) && Intrinsics.areEqual(w.w(this), w.w((KClass) other));
    }
    ...
    public Collection<FunctionDescriptor> getFunctions(@NotNull Name name) {
        ...
        return kotlin.collections.CollectionsKt.d0(getStaticScope$kotlin_reflection().getContributedFunctions(name, noLookupLocation), memberScope$kotlin_reflection.getContributedFunctions(name, noLookupLocation));
    }
    ...
    public Collection<PropertyDescriptor> getProperties(@NotNull Name name) {
        ...
        MemberScope memberScope$kotlin_reflection = getMemberScope$kotlin_reflection();
        NoLookupLocation noLookupLocation = NoLookupLocation.FROM_REFLECTION;
        return kotlin.collections.CollectionsKt.d0(getStaticScope$kotlin_reflection().getContributedVariables(name, noLookupLocation), memberScope$kotlin_reflection.getContributedVariables(name, noLookupLocation));
    }
    ...
    public String toString() {
        ...
        strReplace.getClass();
        return "class ".concat(str.concat(strReplace));
    }
}
