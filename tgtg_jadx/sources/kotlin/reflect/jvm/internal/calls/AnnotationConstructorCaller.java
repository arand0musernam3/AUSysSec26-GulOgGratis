...
public final class AnnotationConstructorCaller implements Caller {
    ...
    public AnnotationConstructorCaller(@NotNull Class<?> cls, @NotNull List<String> list, @NotNull CallMode callMode, @NotNull Origin origin, @NotNull List<Method> list2) {
        ...
        ArrayList arrayList2 = new ArrayList(e0.o(list3, 10));
        ...
        ArrayList arrayList3 = new ArrayList(e0.o(list4, 10));
        Iterator<T> it3 = list4.iterator();
        while (it3.hasNext()) {
            arrayList3.add(((Method) it3.next()).getDefaultValue());
        }
        this.defaultValues = arrayList3;
        if (this.callMode == CallMode.POSITIONAL_CALL && origin == Origin.JAVA && !CollectionsKt.Z(this.parameterNames, "value").isEmpty()) {
            h2.a("Positional call of a Java annotation constructor is allowed only if there are no parameters or one parameter named \"value\". This restriction exists because Java annotations (in contrast to Kotlin)do not impose any order on their arguments. Use KCallable#callBy instead.");
            throw null;
        }
    }
    ...
    public Object call(@NotNull Object[] args) {
        ...
        while (i11 < length) {
            Object obj = args[i11];
            int i13 = i12 + 1;
            Object objTransformKotlinToJvm = (obj == null && this.callMode == CallMode.CALL_BY_NAME) ? this.defaultValues.get(i12) : AnnotationConstructorCallerKt.transformKotlinToJvm(obj, this.erasedParameterTypes.get(i12));
        ...
        return AnnotationConstructorCallerKt.createAnnotationInstance(this.jClass, x0.j(CollectionsKt.y0(this.parameterNames, arrayList)), this.methods);
    }
    ...
    public /* bridge */ /* synthetic */ Member mo968getMember() {
    ...
    public /* synthetic */ AnnotationConstructorCaller(Class cls, List list, CallMode callMode, Origin origin, List list2, int i11, DefaultConstructorMarker defaultConstructorMarker) {
        if ((i11 & 16) != 0) {
            list2 = new ArrayList(e0.o(list, 10));
