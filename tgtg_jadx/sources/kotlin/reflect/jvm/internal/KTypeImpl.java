...
public final class KTypeImpl implements KTypeBase {
    ...
    public final KClassifier convert(KotlinType type) {
        ...
        if (!(classifierDescriptorMo977getDeclarationDescriptor instanceof ClassDescriptor)) {
            if (classifierDescriptorMo977getDeclarationDescriptor instanceof TypeParameterDescriptor) {
                return new KTypeParameterImpl(null, (TypeParameterDescriptor) classifierDescriptorMo977getDeclarationDescriptor);
            }
        ...
        TypeProjection typeProjection = (TypeProjection) CollectionsKt.j0(type.getArguments());
        ...
        if (kClassifierConvert != null) {
            return new KClassImpl(UtilKt.createArrayType(w.v(KTypesJvm.getJvmErasure(kClassifierConvert))));
        }
        d.q(this, "Cannot determine classifier for array element type: ");
        return null;
    }
    ...
    public /* synthetic */ KTypeImpl(KotlinType kotlinType, Function0 function0, int i11, DefaultConstructorMarker defaultConstructorMarker) {
