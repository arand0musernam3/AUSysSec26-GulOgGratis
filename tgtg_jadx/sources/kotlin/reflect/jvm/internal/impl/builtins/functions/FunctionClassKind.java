...
public final class FunctionClassKind {
    ...
    private FunctionClassKind(String str, int i11, FqName fqName, String str2, boolean z11, boolean z12) {
    ...
    public final Name numberedClassName(int i11) {
        Name nameIdentifier = Name.identifier(this.classNamePrefix + i11);
    ...
    public static final class Companion {
        ...
        public final FunctionClassKind byClassNamePrefix(@NotNull FqName fqName, @NotNull String str) {
            ...
            for (FunctionClassKind functionClassKind : FunctionClassKind.values()) {
                if (Intrinsics.areEqual(functionClassKind.getPackageFqName(), fqName) && y.p(str, functionClassKind.getClassNamePrefix(), false)) {
        ...
        public final KindWithArity parseClassName(@NotNull String str, @NotNull FqName fqName) {
            ...
            if (functionClassKindByClassNamePrefix == null || (num = toInt(str.substring(functionClassKindByClassNamePrefix.getClassNamePrefix().length()))) == null) {
                return null;
            }
