...
public final class SuspendFunctionTypesKt {
    ...
    static {
        ...
        mutableClassDescriptor.setTypeParameterDescriptors(c0.c(TypeParameterDescriptorImpl.createWithDefaultBound(mutableClassDescriptor, Annotations.Companion.getEMPTY(), false, Variance.IN_VARIANCE, Name.identifier("T"), 0, storageManager)));
    ...
    public static final SimpleType transformSuspendFunctionToRuntimeFunctionType(@NotNull KotlinType kotlinType) {
        ...
        ArrayList arrayList = new ArrayList(e0.o(valueParameterTypesFromFunctionType, 10));
        ...
        ArrayList arrayListE0 = CollectionsKt.e0(arrayList, KotlinTypeFactory.simpleType$default(empty, typeConstructor, c0.c(TypeUtilsKt.asTypeProjection(FunctionTypesKt.getReturnTypeFromFunctionType(kotlinType))), false, (KotlinTypeRefiner) null, 16, (Object) null));
        SimpleType nullableAnyType = TypeUtilsKt.getBuiltIns(kotlinType).getNullableAnyType();
        nullableAnyType.getClass();
        return FunctionTypesKt.createFunctionType(builtIns, annotations, receiverTypeFromFunctionType, contextReceiverTypesFromFunctionType, arrayListE0, null, nullableAnyType, (128 & 128) != 0 ? false : false).makeNullableAsSpecified(kotlinType.isMarkedNullable());
    }
}
