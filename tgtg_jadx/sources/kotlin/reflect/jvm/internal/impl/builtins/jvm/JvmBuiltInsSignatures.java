...
public final class JvmBuiltInsSignatures {
    ...
    static {
        ...
        LinkedHashSet linkedHashSetH = i1.h(setBuildPrimitiveStringConstructorsSet, signatureBuildingComponents.inJavaLang("Float", (String[]) Arrays.copyOf(strArrConstructors, strArrConstructors.length)));
        ...
        HIDDEN_CONSTRUCTOR_SIGNATURES = i1.h(linkedHashSetH, signatureBuildingComponents.inJavaLang("String", (String[]) Arrays.copyOf(strArrConstructors2, strArrConstructors2.length)));
    ...
    private final Set<String> buildPrimitiveStringConstructorsSet() {
        ...
        List listH = d0.h(jvmPrimitiveType, jvmPrimitiveType2, JvmPrimitiveType.DOUBLE, JvmPrimitiveType.FLOAT, jvmPrimitiveType2, JvmPrimitiveType.INT, JvmPrimitiveType.LONG, JvmPrimitiveType.SHORT);
        ...
        while (it.hasNext()) {
            ...
            i0.s(signatureBuildingComponents.inJavaLang(strAsString, (String[]) Arrays.copyOf(strArrConstructors, strArrConstructors.length)), linkedHashSet);
        }
    ...
    private final Set<String> buildPrimitiveValueMethodsSet() {
        SignatureBuildingComponents signatureBuildingComponents = SignatureBuildingComponents.INSTANCE;
        List<JvmPrimitiveType> listH = d0.h(JvmPrimitiveType.BOOLEAN, JvmPrimitiveType.CHAR);
        LinkedHashSet linkedHashSet = new LinkedHashSet();
        for (JvmPrimitiveType jvmPrimitiveType : listH) {
            String strAsString = jvmPrimitiveType.getWrapperFqName().shortName().asString();
            strAsString.getClass();
            i0.s(signatureBuildingComponents.inJavaLang(strAsString, jvmPrimitiveType.getJavaKeywordName() + "Value()" + jvmPrimitiveType.getDesc()), linkedHashSet);
        }
        return linkedHashSet;
    }
