...
public abstract class KotlinBuiltIns {
    ...
    private static /* synthetic */ void $$$reportNull$$$0(int i11) {
        ...
        switch (i11) {
            ...
            case 144:
            case 145:
            case AppConstants.CONTACT_US_REQUEST_FILE /* 148 */:
            case 150:
            case 151:
            case 152:
            case 153:
    ...
    public KotlinBuiltIns(@NotNull StorageManager storageManager) {
        ...
        this.builtInClassesByName = storageManager.createMemoizedFunction(new Function1<Name, ClassDescriptor>() { // from class: kotlin.reflect.jvm.internal.impl.builtins.KotlinBuiltIns.3
            ...
            public ClassDescriptor invoke(Name name) {
                ClassifierDescriptor classifierDescriptorMo979getContributedClassifier = KotlinBuiltIns.this.getBuiltInsPackageScope().mo979getContributedClassifier(name, NoLookupLocation.FROM_BUILTINS);
                ...
                throw new AssertionError("Must be a class descriptor " + name + ", but was " + classifierDescriptorMo979getContributedClassifier);
            }
        });
    }
    ...
    private static KotlinType getElementTypeForUnsignedArray(@NotNull KotlinType kotlinType, @NotNull ModuleDescriptor moduleDescriptor) {
        ...
        if (!unsignedTypes.isShortNameOfUnsignedArray(classifierDescriptorMo977getDeclarationDescriptor.getName()) || (classId = DescriptorUtilsKt.getClassId(classifierDescriptorMo977getDeclarationDescriptor)) == null || (unsignedClassIdByArrayClassId = unsignedTypes.getUnsignedClassIdByArrayClassId(classId)) == null || (classDescriptorFindClassAcrossModuleDependencies = FindClassInModuleKt.findClassAcrossModuleDependencies(moduleDescriptor, unsignedClassIdByArrayClassId)) == null) {
            return null;
        }
    ...
    public static PrimitiveType getPrimitiveArrayElementType(@NotNull KotlinType kotlinType) {
        ...
        return getPrimitiveArrayType(classifierDescriptorMo977getDeclarationDescriptor);
    }
    ...
    public static boolean isPrimitiveArray(@NotNull KotlinType kotlinType) {
        ...
        ClassifierDescriptor classifierDescriptorMo977getDeclarationDescriptor = kotlinType.getConstructor().mo977getDeclarationDescriptor();
        return (classifierDescriptorMo977getDeclarationDescriptor == null || getPrimitiveArrayType(classifierDescriptorMo977getDeclarationDescriptor) == null) ? false : true;
    }
    ...
    public static boolean isPrimitiveTypeOrNullablePrimitiveType(@NotNull KotlinType kotlinType) {
        ...
        ClassifierDescriptor classifierDescriptorMo977getDeclarationDescriptor = kotlinType.getConstructor().mo977getDeclarationDescriptor();
        return (classifierDescriptorMo977getDeclarationDescriptor instanceof ClassDescriptor) && isPrimitiveClass((ClassDescriptor) classifierDescriptorMo977getDeclarationDescriptor);
    }
    ...
    public static boolean isTypeConstructorForGivenClass(@NotNull TypeConstructor typeConstructor, @NotNull FqNameUnsafe fqNameUnsafe) {
        ...
        return (classifierDescriptorMo977getDeclarationDescriptor instanceof ClassDescriptor) && classFqNameEquals(classifierDescriptorMo977getDeclarationDescriptor, fqNameUnsafe);
    }
    ...
    public static boolean isUIntArray(@NotNull KotlinType kotlinType) {
        if (kotlinType == null) {
            $$$reportNull$$$0(AppConstants.RESULT_CODE_ORDER_COLLECTED);
        }
    ...
    public static boolean isULongArray(@NotNull KotlinType kotlinType) {
        if (kotlinType == null) {
            $$$reportNull$$$0(AppConstants.RESULT_CODE_ORDER_NOT_COLLECTED);
        }
    ...
    public void createBuiltInsModule(boolean z11) {
        ...
        moduleDescriptorImpl.initialize(BuiltInsLoader.Companion.getInstance().createPackageFragmentProvider(this.storageManager, this.builtInsModule, getClassDescriptorFactories(), getPlatformDependentDeclarationFilter(), getAdditionalClassPartsProvider(), z11));
    ...
    public KotlinType getArrayElementType(@NotNull KotlinType kotlinType) {
        ...
        SimpleType simpleType = ((Primitives) this.primitives.invoke()).kotlinArrayTypeToPrimitiveKotlinType.get(kotlinTypeMakeNotNullable);
        if (simpleType != null) {
            return simpleType;
        }
    ...
    public ClassDescriptor getFunction(int i11) {
        return getBuiltInClassByName(StandardNames.getFunctionName(i11));
    }
    ...
    public void setBuiltInsModule(@NotNull final ModuleDescriptorImpl moduleDescriptorImpl) {
        ...
        this.storageManager.compute(new Function0<Void>() { // from class: kotlin.reflect.jvm.internal.impl.builtins.KotlinBuiltIns.4
            ...
            public Void invoke() {
                ...
                sb2.append(kotlinBuiltIns.builtInsModule);
