...
public final class ProtoEnumFlags {
    ...
    public final Modality modality(@Nullable ProtoBuf.Modality modality) {
        int i11 = modality == null ? -1 : WhenMappings.$EnumSwitchMapping$0[modality.ordinal()];
    ...
    public final Variance variance(@NotNull ProtoBuf.Type.Argument.Projection projection) {
        projection.getClass();
        int i11 = WhenMappings.$EnumSwitchMapping$6[projection.ordinal()];
        if (i11 == 1) {
        ...
        d.o(projection, "Only IN, OUT and INV are supported. Actual argument: ");
        return null;
    }
    ...
    public final Variance variance(@NotNull ProtoBuf.TypeParameter.Variance variance) {
        variance.getClass();
        int i11 = WhenMappings.$EnumSwitchMapping$5[variance.ordinal()];
        if (i11 == 1) {
            return Variance.IN_VARIANCE;
        }
        if (i11 == 2) {
