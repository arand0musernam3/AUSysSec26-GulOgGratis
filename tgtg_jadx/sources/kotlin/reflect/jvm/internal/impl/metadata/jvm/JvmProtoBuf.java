    ...
    public static final class StringTableTypes extends GeneratedMessageLite implements StringTableTypesOrBuilder {
        ...
        public int getSerializedSize() {
            ...
            for (int i12 = 0; i12 < this.record_.size(); i12++) {
                iComputeMessageSize += CodedOutputStream.computeMessageSize(1, this.record_.get(i12));
            }
            int iComputeInt32SizeNoTag = 0;
            for (int i13 = 0; i13 < this.localName_.size(); i13++) {
                iComputeInt32SizeNoTag += CodedOutputStream.computeInt32SizeNoTag(this.localName_.get(i13).intValue());
            }
        ...
        public static final class Record extends GeneratedMessageLite implements RecordOrBuilder {
            ...
            public int getSerializedSize() {
                ...
                for (int i12 = 0; i12 < this.substringIndex_.size(); i12++) {
                    iComputeInt32SizeNoTag += CodedOutputStream.computeInt32SizeNoTag(this.substringIndex_.get(i12).intValue());
                }
                ...
                for (int i13 = 0; i13 < this.replaceChar_.size(); i13++) {
                    iComputeInt32SizeNoTag3 += CodedOutputStream.computeInt32SizeNoTag(this.replaceChar_.get(i13).intValue());
                }
