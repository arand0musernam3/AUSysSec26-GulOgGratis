...
public class DescriptorUtils {
    ...
    private static <D extends CallableDescriptor> void collectAllOverriddenDescriptors(@NotNull D d3, @NotNull Set<D> set) {
        if (d3 == null) {
            $$$reportNull$$$0(73);
        }
        if (set == 0) {
        ...
        Iterator<? extends CallableDescriptor> it = d3.getOriginal().getOverriddenDescriptors().iterator();
        while (it.hasNext()) {
    ...
    @NotNull
    public static <D extends CallableDescriptor> Set<D> getAllOverriddenDescriptors(@NotNull D d3) {
        if (d3 == null) {
            $$$reportNull$$$0(71);
        }
        LinkedHashSet linkedHashSet = new LinkedHashSet();
        collectAllOverriddenDescriptors(d3.getOriginal(), linkedHashSet);
    ...
    public static ClassDescriptor getClassDescriptorForTypeConstructor(@NotNull TypeConstructor typeConstructor) {
        ...
        ClassDescriptor classDescriptor = (ClassDescriptor) typeConstructor.mo977getDeclarationDescriptor();
    ...
    @NotNull
    public static DescriptorVisibility getDefaultConstructorVisibility(@NotNull ClassDescriptor classDescriptor, boolean z11) {
        if (classDescriptor == null) {
            $$$reportNull$$$0(48);
        }
    ...
    @Nullable
    public static <D extends DeclarationDescriptor> D getParentOfType(@Nullable DeclarationDescriptor declarationDescriptor, @NotNull Class<D> cls, boolean z11) {
        if (cls == null) {
            $$$reportNull$$$0(19);
        }
        if (declarationDescriptor == null) {
    ...
    public static ClassDescriptor getSuperClassDescriptor(@NotNull ClassDescriptor classDescriptor) {
        ...
        Iterator<KotlinType> it = classDescriptor.getTypeConstructor().mo978getSupertypes().iterator();
        while (it.hasNext()) {
    ...
    private static boolean isSameClass(@NotNull KotlinType kotlinType, @NotNull DeclarationDescriptor declarationDescriptor) {
        ...
        DeclarationDescriptor original = classifierDescriptorMo977getDeclarationDescriptor.getOriginal();
    ...
    public static boolean isSubtypeOfClass(@NotNull KotlinType kotlinType, @NotNull DeclarationDescriptor declarationDescriptor) {
        ...
        Iterator<KotlinType> it = kotlinType.getConstructor().mo978getSupertypes().iterator();
        while (it.hasNext()) {
    ...
    @NotNull
    public static <D extends CallableMemberDescriptor> D unwrapFakeOverride(@NotNull D d3) {
        if (d3 == null) {
            $$$reportNull$$$0(59);
        }
        while (d3.getKind() == CallableMemberDescriptor.Kind.FAKE_OVERRIDE) {
            Collection<? extends CallableMemberDescriptor> overriddenDescriptors = d3.getOverriddenDescriptors();
            if (overriddenDescriptors.isEmpty()) {
                d.e(d3, "Fake override should have at least one overridden descriptor: ");
                return null;
            }
            d3 = (D) overriddenDescriptors.iterator().next();
        }
        return d3;
    }

    @NotNull
    public static <D extends DeclarationDescriptorWithVisibility> D unwrapFakeOverrideToAnyDeclaration(@NotNull D d3) {
        if (d3 == null) {
            $$$reportNull$$$0(64);
        }
        if (d3 instanceof CallableMemberDescriptor) {
            return unwrapFakeOverride((CallableMemberDescriptor) d3);
        }
        if (d3 == null) {
            $$$reportNull$$$0(65);
        }
    ...
    public static ModuleDescriptor getContainingModuleOrNull(@NotNull KotlinType kotlinType) {
        ...
        return getContainingModuleOrNull(classifierDescriptorMo977getDeclarationDescriptor);
    }
}
