...
public class OverridingUtil {
    ...
    private static final List<ExternalOverridabilityCondition> EXTERNAL_CONDITIONS = CollectionsKt.r0(ServiceLoader.load(ExternalOverridabilityCondition.class, ExternalOverridabilityCondition.class.getClassLoader()));
    ...
    */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private static boolean areTypeParametersEquivalent(@org.jetbrains.annotations.NotNull kotlin.reflect.jvm.internal.impl.descriptors.TypeParameterDescriptor r4, @org.jetbrains.annotations.NotNull kotlin.reflect.jvm.internal.impl.descriptors.TypeParameterDescriptor r5, @org.jetbrains.annotations.NotNull kotlin.reflect.jvm.internal.impl.types.TypeCheckerState r6) {
        /*
            if (r4 != 0) goto L7
            r0 = 49
            $$$reportNull$$$0(r0)
    ...
    private static void collectOverriddenDeclarations(@NotNull CallableMemberDescriptor callableMemberDescriptor, @NotNull Set<CallableMemberDescriptor> set) {
        ...
        if (callableMemberDescriptor.getKind().isReal()) {
            ...
            if (callableMemberDescriptor.getOverriddenDescriptors().isEmpty()) {
                d.e(callableMemberDescriptor, "No overridden descriptors found for (fake override) ");
                return;
            }
    ...
    private static Modality determineModalityForFakeOverride(@NotNull Collection<CallableMemberDescriptor> collection, @NotNull ClassDescriptor classDescriptor) {
        ...
        for (CallableMemberDescriptor callableMemberDescriptor : collection) {
            int i11 = AnonymousClass8.$SwitchMap$org$jetbrains$kotlin$descriptors$Modality[callableMemberDescriptor.getModality().ordinal()];
            if (i11 == 1) {
            ...
            if (i11 == 2) {
                d.e(callableMemberDescriptor, "Member cannot have SEALED modality: ");
                return null;
            }
            if (i11 == 3) {
                z12 = true;
    ...
    private Collection<CallableMemberDescriptor> extractAndBindOverridesForMember(@NotNull CallableMemberDescriptor callableMemberDescriptor, @NotNull Collection<? extends CallableMemberDescriptor> collection, @NotNull ClassDescriptor classDescriptor, @NotNull OverridingStrategy overridingStrategy) {
        ...
        for (CallableMemberDescriptor callableMemberDescriptor2 : collection) {
            ...
            int i11 = AnonymousClass8.$SwitchMap$org$jetbrains$kotlin$resolve$OverridingUtil$OverrideCompatibilityInfo$Result[result.ordinal()];
            if (i11 == 1) {
    ...
    public static <D> Set<D> filterOverrides(@NotNull Set<D> set, boolean z11, @Nullable Function0<?> function0, @NotNull Function2<? super D, ? super D, Pair<CallableDescriptor, CallableDescriptor>> function2) {
        ...
        for (D d3 : set) {
            ...
            while (true) {
                ...
                Pair pair = (Pair) function2.invoke(d3, it.next());
                CallableDescriptor callableDescriptor = (CallableDescriptor) pair.f26485a;
                CallableDescriptor callableDescriptor2 = (CallableDescriptor) pair.f26486b;
                if (!overrides(callableDescriptor, callableDescriptor2, z11, true)) {
                    if (overrides(callableDescriptor2, callableDescriptor, z11, true)) {
                        break;
                    }
                } else {
                    it.remove();
    ...
    private static Collection<CallableMemberDescriptor> filterVisibleFakeOverrides(@NotNull final ClassDescriptor classDescriptor, @NotNull Collection<CallableMemberDescriptor> collection) {
        ...
        return CollectionsKt.L(collection, new Function1<CallableMemberDescriptor, Boolean>() { // from class: kotlin.reflect.jvm.internal.impl.resolve.OverridingUtil.5
            @Override // kotlin.jvm.functions.Function1
            public Boolean invoke(CallableMemberDescriptor callableMemberDescriptor) {
                boolean z11 = false;
    ...
    public static OverrideCompatibilityInfo getBasicOverridabilityProblem(@NotNull CallableDescriptor callableDescriptor, @NotNull CallableDescriptor callableDescriptor2) {
        ...
        if (!z12 && !z11) {
            d.o(callableDescriptor, "This type of CallableDescriptor cannot be checked for overridability: ");
            return null;
        }
    ...
    public static boolean isMoreSpecific(@NotNull CallableDescriptor callableDescriptor, @NotNull CallableDescriptor callableDescriptor2) {
        ...
        if (!(callableDescriptor instanceof PropertyDescriptor)) {
            d.t(callableDescriptor.getClass(), "Unexpected callable: ");
            return false;
        }
    ...
    public static <D extends CallableDescriptor> boolean overrides(@NotNull D d3, @NotNull D d11, boolean z11, boolean z12) {
        if (d3 == null) {
            $$$reportNull$$$0(13);
        }
        if (d11 == null) {
        ...
        if (!d3.equals(d11) && DescriptorEquivalenceForOverrides.INSTANCE.areEquivalent(d3.getOriginal(), d11.getOriginal(), z11, z12)) {
            return true;
        }
    ...
    public static <H> H selectMostSpecificMember(@NotNull Collection<H> collection, @NotNull Function1<H, CallableDescriptor> function1) {
        ...
        if (collection.size() == 1) {
            H h12 = (H) CollectionsKt.N(collection);
            if (h12 == null) {
                $$$reportNull$$$0(80);
            }
            return h12;
        ...
        H h13 = (H) CollectionsKt.N(collection);
        CallableDescriptor callableDescriptor = (CallableDescriptor) function1.invoke(h13);
        for (H h14 : collection) {
            CallableDescriptor callableDescriptor2 = (CallableDescriptor) function1.invoke(h14);
        ...
        if (arrayList.size() == 1) {
            H h15 = (H) CollectionsKt.N(arrayList);
            if (h15 == null) {
                $$$reportNull$$$0(82);
            }
            return h15;
        ...
        while (true) {
            ...
            h11 = (H) it2.next();
            if (!FlexibleTypesKt.isFlexible(((CallableDescriptor) function1.invoke(h11)).getReturnType())) {
                break;
            }
        }
        if (h11 != null) {
        ...
        H h16 = (H) CollectionsKt.N(arrayList);
        if (h16 == null) {
            $$$reportNull$$$0(84);
        }
        return h16;
    ...
    public OverrideCompatibilityInfo isOverridableBy(@NotNull CallableDescriptor callableDescriptor, @NotNull CallableDescriptor callableDescriptor2, @Nullable ClassDescriptor classDescriptor, boolean z11) {
        ...
        for (ExternalOverridabilityCondition externalOverridabilityCondition : EXTERNAL_CONDITIONS) {
            if (externalOverridabilityCondition.getContract() != ExternalOverridabilityCondition.Contract.CONFLICTS_ONLY && (!z12 || externalOverridabilityCondition.getContract() != ExternalOverridabilityCondition.Contract.SUCCESS_ONLY)) {
                int i11 = AnonymousClass8.$SwitchMap$org$jetbrains$kotlin$resolve$ExternalOverridabilityCondition$Result[externalOverridabilityCondition.isOverridable(callableDescriptor, callableDescriptor2, classDescriptor).ordinal()];
                if (i11 == 1) {
                    z12 = true;
                } else {
                    if (i11 == 2) {
        ...
        for (ExternalOverridabilityCondition externalOverridabilityCondition2 : EXTERNAL_CONDITIONS) {
            if (externalOverridabilityCondition2.getContract() == ExternalOverridabilityCondition.Contract.CONFLICTS_ONLY) {
                int i12 = AnonymousClass8.$SwitchMap$org$jetbrains$kotlin$resolve$ExternalOverridabilityCondition$Result[externalOverridabilityCondition2.isOverridable(callableDescriptor, callableDescriptor2, classDescriptor).ordinal()];
                if (i12 == 1) {
    ...
    public OverrideCompatibilityInfo isOverridableByWithoutExternalConditions(@NotNull CallableDescriptor callableDescriptor, @NotNull CallableDescriptor callableDescriptor2, boolean z11) {
        ...
        if (typeParameters.size() != typeParameters2.size()) {
            while (i11 < listCompiledValueParameters.size()) {
                if (!KotlinTypeChecker.DEFAULT.equalTypes(listCompiledValueParameters.get(i11), listCompiledValueParameters2.get(i11))) {
        ...
        for (int i12 = 0; i12 < typeParameters.size(); i12++) {
            if (!areTypeParametersEquivalent(typeParameters.get(i12), typeParameters2.get(i12), typeCheckerStateCreateTypeCheckerState)) {
        ...
        while (i11 < listCompiledValueParameters.size()) {
            if (!areTypesEquivalent(listCompiledValueParameters.get(i11), listCompiledValueParameters2.get(i11), typeCheckerStateCreateTypeCheckerState)) {
