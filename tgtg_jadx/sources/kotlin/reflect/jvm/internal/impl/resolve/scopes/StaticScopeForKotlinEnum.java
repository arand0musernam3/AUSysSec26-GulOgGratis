...
public final class StaticScopeForKotlinEnum extends MemberScopeImpl {
    ...
    public StaticScopeForKotlinEnum(@NotNull StorageManager storageManager, @NotNull ClassDescriptor classDescriptor) {
        ...
        this.functions$delegate = storageManager.createLazyValue(new Function0<List<? extends SimpleFunctionDescriptor>>() { // from class: kotlin.reflect.jvm.internal.impl.resolve.scopes.StaticScopeForKotlinEnum$functions$2
            ...
            public final List<SimpleFunctionDescriptor> invoke() {
                return d0.h(DescriptorFactory.createEnumValueOfMethod(this.this$0.containingClass), DescriptorFactory.createEnumValuesMethod(this.this$0.containingClass));
            }
        });
        this.properties$delegate = storageManager.createLazyValue(new Function0<List<? extends PropertyDescriptor>>() { // from class: kotlin.reflect.jvm.internal.impl.resolve.scopes.StaticScopeForKotlinEnum$properties$2
            ...
            public final List<PropertyDescriptor> invoke() {
                return d0.i(DescriptorFactory.createEnumEntriesProperty(this.this$0.containingClass));
            }
        });
    }
    ...
    public List<CallableMemberDescriptor> getContributedDescriptors(@NotNull DescriptorKindFilter descriptorKindFilter, @NotNull Function1<? super Name, Boolean> function1) {
        ...
        function1.getClass();
        return CollectionsKt.d0(getProperties(), getFunctions());
    }
    ...
    public /* bridge */ /* synthetic */ ClassifierDescriptor mo979getContributedClassifier(Name name, LookupLocation lookupLocation) {
