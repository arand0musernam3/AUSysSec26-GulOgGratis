...
public class JavaPropertyDescriptor extends PropertyDescriptorImpl implements JavaCallableMemberDescriptor {
    ...
    @NotNull
    public static JavaPropertyDescriptor create(@NotNull DeclarationDescriptor declarationDescriptor, @NotNull Annotations annotations, @NotNull Modality modality, @NotNull DescriptorVisibility descriptorVisibility, boolean z11, @NotNull Name name, @NotNull SourceElement sourceElement, boolean z12) {
        if (declarationDescriptor == null) {
            $$$reportNull$$$0(7);
        }
        if (annotations == null) {
    ...
    public JavaCallableMemberDescriptor enhance(@Nullable KotlinType kotlinType, @NotNull List<KotlinType> list, @NotNull KotlinType kotlinType2, @Nullable Pair<CallableDescriptor.UserDataKey<?>, ?> pair) {
        ...
        javaPropertyDescriptor.setType(kotlinType2, getTypeParameters(), getDispatchReceiverParameter(), kotlinType != null ? DescriptorFactory.createExtensionReceiverParameterForCallable(this, kotlinType, Annotations.Companion.getEMPTY()) : null, n0.f26529a);
    ...
    public <V> V getUserData(CallableDescriptor.UserDataKey<V> userDataKey) {
        ...
        if (pair == null || !((CallableDescriptor.UserDataKey) pair.f26485a).equals(userDataKey)) {
            return null;
        }
        return (V) this.singleUserData.f26486b;
    }
