...
public class LazySubstitutingClassDescriptor extends ModuleAwareClassDescriptor {
    ...
    */
    ...
    private TypeSubstitutor getSubstitutor() {
        if (this.newSubstitutor == null) {
            if (this.originalSubstitutor.isEmpty()) {
                ...
                this.declaredTypeParameters = CollectionsKt.L(this.typeConstructorParameters, new Function1<TypeParameterDescriptor, Boolean>() { // from class: kotlin.reflect.jvm.internal.impl.descriptors.impl.LazySubstitutingClassDescriptor.1
    ...
    public ClassDescriptor mo969getCompanionObjectDescriptor() {
        return this.original.mo969getCompanionObjectDescriptor();
    }
    ...
    public ClassConstructorDescriptor mo970getUnsubstitutedPrimaryConstructor() {
        return this.original.mo970getUnsubstitutedPrimaryConstructor();
    }
