...
public abstract class AbstractTypeParameterDescriptor extends DeclarationDescriptorNonRootImpl implements TypeParameterDescriptor {
    ...
    public class TypeParameterTypeConstructor extends AbstractTypeConstructor {
        ...
        public void reportSupertypeLoopError(@NotNull KotlinType kotlinType) {
            ...
            this.this$0.mo980reportSupertypeLoopError(kotlinType);
        }
    ...
    public <R, D> R accept(DeclarationDescriptorVisitor<R, D> declarationDescriptorVisitor, D d3) {
        return declarationDescriptorVisitor.visitTypeParameterDescriptor(this, d3);
    }
    ...
    public List<KotlinType> getUpperBounds() {
        List<KotlinType> listMo978getSupertypes = ((TypeParameterTypeConstructor) getTypeConstructor()).mo978getSupertypes();
        if (listMo978getSupertypes == null) {
            $$$reportNull$$$0(8);
        }
        return listMo978getSupertypes;
    }
    ...
    public abstract void mo980reportSupertypeLoopError(@NotNull KotlinType kotlinType);
