    ...
    private final SimpleType transformToNewType(SimpleType simpleType) {
        ...
        if (constructor instanceof CapturedTypeConstructorImpl) {
            ...
            if (capturedTypeConstructorImpl.getNewTypeConstructor() == null) {
                ...
                Collection<KotlinType> collectionMo978getSupertypes = capturedTypeConstructorImpl.mo978getSupertypes();
        ...
        if (constructor instanceof IntegerValueTypeConstructor) {
            Collection<KotlinType> collectionMo978getSupertypes2 = ((IntegerValueTypeConstructor) constructor).mo978getSupertypes();
            ArrayList arrayList2 = new ArrayList(e0.o(collectionMo978getSupertypes2, 10));
            Iterator<T> it2 = collectionMo978getSupertypes2.iterator();
            while (it2.hasNext()) {
            ...
            return KotlinTypeFactory.simpleTypeWithNonTrivialMemberScope(simpleType.getAttributes(), new IntersectionTypeConstructor(arrayList2), n0.f26529a, false, simpleType.getMemberScope());
        }
        if (!(constructor instanceof IntersectionTypeConstructor) || !simpleType.isMarkedNullable()) {
            return simpleType;
        }
        IntersectionTypeConstructor intersectionTypeConstructor = (IntersectionTypeConstructor) constructor;
        Collection<KotlinType> collectionMo978getSupertypes3 = intersectionTypeConstructor.mo978getSupertypes();
        ArrayList arrayList3 = new ArrayList(e0.o(collectionMo978getSupertypes3, 10));
        Iterator<T> it3 = collectionMo978getSupertypes3.iterator();
        while (it3.hasNext()) {
