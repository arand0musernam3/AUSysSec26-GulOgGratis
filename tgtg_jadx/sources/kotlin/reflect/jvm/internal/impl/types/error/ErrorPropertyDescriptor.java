...
public final class ErrorPropertyDescriptor implements PropertyDescriptor {
    ...
    public ErrorPropertyDescriptor() {
        ...
        n0 n0Var = n0.f26529a;
        propertyDescriptorImplCreate.setType(errorPropertyType, n0Var, null, null, n0Var);
    ...
    public <R, D> R accept(DeclarationDescriptorVisitor<R, D> declarationDescriptorVisitor, D d3) {
        return (R) this.$$delegate_0.accept(declarationDescriptorVisitor, d3);
    }
    ...
    public ConstantValue<?> mo972getCompileTimeInitializer() {
        return this.$$delegate_0.mo972getCompileTimeInitializer();
    }
