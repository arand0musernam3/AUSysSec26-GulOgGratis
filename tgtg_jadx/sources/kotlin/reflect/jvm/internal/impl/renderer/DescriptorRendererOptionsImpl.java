...
public final class DescriptorRendererOptionsImpl implements DescriptorRendererOptions {
    ...
    @NotNull
    private final d actualPropertiesInPrimaryConstructor$delegate;

    @NotNull
    private final d alwaysRenderModifiers$delegate;

    @NotNull
    private final d annotationArgumentsRenderingPolicy$delegate;

    @NotNull
    private final d annotationFilter$delegate;

    @NotNull
    private final d boldOnlyForNamesInHtml$delegate;

    @NotNull
    private final d classWithPrimaryConstructor$delegate;

    @NotNull
    private final d classifierNamePolicy$delegate = property(ClassifierNamePolicy.SOURCE_CODE_QUALIFIED.INSTANCE);

    @NotNull
    private final d debugMode$delegate;

    @NotNull
    private final d defaultParameterValueRenderer$delegate;

    @NotNull
    private final d eachAnnotationOnNewLine$delegate;

    @NotNull
    private final d enhancedTypes$delegate;

    @NotNull
    private final d excludedAnnotationClasses$delegate;

    @NotNull
    private final d excludedTypeAnnotationClasses$delegate;

    @NotNull
    private final d includeAdditionalModifiers$delegate;

    @NotNull
    private final d includePropertyConstant$delegate;

    @NotNull
    private final d informativeErrorType$delegate;
    private boolean isLocked;

    @NotNull
    private final d modifiers$delegate;

    @NotNull
    private final d normalizedVisibilities$delegate;

    @NotNull
    private final d overrideRenderingPolicy$delegate;

    @NotNull
    private final d parameterNameRenderingPolicy$delegate;

    @NotNull
    private final d parameterNamesInFunctionalTypes$delegate;

    @NotNull
    private final d presentableUnresolvedTypes$delegate;

    @NotNull
    private final d propertyAccessorRenderingPolicy$delegate;

    @NotNull
    private final d receiverAfterName$delegate;

    @NotNull
    private final d renderCompanionObjectName$delegate;

    @NotNull
    private final d renderConstructorDelegation$delegate;

    @NotNull
    private final d renderConstructorKeyword$delegate;

    @NotNull
    private final d renderDefaultAnnotationArguments$delegate;

    @NotNull
    private final d renderDefaultModality$delegate;

    @NotNull
    private final d renderDefaultVisibility$delegate;

    @NotNull
    private final d renderFunctionContracts$delegate;

    @NotNull
    private final d renderPrimaryConstructorParametersAsProperties$delegate;

    @NotNull
    private final d renderTypeExpansions$delegate;

    @NotNull
    private final d renderUnabbreviatedType$delegate;

    @NotNull
    private final d secondaryConstructorsAsPrimary$delegate;

    @NotNull
    private final d startFromDeclarationKeyword$delegate;

    @NotNull
    private final d startFromName$delegate;

    @NotNull
    private final d textFormat$delegate;

    @NotNull
    private final d typeNormalizer$delegate;

    @NotNull
    private final d uninferredTypeParameterAsName$delegate;

    @NotNull
    private final d unitReturnType$delegate;

    @NotNull
    private final d valueParametersHandler$delegate;

    @NotNull
    private final d verbose$delegate;

    @NotNull
    private final d withDefinedIn$delegate;

    @NotNull
    private final d withSourceFileForTopLevel$delegate;

    @NotNull
    private final d withoutReturnType$delegate;

    @NotNull
    private final d withoutSuperTypes$delegate;

    @NotNull
    private final d withoutTypeParameters$delegate;
    ...
    public DescriptorRendererOptionsImpl() {
        ...
        this.excludedAnnotationClasses$delegate = property(p0.f26531a);
    ...
    private final <T> d property(final T t9) {
        return new b(t9) { // from class: kotlin.reflect.jvm.internal.impl.renderer.DescriptorRendererOptionsImpl$property$$inlined$vetoable$1
            @Override // k80.b
            public boolean beforeChange(@NotNull KProperty<?> kProperty, T t11, T t12) {
                kProperty.getClass();
                if (!this.isLocked()) {
                    return true;
                }
                h2.b("Cannot modify readonly DescriptorRendererOptions");
                return false;
            }
        };
    }
        ...
        for (Field field : declaredFields) {
            if ((field.getModifiers() & 8) == 0) {
                ...
                if (bVar != null) {
                    ...
                    field.set(descriptorRendererOptionsImpl, descriptorRendererOptionsImpl.property(bVar.getValue(this, new PropertyReference1Impl(orCreateKotlinClass, name2, "get".concat(name3)))));
                }
            }
        }
    ...
    public void setReceiverAfterName(boolean z11) {
        this.receiverAfterName$delegate.setValue(this, $$delegatedProperties[29], Boolean.valueOf(z11));
    }

    @Override // kotlin.reflect.jvm.internal.impl.renderer.DescriptorRendererOptions
    public void setRenderCompanionObjectName(boolean z11) {
        this.renderCompanionObjectName$delegate.setValue(this, $$delegatedProperties[30], Boolean.valueOf(z11));
    }
    ...
    public void setWithoutSuperTypes(boolean z11) {
        this.withoutSuperTypes$delegate.setValue(this, $$delegatedProperties[21], Boolean.valueOf(z11));
    }

    @Override // kotlin.reflect.jvm.internal.impl.renderer.DescriptorRendererOptions
    public void setWithoutTypeParameters(boolean z11) {
        this.withoutTypeParameters$delegate.setValue(this, $$delegatedProperties[20], Boolean.valueOf(z11));
    }
}
