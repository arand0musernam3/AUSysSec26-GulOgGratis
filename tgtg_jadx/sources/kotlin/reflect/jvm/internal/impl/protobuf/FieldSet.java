...
final class FieldSet<FieldDescriptorType extends FieldDescriptorLite<FieldDescriptorType>> {
    ...
    private static int computeElementSize(WireFormat.FieldType fieldType, int i11, Object obj) {
    ...
    private static int computeElementSizeNoTag(WireFormat.FieldType fieldType, Object obj) {
        switch (AnonymousClass1.$SwitchMap$com$google$protobuf$WireFormat$FieldType[fieldType.ordinal()]) {
            ...
            default:
                d0.k("There is no way to get here, but the compiler thinks otherwise.");
                return 0;
        }
    }
        ...
        if (key.getLiteJavaType() == WireFormat.JavaType.MESSAGE) {
            if (key.isRepeated()) {
                ...
                if (!(value instanceof MessageLite)) {
                    ...
                    a.f("Wrong object type used with protocol message reflection.");
                    return false;
                }
    ...
    public static Object readPrimitiveField(CodedInputStream codedInputStream, WireFormat.FieldType fieldType, boolean z11) throws IOException {
        switch (AnonymousClass1.$SwitchMap$com$google$protobuf$WireFormat$FieldType[fieldType.ordinal()]) {
            ...
            case AEADAlgorithm.AEAD_AES_SIV_CMAC_256 /* 15 */:
                break;
            case 16:
                a.f("readPrimitiveField() cannot handle nested groups.");
                break;
            case 17:
                a.f("readPrimitiveField() cannot handle embedded messages.");
                break;
            case 18:
                a.f("readPrimitiveField() cannot handle enums.");
                break;
            default:
                d0.k("There is no way to get here, but the compiler thinks otherwise.");
                break;
    ...
    */
    ...
    private static void writeElement(CodedOutputStream codedOutputStream, WireFormat.FieldType fieldType, int i11, Object obj) throws IOException {
        if (fieldType == WireFormat.FieldType.GROUP) {
    ...
    public void addRepeatedField(FieldDescriptorType fielddescriptortype, Object obj) {
        ...
        if (!fielddescriptortype.isRepeated()) {
            a.f("addRepeatedField() can only be called on repeated fields.");
            return;
        }
    ...
    public FieldSet<FieldDescriptorType> clone() {
        ...
        while (true) {
            ...
            Map.Entry<K, Object> arrayEntryAt = smallSortedMap.getArrayEntryAt(i11);
    ...
    public Object getRepeatedField(FieldDescriptorType fielddescriptortype, int i11) {
        if (!fielddescriptortype.isRepeated()) {
            a.f("getRepeatedField() can only be called on repeated fields.");
            return null;
        }
        Object field = getField(fielddescriptortype);
        if (field != null) {
    ...
    public boolean hasField(FieldDescriptorType fielddescriptortype) {
        ...
        a.f("hasField() can only be called on non-repeated fields.");
        return false;
    }

    public Iterator<Map.Entry<FieldDescriptorType, Object>> iterator() {
        boolean z11 = this.hasLazyField;
        SmallSortedMap<FieldDescriptorType, Object> smallSortedMap = this.fields;
        return z11 ? new LazyField.LazyIterator(smallSortedMap.entrySet().iterator()) : smallSortedMap.entrySet().iterator();
    }
    ...
    public void mergeFrom(FieldSet<FieldDescriptorType> fieldSet) {
        ...
        while (true) {
            ...
            mergeFromField(smallSortedMap.getArrayEntryAt(i11));
            i11++;
        }
        Iterator it = smallSortedMap.getOverflowEntries().iterator();
        while (it.hasNext()) {
    ...
    public boolean isInitialized() {
        ...
        while (true) {
            ...
            SmallSortedMap<FieldDescriptorType, Object> smallSortedMap = this.fields;
            if (i11 < numArrayEntries) {
                if (!isInitialized(smallSortedMap.getArrayEntryAt(i11))) {
                    return false;
                }
                i11++;
            } else {
