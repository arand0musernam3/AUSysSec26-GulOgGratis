...
public abstract class KPropertyImpl<V> extends KCallableImpl<V> implements KProperty<V> {
    ...
    public static abstract class Getter<V> extends Accessor<V, V> implements KProperty.Getter<V> {
        ...
        @NotNull
        private final j caller = l.a(m.PUBLICATION, new Function0<Caller<?>>(this) { // from class: kotlin.reflect.jvm.internal.KPropertyImpl$Getter$caller$2
            final /* synthetic */ KPropertyImpl.Getter<V> this$0;
    ...
    public static abstract class Setter<V> extends Accessor<V, Unit> implements KMutableProperty.Setter<V> {
        ...
        /* JADX INFO: renamed from: caller$delegate, reason: from kotlin metadata */
        @NotNull
        private final j caller = l.a(m.PUBLICATION, new Function0<Caller<?>>(this) { // from class: kotlin.reflect.jvm.internal.KPropertyImpl$Setter$caller$2
            final /* synthetic */ KPropertyImpl.Setter<V> this$0;
    ...
    private KPropertyImpl(KDeclarationContainerImpl kDeclarationContainerImpl, String str, String str2, PropertyDescriptor propertyDescriptor, Object obj) {
        ...
        this._javaField = l.a(m.PUBLICATION, new Function0<Field>(this) { // from class: kotlin.reflect.jvm.internal.KPropertyImpl$_javaField$1
    ...
    /* JADX WARN: Multi-variable type inference failed */
    @Nullable
    public final Object getDelegateImpl(@Nullable Member fieldOrMethod, @Nullable Object receiver1, @Nullable Object receiver2) throws IllegalPropertyDelegateAccessException {
        try {
    ...
    public KPropertyImpl(@NotNull KDeclarationContainerImpl kDeclarationContainerImpl, @NotNull PropertyDescriptor propertyDescriptor) {
        ...
        this(kDeclarationContainerImpl, strAsString, RuntimeTypeMapper.INSTANCE.mapPropertySignature(propertyDescriptor).getString(), propertyDescriptor, CallableReference.NO_RECEIVER);
    }
}
