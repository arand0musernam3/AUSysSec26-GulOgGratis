...
public final class KTypeParameterImpl implements KTypeParameter, KClassifierImpl {
        ...
        if (kTypeParameterOwnerImpl == null) {
            ...
            if (containingDeclaration instanceof ClassDescriptor) {
                ...
                if (!(containingDeclaration instanceof CallableMemberDescriptor)) {
                    d.q(containingDeclaration, "Unknown type parameter container: ");
                    throw null;
                }
                ...
                if (containingDeclaration2 instanceof ClassDescriptor) {
                    ...
                    if (deserializedMemberDescriptor == null) {
                        d.q(containingDeclaration, "Non-class callable descriptor must be deserialized: ");
                        throw null;
                    }
                    KClass kClassY = w.y(getContainerClass(deserializedMemberDescriptor));
                    kClassY.getClass();
                    kClassImpl = (KClassImpl) kClassY;
                }
                objAccept = containingDeclaration.accept(new CreateKCallableVisitor(kClassImpl), Unit.f26487a);
            }
            objAccept.getClass();
    ...
    private final Class<?> getContainerClass(DeserializedMemberDescriptor deserializedMemberDescriptor) {
        ...
        d.q(deserializedMemberDescriptor, "Container of deserialized member is not resolved: ");
        return null;
    }

    private final KClassImpl<?> toKClassImpl(ClassDescriptor classDescriptor) {
        Class<?> javaClass = UtilKt.toJavaClass(classDescriptor);
        KClassImpl<?> kClassImpl = (KClassImpl) (javaClass != null ? Reflection.getOrCreateKotlinClass(javaClass) : null);
        if (kClassImpl != null) {
            return kClassImpl;
        }
        d.r(classDescriptor.getContainingDeclaration(), "Type parameter container is not resolved: ");
        return null;
    }
    ...
    public KVariance getVariance() {
        int i11 = WhenMappings.$EnumSwitchMapping$0[getDescriptor().getVariance().ordinal()];
        if (i11 == 1) {
