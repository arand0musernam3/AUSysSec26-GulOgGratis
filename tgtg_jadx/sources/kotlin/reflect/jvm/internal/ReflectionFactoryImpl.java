...
public class ReflectionFactoryImpl extends ReflectionFactory {
    ...
    public KType typeOf(KClassifier kClassifier, List<KTypeProjection> list, boolean z11) {
        return kClassifier instanceof ClassBasedDeclarationContainer ? CachesKt.getOrCreateKType(((ClassBasedDeclarationContainer) kClassifier).getJClass(), list, z11) : KClassifiers.createType(kClassifier, list, z11, Collections.EMPTY_LIST);
    }
    ...
    public KTypeParameter typeParameter(Object obj, String str, KVariance kVariance, boolean z11) {
        ...
        if (obj instanceof KClass) {
            ...
            if (!(obj instanceof KCallable)) {
                a.f(s.j(obj, "Type parameter container must be a class or a callable: "));
                return null;
            }
        ...
        i1.k("Type parameter ", str, " is not found in container: ", obj);
        return null;
    }
