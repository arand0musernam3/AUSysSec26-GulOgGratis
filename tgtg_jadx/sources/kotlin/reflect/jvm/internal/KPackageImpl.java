...
public final class KPackageImpl extends KDeclarationContainerImpl {
    ...
    public final class Data extends KDeclarationContainerImpl.Data {
        ...
        public Data() {
            ...
            this.multifileFacade = ReflectProperties.lazy(new Function0<Class<?>>() { // from class: kotlin.reflect.jvm.internal.KPackageImpl$Data$multifileFacade$2
                ...
                public final Class<?> invoke() {
                    ...
                    String strReplace = multifileClassName.replace('/', '.');
                    strReplace.getClass();
                    return classLoader.loadClass(strReplace);
                }
            });
            this.metadata = ReflectProperties.lazy(new Function0<u>() { // from class: kotlin.reflect.jvm.internal.KPackageImpl$Data$metadata$2
                {
                    super(0);
                }
                ...
                public final u invoke() {
                    ...
                    if (kotlinClass != null && (classHeader = kotlinClass.getClassHeader()) != null) {
                        ...
                        if (data != null && strings != null) {
                            ...
                            return new u((JvmNameResolver) packageDataFrom.f26485a, (ProtoBuf.Package) packageDataFrom.f26486b, classHeader.getMetadataVersion());
                        }
                    }
                    return null;
                }
        ...
        public final u getMetadata() {
            return (u) this.metadata.getValue(this, $$delegatedProperties[3]);
        }
    ...
    public PropertyDescriptor getLocalProperty(int index) {
        u metadata = this.data.invoke().getMetadata();
        if (metadata != null) {
            JvmNameResolver jvmNameResolver = (JvmNameResolver) metadata.f40859a;
            ProtoBuf.Package r22 = (ProtoBuf.Package) metadata.f40860b;
            JvmMetadataVersion jvmMetadataVersion = (JvmMetadataVersion) metadata.f40861c;
            ...
            ProtoBuf.Property property = (ProtoBuf.Property) ProtoBufUtilKt.getExtensionOrNull(r22, generatedExtension, index);
            if (property != null) {
