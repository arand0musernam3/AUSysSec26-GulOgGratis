...
@d
@Deprecated
public abstract class FunctionImpl implements f, Serializable, Function0, Function1, Function2, n, o, p, q, r, s, t, a, b, c, i80.d, e, i80.f, g, h, i, j, k, l, m {
    ...
    private void throwWrongArity(int i11) {
        StringBuilder sbK = org.bouncycastle.jcajce.provider.asymmetric.a.k(i11, "Wrong function arity, expected: ", ", actual: ");
        sbK.append(getArity());
