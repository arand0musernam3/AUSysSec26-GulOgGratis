...
public class Reflection {
    ...
    public static KTypeParameter typeParameter(Object obj, String str, KVariance kVariance, boolean z11) {
        return factory.typeParameter(obj, str, kVariance, z11);
    }
    ...
    public static void setUpperBounds(KTypeParameter kTypeParameter, KType... kTypeArr) {
        factory.setUpperBounds(kTypeParameter, y.T(kTypeArr));
    }
    ...
    public static KType nullableTypeOf(Class cls, KTypeProjection... kTypeProjectionArr) {
        return factory.typeOf(getOrCreateKotlinClass(cls), y.T(kTypeProjectionArr), true);
    }

    public static KType typeOf(Class cls, KTypeProjection... kTypeProjectionArr) {
        return factory.typeOf(getOrCreateKotlinClass(cls), y.T(kTypeProjectionArr), false);
    }
}
